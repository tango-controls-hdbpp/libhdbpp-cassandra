...
from common import getSingletoneAPI as getCommonAPI
...
from files import LoadArchivingConfiguration

__all__=['snap','reader','archiving']

print 'PyTangoArchiving loaded'
