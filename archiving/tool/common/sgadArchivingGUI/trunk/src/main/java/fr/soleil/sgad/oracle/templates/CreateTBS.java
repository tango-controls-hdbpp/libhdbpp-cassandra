...
public class CreateTBS {
	public static String getText() {
		String create_tbs = "";
		create_tbs = "#rem ---------------------------------------------"
				+ fr.soleil.sgad.Constants.newLine + "#rem --						--"
				+ fr.soleil.sgad.Constants.newLine
				+ "#rem --      This script create all tablespaces	--"
				+ fr.soleil.sgad.Constants.newLine
				+ "#rem -- 	change directory if necessary	--"
				+ fr.soleil.sgad.Constants.newLine + "#rem --      "
				...
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ generateTablespaces_Common();

		if (fr.soleil.sgad.oracle.Constants.generationMode == 0) {
			create_tbs = create_tbs + fr.soleil.sgad.Constants.newLine
					+ generateTablespaces_StandardMode();
	...
	private static String generateTablespaces_Common() {
		String create_tbs = "";
		create_tbs = "CREATE TABLESPACE conf"
				+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\conf01.dbf'" + fr.soleil.sgad.Constants.newLine + "\t\t "
				...
				+ fr.soleil.sgad.Constants.newLine
				+ "CREATE TABLESPACE conf_ind"
				+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\conf_ind01.dbf'" + fr.soleil.sgad.Constants.newLine
				...
				+ "EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;"
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine + "CREATE TABLESPACE TOOLS"
				+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\tools01.dbf'" + fr.soleil.sgad.Constants.newLine + "\t\t "
		...
		if (fr.soleil.sgad.oracle.Generator.hdb_generation) {
			create_tbs = create_tbs + "CREATE TABLESPACE SNAP"
					+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
					+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
					+ "\\oradata\\"
					+ fr.soleil.sgad.oracle.Generator._oracle_sid
					+ "\\snap01.dbf'" + fr.soleil.sgad.Constants.newLine
					+ "\t\t " + "SIZE 50M" + fr.soleil.sgad.Constants.newLine
					+ "\t\t " + "REUSE" + fr.soleil.sgad.Constants.newLine
					+ "\t\t " + "AUTOEXTEND ON"
					+ fr.soleil.sgad.Constants.newLine + "\t\t\t "
	...
	private static String generateTablespaces_StandardMode() {
		String create_tbs = "";
		create_tbs = "CREATE TABLESPACE SC_DATA"
				+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\sc_data01.dbf'" + fr.soleil.sgad.Constants.newLine
				...
				+ fr.soleil.sgad.Constants.newLine + ""
				+ fr.soleil.sgad.Constants.newLine
				+ "CREATE TABLESPACE SC_DATA_ind"
				+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\sc_data_ind01.dbf'" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "SIZE 100M" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "REUSE" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "AUTOEXTEND ON" + fr.soleil.sgad.Constants.newLine
				+ "\t\t\t " + "NEXT		100M" + fr.soleil.sgad.Constants.newLine
				...
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\sp_data01.dbf'" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "SIZE 100M" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "REUSE" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "AUTOEXTEND ON" + fr.soleil.sgad.Constants.newLine
				+ "\t\t\t " + "NEXT		100M" + fr.soleil.sgad.Constants.newLine
				...
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ "CREATE TABLESPACE SP_DATA_ind"
				+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\sp_data_ind01.dbf'" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "SIZE 100M" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "REUSE" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "AUTOEXTEND ON" + fr.soleil.sgad.Constants.newLine
				+ "\t\t\t " + "NEXT		100M" + fr.soleil.sgad.Constants.newLine
				...
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ "CREATE TABLESPACE IM_DATA"
				+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\im_data01.dbf'" + fr.soleil.sgad.Constants.newLine
				...
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ "CREATE TABLESPACE IM_DATA_ind"
				+ fr.soleil.sgad.Constants.newLine + "\t " + "DATAFILE '"
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ "\\oradata\\" + fr.soleil.sgad.oracle.Generator._oracle_sid
				+ "\\im_data_ind01.dbf'" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "SIZE 50M" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "REUSE" + fr.soleil.sgad.Constants.newLine
				+ "\t\t " + "AUTOEXTEND ON" + fr.soleil.sgad.Constants.newLine
				+ "\t\t\t " + "NEXT		100M" + fr.soleil.sgad.Constants.newLine
		...
		for (int i = 0; i < fr.soleil.sgad.oracle.Constants.domains.length; i++) {
			for (int j = 1; j < fr.soleil.sgad.oracle.Constants.domainsNum[i]; j++) {
				tbs = tbs
						...
						+ "_"
						+ fr.soleil.sgad.oracle.Constants.domains[i]
								.replaceAll("-", "")
						+ (((fr.soleil.sgad.oracle.Constants.domainsNum[i] > 2) && (j < 10)) ? "0"
								: "")
						+ (((fr.soleil.sgad.oracle.Constants.domainsNum[i] > 2)) ? Integer
								.toString(j)
								: "")
						+ "\""
						+ " DATAFILE '"
						+ Generator._oracleBase_Path
						+ fr.soleil.sgad.oracle.Constants.datafiles[i]
						+ fr.soleil.sgad.oracle.Constants.types[0]
						+ "_"
						+ fr.soleil.sgad.oracle.Constants.domains[i]
								.replaceAll("-", "")
						...
						+ (((fr.soleil.sgad.oracle.Constants.domainsNum[i] > 2)) ? Integer
								...
								: "")
						+ ".dbf"
						+ "' SIZE 10M REUSE AUTOEXTEND ON NEXT 10M\tMAXSIZE\t30000M EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;"
						+ fr.soleil.sgad.Constants.newLine;
			}
		}
		return tbs;
