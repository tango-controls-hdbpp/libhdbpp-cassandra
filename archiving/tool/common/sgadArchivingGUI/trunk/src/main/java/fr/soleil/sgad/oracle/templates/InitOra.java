...
public class InitOra {
	...
	public static String getText() {
		...
		io = "db_name = "
				...
				+ "\\udump"
				+ fr.soleil.sgad.Constants.newLine
				+ "max_dump_file_size = 5M  # limit trace file size to 5mb"
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ "control_files=("
				+ fr.soleil.sgad.Constants.newLine
				...
				+ ((!fr.soleil.sgad.oracle.Generator.hdb_generation
						&& fr.soleil.sgad.oracle.Generator.tdb_generation && !fr.soleil.sgad.oracle.Generator.snap_generation) ? "UNDO_RETENTION=300"
						: "")
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+
				...
				(!(!fr.soleil.sgad.oracle.Generator.hdb_generation
						&& fr.soleil.sgad.oracle.Generator.tdb_generation && !fr.soleil.sgad.oracle.Generator.snap_generation) ? "log_archive_dest = "
						+ fr.soleil.sgad.oracle.Generator._redo_path
						+ fr.soleil.sgad.Constants.newLine
				...
				fr.soleil.sgad.Constants.newLine
				+ "# dispatchers = \"(PROTOCOL=TCP)(DISPATCHERS=3)(SERVICE="
				+ fr.soleil.sgad.oracle.Generator._oracle_sid + ")\""
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine + "UTL_FILE_DIR = '*'"
				+ fr.soleil.sgad.Constants.newLine;
		return io;
	}
}
