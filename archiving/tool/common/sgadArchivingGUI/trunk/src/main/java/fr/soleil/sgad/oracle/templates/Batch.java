...
public class Batch {
	public static String getText() {
		String batchText = "";
		batchText = "SET ORACLE_SID="
				+ fr.soleil.sgad.oracle.Generator._oracle_sid
				+ fr.soleil.sgad.Constants.newLine + "SET ORACLE_BASE="
				+ fr.soleil.sgad.oracle.Generator._oracleBase_Path
				+ fr.soleil.sgad.Constants.newLine + "SET ORACLE_HOME="
				+ fr.soleil.sgad.oracle.Generator._oracleHome_Path
				+ fr.soleil.sgad.Constants.newLine + "ECHO ."
				+ fr.soleil.sgad.Constants.newLine + "oradim -new -sid "
				+ fr.soleil.sgad.oracle.Generator._oracle_sid
				+ " -intpwd oracle -startmode manual -pfile \""
				+ fr.soleil.sgad.oracle.Generator.FilesPath[0] + "\""
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine +

				"%ORACLE_HOME%\\bin\\sqlplus /nolog @"
				+ fr.soleil.sgad.oracle.Generator.FilesPath[1]
				+ fr.soleil.sgad.Constants.newLine + "PAUSE"
				+ fr.soleil.sgad.Constants.newLine
				+ "%ORACLE_HOME%\\bin\\sqlplus /nolog @"
				+ fr.soleil.sgad.oracle.Generator.FilesPath[2]
				+ fr.soleil.sgad.Constants.newLine + "PAUSE"
				+ fr.soleil.sgad.Constants.newLine
				+ "%ORACLE_HOME%\\bin\\sqlplus /nolog @"
				+ fr.soleil.sgad.oracle.Generator.FilesPath[3]
				+ fr.soleil.sgad.Constants.newLine + "PAUSE"
				+ fr.soleil.sgad.Constants.newLine
				+ "%ORACLE_HOME%\\bin\\sqlplus /nolog @"
				+ fr.soleil.sgad.oracle.Generator.FilesPath[4]
				+ fr.soleil.sgad.Constants.newLine + "PAUSE"
				+ fr.soleil.sgad.Constants.newLine
				+ "%ORACLE_HOME%\\bin\\oradim -edit -sid "
				+ fr.soleil.sgad.oracle.Generator._oracle_sid
				+ " -startmode auto" + fr.soleil.sgad.Constants.newLine
