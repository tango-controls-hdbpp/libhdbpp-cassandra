...
public class HDB_TDB_Template {
	public static void objects_gen(int schema) {
		fr.soleil.sgad.mysql.Generator
				.add_object(fr.soleil.sgad.Constants.newLine
						...
						+ "(Schema "
						+ fr.soleil.sgad.mysql.Constants.schema[schema] + ")"
						+ fr.soleil.sgad.Constants.newLine
						+ fr.soleil.sgad.mysql.Constants.separator
						+ fr.soleil.sgad.Constants.newLine);
		tables_gen(schema);
	...
	private static void tableADT_gen(int schema) {
		String table = (0 == schema ? fr.soleil.sgad.mysql.Constants.hdbObjects[0]
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table
				...
				+ " COMMENT='Attribute Definition Table' AUTO_INCREMENT=1 ;"
				+ fr.soleil.sgad.Constants.newLine);
	}

	private static void tableAPT_gen(int schema) {
		String table = (0 == schema ? fr.soleil.sgad.mysql.Constants.hdbObjects[1]
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table
				...
				+ " COMMENT='Attribute Properties table';"
				+ fr.soleil.sgad.Constants.newLine);

	}

	private static void tableAMT_gen(int schema) {
		String table = (0 == schema ? fr.soleil.sgad.mysql.Constants.hdbObjects[2]
		...
		fr.soleil.sgad.mysql.Generator
				.add_object("CREATE TABLE `"
						...
						((1 == schema) ? ", "
								+ fr.soleil.sgad.Constants.newLine + "\t"
								+ "`export_per` int(11) NOT NULL default '0',"
								+ fr.soleil.sgad.Constants.newLine + "\t"
								+ "`keeping_per` int(11) NOT NULL default '0'"
								+ fr.soleil.sgad.Constants.newLine
								: fr.soleil.sgad.Constants.newLine)
						+
						// --
