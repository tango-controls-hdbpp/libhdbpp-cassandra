...
public class Generator {
	...
	public void initialisation() {
		...
		try {
			...
			System.err.println("ERROR !! " + fr.soleil.sgad.Constants.newLine
					+ "\t Origin : \t " + "ScriptGenerator.query"
					+ fr.soleil.sgad.Constants.newLine + "\t Reason : \t "
					+ "I/O_FAILURE" + fr.soleil.sgad.Constants.newLine
	...
	public void pathTuning() throws IOException {
		...
		_redo_path = _oracleBase_Path + File.separator + "redo"
				+ File.separator + _oracle_sid;
		/*
		 * while (_redo_path.equals("")) {
		 * System.out.println("Chemin ORACLE_REDO ?"); _redo_path =
	...
	private void query_schema(int i) throws IOException {
		System.out.println("Creation du schéma " + "'"
				+ fr.soleil.sgad.oracle.Constants.schema[i] + "'" + " ?");
	...
	private void passiveUsers_generation() {
		passiveUsers_gen.append(fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.oracle.Constants.separator
				+ fr.soleil.sgad.Constants.newLine + "--\t\t\t SCHEMA"
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.oracle.Constants.separator
				+ fr.soleil.sgad.Constants.newLine);

		passiveUsers_gen.append("CREATE USER " + "administrator"
				+ " IDENTIFIED BY " + "admin" + " DEFAULT TABLESPACE "
				+ "TOOLS" + " TEMPORARY TABLESPACE" + " temp" + ";"
				+ fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen.append("GRANT " + "dba" + " TO " + "administrator"
				+ ";" + fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen.append("GRANT " + "sysdba" + " TO " + "administrator"
				+ ";" + fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen.append("GRANT CONNECT TO " + "administrator" + ";"
				+ fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen
				.append("GRANT SELECT on SYS.DBA_EXTENTS to administrator"
						+ ";" + fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen
				.append("GRANT SELECT on SYS.DBA_TABLESPACES to administrator"
						+ ";" + fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen
				.append("GRANT SELECT on SYS.DBA_DATA_FILES to administrator"
						+ ";" + fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen
				.append("GRANT SELECT on SYS.DBA_FREE_SPACE to administrator"
						+ ";" + fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen
				.append("GRANT SELECT on SYS.DBA_TAB_COLUMNS to administrator"
						+ ";" + fr.soleil.sgad.Constants.newLine);
		passiveUsers_gen.append("GRANT ALL PRIVILEGES to administrator" + ";"
				+ fr.soleil.sgad.Constants.newLine);
	...
	private void grants_gen() {
		grants_gen.append(fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.oracle.Constants.separator
				+ fr.soleil.sgad.Constants.newLine + "--\t\t\t PRIVILEGES "
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.oracle.Constants.separator
				+ fr.soleil.sgad.Constants.newLine);
		for (int i = 0; i < fr.soleil.sgad.oracle.Constants.roles.length; i++) {
	...
	private void grantsCommon_gen(int schema, int role) {
		String user = fr.soleil.sgad.oracle.Constants.roles_prefix
				+ fr.soleil.sgad.oracle.Constants.schema[schema]
				+ fr.soleil.sgad.oracle.Constants.roles[role];
		grants_gen.append("GRANT CREATE SESSION TO " + user + ";"
				+ fr.soleil.sgad.Constants.newLine);
		grants_gen.append("GRANT EXECUTE ANY TYPE TO " + user + ";"
				+ fr.soleil.sgad.Constants.newLine);
	}
	...
	private void grantsSpecific_gen(int schema, int role) {
		...
		case 0: // HDB
			switch (role) {
			case 0: // manager
				grants_gen.append("GRANT CREATE ANY INDEX TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT CREATE ANY TABLE TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT CREATE ANY PROCEDURE TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT EXECUTE ANY PROCEDURE TO " + user
						+ ";" + fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT SELECT ON "
						+ fr.soleil.sgad.oracle.Constants.schema[schema] + "."
				...
				grants_gen.append("GRANT SELECT ON "
						...
						+ " TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT INSERT ON "
						+ fr.soleil.sgad.oracle.Constants.schema[schema] + "."
						+ fr.soleil.sgad.oracle.Constants.hdbObjects[0]
						+ " TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				...
				grants_gen.append("GRANT INSERT ON "
						...
						+ " TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT UPDATE ON "
						+ fr.soleil.sgad.oracle.Constants.schema[schema] + "."
						+ fr.soleil.sgad.oracle.Constants.hdbObjects[1]
						+ " TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				...
				break;
			case 1: // archiver
				grants_gen.append("GRANT ALTER ANY INDEX TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT LOCK ANY TABLE TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				...
				grants_gen.append("GRANT SELECT ON "
						+ fr.soleil.sgad.oracle.Constants.schema[schema] + "."
						+ fr.soleil.sgad.oracle.Constants.hdbObjects[3]
						+ " TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT INSERT ON "
						+ fr.soleil.sgad.oracle.Constants.schema[schema] + "."
				...
				grants_gen.append("GRANT SELECT ON "
						+ fr.soleil.sgad.oracle.Constants.schema[schema] + "."
						+ fr.soleil.sgad.oracle.Constants.hdbObjects[4]
						+ " TO " + user + ";"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT INSERT ON "
						+ fr.soleil.sgad.oracle.Constants.schema[schema] + "."
			...
			case 0: // manager
				...
				for (int i = 0; i < fr.soleil.sgad.oracle.Constants.snapObjects.length; i++) {
					grants_gen.append("GRANT SELECT ON "
							+ fr.soleil.sgad.oracle.Constants.schema[schema]
							+ "."
							+ fr.soleil.sgad.oracle.Constants.snapObjects[i]
							+ " TO " + user + ";"
							+ fr.soleil.sgad.Constants.newLine);
					grants_gen.append("GRANT INSERT ON "
							+ fr.soleil.sgad.oracle.Constants.schema[schema]
							...
							+ " TO " + user + ";"
							+ fr.soleil.sgad.Constants.newLine);
					grants_gen.append("GRANT EXECUTE ON "
							+ fr.soleil.sgad.oracle.Constants.schema[schema]
							+ "."
							+ fr.soleil.sgad.oracle.Constants.snapObjects[i]
							+ " TO " + user + ";"
	...
	private void passiveUsers_generation(int schema) {
		...
		if (schema < 2) {
			passU = passU + fr.soleil.sgad.Constants.newLine + "CREATE USER "
					+ user + " IDENTIFIED BY " + user + " DEFAULT TABLESPACE "
					+ "conf" + " TEMPORARY TABLESPACE " + "temp"
					+ fr.soleil.sgad.Constants.newLine + "\t"
					+ "QUOTA UNLIMITED ON \"CONF\""
					+ fr.soleil.sgad.Constants.newLine + "\t"
					+ "QUOTA UNLIMITED ON \"CONF_IND\""
					+ fr.soleil.sgad.Constants.newLine + "\t"
				...
				for (int k = 0; k < fr.soleil.sgad.oracle.Constants.domains.length; k++) {
					for (int l = 1; l < fr.soleil.sgad.oracle.Constants.domainsNum[k]; l++) {
						passU = passU
								+ "\t"
								+ "QUOTA UNLIMITED ON \""
								+ fr.soleil.sgad.oracle.Constants.types[0]
								+ "_"
								+ fr.soleil.sgad.oracle.Constants.domains[k]
										.replaceAll("-", "")
								+ (((fr.soleil.sgad.oracle.Constants.domainsNum[k] > 2) && (l < 10)) ? "0"
										: "")
								+ (((fr.soleil.sgad.oracle.Constants.domainsNum[k] > 2)) ? Integer
										.toString(l)
										: "") + "\""
								+ fr.soleil.sgad.Constants.newLine;
					}
					...
					|| 1 == schema) {
				passU = passU + "\t" + "QUOTA UNLIMITED ON \"SC_DATA\""
						+ fr.soleil.sgad.Constants.newLine + "\t"
						+ "QUOTA UNLIMITED ON \"SC_DATA_IND\""
						+ fr.soleil.sgad.Constants.newLine + "\t"
						+ "QUOTA UNLIMITED ON \"SP_DATA\""
						+ fr.soleil.sgad.Constants.newLine + "\t"
						+ "QUOTA UNLIMITED ON \"SP_DATA_IND\""
						+ fr.soleil.sgad.Constants.newLine + "\t"
						+ "QUOTA UNLIMITED ON \"IM_DATA\""
						+ fr.soleil.sgad.Constants.newLine + "\t"
						+ "QUOTA UNLIMITED ON \"IM_DATA_IND\""
						+ fr.soleil.sgad.Constants.newLine;
			}
			...
			passU = passU + fr.soleil.sgad.Constants.newLine + "CREATE USER "
					...
					+ fr.soleil.sgad.Constants.newLine + "\t"
					+ "QUOTA UNLIMITED ON \""
					+ fr.soleil.sgad.oracle.Constants.schema[2].toUpperCase()
					+ "\"" + ";" + fr.soleil.sgad.Constants.newLine
					+ fr.soleil.sgad.Constants.newLine;
		}
		passU = passU + "GRANT CONNECT TO " + user + ";"
				+ fr.soleil.sgad.Constants.newLine;
		passU = passU + "GRANT CREATE TYPE TO " + user + ";"
				+ fr.soleil.sgad.Constants.newLine;
		passU = passU + "GRANT RESOURCE TO " + user + ";"
				+ fr.soleil.sgad.Constants.newLine;
		passU = passU + "GRANT ALL PRIVILEGES TO " + user + ";"
				+ fr.soleil.sgad.Constants.newLine;
		passiveUsers_gen.append(passU);
	}

	private void activeUsers_generation() {
		activeUsers_gen.append(fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.oracle.Constants.separator
				+ fr.soleil.sgad.Constants.newLine
				+ "--\t\t\t UILISATEURS ACTIFS"
	...
	private void activeUsers_generation(int i) {
		...
		for (int j = 0; j < fr.soleil.sgad.oracle.Constants.activesUser.length; j++) {
			String user = schema
					+ fr.soleil.sgad.oracle.Constants.activesUser[j];
			actiU = actiU + "CREATE USER " + user + " IDENTIFIED BY " + user
	...
	private void user2role_generation() {
		user2role_gen.append(fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.oracle.Constants.separator
				+ fr.soleil.sgad.Constants.newLine
				+ "--\t\t\t ASSOSSIATION DE ROLE AUX UILISATEURS ACTIFS"
				+ fr.soleil.sgad.Constants.newLine
				+ fr.soleil.sgad.oracle.Constants.separator
				+ fr.soleil.sgad.Constants.newLine);
		for (int i = 0; i < fr.soleil.sgad.oracle.Constants.roles.length; i++) {
	...
	private void user2role_generation(int schema, int role) {
		String my_role = fr.soleil.sgad.oracle.Constants.roles_prefix
				+ fr.soleil.sgad.oracle.Constants.schema[schema]
				+ fr.soleil.sgad.oracle.Constants.roles[role];
		String my_user = fr.soleil.sgad.oracle.Constants.schema[schema]
				+ fr.soleil.sgad.oracle.Constants.roles[role];
		user2role_gen.append("GRANT " + my_role + " TO " + my_user + ";"
				+ fr.soleil.sgad.Constants.newLine);
	}
	...
	public void printFile() {
		System.out.println("File  : " + fr.soleil.sgad.Constants.newLine
				+ heading.toString() + roles_gen.toString()
				+ passiveUsers_gen.toString() + objects_gen.toString()
				+ grants_gen.toString() + activeUsers_gen.toString()
				+ user2role_gen.toString() + ending.toString());
	}
	...
	public void writeInitOraFile() {
		...
		try {
			...
			stringBuffer.append(fr.soleil.sgad.oracle.templates.InitOra
					.getText());
			...
			System.err.println("ERROR !! " + fr.soleil.sgad.Constants.newLine
					+ "\t Origin : \t " + "Generator.writeInitOraFile"
					+ fr.soleil.sgad.Constants.newLine + "\t Reason : \t "
					+ "I/O_FAILURE" + fr.soleil.sgad.Constants.newLine
					+ "\t Description : \t " + e.getMessage()
					+ fr.soleil.sgad.Constants.newLine + "\t Précision : "
					+ "\t\t FileName" + fileName
					+ fr.soleil.sgad.Constants.newLine);
		}
	}
	...
	public void writeCreateDB() {
		...
		try {
			...
			StringBuffer stringBuffer = new StringBuffer("");
			stringBuffer.append(fr.soleil.sgad.oracle.templates.CreateDB
					.getText());
			...
			System.err.println("ERROR !! " + fr.soleil.sgad.Constants.newLine
					+ "\t Origin : \t " + "Generator.writeCreateDB"
					+ fr.soleil.sgad.Constants.newLine + "\t Reason : \t "
					+ "I/O_FAILURE" + fr.soleil.sgad.Constants.newLine
					+ "\t Description : \t " + e.getMessage()
					+ fr.soleil.sgad.Constants.newLine + "\t Précision : "
	...
	public void writeCreateTBS() {
		...
		try {
			...
			StringBuffer stringBuffer = new StringBuffer("");
			stringBuffer.append(fr.soleil.sgad.oracle.templates.CreateTBS
					.getText());
			...
			System.err.println("ERROR !! " + fr.soleil.sgad.Constants.newLine
					+ "\t Origin : \t " + "Generator.writeCreateTBS"
					+ fr.soleil.sgad.Constants.newLine + "\t Reason : \t "
					+ "I/O_FAILURE" + fr.soleil.sgad.Constants.newLine
					+ "\t Description : \t " + e.getMessage()
					+ fr.soleil.sgad.Constants.newLine + "\t Précision : "
	...
	public void writeCatalogues() {
		...
		try {
			...
			StringBuffer stringBuffer = new StringBuffer("");
			stringBuffer.append(fr.soleil.sgad.oracle.templates.CreateDBCatalog
					.getText());
			...
			System.err.println("ERROR !! " + fr.soleil.sgad.Constants.newLine
					+ "\t Origin : \t " + "Generator.writeCatalogues"
					+ fr.soleil.sgad.Constants.newLine + "\t Reason : \t "
					+ "I/O_FAILURE" + fr.soleil.sgad.Constants.newLine
					+ "\t Description : \t " + e.getMessage()
					+ fr.soleil.sgad.Constants.newLine + "\t Précision : "
	...
	public void writeSchemaFile() {
		...
		try {
			...
			System.err.println("ERROR !! " + fr.soleil.sgad.Constants.newLine
					+ "\t Origin : \t " + "Generator.writeSchemaFile"
					+ fr.soleil.sgad.Constants.newLine + "\t Reason : \t "
					+ "I/O_FAILURE" + fr.soleil.sgad.Constants.newLine
					+ "\t Description : \t " + e.getMessage()
					+ fr.soleil.sgad.Constants.newLine + "\t Précision : "
	...
	public void writeBatchFile() {
		...
		try {
			...
			StringBuffer stringBuffer = new StringBuffer("");
			stringBuffer
					.append(fr.soleil.sgad.oracle.templates.Batch.getText());
			...
			System.err.println("ERROR !! " + fr.soleil.sgad.Constants.newLine
					+ "\t Origin : \t " + "Generator.writeBatchFile"
					+ fr.soleil.sgad.Constants.newLine + "\t Reason : \t "
					+ "I/O_FAILURE" + fr.soleil.sgad.Constants.newLine
					+ "\t Description : \t " + e.getMessage()
					+ fr.soleil.sgad.Constants.newLine + "\t Précision : "
	...
	private void initFilePaths() {
		...
		FilesPath[0] = _oracleBase_Path + File.separator + "admin"
				+ File.separator + _oracle_sid + File.separator + "pfile"
				+ File.separator + "init.ora";
		...
		DirsPath0[0] = _oracleBase_Path + File.separator + "admin"
				+ File.separator + _oracle_sid;
		DirsPath0[1] = _oracleBase_Path + File.separator + "oradata"
				+ File.separator + _oracle_sid;
		DirsPath0[2] = _redo_path;

		DirsPath1[0] = _oracleBase_Path + File.separator + "admin"
				+ File.separator + _oracle_sid + File.separator + "pfile";
		DirsPath1[1] = _oracleBase_Path + File.separator + "admin"
				+ File.separator + _oracle_sid + File.separator + "udump";
		DirsPath1[2] = _oracleBase_Path + File.separator + "admin"
				+ File.separator + _oracle_sid + File.separator + "bdump";
		DirsPath1[3] = _oracleBase_Path + File.separator + "admin"
				+ File.separator + _oracle_sid + File.separator + "cdump";
		DirsPath1[4] = _oracleBase_Path + File.separator + "admin"
				+ File.separator + _oracle_sid + File.separator + "create";
		DirsPath1[5] = _oracleBase_Path + File.separator + "admin"
				+ File.separator + _oracle_sid + File.separator + "archive";
		DirsPath1[6] = _oracleBase_Path + File.separator + "oradata"
				+ File.separator + _oracle_sid;
		DirsPath1[7] = _redo_path;
		DirsPath1[8] = _script_Path;

		System.out.println("Generator.initFilePaths : chemins... "
				+ fr.soleil.sgad.Constants.newLine);
		for (int i = 0; i < FilesPath.length; i++) {
			String s = FilesPath[i];
			System.out
					.println(i + " : " + s + fr.soleil.sgad.Constants.newLine);
		}
