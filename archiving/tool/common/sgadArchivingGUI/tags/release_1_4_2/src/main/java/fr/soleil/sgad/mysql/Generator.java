...
public class Generator {
	...
	private void heading_generation() {
		heading.append(fr.soleil.sgad.mysql.Constants.separator
				+ fr.soleil.sgad.Constants.newLine + "#" + "\t\t\t"
				+ DateUtil.getTime() + ", SYNCHROTRON SOLEIL"
				+ fr.soleil.sgad.Constants.newLine + "#" + "\t\t\t"
	...
	private void grants_gen() {
		...
		grants_gen.append(fr.soleil.sgad.Constants.newLine
				+ "FLUSH PRIVILEGES;" + fr.soleil.sgad.Constants.newLine);
	}

	/*
	 * private void grantsSpecificRemove_gen(int schema , int role) { String
	 * user = fr.soleil.sgad.icons.mysql.Constants.schema[ schema ] +
	 * fr.soleil.sgad.icons.mysql.Constants.roles[ role ];
	 * grants_gen.append(fr.soleil.sgad.icons.Constants.newLine +
	 * fr.soleil.sgad.icons.Constants.newLine +
	 * fr.soleil.sgad.icons.mysql.Constants.separator +
	 * fr.soleil.sgad.icons.Constants.newLine +
	 ...
	 * fr.soleil.sgad.icons.Constants.newLine + "FLUSH PRIVILEGES ;" +
	 * fr.soleil.sgad.icons.Constants.newLine +
	...
	private void grantsSpecific_gen(int schema, int role) {
		...
		case 0: // HDB
			switch (role) {
			case 0: // manager
				grants_gen.append(fr.soleil.sgad.Constants.newLine + "# The '"
						+ user + "' inserts record in the tables '"
						+ fr.soleil.sgad.mysql.Constants.hdbObjects[0]
						+ "' and '"
						+ fr.soleil.sgad.mysql.Constants.hdbObjects[1] + "'."
						+ fr.soleil.sgad.Constants.newLine + "# The '" + user
						+ "' creates the tables related to the attributes."
						+ fr.soleil.sgad.Constants.newLine + "# The '" + user
						+ "' can make a select on every table of the database."
						+ fr.soleil.sgad.Constants.newLine
						+ fr.soleil.sgad.Constants.newLine);

				grants_gen.append("GRANT USAGE ON " + schemaSt + ".* TO '"
						+ user + "'@'localhost' IDENTIFIED BY '" + user + "';"
						+ fr.soleil.sgad.Constants.newLine + "GRANT USAGE ON "
						+ schemaSt + ".* TO '" + user + "'@'%' IDENTIFIED BY '"
						+ user + "';" + fr.soleil.sgad.Constants.newLine
						+ "GRANT SELECT, CREATE ON " + schemaSt + ".* TO '"
						+ user + "'@'localhost';"
						+ fr.soleil.sgad.Constants.newLine
						+ "GRANT SELECT, CREATE ON " + schemaSt + ".* TO '"
						+ user + "'@'%';" + fr.soleil.sgad.Constants.newLine
						+ "GRANT INSERT ON " + schemaSt + "."
						+ fr.soleil.sgad.mysql.Constants.hdbObjects[0]
						+ " TO '" + user + "'@'localhost';"
						+ fr.soleil.sgad.Constants.newLine + "GRANT INSERT ON "
						+ schemaSt + "."
						+ fr.soleil.sgad.mysql.Constants.hdbObjects[0]
						+ " TO '" + user + "'@'%';"
						+ fr.soleil.sgad.Constants.newLine + "GRANT INSERT ON "
			...
			case 1: // archiver
				grants_gen
						.append(fr.soleil.sgad.Constants.newLine
								+ "# The '"
								+ user
								+ "' inserts signals in the tables related to the attributes."
								+ fr.soleil.sgad.Constants.newLine
								+ "# The '"
								+ user
								+ "' can insert/update records in the table named "
								+ "'"
								+ fr.soleil.sgad.mysql.Constants.hdbObjects[2]
								+ "'"
								+ " while an archiving is triggered/stopped."
								+ fr.soleil.sgad.Constants.newLine
								+ "# The '"
								+ user
								+ "' can also delete records that are older than a certain amount of time (temporary archiving)."
								+ fr.soleil.sgad.Constants.newLine
								+ fr.soleil.sgad.Constants.newLine);

				grants_gen.append("GRANT FILE ON *.* TO '" + user
						+ "'@'localhost' IDENTIFIED BY '" + user + "';"
						+ fr.soleil.sgad.Constants.newLine
						+ "GRANT FILE ON *.* TO '" + user
						+ "'@'%' IDENTIFIED BY '" + user + "';"
						+ fr.soleil.sgad.Constants.newLine
						+ "GRANT SELECT, INSERT, UPDATE, DELETE ON " + schemaSt
						+ ".* TO '" + user + "'@'localhost';"
						+ fr.soleil.sgad.Constants.newLine
						+ "GRANT SELECT, INSERT, UPDATE, DELETE ON " + schemaSt
						+ ".* TO '" + user + "'@'%';"
			...
			case 2: // browser
				...
				grants_gen.append("GRANT USAGE ON " + schemaSt + ".* TO '"
						...
						+ schemaSt + ".* TO '" + user + "'@'%' IDENTIFIED BY '"
						+ user + "';" + fr.soleil.sgad.Constants.newLine
						+ "GRANT SELECT ON " + schemaSt + ".* TO '" + user
						+ "'@'localhost';" + fr.soleil.sgad.Constants.newLine
						+ "GRANT SELECT ON " + schemaSt + ".* TO '" + user
						+ "'@'%';" + fr.soleil.sgad.Constants.newLine);
		...
		case 1: // TDB
			...
			case 0: // manager
				grants_gen.append(fr.soleil.sgad.Constants.newLine + "# The '"
						+ user + "' inserts record in the tables '"
						+ fr.soleil.sgad.mysql.Constants.tdbObjects[0]
						+ "' and '"
						+ fr.soleil.sgad.mysql.Constants.tdbObjects[1] + "'."
						+ fr.soleil.sgad.Constants.newLine + "# The '" + user
						+ "' creates the tables related to the attributes."
						+ fr.soleil.sgad.Constants.newLine + "# The '" + user
						+ "' can make a select on every table of the database."
			...
			case 1: // archiver
				grants_gen
						.append(fr.soleil.sgad.Constants.newLine
								...
								+ "' can insert/update records in the table named "
								+ "'"
								+ fr.soleil.sgad.mysql.Constants.tdbObjects[2]
								+ "'"
								+ " while an archiving is triggered/stopped."
								+ fr.soleil.sgad.Constants.newLine
								+ "# The 'archiver' can also delete records that are older than a certain amount of time (temporary archiving)."
								+ fr.soleil.sgad.Constants.newLine
								+ fr.soleil.sgad.Constants.newLine);
			...
			case 3: // cleaner
				grants_gen
						.append(fr.soleil.sgad.Constants.newLine
								+ "# The '"
								+ user
								+ "' must delete the old records in the attributes tables."
								+ fr.soleil.sgad.Constants.newLine);
				...
				grants_gen.append("GRANT USAGE ON " + schemaSt + ".* TO '"
						...
						+ schemaSt + ".* TO '" + user + "'@'%' IDENTIFIED BY '"
						+ user + "';" + fr.soleil.sgad.Constants.newLine
						+ "GRANT SELECT, DELETE, DROP ON " + schemaSt
						+ ".* TO '" + user + "'@'localhost';"
						+ fr.soleil.sgad.Constants.newLine
						+ "GRANT SELECT, DELETE, DROP ON " + schemaSt
						+ ".* TO '" + user + "'@'%';"
		...
		case 2: // SNAP
			...
			case 0: // manager
				grants_gen.append(fr.soleil.sgad.Constants.newLine + "# The '"
						+ user + "' inserts, update record in the tables "
						+ "'" + fr.soleil.sgad.mysql.Constants.snapObjects[0]
						+ "'" + ", " + "'"
						+ fr.soleil.sgad.mysql.Constants.snapObjects[1] + "'"
						+ ", " + "'"
						+ fr.soleil.sgad.mysql.Constants.snapObjects[2] + "'"
						+ " and " + "'"
						+ fr.soleil.sgad.mysql.Constants.snapObjects[3] + "'"
						+ "." + fr.soleil.sgad.Constants.newLine + "# The '"
						+ user
						+ "' can make a select on every table of the database."
						+ fr.soleil.sgad.Constants.newLine
						+ fr.soleil.sgad.Constants.newLine);
				...
				grants_gen.append("GRANT USAGE ON " + schemaSt + ".* TO '"
						...
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT SELECT ON " + schemaSt + ".* TO '"
						+ user + "'@'localhost';"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT SELECT ON " + schemaSt + ".* TO '"
						+ user + "'@'%';" + fr.soleil.sgad.Constants.newLine);
				for (int i = 0; i < 4; i++) {
					grants_gen.append("GRANT INSERT ON " + schemaSt + "."
							+ fr.soleil.sgad.mysql.Constants.snapObjects[i]
							+ " TO '" + user + "'@'localhost';"
							+ fr.soleil.sgad.Constants.newLine);
					grants_gen.append("GRANT INSERT ON " + schemaSt + "."
							+ fr.soleil.sgad.mysql.Constants.snapObjects[i]
				...
				grants_gen.append("GRANT UPDATE ON " + schemaSt + "."
						+ fr.soleil.sgad.mysql.Constants.snapObjects[3]
						+ " TO '" + user + "'@'localhost';"
						+ fr.soleil.sgad.Constants.newLine);
				grants_gen.append("GRANT UPDATE ON " + schemaSt + "."
			...
			case 1: // archiver
				...
				grants_gen
						.append(" and "
								+ "'"
								+ fr.soleil.sgad.mysql.Constants.snapObjects[fr.soleil.sgad.mysql.Constants.snapObjects.length - 1]
								+ "'" + "." + fr.soleil.sgad.Constants.newLine);
				grants_gen.append("# The '" + user
						+ "' can make a select on every table of the database."
						+ fr.soleil.sgad.Constants.newLine
						+ fr.soleil.sgad.Constants.newLine);
	...
	private void initFilePaths() {
		...
		if (Constants.target_OS.compareTo("UNIX") == 0)
			FilesPath[1] = _script_Path + File.separator
					+ "createArchivingDB.sh";
		else
			FilesPath[1] = _script_Path + File.separator
					+ "createArchivingDB.bat";
	}
	...
	public void writeBatchFile() {
		...
		try {
			...
			stringBuffer.append(fr.soleil.sgad.mysql.templates.Batch
					.getText(FilesPath[0]));
