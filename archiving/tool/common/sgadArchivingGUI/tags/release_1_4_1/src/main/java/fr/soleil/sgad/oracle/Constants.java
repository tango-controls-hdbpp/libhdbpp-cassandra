...
public class Constants
{
	 ...
	 * HDB OBjects
	 */
	public static String[] hdbObjects = {"adt", "apt", "amt", "properties", "act", "rnt"};
	public static String[] tdbObjects = {"adt", "apt", "amt", "properties", "act", "rnt"};
	//public static String[] snapObjects = {"context", "list", "snapshot", "ast", "rsa", "register_context", "register_snapshot"};
	...
	public static String[] datafiles =
	        {
		        "\\" + "oradata" + "\\" + Generator._oracle_sid + "\\", //"sc_BOOC01.dbf", // i : 1-> 16
		        "\\" + "oradata" + "\\" + Generator._oracle_sid + "\\", // j : 1-> 22
