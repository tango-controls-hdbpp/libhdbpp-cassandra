        ...
        extends JFrame
{
	...
	private void jbInit() throws Exception
	{
		...
		jMenuItem1.addActionListener(new SGAD_UI_jMenuItem1_actionAdapter(this));
		jMenu2.setText("File");
		jMenuItem2.setText("Exit");
		jMenuItem2.addActionListener(new SGAD_UI_jMenuItem2_actionAdapter(this));
		jRadioButton1.setActionCommand("MyISAM");
		jRadioButton1.setSelected(true);
		jRadioButton1.setText("MyISAM");
		jRadioButton1.addActionListener(new SGAD_UI_jRadioButton1_actionAdapter(this));
		jRadioButton2.setText("InnoDB");
		jRadioButton2.addActionListener(new SGAD_UI_jRadioButton2_actionAdapter(this));
		...
		jCheckBoxMenuItem2.addActionListener(new SGAD_UI_jCheckBoxMenuItem2_actionAdapter(this));
		jMenu5.setText("Modes");
		jCheckBoxMenuItem1.setText("Linux");
		jCheckBoxMenuItem1.addActionListener(new SGAD_UI_jCheckBoxMenuItem1_actionAdapter(this));
		jCheckBoxMenuItem3.setText("Standard");
		jCheckBoxMenuItem3.addActionListener(new SGAD_UI_jCheckBoxMenuItem3_actionAdapter(this));
		jCheckBoxMenuItem4.setText("Splitting");
		jCheckBoxMenuItem4.addActionListener(new SGAD_UI_jCheckBoxMenuItem4_actionAdapter(this));
		jCheckBoxMenuItem5.setText("Partitionning");
		jCheckBoxMenuItem5.addActionListener(new SGAD_UI_jCheckBoxMenuItem5_actionAdapter(this));
		jTextField5.addActionListener(new SGAD_UI_jTextField5_actionAdapter(this));
		...
		jPanel1.add(jLabel4 , new GridBagConstraints(0 , 3 , 1 , 1 , 0.0 , 0.0
		                                             , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(1 , 20 , 1 , 1) , 45 , 5));
		jPanel1.add(jTextField4 , new GridBagConstraints(1 , 3 , 1 , 1 , 1.0 , 0.0
		                                                 , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(1 , 1 , 1 , 20) , 200 , 7));
		...
		jPanel1.add(jLabel5 , new GridBagConstraints(0 , 4 , 1 , 1 , 0.0 , 0.0
		                                             , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(1 , 20 , 20 , 1) , 45 , 5));
		jPanel1.add(jLabel3 , new GridBagConstraints(0 , 2 , 1 , 1 , 0.0 , 0.0
		                                             , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(1 , 20 , 1 , 1) , 45 , 5));
		jPanel1.add(jLabel2 , new GridBagConstraints(0 , 1 , 1 , 1 , 0.0 , 0.0
		                                             , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(1 , 20 , 1 , 1) , 45 , 5));
		jPanel1.add(jLabel1 , new GridBagConstraints(0 , 0 , 1 , 1 , 0.0 , 0.0
		                                             , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(20 , 20 , 1 , 1) , 45 , 5));
		jPanel1.add(jTextField1 , new GridBagConstraints(1 , 0 , 1 , 1 , 0.0 , 0.0
		                                                 , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(20 , 1 , 1 , 20) , 200 , 5));
		jPanel1.add(jTextField2 , new GridBagConstraints(1 , 1 , 1 , 1 , 0.0 , 0.0
		                                                 , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(1 , 1 , 1 , 20) , 200 , 5));
		...
		jPanel1.add(jTextField5 , new GridBagConstraints(1 , 4 , 1 , 1 , 0.0 , 0.0
		                                                 , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(1 , 1 , 20 , 20) , 200 , 5));
		...
		jPanel5.add(jLabel6 , new GridBagConstraints(0 , 2 , 1 , 1 , 0.0 , 0.0
		                                             , GridBagConstraints.WEST , GridBagConstraints.HORIZONTAL , new Insets(0 , 20 , 0 , 0) , 45 , 5));
	...
	void jButton1_actionPerformed(ActionEvent e)
	{
		if ( jTabbedPane2.getSelectedIndex() == 0 )
		{
			...
			//*********************************
			if ( ( fr.soleil.sgad.oracle.Generator._oracle_sid = jTextField1.getText() ).equals("") )
			{
				Messages.emptyField(this , "SID");
			}
			else if ( ( fr.soleil.sgad.oracle.Generator._script_Path = jTextField2.getText() ).
			        equals("") )
			{
				Messages.emptyField(this , "Script generation path");
			}
			else if ( ( fr.soleil.sgad.oracle.Generator._oracleBase_Path = jTextField3.getText() ).
			        equals("") )
			{
				Messages.emptyField(this , "Oracle's base path");
			}
			else if ( ( fr.soleil.sgad.oracle.Generator._oracleHome_Path = jTextField4.getText() ).
			        equals("") )
			{
			...
			else
			{
				...
				{
					fr.soleil.sgad.oracle.Generator._redo_path = fr.soleil.sgad.oracle.Generator.
					        _oracleBase_Path +
					                                   File.separator + "redo" + File.separator +
					                                   fr.soleil.sgad.oracle.Generator._oracle_sid;
				}
				else
				{
					fr.soleil.sgad.oracle.Generator._redo_path = jTextField5.getText();
				}
		...
		else
		{
			...
			if ( ( fr.soleil.sgad.mysql.Generator._script_Path = jTextField6.getText() ).
			        equals("") )
			{
				Messages.emptyField(this , "Script generation path");
			}
	...
	void jCheckBoxMenuItem3_actionPerformed(ActionEvent e)
	{
		...
		jCheckBoxMenuItem5.setSelected(false);
		fr.soleil.sgad.oracle.Constants.generationMode = 0;
		System.out.println("Mode : " + fr.soleil.sgad.oracle.Constants.generationModes[ fr.soleil.sgad.oracle.Constants.generationMode ]);
	}
...
class SGAD_UI_jButton2_actionAdapter
...
class SGAD_UI_jButton1_actionAdapter
        implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
...
class SGAD_UI_jRadioButton1_actionAdapter implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
...
class SGAD_UI_jRadioButton2_actionAdapter implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
...
class SGAD_UI_jCheckBoxMenuItem2_actionAdapter implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
...
class SGAD_UI_jCheckBoxMenuItem1_actionAdapter implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
...
class SGAD_UI_jCheckBoxMenuItem3_actionAdapter implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
...
class SGAD_UI_jCheckBoxMenuItem4_actionAdapter implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
...
class SGAD_UI_jCheckBoxMenuItem5_actionAdapter implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
...
class SGAD_UI_jTextField5_actionAdapter implements java.awt.event.ActionListener
{
	SGAD_UI adaptee;
