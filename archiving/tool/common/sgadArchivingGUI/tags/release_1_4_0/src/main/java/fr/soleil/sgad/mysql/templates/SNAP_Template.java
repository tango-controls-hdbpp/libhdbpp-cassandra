...
public class SNAP_Template
{
	...
	private static void tableContext_gen()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_context` smallint(6) NOT NULL auto_increment," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`time` date NOT NULL default '0000-00-00'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`name` varchar(128) NOT NULL default ''," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`author` varchar(64) NOT NULL default ''," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`reason` longtext NOT NULL," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`description` longtext NOT NULL," + fr.soleil.sgad.Constants.newLine +
		                                "PRIMARY KEY  (`id_context`)," + fr.soleil.sgad.Constants.newLine +
		                                "UNIQUE KEY `id_context_2` (`id_context`)," + fr.soleil.sgad.Constants.newLine +
		                                "KEY `id_context` (`id_context`)" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " AUTO_INCREMENT=1 ;" + fr.soleil.sgad.Constants.newLine);
	...
	private static void tableList_gen()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object(fr.soleil.sgad.Constants.newLine + fr.soleil.sgad.mysql.Constants.separator + fr.soleil.sgad.Constants.newLine +
		                                ...
		                                "#" + fr.soleil.sgad.Constants.newLine + fr.soleil.sgad.Constants.newLine);
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_context` smallint(6) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_att` smallint(6) NOT NULL default '0'" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + ";" + fr.soleil.sgad.Constants.newLine);
	}
	...
	private static void tableSnapshots_gen()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object(fr.soleil.sgad.Constants.newLine + fr.soleil.sgad.mysql.Constants.separator + fr.soleil.sgad.Constants.newLine +
		                                ...
		                                "#" + fr.soleil.sgad.Constants.newLine + fr.soleil.sgad.Constants.newLine);
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_snap` smallint(6) NOT NULL auto_increment," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_context` mediumint(9) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`time` timestamp(14) NOT NULL DEFAULT '2005-07-01 0:00:00'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`snap_comment` varchar(255) NOT NULL default ''," + fr.soleil.sgad.Constants.newLine +
		                                "PRIMARY KEY  (`id_snap`)," + fr.soleil.sgad.Constants.newLine +
		                                "KEY `id_snap` (`id_snap`)" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " AUTO_INCREMENT=1 ;" + fr.soleil.sgad.Constants.newLine);
	...
	private static void tableAST_gen()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`ID` smallint(5) NOT NULL auto_increment," + fr.soleil.sgad.Constants.newLine +
		                                ...
		                                "KEY `ID_2` (`ID`)" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Attribute Snap Table' AUTO_INCREMENT=1 ;" + fr.soleil.sgad.Constants.newLine);
	}
	...
	private static void table_im_1val()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_snap` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_att` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`dim_x` SMALLINT( 6 ) NOT NULL," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`dim_y` SMALLINT( 6 ) NOT NULL," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`value` longblob" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Table for Image, Read only attributes';" + fr.soleil.sgad.Constants.newLine);
	...
	private static void table_im_2val()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                ...
		                                "\t" + "`write_value` longblob" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Table for Image, Write only attributes';" + fr.soleil.sgad.Constants.newLine);
	...
	private static void table_sc_num_1val()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_snap` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_att` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`value` double NOT NULL default '0'" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Table for Scalar, Read only attributes';" + fr.soleil.sgad.Constants.newLine);
	...
	private static void table_sc_num_2val()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_snap` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_att` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`read_value` double NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`write_value` double NOT NULL default '0'" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Table for Scalar, Read/Write + Read with Write attributes';" + fr.soleil.sgad.Constants.newLine);
	}
    ...
    private static void table_sc_str_1val()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                ...
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Table for String, Read only attributes';" + fr.soleil.sgad.Constants.newLine);
	...
	private static void table_sc_str_2val()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_snap` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`id_att` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`read_value` varchar(255)," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`write_value` varchar(255)" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Table for String, Read/Write + Read with Write attributes';" + fr.soleil.sgad.Constants.newLine);
	}
    ...
    private static void table_sp_1val()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                ...
		                                "\t" + "`id_att` int(11) NOT NULL default '0'," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`dim_x` SMALLINT( 6 ) NOT NULL," + fr.soleil.sgad.Constants.newLine +
		                                "\t" + "`value` blob" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Table for Spectrum, Read only attributes';" + fr.soleil.sgad.Constants.newLine);
	}
	...
	private static void table_sp_2val()
	{
		...
		fr.soleil.sgad.mysql.Generator.add_object("CREATE TABLE `" + table + "` (" + fr.soleil.sgad.Constants.newLine +
		                                ...
		                                "\t" + "`write_value` blob" + fr.soleil.sgad.Constants.newLine +
		                                ") TYPE=" + fr.soleil.sgad.mysql.Constants.storage_engine + " COMMENT='Table for Spectrum, Read/Write attributes';" + fr.soleil.sgad.Constants.newLine);
	}
