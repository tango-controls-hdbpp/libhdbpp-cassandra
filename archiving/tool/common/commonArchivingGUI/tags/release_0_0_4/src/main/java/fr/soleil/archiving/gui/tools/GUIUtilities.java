...
//
// $Log$
// Revision 1.2  2010/11/15 08:21:00  abeilleg
// *** empty log message ***
//
...
public class GUIUtilities {
    ...
    public static void writeWithoutDate(final PrintWriter pw, final String s,
	    final boolean hasNewLine) throws Exception {
	if (hasNewLine) {
	    pw.println(s);
	} else {
	    pw.print(s);
