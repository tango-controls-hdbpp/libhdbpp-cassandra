...
public class BensikinDate implements Cloneable, Comparable {
	 ...
	 */
	public Date toDate() {
		GregorianCalendar calend = new GregorianCalendar(year, month - 1, day,
	 ...
	 *             to
	 */
	public static Timestamp stringToTimestamp(String in, boolean hasTime,
			int errorMessage) throws FieldFormatException {
		int l = in.length();
		Timestamp ret = null;
		String format = null;
