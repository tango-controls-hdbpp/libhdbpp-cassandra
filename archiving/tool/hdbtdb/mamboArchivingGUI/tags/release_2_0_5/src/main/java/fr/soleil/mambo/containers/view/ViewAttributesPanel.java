...
public class ViewAttributesPanel extends JPanel
{
    ...
    private void initComponents ()
    {
    	...
    	viewAttributesGraphPanel = ViewAttributesGraphPanel.getInstance();
	...
	public void requestToRefresh(){
		try{
			viewAttributesGraphPanel.clean();
		}catch(Exception e){
		}
		viewAttributesGraphPanel.repaint();
        viewAttributesGraphPanel.validate();
