//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/models/ACPossibleAttributesTreeModel.java,v $
//
...
public class ACPossibleAttributesTreeModel extends AttributesTreeModel
{
    ...
    private ACPossibleAttributesTreeModel ()
    {
        ...
        //CLA 24/05/06
        this.build( source , new Criterions () );
    }

    /**
     * @param source
     * @param searchCriterions 8 juil. 2005
     */
