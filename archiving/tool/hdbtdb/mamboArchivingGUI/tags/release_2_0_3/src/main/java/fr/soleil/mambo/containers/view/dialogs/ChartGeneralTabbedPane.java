...
public class ChartGeneralTabbedPane extends JPanel
{
    ...
    private static ChartGeneralTabbedPane instance = null;


    /**
     * @return 8 juil. 2005
     */
    public static ChartGeneralTabbedPane getInstance ()
    {
        if ( instance == null )
        {
            instance = new ChartGeneralTabbedPane();
        }
     ...
     */
    private ChartGeneralTabbedPane ()
    {
        initComponents();
        this.add( innerPane );
    }
