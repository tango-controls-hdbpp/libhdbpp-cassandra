...
public class FakeNumberImage extends NumberImage
{
    ...
    public Property getProperty(String s)
    {
      ...
      return p;*/
    	...
    	// SPJZ: Cette méthode vient surcharger celle de NumberImage certainement car cette dernière 
    	// arme des timers mais je ne vois pas quand elle est appelée. 
    	// Néanmoins je la laisse par précaution. 
      Property p = null;
