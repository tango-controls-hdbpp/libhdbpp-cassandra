...
public class ArchivingConfiguration
{
    ...
    private static void updateCurrentAbsoluteMode ( boolean historic )
    {
        ...
        else
        {
            ...
            boolean slowDrift = historic ? panel.isHDBAbsoluteDLCheck() : panel.isTDBAbsoluteDLCheck() ;
            upperLimit = Math.abs ( upperLimit );
            lowerLimit = Math.abs ( lowerLimit );
            
            ModeAbsolu ModeA = new ModeAbsolu( absolutePeriod , lowerLimit , upperLimit, slowDrift);
    ...
    private static void updateCurrentRelativeMode ( boolean historic ) throws ArchivingException
    {
        ...
        else
        {
            ...
            boolean slowDrift = historic ? panel.isHDBRelativeDLCheck() : panel.isTDBRelativeDLCheck() ;            
            upperLimit = Math.abs ( upperLimit );
            lowerLimit = Math.abs ( lowerLimit );
            
            ModeRelatif ModeR = new ModeRelatif( relativePeriod , lowerLimit , upperLimit, slowDrift );
