...
public class XMLOptionsManager implements IOptionsManager 
{
     ...
     */
    private Hashtable loadOptionsIntoHash ( String optionsResourceLocation ) throws Exception
	{
    ...
    private Hashtable loadOptionsIntoHashFromRoot ( Node rootNode ) 
    {
		...
		{    
		    ...
		    //   (which is normally five: display, print, logs, save ,and wordlist)
		    {
		        ...
		        //System.out.println ( "loadOptionsIntoHashFromRoot/currentBookType/"+currentBookType+"/" );
    ...
    private Vector loadOptionBook (Node currentBookNode ) 
    {
		...
		{    
	        ...
	        //as many loops as there are options in the current options sub-block
		    {
		        ...
		        //System.out.println ( "loadOptionBook/currentOptionChapterType/"+currentOptionChapterType+"/" );
