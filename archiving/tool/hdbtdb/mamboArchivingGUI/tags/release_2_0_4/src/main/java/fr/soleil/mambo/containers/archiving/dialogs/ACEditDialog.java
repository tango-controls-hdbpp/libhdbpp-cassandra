//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/containers/archiving/dialogs/ACEditDialog.java,v $
//
...
public class ACEditDialog extends JDialog //implements  
{
    private GeneralTab generalTab;
    private AttributesTab attributesTab;
    private AttributesTabAlternate attributesTabAlternate;
     ...
     * @return 8 juil. 2005
     */
    public static ACEditDialog getInstance ( boolean _isAlternateSelectionMode ,  boolean _isHistoric )
    {
        if ( instance == null 
    ...
    private void initComponents ()
    {
        ...
        {
            attributesTabAlternate = AttributesTabAlternate.getInstance();
            attributesScrollPane = new JScrollPane(attributesTabAlternate);
        }
        else
        {
        ...
        attributesPropertiesTab = AttributesPropertiesTab.getInstance ( this.isHistoric );
        attributesPropertiesScrollPane = new JScrollPane(attributesPropertiesTab);
        attributesPropertiesScrollPane.setPreferredSize( GUIUtilities.getEditScrollPaneSize() );
    ...
    private void addComponents ()
    {
        ...
        String msgDisplayTab = Messages.getMessage( "DIALOGS_EDIT_AC_GENERAL_TITLE" );
        msgPrint = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_TITLE" );
        String msgLogs = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_TITLE" );
    ...
    {
        //System.out.println( "ACEditDialog/setAlternateSelectionMode/isAlternateSelectionMode/" + isAlternateSelectionMode + "/" );
        this.isAlternateSelectionMode = _isAlternateSelectionMode;

        if ( this.isAlternateSelectionMode )
        {
            if ( attributesTabAlternate == null )
            {
                attributesTabAlternate = AttributesTabAlternate.getInstance();
            }
            attributesScrollPane.setViewportView( attributesTabAlternate );
        }
        else
        {
