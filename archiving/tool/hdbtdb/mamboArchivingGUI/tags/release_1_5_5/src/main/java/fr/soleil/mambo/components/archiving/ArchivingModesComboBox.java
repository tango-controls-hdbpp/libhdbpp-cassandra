...
public class ArchivingModesComboBox extends JComboBox
{
    ...
    //private String [] standardOperators = { NO_SELECTION , ISnapManager.OP_EQUALS , ISnapManager.OP_LOWER_THAN_STRICT , ISnapManager.OP_GREATER_THAN_STRICT , ISnapManager.OP_LOWER_THAN , ISnapManager.OP_LOWER_THAN };
    private String[] standardOperators = {NO_SELECTION, "Periodical", "Absolute", "Relative", "Threshold", "On difference", "On calculation", "External"};
    ...
    public ArchivingModesComboBox ( int type ) throws IllegalStateException
    {
        ...
        switch ( type )
        {
            ...
            default :
                throw new IllegalStateException( "Expected either of " + STANDARD_TYPE + "," + " as a parameter. Received " + type + " instead." );
        }
