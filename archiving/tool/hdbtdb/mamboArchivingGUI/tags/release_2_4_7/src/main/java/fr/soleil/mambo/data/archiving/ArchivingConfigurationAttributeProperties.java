...
public class ArchivingConfigurationAttributeProperties {
	...
	public ArchivingConfigurationAttributeProperties(
			ArchivingConfigurationAttributeHDBProperties _HDBProperties,
			ArchivingConfigurationAttributeTDBProperties _TDBProperties) {
	...
	public void setHDBProperties(
			ArchivingConfigurationAttributeHDBProperties properties) {
	...
	public void setTDBProperties(
			ArchivingConfigurationAttributeTDBProperties properties) {
	...
	public static void setCurrentProperties(
			ArchivingConfigurationAttributeProperties currentProperties) {
	...
	public void addMode(ArchivingConfigurationMode currentMode, boolean historic) {
		if (historic) {
			// ArchivingConfigurationAttributeHDBProperties currentHDBProperties
			// = this.getHDBProperties ();
			this.HDBProperties.addMode(currentMode);

			/*
			 * System.out.println (
			 * "--------currentHDBProperties START---------" );
			 * System.out.println ( this.HDBProperties.toString () );
			 * System.out.println (
			 * "--------currentHDBProperties END-----------" );
			 */
		} else {
			// ArchivingConfigurationAttributeTDBProperties currentTDBProperties
			// = this.getTDBProperties ();
			this.TDBProperties.addMode(currentMode);

			/*
			 * System.out.println (
			 * "--------currentTDBProperties START---------" );
			 * System.out.println ( this.TDBProperties.toString () );
			 * System.out.println (
			 * "--------currentTDBProperties END-----------" );
			 */
		}
