...
public class ACOptions extends ReadWriteOptionBook implements PushPullOptionBook {
	...
	final String plaf_s = (String) content.get(SELECTION_MODE);
	...
	final Enumeration enumeration = content.keys();
	while (enumeration.hasMoreElements()) {
	    final String nextOptionKey = (String) enumeration.nextElement();
	    final String nextOptionValue = (String) content.get(nextOptionKey);
