...
public class ACTdbExportPeriodComboBox extends JComboBox {
	...
	public ACTdbExportPeriodComboBox() {
		...
		try {
			defaultExportValue = Long.parseLong(manager
					.getACDefaultsPropertyValue("TDB_EXPORT_PERIOD"));
		} catch (NumberFormatException e) {
			System.out
					.println("NumberFormatException has been received during TDB_EXPORT_PERIOD reading");
	...
	public void setExportPeriod(long period) {
		Integer key = null;
		try {
			key = (Integer) reverseExportPeriodsTable.get(new Long((!Mambo
					.canModifyExportPeriod() ? defaultExportValue : period)));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void initComponent() {
		...
		String msg = Messages
				.getMessage("DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_EXPORT_PERIOD_5MN");
		addItem(msg);
		msg = Messages
				.getMessage("DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_EXPORT_PERIOD_10MN");
		addItem(msg);
		msg = Messages
				.getMessage("DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_EXPORT_PERIOD_30MN");
		addItem(msg);
		msg = Messages
				.getMessage("DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_EXPORT_PERIOD_1H");
		addItem(msg);
		msg = Messages
				.getMessage("DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_EXPORT_PERIOD_2H");
		addItem(msg);
		msg = Messages
				.getMessage("DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_EXPORT_PERIOD_4H");
		addItem(msg);
		msg = Messages
				.getMessage("DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_EXPORT_PERIOD_6H");
		addItem(msg);
	...
	private void initExportPeriodsTable() {
		...
		reverseExportPeriodsTable.put(new Long(exportPeriodsTable[0]),
				new Integer(0));
		reverseExportPeriodsTable.put(new Long(exportPeriodsTable[1]),
				new Integer(1));
		reverseExportPeriodsTable.put(new Long(exportPeriodsTable[2]),
				new Integer(2));
		reverseExportPeriodsTable.put(new Long(exportPeriodsTable[3]),
				new Integer(3));
		reverseExportPeriodsTable.put(new Long(exportPeriodsTable[4]),
				new Integer(4));
		reverseExportPeriodsTable.put(new Long(exportPeriodsTable[5]),
				new Integer(5));
		reverseExportPeriodsTable.put(new Long(exportPeriodsTable[6]),
				new Integer(6));
	}
