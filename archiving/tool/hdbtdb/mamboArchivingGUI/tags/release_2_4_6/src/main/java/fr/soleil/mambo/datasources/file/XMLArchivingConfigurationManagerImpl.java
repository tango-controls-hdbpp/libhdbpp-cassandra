...
public class XMLArchivingConfigurationManagerImpl implements IArchivingConfigurationManager {
     ...
     */
    public void saveArchivingConfiguration(final ArchivingConfiguration ac,
	    final Hashtable saveParameters) throws Exception {
     ...
     */
    public ArchivingConfiguration[] loadArchivingConfigurations(final Criterions searchCriterions)
	    throws Exception {
