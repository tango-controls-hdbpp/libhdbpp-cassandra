...
public class ViewConfigurationData {
    ...
    public ViewConfigurationData(GeneralChartProperties _generalChartProperties, Axis _y1, Axis _y2) {
    ...
    public ViewConfigurationData cloneData() {
        ...
        ret.setGeneralChartProperties(this.getGeneralChartProperties() == null ? null : this
                .getGeneralChartProperties().cloneGeneralChartProperties());
    ...
    public void upDateVCData(DateRangeBox _dateRangeBox, ViewConfiguration currentVC) {
