...
public class PartialImageDataTable extends JTable {
	...
	public PartialImageDataTable(Vector partialImageData, String displayFormat) {
		super();
		PartialImageDataTableModel model = new PartialImageDataTableModel(
				partialImageData);
		super.setModel(model);

		// this.setDefaultRenderer( Object.class , new
		// PartialImageDataTableRenderer() );

		this.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		ListSelectionModel rowSM = this.getSelectionModel();
		rowSM.addListSelectionListener(new ImagesListSelectionListener(model,
				displayFormat));
	}
