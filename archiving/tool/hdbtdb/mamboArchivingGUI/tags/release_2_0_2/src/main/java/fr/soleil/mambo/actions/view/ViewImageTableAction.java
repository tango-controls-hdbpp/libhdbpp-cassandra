...
public class ViewImageTableAction extends AbstractAction
{
    ...
    /**
      * @param name
      */
     public ViewImageTableAction ( String name, ImageData _imageData, String _displayFormat )
     {
    ...
    {
        ViewImageTableDialog dialog = new ViewImageTableDialog ( this.imageData, displayFormat );
