...
public class ACRecapPanel extends JPanel
{
    ...
    public void initComponents ()
    {
        boolean nothingToDisplay = (
                ...
                || ArchivingConfiguration.getSelectedArchivingConfiguration().getAttributes().getAttributes() == null
                || ArchivingConfiguration.getSelectedArchivingConfiguration().getAttributes().getAttributes().isEmpty()
        );
