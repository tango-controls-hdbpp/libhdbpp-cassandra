//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/actions/view/listeners/VCPossibleAttributesTreeSelectionListener.java,v $
//
// Project:      Tango Archiving Service
//
// Description:  Java source code for the class  VCPossibleAttributesTreeSelectionListener.
...
public class VCPossibleAttributesTreeSelectionListener implements TreeSelectionListener
{
    ...
    {
        //ACPossibleAttributesTree tree = (ACPossibleAttributesTree) event.getSource ();
...
// TODO Auto-generated catch block
     ...
     * @throws DevFailed
     */
    public void query ( String st , int level , boolean historic ) throws DevFailed , ArchivingException
    {
        ...
        if ( level == 3 )
        {
            ...
            ArrayList attribute_list = source.getAttributes( domain , family , member , historic );
