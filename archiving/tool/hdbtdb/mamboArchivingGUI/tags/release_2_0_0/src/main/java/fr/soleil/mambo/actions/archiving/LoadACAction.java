...
public class LoadACAction extends AbstractAction
{
    ...
    private void loadACOnceThePathIsSet() 
    {
        ...
        try
        {
            ArchivingConfiguration selectedArchivingConfiguration = manager.loadArchivingConfiguration();
            ...
            String msg = Messages.getLogMessage( "LOAD_ARCHIVING_CONFIGURATION_ACTION_OK" );
            logger.trace( ILogger.LEVEL_DEBUG , msg );
        }
        catch ( FileNotFoundException fnfe )
        {
            String msg = Messages.getLogMessage( "LOAD_ARCHIVING_CONFIGURATION_ACTION_WARNING" );
        ...
        {
            String msg = Messages.getLogMessage( "LOAD_ARCHIVING_CONFIGURATION_ACTION_KO" );
