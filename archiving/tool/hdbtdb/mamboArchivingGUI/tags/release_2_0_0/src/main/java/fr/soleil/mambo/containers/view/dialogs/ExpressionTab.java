...
public class ExpressionTab extends JPanel
{
    ...
    protected JPanel attributesPanel, detailPanel, actionPanel;
    ...
    public void delete()
    {
        Vector<ExpressionAttribute> selectedAttributes = ExpressionTree.getInstance().getSelectedAttributes();
