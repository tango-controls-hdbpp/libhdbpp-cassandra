//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/data/view/ViewConfigurationAttributePlotProperties.java,v $
//
// Project:      Tango Archiving Service
//
// Description:  Java source code for the class  ViewConfigurationAttributePlotProperties.
...
public class ViewConfigurationAttributePlotProperties
{
    ...
    public String toString ()
    {
        ...
        openingLine.setAttribute( VIEW_TYPE_PROPERTY_XML_TAG , String.valueOf( this.viewType ) );
        openingLine.setAttribute( AXIS_CHOICE_PROPERTY_XML_TAG , String.valueOf( this.axisChoice ) );
    ...
    public ViewConfigurationAttributePlotProperties ( int _viewType , int _axisChoice , Bar _bar , Curve _curve , Marker _marker , ITransform _transform, boolean hidden )
    {
    ...
    public boolean isEmpty ()
    {
        ...
        boolean transformIsEmpty = ( this.transform == null || this.transform.isEmpty() );
    ...
    public void push ()
    {
        ...
        plotPropertiesPanel.setViewType( viewType );
        plotPropertiesPanel.setAxisChoice( axisChoice );
        ...
        plotPropertiesPanel.setHidden( hidden );
    }
