//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/models/ACAttributesTreeModel.java,v $
//
...
public class ACAttributesTreeModel extends AttributesTreeModel
{

    //private ACAttributesSelectTree treeInstance = null;
     ...
     */
    /*public void setTree ( ACAttributesSelectTree tree )
    {
        this.treeInstance = tree;
    }*/

    /**
     * @param validSelected 27 juin 2005
     */

//  moved from daughter ACAttr
    public void addSelectedAttibutes ( Vector validSelected )
    {
        TreeMap possibleAttr = ACPossibleAttributesTreeModel.getInstance().getAttributes();
            ...
            for ( int depth = 0 ; depth < CONTEXT_TREE_DEPTH ; depth++ )
            {
                ...
                else
                {
                    ...
                    if ( depth == CONTEXT_TREE_DEPTH - 1 )
                    {
                        ...
                        ArchivingConfigurationAttribute attribute = new ArchivingConfigurationAttribute( _attribute );
                        if ( attribute != null )
                        {
    ...
    {
        /*Enumeration enum = validSelected.elements ();
        while ( enum.hasMoreElements () )
        {
            TreePath aPath = (TreePath) enum.nextElement ();

            DefaultMutableTreeNode lastChild =  (DefaultMutableTreeNode) aPath.getLastPathComponent ();
    ...
    public void removeSelectedAttributes2 ( Vector validSelected )
    {
        ...
        while ( enumeration.hasMoreElements() )
        {
            ...
            /*Enumeration enum1 = this.getAttributes().keys();
    ...
    {
        super.reload();
        ACAttributeDetailHdbPanel.getInstance().load( new ArchivingConfigurationAttribute() );
        ACAttributeDetailTdbPanel.getInstance().load( new ArchivingConfigurationAttribute() );
    ...
    {
        Vector _domains = source.loadDomains( searchCriterions, false );

        Enumeration enumeration = ( ( DefaultMutableTreeNode ) root ).preorderEnumeration();
     ...
     * @return 25 août 2005
     */
    private boolean isWanted ( Vector _domains , Object[] currentPath )
    {
        ...
        Enumeration e = _domains.elements();
        while ( e.hasMoreElements() )
        {
            Domain d = ( Domain ) e.nextElement();
            ...
            Map _families = d.getFamilies();
            Iterator e1 = _families.values().iterator();
            while ( e1.hasNext() )
            {
                Family f = ( Family ) e1.next();
                ...
                Iterator e2 = f.getMembers().values().iterator();
                while ( e2.hasNext() )
                {
    ...
    public void setAttributes ( TreeMap in )
    {
    ...
    /*public void traceHT (String s)
    {
        Enumeration enum = this.attributesHT.keys ();
        System.out.println ( s );
        while ( enum.hasMoreElements () )
        {
            String next = (String) enum.nextElement ();
            System.out.println ( "traceHT/next|"+next+"|" );
        }
        System.out.println ( s );
    }*/
}
