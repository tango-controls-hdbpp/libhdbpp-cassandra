...
public class ArchivingConfigurationXMLHelperFactory
{
	 ...
	 private static IArchivingConfigurationXMLHelper currentImpl = null;
	     ...
	     * @return 8 juil. 2005
	     */
    public static IArchivingConfigurationXMLHelper getImpl ( int typeOfImpl ) throws  IllegalStateException
    {
        switch ( typeOfImpl )
        {
            ...
            default:
                throw new IllegalStateException( "Expected either STANDARD_IMPL_TYPE (1) or FORCED_EXPORT_PERIOD_IMPL_TYPE (2), got " + typeOfImpl + " instead." );
        }
