//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/data/view/plot/Polynomial2OrderTransform.java,v $
//
...
public class Polynomial2OrderTransform implements ITransform
{
    private double a0;
    private double a1;
    private double a2;
    ...
    /* (non-Javadoc)
     * @see mambo.data.view.plot.ITransform#push()
     */
    public void push ()
    {
        AttributesPlotPropertiesPanel plotPropertiesPanel = AttributesPlotPropertiesTab.getInstance().getPropertiesPanel();
        plotPropertiesPanel.setTransformA0( a0 );
        plotPropertiesPanel.setTransformA1( a1 );
        plotPropertiesPanel.setTransformA2( a2 );
    }
