...
public class ACHistory
{
     ...
     * @param openedAc
     */
    public ACHistory ( ArchivingConfiguration _selectedAC , LimitedACStack _openedACs )
    {
    ...
    public void push ()
    {
        ...
        {
            this.selectedAC.setModified ( false );
        ...
        OpenedACComboBox openedACComboBox = OpenedACComboBox.getInstance( this.openedACs );
    ...
    /**
     * @param openedACs The openedACs to set.
     */
