...
public class LoadACDefaults extends AbstractAction
{
     ...
     * @param name
     */
    public LoadACDefaults ( String name , boolean _isDefault )
    {
    ...
    public void actionPerformed ( ActionEvent actionEvent )
    {
        ...
        manager.setDefault( this.isDefault );
        ...
        try
        {
            ACOptions selectedACOptions = manager.loadACDefaults();
            ...
            String msg = Messages.getLogMessage( "LOAD_ARCHIVING_CONFIGURATION_DEFAULTS_ACTION_OK" );
            logger.trace( ILogger.LEVEL_DEBUG , msg );
        }
        catch ( FileNotFoundException fnfe )
        {
            String msg = Messages.getLogMessage( "LOAD_ARCHIVING_CONFIGURATION_DEFAULTS_ACTION_WARNING" );
        ...
        {
            String msg = Messages.getLogMessage( "LOAD_ARCHIVING_CONFIGURATION_DEFAULTS_ACTION_KO" );
