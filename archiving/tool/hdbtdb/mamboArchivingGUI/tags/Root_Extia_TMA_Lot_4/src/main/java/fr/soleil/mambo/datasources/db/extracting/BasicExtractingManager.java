	...
	public Hashtable<String, Object> retrieveDataHash(String[] param,
		...
		case AttrDataFormat._SCALAR:
			...
			case TangoConst.Tango_DEV_USHORT:
				...
				writeView = getScalarView(splitedData, dataWritable, dataType,
						1);
				if (showRead) {
					switch (dataWritable) {
		...
		case AttrDataFormat._SPECTRUM:
			...
			case TangoConst.Tango_DEV_USHORT:
				...
				if (readSpectrumView != null && readSpectrumView.length > 0) {
					ret.put(ViewConfigurationAttribute.READ_DATA_VIEW_KEY,
							readSpectrumView);
				}
				if (writeSpectrumView != null && writeSpectrumView.length > 0) {
					ret.put(ViewConfigurationAttribute.WRITE_DATA_VIEW_KEY,
							writeSpectrumView);
				}
				break;
				...
				for (int i = 0; i < splitedData[0].getMax_x(); i++) {
					...
					case TangoConst.Tango_DEV_USHORT:
						for (int j = 0; j < splitedData[0].getData_timed().length; j++) {
							long time = (long) splitedData[0].getData_timed()[j].time
									.longValue();
							double y = Double.NaN;
							if (splitedData[0].getData_timed()[j].value != null
									&& i < splitedData[0].getData_timed()[j].value.length
									&& splitedData[0].getData_timed()[j].value[i] != null) {
								y = ((Short) splitedData[0].getData_timed()[j].value[i])
										.doubleValue();
							}
					...
					case TangoConst.Tango_DEV_ULONG:
						for (int j = 0; j < splitedData[0].getData_timed().length; j++) {
							...
							if (splitedData[0].getData_timed()[j].value != null
									&& i < splitedData[0].getData_timed()[j].value.length
									&& splitedData[0].getData_timed()[j].value[i] != null) {
								y = ((Integer) splitedData[0].getData_timed()[j].value[i])
										.doubleValue();
							}
							readSpectrumView[i].add(time, y);
						}
					...
					case TangoConst.Tango_DEV_FLOAT:
						for (int j = 0; j < splitedData[0].getData_timed().length; j++) {
							...
							if (splitedData[0].getData_timed()[j].value != null
									&& i < splitedData[0].getData_timed()[j].value.length
									&& splitedData[0].getData_timed()[j].value[i] != null) {
								y = ((Float) splitedData[0].getData_timed()[j].value[i])
										.doubleValue();
							}
							readSpectrumView[i].add(time, y);
						}
					...
					case TangoConst.Tango_DEV_DOUBLE:
						for (int j = 0; j < splitedData[0].getData_timed().length; j++) {
							...
							if (splitedData[0].getData_timed()[j].value != null
									&& i < splitedData[0].getData_timed()[j].value.length
									&& splitedData[0].getData_timed()[j].value[i] != null) {
								y = ((Double) splitedData[0].getData_timed()[j].value[i])
										.doubleValue();
							}
							readSpectrumView[i].add(time, y);
						}
				...
				for (int i = 0; i < splitedData[1].getMax_x(); i++) {
					...
					case TangoConst.Tango_DEV_USHORT:
						for (int j = 0; j < splitedData[1].getData_timed().length; j++) {
							long time = (long) splitedData[1].getData_timed()[j].time
									.longValue();
							double y = Double.NaN;
							if (splitedData[1].getData_timed()[j].value != null
									&& i < splitedData[1].getData_timed()[j].value.length
									&& splitedData[1].getData_timed()[j].value[i] != null) {
								y = ((Short) splitedData[1].getData_timed()[j].value[i])
										.doubleValue();
							}
					...
					case TangoConst.Tango_DEV_ULONG:
						for (int j = 0; j < splitedData[1].getData_timed().length; j++) {
							...
							if (splitedData[1].getData_timed()[j].value != null
									&& i < splitedData[1].getData_timed()[j].value.length
									&& splitedData[1].getData_timed()[j].value[i] != null) {
								y = ((Integer) splitedData[1].getData_timed()[j].value[i])
										.doubleValue();
							}
							writeSpectrumView[i].add(time, y);
						}
					...
					case TangoConst.Tango_DEV_FLOAT:
						for (int j = 0; j < splitedData[1].getData_timed().length; j++) {
							...
							if (splitedData[1].getData_timed()[j].value != null
									&& i < splitedData[1].getData_timed()[j].value.length
									&& splitedData[1].getData_timed()[j].value[i] != null) {
								y = ((Float) splitedData[1].getData_timed()[j].value[i])
										.doubleValue();
							}
							writeSpectrumView[i].add(time, y);
						}
					...
					case TangoConst.Tango_DEV_DOUBLE:
						for (int j = 0; j < splitedData[1].getData_timed().length; j++) {
							...
							if (splitedData[1].getData_timed()[j].value != null
									&& i < splitedData[1].getData_timed()[j].value.length
									&& splitedData[1].getData_timed()[j].value[i] != null) {
								y = ((Double) splitedData[1].getData_timed()[j].value[i])
										.doubleValue();
							}
							writeSpectrumView[i].add(time, y);
						}
