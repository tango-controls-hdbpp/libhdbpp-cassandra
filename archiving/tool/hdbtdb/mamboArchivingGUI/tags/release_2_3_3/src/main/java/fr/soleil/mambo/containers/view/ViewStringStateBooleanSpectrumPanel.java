...
public class ViewStringStateBooleanSpectrumPanel extends
        AbstractViewSpectrumPanel {
    ...
    protected void initComponents() {
        ...
        if (splitedData[0] != null) {
            ...
            readTable = new MamboFormatableTable(
                    new ViewStringStateBooleanSpectrumTableModel(
    ...
    protected void addComponents() {
        ...
        if (splitedData != null) {
            if (splitedData[0] != null) {
                ...
                GUIUtilities.setObjectBackground(readPane,
                        GUIUtilities.VIEW_COLOR);
            ...
            if (splitedData[1] != null) {
                ...
                GUIUtilities.setObjectBackground(writePane,
                        GUIUtilities.VIEW_COLOR);
