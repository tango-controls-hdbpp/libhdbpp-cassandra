...
public class Messages
{
    ...
    {
        myResources = ResourceBundle.getBundle(resourcesFileName, currentLocale);
        myLogResources = ResourceBundle.getBundle(logsFileName, currentLocale);
        myAppProperties = ResourceBundle.getBundle(buildFileName, currentLocale);
        
        /*try {
			myProperties = ResourceBundle.getBundle(propertiesFileName);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			System.out.println("the properties file has not been found, default behaviour will be applied");
			//e.printStackTrace();
		}*/
    }
  ...
  /*  
    public static String getProperty ( String key )
    {
        try
        {
            String ret = myProperties.getString( key );
            return ret;
        }
        catch ( Exception e )
        {
