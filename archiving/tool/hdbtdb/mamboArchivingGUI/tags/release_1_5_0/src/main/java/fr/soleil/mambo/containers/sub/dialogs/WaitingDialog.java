...
public class WaitingDialog extends JDialog {
    ...
    public static void openInstance () {
        ...
        int myWidth = 500;
        int myHeight = 0;
        int relativeX = MamboFrame.getInstance().getX()
                + MamboFrame.getInstance().getWidth() - myWidth;
        relativeX /= 2;
        int relativeY = MamboFrame.getInstance().getY()
                + MamboFrame.getInstance().getHeight() - myHeight;
        relativeY /= 2;
