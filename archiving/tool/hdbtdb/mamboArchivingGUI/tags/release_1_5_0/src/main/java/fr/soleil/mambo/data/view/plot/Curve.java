...
public class Curve
{
    ...
    public String toString ()
    {
        ...
        openingLine.setAttribute( STYLE_PROPERTY_XML_TAG , String.valueOf( lineStyle ) );
    ...
    public void push ()
    {
        ...
        plotPropertiesPanel.setCurveColor( this.getColor() );
        plotPropertiesPanel.setCurveLineStyle( this.getLineStyle() );
        plotPropertiesPanel.setCurveWidth( this.getWidth() );
    }
