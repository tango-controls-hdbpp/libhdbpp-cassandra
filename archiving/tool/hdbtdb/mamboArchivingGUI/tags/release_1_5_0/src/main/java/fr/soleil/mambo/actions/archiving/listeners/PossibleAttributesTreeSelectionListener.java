//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/actions/archiving/listeners/PossibleAttributesTreeSelectionListener.java,v $
//
// Project:      Tango Archiving Service
//
// Description:  Java source code for the class  PossibleAttributesTreeSelectionListener.
...
public class PossibleAttributesTreeSelectionListener implements TreeSelectionListener
{
    ...
    public ArrayList dbGetAttributeList ( String device_name )
    {
        ...
        try
        {
            ...
            Collections.sort(liste_att, Collator.getInstance(Locale.FRENCH));
            return liste_att;
        }
        catch ( DevFailed e )
        {
