...
public class MamboMenuBar extends JMenuBar
{
    ...
    private MamboMenuBar ()
    {
        ...
        msg = Messages.getMessage( "VIEW_ACTION_EXPEND_GRAPHEVIEW" );
        VCHideAction hideTree = VCHideAction.getInstence( msg );
        //--
        ...
        JMenuItem hideMenuItem = new JMenuItem( hideTree );
