/*
 * Synchrotron Soleil File : SamplingTypeComboBox.java Project : mambo
 * Description : Author : CLAISSE Original : 29 ao�t 2006 Revision: Author:
 * Date: State: Log: SamplingTypeComboBox.java,v
 */
/*
 * Created on 29 ao�t 2006 To change the template for this generated file go to
	...
	public class SamplingTypeComboBoxRenderer implements ListCellRenderer {
		...
		public Component getListCellRendererComponent(JList list, Object value,
			...
			if (value == null || !(value instanceof SamplingType)) {
				return defaultListCellRendererComponent
