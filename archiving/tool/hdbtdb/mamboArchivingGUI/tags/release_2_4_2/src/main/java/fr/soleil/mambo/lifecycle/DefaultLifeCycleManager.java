...
public class DefaultLifeCycleManager implements LifeCycleManager {
    ...
    private void loadOptions(Splash splash) throws Exception {
        ...
        try {
            ...
            String optionsLoadPath = Mambo.getAccountManager().getSelectedAccountWorkingPath()
                    + "/options/options.xml";
    ...
    private void loadHistory(Splash splash) throws Exception {
        ...
        try {
            ...
            String historyLoadPath = Mambo.getAccountManager().getSelectedAccountWorkingPath()
                    + "/history/history.xml";
