...
public class ACRecapTableModel extends DefaultTableModel {
	...
	// --CLA
	private Hashtable<String, Mode> TDBmodesBuffer = new Hashtable<String, Mode>();
	private Hashtable<String, Mode> HDBmodesBuffer = new Hashtable<String, Mode>();
	...
	public ACRecapTableModel() {
		...
		HDBmodesBuffer = new Hashtable<String, Mode>();
		TDBmodesBuffer = new Hashtable<String, Mode>();
	}
	...
	public int getRowCount() {
		Mode _mode = null;
		/*
		 * try { _mode = DBManagerFactory.getCurrentImpl().getArchivingMode(
		 * attribute.getCompleteName() , historic ); } catch ( Exception e1 ) {
		 * _mode = null; }
		 */

		if (HDBmodesBuffer == null) {
			this.HDBmodesBuffer = new Hashtable<String, Mode>();
		}

		if (TDBmodesBuffer == null) {
			this.TDBmodesBuffer = new Hashtable<String, Mode>();
		}

		Hashtable<String, Mode> modesBuffer = historic ? this.HDBmodesBuffer
				: this.TDBmodesBuffer;

		String completeName = attribute.getCompleteName();

		if (attribute != null && completeName != null) {
			_mode = (Mode) modesBuffer.get(completeName);

			if (_mode == null && completeName != null) {
				try {
					_mode = ArchivingManagerFactory.getCurrentImpl()
				...
				if (completeName != null && _mode != null) {
					modesBuffer.put(completeName, _mode);
				}
			}
		}
		// -CLA
	 ...
	 */
	/*
	 * public int getRowCount () { Mode mode; try { mode =
	 * DBManagerFactory.getCurrentImpl().getArchivingMode(
	 * attribute.getCompleteName() , historic ); } catch ( Exception e1 ) { mode
	 * = null; } switch ( this.mode ) { case modeP: if ( DBProperties != null &&
	 * DBProperties.getMode( ArchivingConfigurationMode.TYPE_P ) != null ) {
	 * return 1; } else { if ( mode != null && mode.getModeP() != null ) {
	 * return 1; } return 0; } case modeA: if ( DBProperties != null &&
	 * DBProperties.getMode( ArchivingConfigurationMode.TYPE_A ) != null ) {
	 * return 3; } else { if ( mode != null && mode.getModeA() != null ) {
	 * return 3; } return 0; } case modeR: if ( DBProperties != null &&
	 * DBProperties.getMode( ArchivingConfigurationMode.TYPE_R ) != null ) {
	 * return 3; } else { if ( mode != null && mode.getModeR() != null ) {
	 * return 3; } return 0; } case modeT: if ( DBProperties != null &&
	 * DBProperties.getMode( ArchivingConfigurationMode.TYPE_T ) != null ) {
	 * return 3; } else { if ( mode != null && mode.getModeT() != null ) {
	 * return 3; } return 0; } case modeD: if ( DBProperties != null &&
	 * DBProperties.getMode( ArchivingConfigurationMode.TYPE_D ) != null ) {
	 * return 1; } else { if ( mode != null && mode.getModeD() != null ) {
	 * return 1; } return 0; } case modeC: if ( DBProperties != null &&
	 * DBProperties.getMode( ArchivingConfigurationMode.TYPE_C ) != null ) {
	 * return 3; } else { if ( mode != null && mode.getModeC() != null ) {
	 * return 3; } return 0; } case modeE: if ( DBProperties != null &&
	 * DBProperties.getMode( ArchivingConfigurationMode.TYPE_E ) != null ) {
	 * return 1; } else { if ( mode != null && mode.getModeE() != null ) {
	 * return 1; } return 0; } case titleOrGeneral: if ( attribute == null ) {
	 * return 1; } if ( !historic ) { if ( DBProperties != null ) { if (
	 * DBProperties.getModes().length > 0 ) { return 2; } else { if ( mode !=
	 * null && mode.getTdbSpec() != null ) { return 2; } } } return 0; } else {
	 * if ( DBProperties != null ) { if ( DBProperties.getModes().length > 0 ) {
	 * return 1; } else { if ( mode != null && mode.getTdbSpec() != null ) {
	 * return 1; } } } return 0; } default: return 0; } // end switch
	 * (this.mode) } // end getRowCount()
	 */
	/*
	 * (non-Javadoc)
	 *
	...
	private Object getThirdColumnValue(int rowIndex) {
		if (attribute == null) {
			...
			case 0:
				...
				// "ARCHIVING_ATTRIBUTES_DETAIL_TITLE_TABLE_EXPORT" );
				// }
				// else
				// {
				// return "";
				...
				case modeP:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEP_PERIOD");
				case modeA:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEA_PERIOD");
				case modeR:
					return Messages
				...
				case modeE:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEE_ARCHIVED");
				default:
					return "";
				}
			case 1:
				switch (this.mode) {
				/*
				 * case titleOrGeneral: if ( !historic ) { return
				 * Messages.getMessage(
				 * "ARCHIVING_ATTRIBUTES_DETAIL_TITLE_TABLE_KEEPING" ); } else {
				 * return ""; }
				 */
				case modeA:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEA_UPPER");
				case modeR:
					return Messages
			...
			case 2:
				...
				case modeA:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEA_LOWER");
				case modeR:
					return Messages
				...
				case modeC:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEC_TYPE");
				default:
					return "";
				}
			case 3:
				...
				case modeA:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEA_SLOW_DRIFT");
				case modeR:
					return Messages
	...
	private Object getDBColumnValue(int rowIndex) {
		if (attribute == null) {
			return Messages
					.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_TITLE_TABLE_DB");
		} else {
			IArchivingManager manager = ArchivingManagerFactory
					.getCurrentImpl();
			Mode mode;
			try {
				mode = manager.getArchivingMode(attribute.getCompleteName(),
						historic);
			} catch (Exception e) {
				mode = null;
			}
			...
			case 0:
				...
				// return MamboTimeFormater.formatTime(
			...
			case 1:
				switch (this.mode) {
				/*
				 * case titleOrGeneral: if ( !historic ) { if (
				 * mode.getTdbSpec() != null ) { //return
				 * mode.getTdbSpec().getKeepingPeriod() + "ms"; return
				 * MamboTimeFormater.formatTime(
				 * mode.getTdbSpec().getKeepingPeriod() ); } } return "";
				 */
				case modeA:
					if (mode.getModeA() != null) {
			...
			case 3:
				...
				case modeA:
					if (mode.getModeA() != null) {
						return Boolean.toString(mode.getModeA().isSlow_drift())
								+ "";
					}
					return "";
				case modeR:
					if (mode.getModeR() != null) {
						return Boolean.toString(mode.getModeR().isSlow_drift())
								+ "";
					}
					return "";
				default:
	...
	private Object getACColumnValue(int rowIndex) {
		if (attribute == null) {
			return Messages
					.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_TITLE_TABLE_AC");
		} else {
			if (DBProperties == null) {
				return "";
			}
			...
			case 0:
				...
				// if ( modes.length > 0 )
				// {
				// //return ( ( ArchivingConfigurationAttributeTDBProperties )
				// DBProperties ).getExportPeriod() + "ms";
				// return MamboTimeFormater.formatTime( ( (
				// ArchivingConfigurationAttributeTDBProperties ) DBProperties
				// ).getExportPeriod() );
				// }
				// }
				// return "";
				case modeP:
					ArchivingConfigurationMode ACPMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_P);
					if (ACPMode != null) {
						if (DBProperties instanceof ArchivingConfigurationAttributeTDBProperties) {
							return ACPMode.getMode().getModeP().getPeriod()
									+ "ms";
						}
						return ACPMode.getMode().getModeP().getPeriod() / 1000
								+ "s";
					}
					return "";
				case modeA:
					ArchivingConfigurationMode ACAMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_A);
					if (ACAMode != null) {
						if (DBProperties instanceof ArchivingConfigurationAttributeTDBProperties) {
							return ACAMode.getMode().getModeA().getPeriod()
									+ "ms";
						}
						return ACAMode.getMode().getModeA().getPeriod() / 1000
								+ "s";
					}
					return "";
				case modeR:
					ArchivingConfigurationMode ACRMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_R);
					if (ACRMode != null) {
						if (DBProperties instanceof ArchivingConfigurationAttributeTDBProperties) {
							return ACRMode.getMode().getModeR().getPeriod()
									+ "ms";
						}
						return ACRMode.getMode().getModeR().getPeriod() / 1000
								+ "s";
					}
					return "";
				case modeT:
					ArchivingConfigurationMode ACTMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_T);
					if (ACTMode != null) {
						if (DBProperties instanceof ArchivingConfigurationAttributeTDBProperties) {
							return ACTMode.getMode().getModeT().getPeriod()
									+ "ms";
						}
						return ACTMode.getMode().getModeT().getPeriod() / 1000
								+ "s";
					}
					return "";
				case modeD:
					ArchivingConfigurationMode ACDMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_D);
					if (ACDMode != null) {
						if (DBProperties instanceof ArchivingConfigurationAttributeTDBProperties) {
							return ACDMode.getMode().getModeD().getPeriod()
									+ "ms";
						}
						return ACDMode.getMode().getModeD().getPeriod() / 1000
								+ "s";
					}
					return "";
				case modeC:
					ArchivingConfigurationMode ACCMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_C);
					if (ACCMode != null) {
						if (DBProperties instanceof ArchivingConfigurationAttributeTDBProperties) {
							return ACCMode.getMode().getModeC().getPeriod()
									+ "ms";
						}
						return ACCMode.getMode().getModeC().getPeriod() / 1000
								+ "s";
					}
					return "";
				case modeE:
					ArchivingConfigurationMode ACEMode = DBProperties
			...
			case 1:
				switch (this.mode) {
				/*
				 * case titleOrGeneral: if ( !historic ) { if ( modes.length > 0
				 * ) { //return ( ( ArchivingConfigurationAttributeTDBProperties
				 * ) DBProperties ).getKeepingPeriod() + "ms"; return
				 * MamboTimeFormater.formatTime( ( (
				 * ArchivingConfigurationAttributeTDBProperties ) DBProperties
				 * ).getKeepingPeriod() ); } } return "";
				 */
				case modeA:
					ArchivingConfigurationMode ACAMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_A);
			...
			case 3:
				...
				case modeA:
					ArchivingConfigurationMode ACAMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_A);
					if (ACAMode != null) {
						return Boolean.toString(ACAMode.getMode().getModeA()
								.isSlow_drift())
								+ "";
					}
					return "";
				case modeR:
					ArchivingConfigurationMode ACRMode = DBProperties
							.getMode(ArchivingConfigurationMode.TYPE_R);
					if (ACRMode != null) {
						return Boolean.toString(ACRMode.getMode().getModeR()
								.isSlow_drift())
								+ "";
					}
					return "";
	...
	private Object getSecondColumnValue(int rowIndex) {
		if (attribute == null) {
			...
			case 0:
				...
				// {
				// return Messages.getMessage(
				// "ARCHIVING_ATTRIBUTES_DETAIL_TITLE_TABLE_ANY" );
				// }
				// else
				// {
				// return "";
				...
				case modeP:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEP_NAME");
				case modeA:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEA_NAME");
				case modeR:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODER_NAME");
				case modeT:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODET_NAME");
				case modeD:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODED_NAME");
				case modeC:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEC_NAME");
				case modeE:
					return Messages
							.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_MODEE_NAME");
				default:
					return "";
				}
			default:
	...
	private Object getFirstColumnValue(int rowIndex) {
		if (attribute == null) {
			return Messages
					.getMessage("ARCHIVING_ATTRIBUTES_DETAIL_TITLE_TABLE_NAME");
		} else {
			switch (rowIndex) {
			case 0:
				switch (this.mode) {
