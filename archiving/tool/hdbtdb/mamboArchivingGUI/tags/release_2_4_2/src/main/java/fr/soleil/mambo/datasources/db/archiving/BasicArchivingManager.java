...
public class BasicArchivingManager extends DbConnectionManager implements IArchivingManager {
    ...
    public void stopArchiving(ArchivingConfiguration ac) throws ArchivingException {
        if (ac != null) {
            ...
            AttributesArchivingException toThrow = new AttributesArchivingException();
    ...
    public Archiver getCurrentArchiverForAttribute(String completeName, boolean _historic)
            throws ArchivingException {
        openConnection();
        DataBaseManager database = getDataBaseApi(_historic);

        String archiverName = database.getMode().getArchiverForAttributeEvenIfTheStopDateIsNotNull(
                completeName);
