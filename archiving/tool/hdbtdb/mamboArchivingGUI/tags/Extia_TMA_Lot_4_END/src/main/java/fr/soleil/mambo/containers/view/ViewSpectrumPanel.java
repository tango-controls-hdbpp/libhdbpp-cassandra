...
public class ViewSpectrumPanel extends AbstractViewSpectrumPanel {
    ...
    protected void initComponents() {
        ...
        if (splitedData == null
                || ((splitedData[0] == null) && (splitedData[1] == null))) {
            ...
            GUIUtilities.setObjectBackground(viewButton,
            ...
            switch (writable) {
                case ViewSpectrumTableModel.R:
                    ...
                    SpringUtilities.makeCompactGrid(buttonPanel, 2, 1, 5, 5, 5,
                            5, true);
                    break;
                ...
                case ViewSpectrumTableModel.RW:
                    ...
                    buttonPanel.add(Box.createHorizontalGlue());
                    buttonPanel.add(noneWrite);
                    SpringUtilities.makeCompactGrid(buttonPanel, 2, 3, 5, 5, 5,
                            5, true);
                    break;
            }
            ...
            GUIUtilities.setObjectBackground(choiceTable,
                    GUIUtilities.VIEW_COLOR);
            ...
            GUIUtilities.setObjectBackground(choiceTableScrollPane,
                    GUIUtilities.VIEW_COLOR);
            GUIUtilities.setObjectBackground(choiceTableScrollPane
                    .getViewport(), GUIUtilities.VIEW_COLOR);
            GUIUtilities.setObjectBackground(choiceTableScrollPane
        ...
        if (data == null) {
            ...
            switch (viewType) {
                ...
                case ViewConfigurationAttributePlotProperties.SPECTRUM_VIEW_TYPE_TIME_STACK:
                    names = new String[data.getData_timed() == null ? 0 : data
                    ...
                    for (int i = 0; i < names.length; i++) {
                        ...
                        if (time == null) {
                            ...
                            calendar
                                    .setTimeInMillis(data.getData_timed()[i].time
                                            .longValue());
                            names[i] = dateFormat.format(calendar.getTime())
                                    + " " + toEnd;
                            calendar = null;
                        }
                    }
    ...
    protected void addComponents() {
        if (splitedData == null
            ...
            GUIUtilities
                    .setObjectBackground(nameLabel, GUIUtilities.VIEW_COLOR);
            ...
            this.add(nameLabel, readLabelConstraints);

            JLabel noDataLabel = new JLabel(Messages
                    .getMessage("VIEW_ATTRIBUTES_NO_DATA"));
            noDataLabel.setVerticalAlignment(SwingConstants.NORTH);
            GUIUtilities.setObjectBackground(noDataLabel,
                    GUIUtilities.VIEW_COLOR);
                        ...
                        if (extractingManager != null) {
                            if (extractingManager.isShowRead()) {
                                DataArray readDataArray = extractDataArray(row,
                                        ...
                                        getViewSpectrumType(), splitedData[0]);
                            ...
                            if (extractingManager.isShowWrite()) {
                                DataArray writeDataArray = extractDataArray(
                                        row, writeNameColumn,
                                        writeBooleanColumn,
                                        getViewSpectrumType(), splitedData[1]);
            ...
            if (selected.booleanValue()) {
                switch (viewType) {
                    case ViewConfigurationAttributePlotProperties.SPECTRUM_VIEW_TYPE_INDEX:
                        ...
                        dataArray.setName(""
                                + model.getValueAt(row, nameColumn));
    ...
    public void enableViewButton(boolean enable, boolean updateText) {
        if (viewButton != null) {
            ...
            if (updateText) {
                if (enable) {
                    viewButton.setText(Messages
                            .getMessage("VIEW_ACTION_VIEW_BUTTON")
                            + " " + getName());
                } else {
                    viewButton.setText(Messages
                            .getMessage("VIEW_ATTRIBUTES_NO_DATA")
