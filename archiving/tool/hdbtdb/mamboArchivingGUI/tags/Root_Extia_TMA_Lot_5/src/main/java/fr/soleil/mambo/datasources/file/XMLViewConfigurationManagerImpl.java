...
public class XMLViewConfigurationManagerImpl implements
		IViewConfigurationManager {
	 ...
	 * java.util.Hashtable)
	 */
	public void saveViewConfiguration(ViewConfiguration vc,
	...
	public ViewConfiguration loadViewConfiguration() throws Exception {
		String _location = this.getSaveLocation();
		ViewConfiguration vc = ViewConfigurationXMLHelper
