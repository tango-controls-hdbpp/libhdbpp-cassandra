    ...
    protected void initComponents() {
        ...
        if ((splitedData == null)
            ...
            if (splitedData == null) {
                ...
                String[] readNames = generateNames(splitedData[0], viewType,
                        Messages.getMessage("VIEW_SPECTRUM_READ"));
                String[] writeNames = generateNames(splitedData[1], viewType,
            ...
            switch (dataType) {
                ...
                case TangoConst.Tango_DEV_DOUBLE:
                    ...
                    for (int row = 0; row < model.getRowCount(); row++) {
                        ...
                        readDataArray = null;
                        DataArray writeDataArray = extractDataArray(row,
                                writeNameColumn, writeBooleanColumn,
