...
public class GeneralChartProperties {
    ...
    public String toString() {
        ...
        openingLine.setAttributeIfNotNull(LEGENDS_ARE_VISIBLE_PROPERTY_XML_TAG,
                String.valueOf(legendsAreVisible));
        openingLine.setAttributeIfNotNull(LEGENDS_PLACEMENT_PROPERTY_XML_TAG,
                String.valueOf(legendsPlacement));
        openingLine.setAttributeIfNotNull(BACKGROUND_COLOR_PROPERTY_XML_TAG,
                GUIUtilities.colorToString(backgroundColor));
        openingLine.setAttributeIfNotNull(HEADER_FONT_PROPERTY_XML_TAG,
                GUIUtilities.fontToString(headerFont));
        openingLine.setAttributeIfNotNull(LABEL_FONT_PROPERTY_XML_TAG,
                GUIUtilities.fontToString(labelFont));
        openingLine.setAttributeIfNotNull(AXIS_GRID_PROPERTY_XML_TAG, String
                .valueOf(axisGrid));
        openingLine.setAttributeIfNotNull(AXIS_GRID_STYLE_PROPERTY_XML_TAG,
                String.valueOf(axisGridStyle));
        ...
        openingLine.setAttributeIfNotNull(DISPLAY_DURATION_PROPERTY_XML_TAG,
                String.valueOf(displayDuration));
        openingLine.setAttributeIfNotNull(TIME_PRECISION_XML_TAG, String
                .valueOf(timePrecision));

        // System.out.println ( "headerFont/" + GUIUtilities.fontToString (
        // headerFont ) + "/" );
    ...
    /**
     * @param legendsAreVisible
     *            The legendsAreVisible to set.
     */
    ...
    public ChartViewer getAsJLChart() {
        ...
        if (this.backgroundColor != null) {
            chartviewerComponent.setChartCometeBackground(CometeColor
                    .getColor(this.backgroundColor));
        }
        if (headerFont != null) {
            chartviewerComponent.setHeaderCometeFont(CometeFont
                    .getFont(headerFont));
        }

        if (labelFont != null) {
            chartviewerComponent.setLabelCometeFont(CometeFont
                    .getFont(this.labelFont));
        }

        chartviewerComponent.setHeader(this.title);
        chartviewerComponent.setHeaderVisible(true);

        chartviewerComponent.setTimePrecision(this.timePrecision);
        chartviewerComponent.setLabelVisible(this.legendsAreVisible);
        chartviewerComponent.setLabelPlacement(this.legendsPlacement);
        chartviewerComponent.setNoValueString(OptionsVCTab.getInstance()
                .getNoValueString());
    ...
    public GeneralChartProperties cloneGeneralChartProperties() {
        ...
        ret.setBackgroundColor(this.getBackgroundColor() == null ? null
                : new Color(this.getBackgroundColor().getRGB()));
        ret.setDisplayDuration(this.getDisplayDuration());
        ret.setHeaderFont(this.getHeaderFont() == null ? null : new Font(this
                .getHeaderFont().getAttributes()));
        ret.setLabelFont(this.getLabelFont() == null ? null : new Font(this
                .getLabelFont().getAttributes()));
