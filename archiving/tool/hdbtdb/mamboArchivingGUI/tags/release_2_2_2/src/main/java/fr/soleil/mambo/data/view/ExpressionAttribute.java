...
public class ExpressionAttribute {
    ...
    public void prepareView(ChartViewer chart) {
        if (properties != null) {
            ...
            Polynomial2OrderTransform transform = properties.getTransform();
            ...
            if (marker != null) {
                ...
                chartComponent.setDataViewMarkerStyle(getName(), marker
                        .getStyle());
                chartComponent.setDataViewLabelVisible(getName(), marker
                        .isLegendVisible());
            }
            if (curve != null) {
            ...
            if (transform != null) {
                chartComponent.setDataViewTransformA0(getName(), transform
                        .getA0());
                chartComponent.setDataViewTransformA1(getName(), transform
                        .getA1());
                chartComponent.setDataViewTransformA2(getName(), transform
                        .getA2());
            }
            if (properties.isHidden()) {
                chartComponent.setDataViewLineWidth(getName(), 0);
                chartComponent.setDataViewMarkerStyle(getName(),
                        JLDataView.MARKER_NONE);
                chartComponent.setDataViewBarWidth(getName(), 0);
                chartComponent.setDataViewFillStyle(getName(),
                        JLDataView.FILL_STYLE_NONE);
                chartComponent.setDataViewLabelVisible(getName(), false);
                chartComponent.setDataViewClickable(getName(), false);
            }
