...
public class ViewConfigurationAttribute extends Attribute {
    ...
    private void setAttributeDataView(ChartViewer chart, String nameId,
        ...
        if (plotProperties != null) {
            ...
            Polynomial2OrderTransform transform = plotProperties.getTransform();
            ...
            if (marker != null) {
                ...
                chartComponent.setDataViewLabelVisible(nameId, marker
                        .isLegendVisible());
            }
            if (curve != null) {
                if (hasWrite) {
            ...
            if (bar != null) {
                ...
                chartComponent.setDataViewBarWidth(nameId, bar.getWidth());
            }
            if (transform != null) {
                chartComponent
                        .setDataViewTransformA0(nameId, transform.getA0());
                chartComponent
                        .setDataViewTransformA1(nameId, transform.getA1());
                chartComponent
                        .setDataViewTransformA2(nameId, transform.getA2());
            }
            if (plotProperties.isHidden()) {
                chartComponent.setDataViewLineWidth(nameId, 0);
                chartComponent.setDataViewMarkerStyle(nameId,
                        JLDataView.MARKER_NONE);
                chartComponent.setDataViewBarWidth(nameId, 0);
                chartComponent.setDataViewFillStyle(nameId,
