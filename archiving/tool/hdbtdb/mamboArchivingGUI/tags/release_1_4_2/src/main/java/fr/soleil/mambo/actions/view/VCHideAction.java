...
public class VCHideAction extends AbstractAction
{
    ...
    public void actionPerformed(ActionEvent e) {
        try{
        	if(visible == true){
        		visible = false;
        		ViewAttributesPanel.getInstance().remove( ViewAttributesTreePanel.getInstance() );
        		ViewAttributesPanel.getInstance().setLayout();
        		ViewAttributesPanel.getInstance().repaint();
        		ViewAttributesPanel.getInstance().validate();
        		name = Messages.getMessage( "VIEW_ACTION_SHOWK_GRAPHEVIEW" );
                putValue( Action.NAME , name );
                putValue( Action.SHORT_DESCRIPTION , name );
        	}else{
        		visible = true;
        		ViewAttributesPanel.getInstance().add( ViewAttributesTreePanel.getInstance() , 0 );
        		ViewAttributesPanel.getInstance().setLayout();
        		ViewAttributesPanel.getInstance().repaint();
        		ViewAttributesPanel.getInstance().validate();
...
//    		ViewAttributesTreePanel.getInstance().setVisible( visible );
