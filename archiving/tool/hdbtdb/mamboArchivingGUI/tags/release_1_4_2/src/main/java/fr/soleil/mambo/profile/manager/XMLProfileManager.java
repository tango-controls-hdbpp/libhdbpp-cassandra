//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/profile/manager/XMLProfileManager.java,v $
//
...
// Revision 1.5  2007/02/01 14:13:30  pierrejoseph
// XmlHelper reorg
//
// Revision 1.4  2006/10/25 08:00:46  ounsy
// replaced calls to show() by calls to setVisible(true)
//
// Revision 1.3  2006/05/19 15:05:29  ounsy
// minor changes
//
// Revision 1.2  2005/12/15 11:47:07  ounsy
// minor changes
//
...
class XMLProfileManager implements IProfileManager
{
    ...
    private final static String profileFileName = "mambo.profile";
    private final static String lockFileName = ".lock";
    private final static String mainNodeTag = "MamboProfiles";
    ...
    private void showFailedMessage ( int failureType )
    {
        ...
        MamboErrorDialog dialog = new MamboErrorDialog( title , message );
    ...
    private void saveProfiles () throws Exception
    {
        ...
        for ( int i = 0 ; i < profileArray.length ; i++ )
        {
            //content += "\n    " + profileArray[i].toXMLString();
            content += GUIUtilities.CRLF + "    ";
            content += profileArray[ i ].toXMLString();
        }
