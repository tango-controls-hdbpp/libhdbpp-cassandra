...
{
    private static ViewExpressionVariablesEditPanel instance = null;
    protected String[] variables;
    protected JLabel[] title, name;
    protected String expression;
    protected boolean x = false;

    public static ViewExpressionVariablesEditPanel getInstance ()
    {
        if (instance == null)
        {
            instance = new ViewExpressionVariablesEditPanel();
        }
        return instance;
    }

    public ViewExpressionVariablesEditPanel ()
    {
        super();
        expression = "";
    }
    ...
    public void clean ()
    {
        ...
        name = null;
        title = null;
        ExpressionNamesChooser.getInstance().clean();
        ExpressionNamesChooser.getInstance().dispose();
    }
