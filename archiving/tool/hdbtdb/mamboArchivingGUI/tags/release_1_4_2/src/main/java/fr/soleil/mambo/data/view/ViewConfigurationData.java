...
//      boolean dynamic = dateRangeBoxTreePanel.getDynamicDateRangeCheckBox().isSelected();
        if ( dynamic )
        {
        ...
        //upDate DateRange of ViewAttributesTreePanel after upDate generalTab.getDateRangeBox()
        DateRangeBox dateRangeBoxTreePanel = ViewAttributesTreePanel.getInstance().getDateRangeBox();
        dateRangeBoxTreePanel.update( generalTab.getDateRangeBox() );
    ...
    public void upDateVCData( DateRangeBox _dateRangeBox ){
        ...
        {
        	//TODO peut exister d'autre parametres a metre a jour
...
//        GeneralTab generalTab = GeneralTab.getInstance();
    ...
    public void setDateRangBox( DateRangeBox dateRangeBox ){
    	this.setDateRange( dateRangeBox.getDateRange() );
    	this.setStartDate( dateRangeBox.getStartDate() );
    	this.setEndDate( dateRangeBox.getEndDate() );
    	this.setDynamicDateRange( dateRangeBox.getDynamicDateRangeCheckBox().isSelected() );
    }
