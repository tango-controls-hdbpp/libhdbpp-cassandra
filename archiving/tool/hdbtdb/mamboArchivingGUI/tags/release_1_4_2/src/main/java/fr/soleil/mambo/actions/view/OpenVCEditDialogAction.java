    ...
    public void actionPerformed ( ActionEvent actionEvent ) 
    {
        ...
        try
        {
            ...
            if (needsNewVc) {// new VC
            	...
            	VCToPush.getData().setDateRangBox( dateRangeBoxTreePanel );
                VCToPush.pushLight ();
//                ViewAttributesTreePanel viewAttributesTreePanel = ViewAttributesTreePanel.getInstance();
//                dialog.getGeneralTab().getDateRangeBox().update(viewAttributesTreePanel.getDateRangeBox());
