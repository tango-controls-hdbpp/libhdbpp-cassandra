...
public class ACOptions extends ReadWriteOptionBook implements PushPullOptionBook
{
    ...
    public ArchivingConfigurationAttributeProperties getDefaultACProperties ()
    {
        ...
        //-------------HDB
        selection = ( String ) this.content.get( HDB_PERIODIC_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( HDB_PERIOD );
        ...
        selection = ( String ) this.content.get( HDB_ABSOLUTE_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( HDB_ABSOLUTE_MODE_PERIOD );
                int period_i = Integer.parseInt( period );
                lower = ( String ) this.content.get( HDB_ABSOLUTE_MODE_LOWER );
                double lower_d = Double.parseDouble( lower );
                upper = ( String ) this.content.get( HDB_ABSOLUTE_MODE_UPPER );
                double upper_d = Double.parseDouble( upper );

                ModeAbsolu _mode = new ModeAbsolu( period_i , lower_d , upper_d );
        ...
        selection = ( String ) this.content.get( HDB_RELATIVE_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( HDB_RELATIVE_MODE_PERIOD );
                int period_i = Integer.parseInt( period );
                lower = ( String ) this.content.get( HDB_RELATIVE_MODE_LOWER );
                double lower_d = Double.parseDouble( lower );
                upper = ( String ) this.content.get( HDB_RELATIVE_MODE_UPPER );
                double upper_d = Double.parseDouble( upper );

                ModeRelatif _mode = new ModeRelatif( period_i , lower_d , upper_d );
        ...
        selection = ( String ) this.content.get( HDB_THRESHOLD_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( HDB_THRESHOLD_MODE_PERIOD );
                int period_i = Integer.parseInt( period );
                lower = ( String ) this.content.get( HDB_THRESHOLD_MODE_LOWER );
                double lower_d = Double.parseDouble( lower );
                upper = ( String ) this.content.get( HDB_THRESHOLD_MODE_UPPER );
                double upper_d = Double.parseDouble( upper );
        ...
        selection = ( String ) this.content.get( HDB_DIFFERENCE_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( HDB_DIFFERENCE_MODE_PERIOD );
                int period_i = Integer.parseInt( period );
        ...
        //-------------TDB
        selection = ( String ) this.content.get( TDB_PERIODIC_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( TDB_PERIOD );
                int period_i = Integer.parseInt( period );
                ModePeriode _mode = new ModePeriode( period_i );
        ...
        selection = ( String ) this.content.get( TDB_ABSOLUTE_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( TDB_ABSOLUTE_MODE_PERIOD );
                int period_i = Integer.parseInt( period );
                lower = ( String ) this.content.get( TDB_ABSOLUTE_MODE_LOWER );
                double lower_d = Double.parseDouble( lower );
                upper = ( String ) this.content.get( TDB_ABSOLUTE_MODE_UPPER );
                double upper_d = Double.parseDouble( upper );
        ...
        selection = ( String ) this.content.get( TDB_RELATIVE_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( TDB_RELATIVE_MODE_PERIOD );
                int period_i = Integer.parseInt( period );
                lower = ( String ) this.content.get( TDB_RELATIVE_MODE_LOWER );
                double lower_d = Double.parseDouble( lower );
                upper = ( String ) this.content.get( TDB_RELATIVE_MODE_UPPER );
                double upper_d = Double.parseDouble( upper );
        ...
        selection = ( String ) this.content.get( TDB_THRESHOLD_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( TDB_THRESHOLD_MODE_PERIOD );
                int period_i = Integer.parseInt( period );
                lower = ( String ) this.content.get( TDB_THRESHOLD_MODE_LOWER );
                double lower_d = Double.parseDouble( lower );
                upper = ( String ) this.content.get( TDB_THRESHOLD_MODE_UPPER );
                double upper_d = Double.parseDouble( upper );
        ...
        selection = ( String ) this.content.get( TDB_DIFFERENCE_MODE );
        if ( selection != null )
        {
            try
            {
                period = ( String ) this.content.get( TDB_DIFFERENCE_MODE_PERIOD );
                int period_i = Integer.parseInt( period );
                ModeDifference _mode = new ModeDifference( period_i );
        ...
        try
        {
            period = ( String ) this.content.get( TDB_EXPORT_PERIOD );
...
//do nothing
    ...
    private void fillStackDepth ()
    {
        ...
        try
        {
            int _stackDepth = Integer.parseInt( stackDepth_s );
            this.setStackDepth( _stackDepth );
        }
        catch ( Exception e )
        {
        }
        this.content.put( STACK_DEPTH , stackDepth_s );
    }
    ...
    private void fillDefaultValues ()
    {
        ...
        this.content.put( HDB_PERIOD , String.valueOf( value ) );

        value = defaultPanel.getHDBAbsolutePeriod();
        this.content.put( HDB_ABSOLUTE_MODE_PERIOD , String.valueOf( value ) );

        value = defaultPanel.getHDBRelativePeriod();
        this.content.put( HDB_RELATIVE_MODE_PERIOD , String.valueOf( value ) );

        value = defaultPanel.getHDBThresholdPeriod();
        this.content.put( HDB_THRESHOLD_MODE_PERIOD , String.valueOf( value ) );

        value = defaultPanel.getHDBDifferencePeriod();
        this.content.put( HDB_DIFFERENCE_MODE_PERIOD , String.valueOf( value ) );
        //------
        //------TDB Periods
        value = defaultPanel.getTDBperiod();
        this.content.put( TDB_PERIOD , String.valueOf( value ) );

        l = defaultPanel.getExportPeriod();
        this.content.put( TDB_EXPORT_PERIOD , String.valueOf( l ) );
        ...
        this.content.put( TDB_ABSOLUTE_MODE_PERIOD , String.valueOf( value ) );

        value = defaultPanel.getTDBRelativePeriod();
        this.content.put( TDB_RELATIVE_MODE_PERIOD , String.valueOf( value ) );

        value = defaultPanel.getTDBThresholdPeriod();
        this.content.put( TDB_THRESHOLD_MODE_PERIOD , String.valueOf( value ) );

        value = defaultPanel.getTDBDifferencePeriod();
        this.content.put( TDB_DIFFERENCE_MODE_PERIOD , String.valueOf( value ) );
        //------

        //------HDB upper/lower
        value_s = defaultPanel.getHDBAbsoluteUpper();
        this.content.put( HDB_ABSOLUTE_MODE_UPPER , value_s );

        value_s = defaultPanel.getHDBRelativeUpper();
        this.content.put( HDB_RELATIVE_MODE_UPPER , value_s );

        value_s = defaultPanel.getHDBThresholdUpper();
        this.content.put( HDB_THRESHOLD_MODE_UPPER , value_s );

        value_s = defaultPanel.getHDBAbsoluteLower();
        this.content.put( HDB_ABSOLUTE_MODE_LOWER , value_s );

        value_s = defaultPanel.getHDBRelativeLower();
        this.content.put( HDB_RELATIVE_MODE_LOWER , value_s );

        value_s = defaultPanel.getHDBThresholdLower();
        this.content.put( HDB_THRESHOLD_MODE_LOWER , value_s );
        //------

        //------TDB upper/lower
        value_s = defaultPanel.getTDBAbsoluteUpper();
        this.content.put( TDB_ABSOLUTE_MODE_UPPER , value_s );

        value_s = defaultPanel.getTDBRelativeUpper();
        this.content.put( TDB_RELATIVE_MODE_UPPER , value_s );

        value_s = defaultPanel.getTDBThresholdUpper();
        this.content.put( TDB_THRESHOLD_MODE_UPPER , value_s );

        value_s = defaultPanel.getTDBAbsoluteLower();
        this.content.put( TDB_ABSOLUTE_MODE_LOWER , value_s );

        value_s = defaultPanel.getTDBRelativeLower();
        this.content.put( TDB_RELATIVE_MODE_LOWER , value_s );

        value_s = defaultPanel.getTDBThresholdLower();
        this.content.put( TDB_THRESHOLD_MODE_LOWER , value_s );
        //------
    }
    ...
    private void fillDefaultModes ()
    {
        ...
        {
            this.content.put( HDB_PERIODIC_MODE , HDB_PERIODIC_MODE );
        }
        else
        {
            this.content.remove( HDB_PERIODIC_MODE );
        }

        if ( defaultPanel.hasModeHDB_A() )
        {
            this.content.put( HDB_ABSOLUTE_MODE , HDB_ABSOLUTE_MODE );
        }
        else
        {
            this.content.remove( HDB_ABSOLUTE_MODE );
        }

        if ( defaultPanel.hasModeHDB_R() )
        {
            this.content.put( HDB_RELATIVE_MODE , HDB_RELATIVE_MODE );
        }
        else
        {
            this.content.remove( HDB_RELATIVE_MODE );
        }

        if ( defaultPanel.hasModeHDB_T() )
        {
            this.content.put( HDB_THRESHOLD_MODE , HDB_THRESHOLD_MODE );
        }
        else
        {
            this.content.remove( HDB_THRESHOLD_MODE );
        }

        if ( defaultPanel.hasModeHDB_D() )
        {
            this.content.put( HDB_DIFFERENCE_MODE , HDB_DIFFERENCE_MODE );
        }
        else
        {
            this.content.remove( HDB_DIFFERENCE_MODE );
        }
        //----
        if ( defaultPanel.hasModeTDB_P() )
        {
            this.content.put( TDB_PERIODIC_MODE , TDB_PERIODIC_MODE );
        }
        else
        {
            this.content.remove( TDB_PERIODIC_MODE );
        }

        if ( defaultPanel.hasModeTDB_A() )
        {
            this.content.put( TDB_ABSOLUTE_MODE , TDB_ABSOLUTE_MODE );
        }
        else
        {
            this.content.remove( TDB_ABSOLUTE_MODE );
        }

        if ( defaultPanel.hasModeTDB_R() )
        {
            this.content.put( TDB_RELATIVE_MODE , TDB_RELATIVE_MODE );
        }
        else
        {
            this.content.remove( TDB_RELATIVE_MODE );
        }

        if ( defaultPanel.hasModeTDB_T() )
        {
            this.content.put( TDB_THRESHOLD_MODE , TDB_THRESHOLD_MODE );
        }
        else
        {
            this.content.remove( TDB_THRESHOLD_MODE );
        }

        if ( defaultPanel.hasModeTDB_D() )
        {
            this.content.put( TDB_DIFFERENCE_MODE , TDB_DIFFERENCE_MODE );
        }
        else
        {
            this.content.remove( TDB_DIFFERENCE_MODE );
        }
    }
    ...
    private void pushStackDepth ()
    {
        ...
        String stackDepth_s = ( String ) this.content.get( STACK_DEPTH );
        stackDepth_s = stackDepth_s == null ? "" : stackDepth_s;
        ...
        try
        {
            ...
            openedACComboBox.setMaxSize ( _stackDepth );*/
        }
        catch ( Exception e )
        {
        }
    ...
    private void pushDefaultValues ()
    {
		...
		System.out.println ( this.toPropertiesString () );
		System.out.println ( "ACOptions/pushDefaultValues/IN--------------" );*/
        ...
        //---HDB periods
        s = ( String ) this.content.get( HDB_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
        ...
        s = ( String ) this.content.get( HDB_ABSOLUTE_MODE_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            i = Integer.parseInt( s );
        ...
        s = ( String ) this.content.get( HDB_RELATIVE_MODE_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            i = Integer.parseInt( s );
        ...
        s = ( String ) this.content.get( HDB_THRESHOLD_MODE_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            i = Integer.parseInt( s );
        ...
        s = ( String ) this.content.get( HDB_DIFFERENCE_MODE_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            i = Integer.parseInt( s );
        ...
        //---TDB periods
        s = ( String ) this.content.get( TDB_PERIOD );
        ...
        s = ( String ) this.content.get( TDB_EXPORT_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            l = Long.parseLong( s );
        ...
        s = ( String ) this.content.get( TDB_ABSOLUTE_MODE_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            i = Integer.parseInt( s );
        ...
        s = ( String ) this.content.get( TDB_RELATIVE_MODE_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            i = Integer.parseInt( s );
        ...
        s = ( String ) this.content.get( TDB_THRESHOLD_MODE_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            i = Integer.parseInt( s );
        ...
        s = ( String ) this.content.get( TDB_DIFFERENCE_MODE_PERIOD );
        if ( s != null && !s.equals ( "" ) )
        {
            i = Integer.parseInt( s );
        ...
        s = ( String ) this.content.get( HDB_ABSOLUTE_MODE_UPPER );
        defaultPanel.setHDBAbsoluteUpper( s );

        s = ( String ) this.content.get( HDB_RELATIVE_MODE_UPPER );
        defaultPanel.setHDBRelativeUpper( s );

        s = ( String ) this.content.get( HDB_THRESHOLD_MODE_UPPER );
        defaultPanel.setHDBThresholdUpper( s );

        s = ( String ) this.content.get( HDB_ABSOLUTE_MODE_LOWER );
        defaultPanel.setHDBAbsoluteLower( s );

        s = ( String ) this.content.get( HDB_RELATIVE_MODE_LOWER );
        defaultPanel.setHDBRelativeLower( s );

        s = ( String ) this.content.get( HDB_THRESHOLD_MODE_LOWER );
        defaultPanel.setHDBThresholdLower( s );

        //---TDB values
        s = ( String ) this.content.get( TDB_ABSOLUTE_MODE_UPPER );
        defaultPanel.setTDBAbsoluteUpper( s );

        s = ( String ) this.content.get( TDB_RELATIVE_MODE_UPPER );
        defaultPanel.setTDBRelativeUpper( s );

        s = ( String ) this.content.get( TDB_THRESHOLD_MODE_UPPER );
        defaultPanel.setTDBThresholdUpper( s );

        s = ( String ) this.content.get( TDB_ABSOLUTE_MODE_LOWER );
        defaultPanel.setTDBAbsoluteLower( s );

        s = ( String ) this.content.get( TDB_RELATIVE_MODE_LOWER );
        defaultPanel.setTDBRelativeLower( s );

        s = ( String ) this.content.get( TDB_THRESHOLD_MODE_LOWER );
