//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/components/archiving/ACAttributesPropertiesTree.java,v $
//
...
public class ACAttributesPropertiesTree extends AttributesTree
{
     ...
     * @param newModel
     */
    private ACAttributesPropertiesTree ( TreeModel newModel )
    {
        super( newModel );
        this.addTreeSelectionListener( new ACAttributesPropertiesTreeSelectionListener() );
     ...
     * @return 8 juil. 2005
     */
    public static ACAttributesPropertiesTree getInstance ( TreeModel newModel )
    {
        if ( instance == null )
        {
            instance = new ACAttributesPropertiesTree( newModel );
        }
        else instance.setModel( newModel );
