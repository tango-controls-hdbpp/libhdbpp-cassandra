...
public class VCOptions extends ReadWriteOptionBook implements PushPullOptionBook
{
    ...
    */
    public void fillFromOptionsDialog ()
    {
        ...
        this.content.put( CHART_NO_VALUE_STRING, noValueString );
    }
    ...
    */
    public void push ()
    {
        ...
        String plaf_s = ( String ) this.content.get( DISPLAY_WRITE );
        if ( plaf_s != null )
        {
        ...
        plaf_s = ( String ) this.content.get( DISPLAY_READ );
        if ( plaf_s != null )
        {
            int plaf = Integer.parseInt( plaf_s );
        ...
        plaf_s = ( String ) this.content.get( FORCE_TDB_EXPORT );
        ...
        try
        {
            ...
            openedVCComboBox.setMaxSize( _stackDepth );
        }
        catch ( Exception e )
        {
        }
        ...
        String noValueString = ( String ) this.content.get( CHART_NO_VALUE_STRING );
