    ...
    public void openConnection () throws ArchivingException
    {
        if ( ! isReady )
        {
            ...
            if ( Mambo.isHdbAvailable() == true ) {
                ...
                String racConnection = System.getProperty("HDB_RAC")== null?"FALSE":System.getProperty("HDB_RAC");
            	try
            	{
            		...
            		{
            			this.hdbManager.ArchivingConfigureWithoutArchiverListInit(HDBHost, HDBName, HDBuser , HDBpassword, Boolean.parseBoolean(racConnection)  );
            		}
            	}
            ...
            try
            {
                ...
                String racConnection = System.getProperty("TDB_RAC")== null?"FALSE":System.getProperty("TDB_RAC");
               	if(Mambo.canChooseArchivers())
                {
                ...
                {
                    this.tdbManager.ArchivingConfigureWithoutArchiverListInit(TDBHost, TDBName, TDBuser , TDBpassword, Boolean.parseBoolean(racConnection)  );
                }
            }
            catch ( ArchivingException ae )
            {
