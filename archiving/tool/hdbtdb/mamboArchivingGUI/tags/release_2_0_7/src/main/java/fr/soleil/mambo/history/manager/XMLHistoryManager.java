...
import fr.soleil.mambo.tools.xmlhelpers.ac.ArchivingConfigurationXMLHelper;
...
public class XMLHistoryManager implements IHistoryManager 
{
    ...
    private static Hashtable loadHistoryIntoHashFromRoot(Node rootNode) throws Exception 
    {
		...
		{    
		    ...
		    //   (which is normally two: AC and VC)
		    {
		        ...
		        //System.out.println ( "loadHistoryIntoHashFromRoot/currentBookType/"+currentBookType+"/" );
    ...
    private static Hashtable loadVCBook(Node currentBookNode) throws Exception 
    {
		...
		{    
		    ...
		    for ( int i = 0; i < bookNodes.getLength (); i++ ) 
		    {
		        ...
		        //System.out.println ( "loadVCBook/currentBookType/"+currentBookType+"/" );
     ...
     * @throws Exception
     */
    private static LimitedVCStack loadOpenedVCBook(Node currentSubNode) throws Exception 
    {
		...
		{    
		    ...
		    for ( int i = 0; i < bookNodes.getLength (); i++ ) 
		    {
		        ...
		        if ( ViewConfiguration.XML_TAG.equals ( currentBookType ) )
				{
		            ...
		            ViewConfiguration openedVC = ViewConfigurationXMLHelper.loadViewConfigurationIntoHashFromRoot ( currentSubSubNode );
		            //System.out.println ( "loadOpenedVCBook/new VC!!!/name/"+openedVC.getData().getName() );
     ...
     * @throws Exception
     */
    private static LimitedACStack loadOpenedACBook(Node currentSubNode) throws Exception 
    {
		...
		{    
		    ...
		    for ( int i = 0; i < bookNodes.getLength (); i++ ) 
		    {
				...
				{
		            //ArchivingConfiguration openedAC = ArchivingConfigurationXMLHelper.loadArchivingConfigurationIntoHashFromRoot ( currentSubSubNode );
		        	ArchivingConfiguration openedAC = ArchivingConfigurationXMLHelperFactory.getCurrentImpl().loadArchivingConfigurationIntoHashFromRoot ( currentSubSubNode );
		            //System.out.println ( "loadOpenedACBook/new AC!!!/name/"+openedAC.getData().getName() );
     ...
     * @throws Exception
     */
    private static ViewConfiguration loadSelectedVCBook(Node currentSubNode) throws Exception 
    {
        if ( currentSubNode.hasChildNodes () )
		{    
		    NodeList bookNodes = currentSubNode.getChildNodes ();
		    ...
		    for ( int i = 0; i < bookNodes.getLength (); i++ ) 
		    {
		        ...
		        if ( ViewConfiguration.XML_TAG.equals ( currentBookType ) )
				{
		            ViewConfiguration selectedVC = ViewConfigurationXMLHelper.loadViewConfigurationIntoHashFromRoot ( currentSubSubNode );
		            return selectedVC;
				}
		    }
		}
     ...
     * @throws Exception
     */
    private static ArchivingConfiguration loadSelectedACBook(Node currentSubNode) throws Exception 
    {
        if ( currentSubNode.hasChildNodes () )
		{    
		    NodeList bookNodes = currentSubNode.getChildNodes ();
		    ...
		    for ( int i = 0; i < bookNodes.getLength (); i++ ) 
		    {
				...
				{
		        	ArchivingConfiguration selectedAC = ArchivingConfigurationXMLHelperFactory.getCurrentImpl().loadArchivingConfigurationIntoHashFromRoot ( currentSubSubNode );
		            //ArchivingConfiguration selectedAC = ArchivingConfigurationXMLHelper.loadArchivingConfigurationIntoHashFromRoot ( currentSubSubNode );
		            return selectedAC;
				}
		    }
		}
