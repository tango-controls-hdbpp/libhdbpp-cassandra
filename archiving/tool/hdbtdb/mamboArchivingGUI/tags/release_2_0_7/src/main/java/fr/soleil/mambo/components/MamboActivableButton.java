...
public class MamboActivableButton extends JButton
{
     ...
     * @param enabled  the ImageIcon when button is enabled
     * @param disabled the ImageIcon when button is disabled
     */
     ...
     * @param m        MouseListener of the button
     * @param enabled  the ImageIcon when button is enabled
     * @param disabled the ImageIcon when button is disabled
     */
    public MamboActivableButton ( String text, MouseListener m, ImageIcon enabled, ImageIcon disabled )
    {
        super( text );
        setToolTipText(text);
        setMargin( new Insets( 0 , 0 , 0 , 0 ) );
