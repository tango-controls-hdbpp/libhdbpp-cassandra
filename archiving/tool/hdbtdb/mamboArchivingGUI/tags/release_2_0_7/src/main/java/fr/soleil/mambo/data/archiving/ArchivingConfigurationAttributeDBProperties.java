...
public class ArchivingConfigurationAttributeDBProperties
{
    ...
    public String toString ()
    {
        ...
        if ( modes != null )
        {
            ...
            while ( enumeration.hasMoreElements() )
            {
                ...
                ArchivingConfigurationMode nextValue = ( ArchivingConfigurationMode ) modes.get( nextKey );
    ...
    public ArchivingConfigurationMode[] getModes ()
    {
        ...
        ArchivingConfigurationMode[] _modes = new ArchivingConfigurationMode[ modes.size() ];
    ...
    public void addMode ( ArchivingConfigurationMode _mode )
    {
        ...
        /*System.out.println ( "-----------addMode REPERE 1 currentAC ------------" );
        ...
        //ArchivingConfiguration currentAC4 = ArchivingConfiguration.getCurrentArchivingConfiguration ();
        /*System.out.println ( "-----------addMode REPERE 2 currentAC ------------" );
        System.out.println ( currentAC4.toString () );
        System.out.println ( "-----------addMode REPERE 2 currentAC ------------" );*/
    }

    public void removeMode ( int _modeToRemove )
    {
        //System.out.println ( "ArchivingConfigurationAttributeDBProperties/removeMode/_modeToRemove/"+_modeToRemove+"/this.modes/"+this.modes.size()+"/" );

        /*Enumeration enumeration = this.modes.keys();
        while ( enumeration.hasMoreElements() )
        {
            Integer next = ( Integer ) enumeration.nextElement();
            //System.out.println ( "ArchivingConfigurationAttributeDBProperties/removeMode/next/"+next+"/" );
        }*/
    ...
    public void push() 
    {
        ...
        if ( panel != null )
        {
            ...
            try 
            {
                String completeName = this.properties.getAttribute ().getCompleteName ();
