        ...
        if ( ! isReady )
        {
            ...
            if ( Mambo.isHdbAvailable() == true ) {
            	...
            	try
            	{
            		...
            		{
            			this.manager.ArchivingConfigureWithoutArchiverListInit(HDBHost, HDBName, HDBuser , HDBpassword ,true );
            		}
            ...
            try
            {
                ...
                {
                    this.manager.ArchivingConfigureWithoutArchiverListInit(TDBHost, TDBName, TDBuser , TDBpassword ,false );
                }
            }
            catch ( ArchivingException ae )
            {
