//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/options/ReadWriteOptionBook.java,v $
//
...
public class ReadWriteOptionBook
{
    ...
    public void build ( Vector options )
    {
        ...
        while ( e.hasMoreElements() )
        {
            ...
            String nextName = ( String ) nextOption.get( ReadWriteOptionBook.NAME_TAG );
            String nextValue = ( String ) nextOption.get( ReadWriteOptionBook.VALUE_TAG );
            //System.out.println ( "Options/loadOptions/nextName/"+nextName+"/nextValue/"+nextValue+"/" );
