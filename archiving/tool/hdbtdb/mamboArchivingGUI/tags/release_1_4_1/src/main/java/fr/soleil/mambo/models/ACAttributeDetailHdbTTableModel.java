...
public class ACAttributeDetailHdbTTableModel extends DefaultTableModel
{
    ...
    private Object getACColumnValue ( int rowIndex )
    {
        ...
        {
            ArchivingConfigurationMode ACTMode = HDBProperties.getMode( ArchivingConfigurationMode.TYPE_T );
            if ( ACTMode != null )
            {
                switch ( rowIndex )
                {
    ...
    private Object getSecondColumnValue ( int rowIndex )
    {
        ...
        {
            case 0:
                ret = Messages.getMessage( "ARCHIVING_ATTRIBUTES_DETAIL_MODET_PERIOD" );
                break;
            case 1:
                ret = Messages.getMessage( "ARCHIVING_ATTRIBUTES_DETAIL_MODET_UPPER" );
                break;
            case 2:
                ret = Messages.getMessage( "ARCHIVING_ATTRIBUTES_DETAIL_MODET_LOWER" );
                break;
        }
        return ret;
    }
