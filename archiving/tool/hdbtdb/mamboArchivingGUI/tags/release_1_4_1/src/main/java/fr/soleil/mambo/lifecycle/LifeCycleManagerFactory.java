...
public class LifeCycleManagerFactory
{
     ...
     * @param typeOfImpl : it's the default implementation if no properties file will be found
     * @return 8 juil. 2005
     */
    public static LifeCycleManager getImpl ( int typeOfImpl )
    {
    	...
    	if(properties != null)
    	{
    		...
    		String lifeCycleName = properties.getProperty(LIFE_CYCLE_MANAGER_PROPERTY);
    		// we create an instance of it, it's the current implementation
    		if(lifeCycleName != null)
    			currentImpl = getLifeCycleManager(lifeCycleName);
    		// if the currentImpl is not equal to null, we sucessfully create a new instance
    		if(currentImpl != null)
    			return currentImpl;
    	}
        ...
        switch ( typeOfImpl )
        {
            ...
            default:
                throw new IllegalStateException( "Expected DEFAULT_LIFE_CYCLE (0), got " + typeOfImpl + " instead." );
        }
    ...
    private static Properties getPropertiesFile()
    {
        ...
        try{
            ...
            stream = LifeCycleManagerFactory.class.getClassLoader().getResourceAsStream(MAMBO_PROPERTIES);
