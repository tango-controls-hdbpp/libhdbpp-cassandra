...
import fr.soleil.mambo.actions.view.VCSetAxisAttributesGroupProperties;
...
public class AttributesPlotPropertiesPanel extends JPanel implements MouseListener
{
    private static int           colorIndex;
    private final static int     totalColors   = 30;
  ...
  /*      String msg;
    ...
    private JPanel initFactorPanel ()
    {
        ...
        // SetButton Creation
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_ATTRIBUTES_PROPERTIES_SET" );
        setBalancingFactorButton = new JButton( new VCSetBalancingFactorAttributesGroupProperties( msg, expression ) );
    ...
    private JPanel initAxisChoicePanel ()
    {
        ...
        // SetButton Creation
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_ATTRIBUTES_PROPERTIES_SET" );
        setAxisButton = new JButton( new VCSetAxisAttributesGroupProperties( msg, expression ) );
    ...
    JPanel balFactorPanel;
        ...
        // SetButton Creation
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_ATTRIBUTES_PROPERTIES_SET" );
        setAxisButton = new JButton( new SetAttributesGroupProperties( msg ) );
        setAxisButton.setMaximumSize( new Dimension( Integer.MAX_VALUE , 20 ) );
