...
public class ACRecapEditCopyValidateAction extends AbstractAction {
     ...
     * @return
     */
    public static ACRecapEditCopyValidateAction getInstance ( String name, JTextArea copyText, JDialog _dialog )
    {
    ...
    public static ACRecapEditCopyValidateAction getInstance ()
    {
	  ...
	  * @param name
	  */
     private ACRecapEditCopyValidateAction ( String name, JTextArea copyText, JDialog _dialog )
	 {
