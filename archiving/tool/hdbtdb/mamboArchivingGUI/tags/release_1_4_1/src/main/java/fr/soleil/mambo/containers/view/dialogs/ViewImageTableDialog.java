/*	Synchrotron Soleil 
 *  
 *   File          :  ViewImageTableDialog.java
 *  
...
public class ViewImageTableDialog extends JDialog
{
    ...
    private ImageIcon viewIcon = new ImageIcon(Mambo.class.getResource("icons/viewImage.gif"));
    ...
    {
        super( VCViewDialog.getInstance ( false ) , "" , true );
    ...
    {
        String title = this.imageData.getName () + " (" + this.imageData.getDate() + ")";
        this.setTitle ( title );
        this.setLocation(VCViewDialog.getInstance ( false ).getX(), VCViewDialog.getInstance ( false ).getY());
    }
    ...
    private void initComponents() 
    {
        ...
        ImageViewTableModel model = new ImageViewTableModel ( this.imageData.getValue () );
        ...
        viewButton = new JButton(new ViewImageAction(imageData.getName(), imageData.getValue(), displayFormat));
