//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/data/archiving/ArchivingConfigurationAttribute.java,v $
//
...
public class ArchivingConfigurationAttribute extends Attribute
{
    ...
    public ArchivingConfigurationAttribute ( ArchivingConfigurationAttributeProperties _properties , Attributes _contextAttributes )
    {
    ...
    public String toString ()
    {
        ...
        openingLine.setAttribute( ArchivingConfigurationAttribute.COMPLETE_NAME_PROPERTY_XML_TAG , super.getCompleteName() );
    ...
    public void loadFromCurrentArchivingState () throws Exception
    {
        ...
        {
            ArchivingConfigurationAttributeHDBProperties HDBProperties = ArchivingConfigurationAttributeHDBProperties.loadHDBProperties( this.getCompleteName() );
        ...
        {
            ArchivingConfigurationAttributeTDBProperties TDBProperties = ArchivingConfigurationAttributeTDBProperties.loadTDBProperties( this.getCompleteName() );
    ...
    public void addProperties ( ArchivingConfigurationAttributeProperties properties )
    {
        ...
        if ( !HDBPropertiesToAdd.isEmpty() )
        {
            ...
            ArchivingConfigurationAttributeHDBProperties HDBProperties = this.getProperties().getHDBProperties();
        ...
        if ( !TDBPropertiesToAdd.isEmpty() )
        {
            ...
            ArchivingConfigurationAttributeTDBProperties TDBProperties = this.getProperties().getTDBProperties();
    ...
    public void removeProperty ( boolean hasMode , int type , boolean historic )
    {
        if ( !hasMode )
        {
            ArchivingConfigurationAttributeHDBProperties HDBProperties = this.properties.getHDBProperties();
            ArchivingConfigurationAttributeTDBProperties TDBProperties = this.properties.getTDBProperties();
    ...
    /**
     * @param exportPeriod 26 juil. 2005
     */
    ...
    public void setDedicatedArchiver ( boolean _historic , String _dedicatedArchiver ) 
    {
