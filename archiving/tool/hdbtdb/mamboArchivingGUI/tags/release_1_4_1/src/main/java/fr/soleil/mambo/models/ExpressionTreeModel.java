...
public class ExpressionTreeModel extends DefaultTreeModel
{
    ...
    protected TreeMap expressionAttributes;
    ...
    protected ExpressionTreeModel ()
    {
        ...
        setRoot(rootNode);
        expressionAttributes = new TreeMap(Collator.getInstance(Locale.FRENCH));
    }
    ...
    public ExpressionAttribute removeAttribute(String attributeName)
    {
        ...
        node = null;
        this.reload();
        return (ExpressionAttribute)expressionAttributes.remove(attributeName);
    }
    ...
    public TreeMap getExpressionAttributes ()
    {
    ...
    {
        return (ExpressionAttribute)expressionAttributes.get(attributeName);
    }

    protected void build()
    {
        rootNode.removeAllChildren();
        Set keySet = expressionAttributes.keySet();
