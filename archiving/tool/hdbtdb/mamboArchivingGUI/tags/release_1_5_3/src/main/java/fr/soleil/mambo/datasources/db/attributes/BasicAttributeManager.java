...
public class BasicAttributeManager extends DbConnectionManager implements IAttributeManager
{
    ...
    public Vector loadDomains ( Criterions searchCriterions , boolean _historic, boolean forceReload )
    {
        ...
        try
        {
            ...
            String domains_s[] = database.get_domains_by_criterion( domain_criterions );
            ...
            for ( int domainsIndex = 0 ; domainsIndex < numberOfDomains ; domainsIndex++ )
            {
                ...
                String[] families_s = database.get_families_by_criterion( currentDomainName , family_criterions );
                ...
                for ( int familiesIndex = 0 ; familiesIndex < numberOfFamilies ; familiesIndex++ )
                {
                    ...
                    String[] members_s = database.get_members_by_criterion( currentDomainName , currentFamilyName , member_criterions );
                    ...
                    for ( int membersIndex = 0 ; membersIndex < numberOfMembers ; membersIndex++ )
                    {
                        ...
                        if ( loadCompletely )
                        {
                            String[] attributes_s = database.getAttributes_by_criterion( currentDomainName , currentFamilyName , currentMemberName , attribute_criterions );
    ...
    public Vector loadDomains ( boolean _historic, boolean forceReload )
    {
        ...
        try
        {
            ...
            String completeNames[] = database.get_attributes_complete_names();
    ...
    {
        DataBaseApi database = getDataBaseApi( _historic );
        String[] list = database.getAttributes( domain , family , member );
    ...
    public int getDataType ( String completeName, boolean _historic )
    {
        try
        {
            ...
            int type = database.getAttDataType( completeName );
    ...
    public int getDataWritable (String completeName, boolean _historic)
    {
        try
        {
            ...
            int writable = database.getAttDataWritable( completeName );
    ...
    public String getDisplayFormat (String completeName, boolean _historic)
    {
        try
        {
            ...
            String format = database.getDisplayFormat( completeName );
    ...
    public int getFormat (String name, boolean _historic)
    {
        ...
        {
            DataBaseApi database = getDataBaseApi( _historic );
            return database.getAttDataFormat( name );
        }
        catch (Exception e)
        {
            return -1;
