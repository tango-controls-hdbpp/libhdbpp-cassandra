...
public class ViewConfigurationAttributeProperties
{
    ...
    /**
     * @param extractProperties The extractProperties to set.
     */
    public void setExtractProperties ( ViewConfigurationAttributeExtractProperties extractProperties )
    {
    ...
    /**
     * @param plotProperties The plotProperties to set.
     */
    public void setPlotProperties ( ViewConfigurationAttributePlotProperties _plotProperties )
    {
    ...
    /**
     * @param currentProperties2 23 août 2005
     */
    public static void setCurrentProperties ( ViewConfigurationAttributeProperties _currentProperties )
    {
