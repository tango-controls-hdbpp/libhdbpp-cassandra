...
public class GUIUtilities
{
    ...
    public static void setObjectBackground ( Component comp , int colorCase )
    {
        ...
        switch ( colorCase )
        {
            ...
            case PROFILE_COLOR:
                comp.setBackground( getProfileColor() );
                break;
     ...
     */
    public static void addDebugBorderToPanel ( JComponent panelToDebug , boolean debug , Color borderColor , int thickness )
    {
        if ( debug )
        {
    ...
    public static TitledBorder getPlotSubPanelsLineBorder ( String name )
    {
        ...
        return BorderFactory.createTitledBorder( BorderFactory.createLineBorder(fColor, 1) ,
                                                 name , TitledBorder.LEFT , TitledBorder.DEFAULT_POSITION ,
                                                 labelbFont , fColor );
    }
    ...
    public static TitledBorder getPlotSubPanelsLineBorder ( String name, Color lineColor )
    {
        ...
        return BorderFactory.createTitledBorder( BorderFactory.createLineBorder(lineColor, 1) ,
                                                 name , TitledBorder.LEFT , TitledBorder.DEFAULT_POSITION ,
                                                 labelbFont , fColor );
    }
