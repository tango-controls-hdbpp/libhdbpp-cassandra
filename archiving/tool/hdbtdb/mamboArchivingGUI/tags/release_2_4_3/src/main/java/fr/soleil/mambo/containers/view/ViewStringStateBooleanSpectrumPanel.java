...
public class ViewStringStateBooleanSpectrumPanel extends AbstractViewSpectrumPanel {
    ...
    public ViewStringStateBooleanSpectrumPanel(ViewConfigurationAttribute theSpectrum,
        ...
        data_type = spectrum.getDataType(viewConfigurationBean.getViewConfiguration().getData()
                .isHistoric());
    ...
    protected void initComponents() {
        ...
        if (splitedData[0] != null) {
            ...
            copyRead = new JButton(new ViewCopyAction(Messages.getMessage("VIEW_SPECTRUM_COPY"),
                    this, READ_REFERENCE));
            ...
            editRead = new JButton(new ViewEditCopyAction(Messages
                    .getMessage("VIEW_SPECTRUM_EDIT_COPY"), this, READ_REFERENCE));
        ...
        if (splitedData[1] != null) {
            ...
            copyWrite = new JButton(new ViewCopyAction(Messages.getMessage("VIEW_SPECTRUM_COPY"),
                    this, WRITE_REFERENCE));
            ...
            editWrite = new JButton(new ViewEditCopyAction(Messages
                    .getMessage("VIEW_SPECTRUM_EDIT_COPY"), this, WRITE_REFERENCE));
