//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/models/ACAttributeDetailTdbRTableModel.java,v $
//
// Project:      Tango Archiving Service
//
// Description:  Java source code for the class  ACAttributeDetailTdbRTableModel.
...
public class ACAttributeDetailTdbRTableModel extends DefaultTableModel {
	...
	private Object getACColumnValue(int rowIndex) {
		...
		if (TDBProperties != null) {
			ArchivingConfigurationMode ACRMode = TDBProperties
