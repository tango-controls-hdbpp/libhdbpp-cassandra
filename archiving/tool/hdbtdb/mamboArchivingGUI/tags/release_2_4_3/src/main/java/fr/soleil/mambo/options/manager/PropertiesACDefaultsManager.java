...
public class PropertiesACDefaultsManager implements IACDefaultsManager {
	...
	public void startUp() throws IllegalStateException {
		...
		defaultBundle = ResourceBundle
				.getBundle("fr.soleil.mambo.resources.defaults.ac");
	}
	 ...
	 * 
	 * @see
	 * mambo.options.manager.IACDefaultsManager#saveACDefaults(mambo.options
	 * .sub.ACOptions, java.lang.String)
	 */
	public void saveACDefaults(ACOptions options) throws Exception {
		String _location = saveLocation == null ? this.defaultSaveLocation
				: this.saveLocation;
	 ...
	 * 
	 * @see
	 * mambo.options.manager.IACDefaultsManager#loadACDefaults(java.lang.String)
	 */
