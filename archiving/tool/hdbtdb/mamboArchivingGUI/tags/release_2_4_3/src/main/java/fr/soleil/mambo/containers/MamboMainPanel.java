...
public class MamboMainPanel extends JPanel {
	...
	if (Mambo.hasACs()) {
	    final JSplitPane archivingSplit = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, false);
	...
	final JPanel mainGrid = new JPanel();
	...
	final Dimension dim = GraphicsEnvironment.getLocalGraphicsEnvironment()
