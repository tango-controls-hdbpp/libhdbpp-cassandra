...
public class LoadVCAction extends AbstractAction {
	...
	if (existing == null) {
	    ...
	    final int ok = JOptionPane.showConfirmDialog(MamboFrame.getInstance(), Messages
		    .getMessage("DIALOGS_FILE_ALREADY_OPENED"), Messages
		    .getMessage("DIALOGS_FILE_ALREADY_OPENED_TITLE"), JOptionPane.YES_NO_OPTION,
     ...
     * 
     */
    private void loadVCOnceThePathIsSet(final boolean modified) {
	final IViewConfigurationManager manager = ViewConfigurationManagerFactory.getCurrentImpl();
