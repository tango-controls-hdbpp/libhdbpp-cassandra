...
public class VCEditDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        attributesPlotPropertiesTab = new AttributesPlotPropertiesTab(viewConfigurationBean, this);

        generalTab = new GeneralTab(viewConfigurationBean, this);
        generalScrollPane = new JScrollPane(generalTab);

        attributesTab = new AttributesTab(viewConfigurationBean, this, attributesPlotPropertiesTab
    ...
    private void addComponents() {
        ...
        finishButtonConstraints.insets = new Insets(0, 4 * defaultInsets.left, 0, 0);
    ...
    public void scrollBackTo0() {
        if (generalScrollPane != null) {
            generalScrollPane.getVerticalScrollBar().setValue(
                    generalScrollPane.getVerticalScrollBar().getMinimum());
            generalScrollPane.getHorizontalScrollBar().setValue(
                    generalScrollPane.getHorizontalScrollBar().getMinimum());
        }
        if (attributesScrollPane != null) {
            attributesScrollPane.getVerticalScrollBar().setValue(
                    attributesScrollPane.getVerticalScrollBar().getMinimum());
            attributesScrollPane.getHorizontalScrollBar().setValue(
                    attributesScrollPane.getHorizontalScrollBar().getMinimum());
        }
        if (attributesPlotPropertiesScrollPane != null) {
            attributesPlotPropertiesScrollPane.getVerticalScrollBar().setValue(
                    attributesPlotPropertiesScrollPane.getVerticalScrollBar().getMinimum());
            attributesPlotPropertiesScrollPane.getHorizontalScrollBar().setValue(
                    attributesPlotPropertiesScrollPane.getHorizontalScrollBar().getMinimum());
        }
        if (expressionScrollPane != null) {
            expressionScrollPane.getVerticalScrollBar().setValue(
                    expressionScrollPane.getVerticalScrollBar().getMinimum());
            expressionScrollPane.getHorizontalScrollBar().setValue(
                    expressionScrollPane.getHorizontalScrollBar().getMinimum());
        }
    }
