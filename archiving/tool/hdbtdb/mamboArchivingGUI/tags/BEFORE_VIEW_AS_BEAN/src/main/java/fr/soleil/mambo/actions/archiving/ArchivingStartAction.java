//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/actions/archiving/ArchivingStartAction.java,v $
//
...
public class ArchivingStartAction extends AbstractAction
{
    ...
    public void actionPerformed ( ActionEvent actionEvent )
    {
        ...
        //System.out.println ("ArchivingStartAction--------------------------------------");
        ...
        catch ( ArchivingConfigurationException ace )
        {
            ...
            switch ( cod )
            {
                ...
                /*case ArchivingConfigurationAttributeTDBProperties.KEEPING_PERIOD_TOO_LOW:
                    errorCase = Messages.getLogMessage( "START_ARCHIVING_ACTION_KEEPING_PERIOD_TOO_LOW" );
                    break;*/
                ...
                case ArchivingConfigurationMode.MODE_R_PERCENT_INF_BIGGER_THAN_PERCENT_SUP:
                    errorCase = Messages.getLogMessage( "START_ARCHIVING_ACTION_MODE_R_PERCENT_INF_BIGGER_THAN_PERCENT_SUP" );
                    break;
            }
