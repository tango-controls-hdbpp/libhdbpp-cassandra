//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/components/view/CustomJLChart.java,v $
//
...
// expressions are no more accessible through chart menu (only accessible through VC edit dialog)
//
