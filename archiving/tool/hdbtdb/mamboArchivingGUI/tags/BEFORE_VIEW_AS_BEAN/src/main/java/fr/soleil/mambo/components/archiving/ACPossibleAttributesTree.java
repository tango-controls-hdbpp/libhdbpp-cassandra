//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/components/archiving/ACPossibleAttributesTree.java,v $
//
...
public class ACPossibleAttributesTree extends AttributesTree
{
     ...
     * @param newModel
     */
    private ACPossibleAttributesTree ( TreeModel newModel )
    {
        super( newModel );
     ...
     * @return 8 juil. 2005
     */
    public static ACPossibleAttributesTree getInstance ( TreeModel newModel )
    {
        if ( possibleAttributesTreeInstance == null )
        {
            possibleAttributesTreeInstance = new ACPossibleAttributesTree( newModel );
        }
