...
public class ArchivingAttributesDetailPanel extends JPanel
{
    ...
    private JLabel isArchivedLabel;
    private JLabel modeLabel;

    private JLabel isArchivedHDBLabel;
    private JLabel isArchivedTDBLabel;
    private JLabel modeHDBLabel;
    private JLabel modeTDBLabel;
    ...
    private void initComponents ()
    {
        ...
        if ( this.historic )
        {
            //System.out.println ( "CLA/ArchivingAttributesDetailPanel/initComponents/HDB" );
            tabbedPane.add( "HDB" , ACAttributeDetailHdbPanel.getInstance() );    
        }
        else
        {
            //System.out.println ( "CLA/ArchivingAttributesDetailPanel/initComponents/TDB" );
