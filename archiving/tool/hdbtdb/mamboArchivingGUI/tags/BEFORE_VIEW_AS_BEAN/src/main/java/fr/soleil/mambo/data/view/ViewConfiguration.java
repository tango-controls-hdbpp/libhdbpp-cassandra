...
//  MULTI-CONF
    ...
    public ViewConfiguration ()
    {
        ...
        this.expressions = new TreeMap<String, ExpressionAttribute>(Collator.getInstance());
    }
    ...
    public void push ()
    {
        ...
        ViewConfiguration.setSelectedViewConfigurationAndPush( this );
     ...
     */
    public static void setSelectedViewConfigurationAndPush ( ViewConfiguration selectedViewConfiguration )
    {
    ...
    public TreeMap<String, ExpressionAttribute> getExpressionsDuplicata() {
		...
		while (keyIterator.hasNext()) {
			...
			duplicata.put(new String(key), (expressions.get(key))
					.duplicate());
		}
		return duplicata;
	}
    ...
    /**
     * Adds a new expression to the ViewConfiguration.
     * Useful when loading a VC from XML.
     *
