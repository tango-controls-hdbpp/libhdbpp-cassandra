//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/components/archiving/OpenedACComboBox.java,v $
//
...
public class OpenedACComboBox extends OpenedConfComboBox 
{
//  MULTI-CONF
    ...
    public void removeElement(ArchivingConfiguration selectedAC) 
    {
        ...
        {
            ArchivingConfiguration nextSelectedAC = (ArchivingConfiguration) this.stack.firstElement ();
