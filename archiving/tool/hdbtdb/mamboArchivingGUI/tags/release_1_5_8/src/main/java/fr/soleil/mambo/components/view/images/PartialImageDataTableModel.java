...
/**
 * The table model used by PartialImageDataTable, this model lists partially loaded images in a given date range.
 * Its rows are the partially loaded images.
 *
 * @author CLAISSE
 */
public class PartialImageDataTableModel extends DefaultTableModel
{
    ...
    /*public PartialImageDataTableModel ( ImageData [] _rows )
    {
        this.rows = _rows;
    }*/
