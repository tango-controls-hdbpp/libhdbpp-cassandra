...
public class ArchivingConfigurationAttributeTDBProperties extends ArchivingConfigurationAttributeDBProperties
{
    ...
    //public static final String TDB_SPEC_KEEPING_PERIOD_XML_TAG = "keepingPeriod";
    ...
    {
        String ret = "";
        //System.out.println ( "ArchivingConfigurationAttributeTDBProperties/toString/exportPeriod/"+exportPeriod+"/" );
        ...
        //openingLine.setAttribute( TDB_SPEC_KEEPING_PERIOD_XML_TAG , String.valueOf( keepingPeriod ) );
        ...
        //System.out.println ( "ArchivingConfigurationAttributeTDBProperties/toString/openingLine/"+openingLine+"/" );
     ...
     */
    /*public ArchivingConfigurationMode getTDBMode() {
        return TDBMode;
    }*/
    /**
     * @param mode The tDBMode to set.
     */
    /*public void setTDBMode(ArchivingConfigurationMode mode) {
        TDBMode = mode;
    }*/
    /**
    ...
    /**
     * @param exportPeriod The exportPeriod to set.
     */
    ...
    public void setDefaultPeriod ( int period )
    {
        ...
        //System.out.println ( "TDBProperties/setDefaultPeriod/period/"+period+"/" );
        //
    ...
    public void controlValues () throws ArchivingConfigurationException
    {
        ...
        {
            //System.out.println ( "ArchivingConfigurationAttributeTDBProperties/controlValues/exportPeriod/"+exportPeriod+"/EXPORT_PERIOD_MIN/"+EXPORT_PERIOD_MIN+"/" );
            throw new ArchivingConfigurationException( null , EXPORT_PERIOD_TOO_LOW );
        }

        /*if ( keepingPeriod < KEEPING_PERIOD_MIN )
        {
            throw new ArchivingConfigurationException( null , KEEPING_PERIOD_TOO_LOW );
        }*/
