                ...
                if (splitedData[0] != null) {
                    ...
                    for (int i = 0; i < splitedData[0].getMax_x(); i++) {
                        ...
                        switch (dataType) {
                            case TangoConst.Tango_DEV_SHORT:
                            case TangoConst.Tango_DEV_USHORT:
                                for (int j = 0; j < splitedData[0]
                                        .getData_timed().length; j++) {
                                    long time = (long) splitedData[0]
                                            .getData_timed()[j].time
                                            .longValue();
                                    double y = Double.NaN;
                                    if (splitedData[0].getData_timed()[j].value != null
                                            && i < splitedData[0]
                                                    .getData_timed()[j].value.length
                                            && splitedData[0].getData_timed()[j].value[i] != null) {
                                        y = ((Short) splitedData[0]
                                                .getData_timed()[j].value[i])
                                                .doubleValue();
                                    }
                ...
                if (splitedData[1] != null) {
                    ...
                    for (int i = 0; i < splitedData[1].getMax_x(); i++) {
                        ...
                        switch (dataType) {
                            case TangoConst.Tango_DEV_SHORT:
                            case TangoConst.Tango_DEV_USHORT:
                                for (int j = 0; j < splitedData[1]
                                        .getData_timed().length; j++) {
                                    long time = (long) splitedData[1]
                                            .getData_timed()[j].time
                                            .longValue();
                                    double y = Double.NaN;
