...
public class AttributesPlotPropertiesTab extends JPanel {
    ...
    private final static ImageIcon        expandFirstIcon    = new ImageIcon(
                                                                     Mambo.class
                                                                             .getResource("icons/expand.gif"));
    private final static ImageIcon        warningIcon        = new ImageIcon(
                                                                     Mambo.class
    ...
    private JButton                       expandAllButton,
            expandSelectedButton, expandFirstButton;
