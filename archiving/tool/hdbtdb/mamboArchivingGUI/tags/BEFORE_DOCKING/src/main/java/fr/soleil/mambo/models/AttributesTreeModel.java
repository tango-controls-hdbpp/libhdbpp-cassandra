...
public abstract class AttributesTreeModel<A extends Attribute> extends
        DefaultTreeModel {
                ...
                for (int famIndex = 0; famIndex < familiesToSort.size(); famIndex++) {
                    ...
                    for (int membIndex = 0; membIndex < membersToSort.size(); membIndex++) {
                        ...
                        Collection<Attribute> coll = member.getAttributes()
                                .values();
                        Vector<A> attributesToSort = new Vector<A>();
                        Iterator<Attribute> it = coll.iterator();
                        while (it.hasNext()) {
                            attributesToSort
                                    .add(getValidAttributeFor(it.next()));
                        }
                        ...
                        for (int attrIndex = 0; attrIndex < attributesToSort
                            ...
                            A attribute = attributesToSort.get(attrIndex);
                            // --
     ...
     *            29 juin 2005
     */
    public void addAttribute(TreeNode[] path, A attribute) {
