...
public class DateRangeBox extends JPanel {
    ...
    private ArrayList<SoftReference<IDateRangeBoxListener>> listeners;
    ...
    public DateRangeBox() {
        ...
        listeners = new ArrayList<SoftReference<IDateRangeBoxListener>>();
        ...
        if (listener != null) {
            synchronized (listeners) {
                ...
                for (int i = 0; i < listeners.size(); i++) {
                    SoftReference<IDateRangeBoxListener> soft = listeners
                            .get(i);
                ...
                if (canAdd) {
                    listeners.add(new SoftReference<IDateRangeBoxListener>(
                            listener));
                }
            }
        }
    ...
    public void removeDateRangeBoxListener(IDateRangeBoxListener listener) {
        if (listener != null) {
            synchronized (listeners) {
                ArrayList<SoftReference<IDateRangeBoxListener>> toRemove = new ArrayList<SoftReference<IDateRangeBoxListener>>();
                for (int i = 0; i < listeners.size(); i++) {
                    SoftReference<IDateRangeBoxListener> soft = listeners
                            .get(i);
                    IDateRangeBoxListener temp = soft.get();
    ...
    private void fireDateRangeBoxEvent() {
        synchronized (listeners) {
            ...
            for (int i = 0; i < listeners.size(); i++) {
                SoftReference<IDateRangeBoxListener> soft = listeners.get(i);
                IDateRangeBoxListener temp = soft.get();
                if (temp != null) {
