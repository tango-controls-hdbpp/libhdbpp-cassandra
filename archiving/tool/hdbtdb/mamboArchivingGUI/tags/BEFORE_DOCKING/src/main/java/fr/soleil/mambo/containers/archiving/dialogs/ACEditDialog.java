...
public class ACEditDialog extends JDialog {
    ...
    private static int                  defaultTangoManagerType = AttributeTableSelectionBean.DUMMY;
    private int                         tangoManagerType;
    ...
    private ACEditDialog(boolean _isAlternateSelectionMode, boolean _isHistoric) {
        ...
        tangoManagerType = AttributeTableSelectionBean.DUMMY;
        ...
        setTangoManagerType(defaultTangoManagerType);
    ...
    public int getTangoManagerType() {
        return tangoManagerType;
    }

    public static void setDefaultTangoManagerType(int defaultTangoManagerType) {
        ACEditDialog.defaultTangoManagerType = defaultTangoManagerType;
    }

    public void setTangoManagerType(int tangoManagerType) {
        if (this.tangoManagerType != tangoManagerType) {
            this.tangoManagerType = tangoManagerType;
            if (attributeTableSelectionBean != null) {
                if (attributeTableSelectionBean.getTangoManagerType() != tangoManagerType) {
                    attributeTableSelectionBean.stop();
                    attributeTableSelectionBean
                            .setTangoManager(tangoManagerType);
                    attributeTableSelectionBean.start();
                }
            }
        }
    }

    private void updateTangoManagerType() {
        if (attributeTableSelectionBean == null) {
            attributeTableSelectionBean = new AttributeTableSelectionBean(
                    tangoManagerType, null, null, null);
            attributeTableSelectionBean.start();
        }
        else {
            if (attributeTableSelectionBean.getTangoManagerType() != tangoManagerType) {
                attributeTableSelectionBean.stop();
                attributeTableSelectionBean.setTangoManager(tangoManagerType);
                attributeTableSelectionBean.start();
            }
        }
    }
