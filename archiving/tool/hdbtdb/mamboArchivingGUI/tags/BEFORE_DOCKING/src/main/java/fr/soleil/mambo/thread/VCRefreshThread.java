    ...
    public void run() {
        ...
        if ((!canceled) && (viewConfigurationBean != null)) {
            viewConfigurationBean.getEditDialog()
                    ...
                    .getVcAttributesPropertiesTree().saveExpandedPath();
        }
        ...
        if ((!canceled) && (viewConfigurationBean != null)) {
            viewConfigurationBean.getEditDialog()
                    .getAttributesPlotPropertiesTab()
                    .getVcAttributesPropertiesTree().openExpandedPath();
        }
        ...
        if ((!canceled) && (selectedVC != null)
            ...
            try {
                ...
                if (!canceled) {
                    ...
                    // viewConfigurationBean.getAttributesPanel()
                    // .getViewAttributesGraphPanel().revalidate();
                    // viewConfigurationBean.getAttributesPanel()
                    // .getViewAttributesGraphPanel().repaint();
                    if (!canceled) {
