...
public class ViewSpectrumChartDialog extends JDialog {
    ...
    public void updateContent() {
        ...
        if (specPanel.getViewSpectrumType() == ViewConfigurationAttributePlotProperties.SPECTRUM_VIEW_TYPE_INDEX) {
            chartRecorderComponent.setAnnotation(IChartViewer.TIME_ANNO,
                    IChartViewer.X);
        } else {
            chartRecorderComponent.setAxisScaleEditionEnabled(false,
                    IChartViewer.X);
            chartRecorderComponent.setAnnotation(IChartViewer.VALUE_ANNO,
                    IChartViewer.X);
        }
