...
public class XMLViewConfigurationManagerImpl implements IViewConfigurationManager {
     ...
     * 
     * @see
     * mambo.datasources.file.IViewConfigurationManager#saveViewConfiguration
     * (mambo.data.view.ViewConfiguration, java.lang.String,
     * java.util.Hashtable)
     */
    public void saveViewConfiguration(final ViewConfiguration vc, final Hashtable saveParameters)
	    throws Exception {
	final String _location = getSaveLocation();
	// System.out.println (
	// "XMLViewConfigurationManagerImpl/saveViewConfiguration/_location/"+_location+"/"
	// );
     ...
     * 
     * @see
     * mambo.datasources.file.IViewConfigurationManager#loadViewConfigurations
     * (fr.soleil.snapArchivingApi.SnapshotingTools.Tools.Criterions)
     */
    public ViewConfiguration[] loadViewConfigurations(final Criterions searchCriterions)
	    throws Exception {
     ...
     * 
     * @see
     * mambo.datasources.file.IViewConfigurationManager#findViewConfigurations
     * (mambo.data.view.ViewConfiguration[],
     * fr.soleil.snapArchivingApi.SnapshotingTools.Tools.Criterions)
     */
    public ViewConfiguration[] findViewConfigurations(final ViewConfiguration[] in,
     ...
     * 
     * @see
     * mambo.datasources.file.IViewConfigurationManager#startUp(java.lang.Object
     * )
     */
     ...
     * 
     * @see
     * mambo.datasources.file.IViewConfigurationManager#loadViewConfiguration
     * (java.lang.String)
     */
    public ViewConfiguration loadViewConfiguration() throws Exception {
	final String _location = getSaveLocation();
	final ViewConfiguration vc = ViewConfigurationXMLHelper
		.loadViewConfigurationIntoHash(_location);
