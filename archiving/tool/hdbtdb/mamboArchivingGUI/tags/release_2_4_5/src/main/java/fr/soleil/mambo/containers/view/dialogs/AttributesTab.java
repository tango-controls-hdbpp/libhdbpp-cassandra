...
public class AttributesTab extends JPanel {
	...
	private void initPossibleAttributesTreeBox() {
		...
		possibleAttributesRegexpField.setToolTipText(Messages.getMessage("ACTIONS_MATCH_TOOLTIP"));
		possibleAttributesSearchButton.setToolTipText(Messages.getMessage("ACTIONS_MATCH_TOOLTIP"));
	...
	private void initSelectedAttributesTreeBox() {
		...
		selectedAttributesRegexpField.setToolTipText(Messages.getMessage("ACTIONS_MATCH_TOOLTIP"));
		selectedAttributesSearchButton.setToolTipText(Messages.getMessage("ACTIONS_MATCH_TOOLTIP"));
