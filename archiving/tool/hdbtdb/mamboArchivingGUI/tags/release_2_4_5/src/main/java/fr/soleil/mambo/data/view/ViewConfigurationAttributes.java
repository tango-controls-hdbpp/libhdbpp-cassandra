...
public class ViewConfigurationAttributes {
    ...
    public void setChartAttributeExpressionOfString(HashMap<String, DbData[]> dataMap,
            boolean historic, ChartViewer chart, String currentViewId) {
        if (dataMap != null) {
            try {
                IExtractingManager extractingManager = ExtractingManagerFactory.getCurrentImpl();
                if (extractingManager.isCanceled())
                ...
                for (ExpressionAttribute attributeExpression : notNumberExpression) {
                    if (extractingManager.isCanceled())
                        return;
                    ...
                    if (variablesNames != null) {
                            ...
                            if (attr != null) {
                                ...
                                switch (attr.getDataType(historic)) {
                                    ...
                                    case TangoConst.Tango_DEV_STATE:
                                        DbData[] SplitedData = dataMap.get(attributName);
                                        if (SplitedData != null) {
                                            DbData data = null;
                                            if (isRead) {
                                                data = SplitedData[0];
                        ...
                        if (chart != null) {
                            ...
                            DataArray expressionDataArray = constructCurveForStringExpression(
                                    attributeExpression, variablesDatas, timePrecision);
                            ...
                            if (expressionDataArray != null) {
                                ...
                                if (currentViewId != null) {
                                    ViewScalarDAO dao = daoFactory.getDAOScalar(currentViewId);
                                    if (dao != null) {
    ...
    public void setIdViewSelected(String idViewSelected) {
