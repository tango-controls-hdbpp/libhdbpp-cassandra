...
public class ArchivingGeneralPanel extends JPanel {
	...
	private final static ImageIcon newIcon = new ImageIcon(Mambo.class
	...
	private void initComponents() {
		...
		newAction = new OpenACEditDialogAction(msg, true,
				isAlternateSelectionMode);
		newButton = new MamboActivableButton(newAction, newIcon, newIcon);
		GUIUtilities.setObjectBackground(newButton,
				GUIUtilities.ARCHIVING_COLOR);
