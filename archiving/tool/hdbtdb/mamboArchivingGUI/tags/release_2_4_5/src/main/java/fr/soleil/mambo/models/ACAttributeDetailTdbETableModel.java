//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/models/ACAttributeDetailTdbETableModel.java,v $
//
// Project:      Tango Archiving Service
//
// Description:  Java source code for the class  ACAttributeDetailTdbETableModel.
...
public class ACAttributeDetailTdbETableModel extends DefaultTableModel {
	private static ACAttributeDetailTdbETableModel instance;
	private ArchivingConfigurationAttribute attribute;
	private ArchivingConfigurationAttributeTDBProperties TDBProperties;

	public static ACAttributeDetailTdbETableModel getInstance() {
		if (instance == null) {
			instance = new ACAttributeDetailTdbETableModel();
		}

		return instance;
	}

	private ACAttributeDetailTdbETableModel() {
		super();
	}
	...
	private Object getACColumnValue(int rowIndex) {
		...
		if (TDBProperties != null) {
			ArchivingConfigurationMode ACEMode = TDBProperties
	...
	public boolean toPaint() {
		if (TDBProperties != null) {
			if (TDBProperties.getMode(ArchivingConfigurationMode.TYPE_E) != null) {
				return true;
