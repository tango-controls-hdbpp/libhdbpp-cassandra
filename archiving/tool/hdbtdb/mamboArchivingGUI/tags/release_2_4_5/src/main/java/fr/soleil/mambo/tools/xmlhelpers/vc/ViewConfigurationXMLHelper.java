...
public class ViewConfigurationXMLHelper {
        ...
        if (rootNode.hasChildNodes()) {
            ...
            // as many loops as there are attributes in the VC
            {
                ...
                if (currentChildType.equals(ViewConfigurationAttribute.XML_TAG)) {
                    ...
                    ViewConfigurationData viewConfData = loadGenericPlotParameters(viewConf
                            .getData(), currentChild);
        ...
        if (genericPlotParametersNode.hasChildNodes()) {
            ...
            for (int i = 0; i < genericPlotParametersSubNodes.getLength(); i++) {
                ...
                if (currentSubNodeType.equals(ChartPropertiesUtils.XML_TAG)) {
                    ...
                    xAxis.setAnnotation(IChartViewer.TIME_ANNO);
     ...
     * @return 24 ao�t 2005
     */
    private static AxisProperties loadAxis(Hashtable<String, String> attributeProperties,
            int gridStyle) {
        ...
        String scaleMode_s = attributeProperties
                .get(AxisPropertiesUtils.SCALE_MODE_PROPERTY_XML_TAG);
        String labelFormat_s = attributeProperties
                .get(AxisPropertiesUtils.LABEL_FORMAT_PROPERTY_XML_TAG);
        String showSubGrid_s = attributeProperties
                .get(AxisPropertiesUtils.SHOW_SUB_GRID_PROPERTY_XML_TAG);
        String drawOpposite_s = attributeProperties
                .get(AxisPropertiesUtils.DRAW_OPPOSITE_PROPERTY_XML_TAG);
        String isVisible_s = attributeProperties
                .get(AxisPropertiesUtils.IS_VISIBLE_PROPERTY_XML_TAG);
        String autoScale_s = attributeProperties
                .get(AxisPropertiesUtils.AUTO_SCALE_PROPERTY_XML_TAG);
        ...
        String labelInterval_s = attributeProperties
                .get(AxisPropertiesUtils.LABEL_INTERVAL_XML_TAG);
        String annotation_s = attributeProperties.get(AxisPropertiesUtils.ANNOTATION_XML_TAG);
        ...
        ret.setColor(AwtColorTool.getCometeColor(color));
     ...
     * @return 24 ao�t 2005
     */
    private static ChartProperties loadChartProperties(Hashtable<String, String> attributeProperties) {
        ChartProperties ret = new ChartProperties();

        String axisGrid_s = attributeProperties
                .get(ChartPropertiesUtils.AXIS_GRID_PROPERTY_XML_TAG);
        String axisGridStyle_s = attributeProperties
                .get(ChartPropertiesUtils.AXIS_GRID_STYLE_PROPERTY_XML_TAG);
        String backgroundColor_s = attributeProperties
                .get(ChartPropertiesUtils.BACKGROUND_COLOR_PROPERTY_XML_TAG);
        String displayDuration_s = attributeProperties
                .get(ChartPropertiesUtils.DISPLAY_DURATION_PROPERTY_XML_TAG);
        String headerFont_s = attributeProperties
                .get(ChartPropertiesUtils.HEADER_FONT_PROPERTY_XML_TAG);
        String labelFont_s = attributeProperties
                .get(ChartPropertiesUtils.LABEL_FONT_PROPERTY_XML_TAG);
        String legendsAreVisible_s = attributeProperties
                .get(ChartPropertiesUtils.LEGENDS_ARE_VISIBLE_PROPERTY_XML_TAG);
        String legendsPlacement_s = attributeProperties
                .get(ChartPropertiesUtils.LEGENDS_PLACEMENT_PROPERTY_XML_TAG);
        ...
        String timePrecision_s = attributeProperties
                .get(ChartPropertiesUtils.TIME_PRECISION_XML_TAG);
        String dataSendingEnabled_s = attributeProperties
                .get(ChartPropertiesUtils.DATA_SENDING_ENABLED_XML_TAG);
        String autoHighLightOnLegend_s = attributeProperties
                .get(ChartPropertiesUtils.AUTO_HIGHLIGHT_ON_LEGEND_XML_TAG);
        ...
        CometeColor backgroundColor = AwtColorTool.getCometeColor(GUIUtilities
        ...
        CometeFont headerFont = AwtFontTool.getCometeFont(GUIUtilities.StringToFont(headerFont_s));
        CometeFont labelFont = AwtFontTool.getCometeFont(GUIUtilities.StringToFont(labelFont_s));
    ...
    private static Bar loadBar(Node currentSubNode) throws Exception {
        ...
        Bar bar = new Bar(AwtColorTool.getCometeColor(fillColor), width, fillStyle, fillingMethod);
    ...
    private static Curve loadCurve(Node currentSubNode) throws Exception {
        ...
        curve.setColor(AwtColorTool.getCometeColor(fillColor));
    ...
    private static Marker loadMarker(Node currentSubNode) throws Exception {
        ...
        marker.setColor(AwtColorTool.getCometeColor(color));
