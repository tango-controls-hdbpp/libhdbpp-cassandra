...
public class Marker
{
    ...
    public String toString ()
    {
        ...
        openingLine.setAttribute( COLOR_PROPERTY_XML_TAG , GUIUtilities.colorToString( color ) );
        ...
        openingLine.setAttribute( IS_LEGEND_VISIBLE_PROPERTY_XML_TAG , String.valueOf( isLegendVisible ) );
    ...
    public void push ()
    {
        ...
        plotPropertiesPanel.setMarkerColor( this.getColor() );
        plotPropertiesPanel.setMarkerSize( this.getSize() );
        plotPropertiesPanel.setMarkerStyle( this.getStyle() );
    }
