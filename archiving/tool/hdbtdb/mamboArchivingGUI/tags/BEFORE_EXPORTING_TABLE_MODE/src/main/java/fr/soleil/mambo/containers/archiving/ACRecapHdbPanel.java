//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/containers/archiving/ACRecapHdbPanel.java,v $
//
// Project:      Tango Archiving Service
//
// Description:  Java source code for the class  ACRecapHdbPanel.
...
// $Revision: 1.3 $
//
// $Log: ACRecapHdbPanel.java,v $
// Revision 1.3  2006/04/10 09:14:22  ounsy
// optimisation on loading an archiving assessment
//
// Revision 1.2  2005/12/15 11:21:40  ounsy
...
public class ACRecapHdbPanel extends JPanel
{

    private int nbTables;

    public ACRecapHdbPanel ()
    {
        super();
        nbTables = 0;
    ...
    private void initComponents ()
    {
        ...
        for ( int i = 0 ; i < attrs.length ; i++ )
        {
            ...
            //ACRecapTableModel modelG = ( ACRecapTableModel ) tableG.getModel();
            ACRecapTableModel modelG = new ACRecapTableModel ();
            
            modelG.load( attrs[ i ] , true , ACRecapTableModel.titleOrGeneral );
            ...
            //ACRecapTableModel modelP = ( ACRecapTableModel ) tableP.getModel();
            ACRecapTableModel modelP = new ACRecapTableModel ();
            
            
            modelP.load( attrs[ i ] , true , ACRecapTableModel.modeP );
            ...
            //ACRecapTableModel modelA = ( ACRecapTableModel ) tableA.getModel();
            ACRecapTableModel modelA = new ACRecapTableModel ();
            
            
            modelA.load( attrs[ i ] , true , ACRecapTableModel.modeA );
            ...
            //ACRecapTableModel modelR = ( ACRecapTableModel ) tableR.getModel();
            ACRecapTableModel modelR = new ACRecapTableModel ();
            
            
            modelR.load( attrs[ i ] , true , ACRecapTableModel.modeR );
            ...
            //ACRecapTableModel modelT = ( ACRecapTableModel ) tableT.getModel();
            ACRecapTableModel modelT = new ACRecapTableModel ();
            
            
            modelT.load( attrs[ i ] , true , ACRecapTableModel.modeT );
            ...
            //ACRecapTableModel modelD = ( ACRecapTableModel ) tableD.getModel();
            ACRecapTableModel modelD = new ACRecapTableModel ();
            
            
            modelD.load( attrs[ i ] , true , ACRecapTableModel.modeD );
            ...
            //ACRecapTableModel modelC = ( ACRecapTableModel ) tableC.getModel();
            ACRecapTableModel modelC = new ACRecapTableModel ();
            
            
            modelC.load( attrs[ i ] , true , ACRecapTableModel.modeC );
            ...
            //ACRecapTableModel modelE = ( ACRecapTableModel ) tableE.getModel();
            ACRecapTableModel modelE = new ACRecapTableModel ();
            
            modelE.load( attrs[ i ] , true , ACRecapTableModel.modeE );
