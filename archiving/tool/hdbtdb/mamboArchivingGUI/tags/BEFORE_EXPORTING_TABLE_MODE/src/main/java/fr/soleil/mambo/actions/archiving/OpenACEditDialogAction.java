//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/actions/archiving/OpenACEditDialogAction.java,v $
//
...
import fr.soleil.mambo.containers.archiving.dialogs.AttributesPropertiesTab;
...
public class OpenACEditDialogAction extends AbstractAction
{
     ...
     * @param name
     */
    public OpenACEditDialogAction ( String name , boolean _isNew , boolean _isAlternateSelectionMode /*, boolean _isHistoric*/ )
    {
    ...
    {
        System.gc();
        ArchivingConfiguration selectedArchivingConfiguration = ArchivingConfiguration.getSelectedArchivingConfiguration();
        boolean needsNewAc = this.isNew || selectedArchivingConfiguration == null;
        ...
        try
        {
            if ( needsNewAc )
            {
                needsStackCleaning = ( OpenedACComboBox.getInstance().getStackSize() == OpenedACComboBox.getInstance().getMaxSize() );
                ...
                //System.out.println ( "CLA/1/isHistoric/"+isHistoric );
                ...
                AttributesPropertiesPanel panel = AttributesPropertiesPanel.getInstance ( this.isHistoric );
        ...
        ACEditDialog dialog = ACEditDialog.getInstance( this.isAlternateSelectionMode , this.isHistoric );
