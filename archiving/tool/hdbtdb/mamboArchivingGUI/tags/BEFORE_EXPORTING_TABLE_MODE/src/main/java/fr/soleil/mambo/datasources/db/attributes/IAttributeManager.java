//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/datasources/db/attributes/IAttributeManager.java,v $
//
...
public interface IAttributeManager
{
    ...
    public Vector loadDomains ( Criterions searchCriterions , boolean historic, boolean forceReload ) throws DevFailed , ArchivingException;

    public ArrayList getAttributes ( String domain , String family , String member , boolean historic ) throws DevFailed , ArchivingException;

    public DataBaseManager getDataBaseApi ( boolean historic ) throws DevFailed , ArchivingException;
    ...
    //public Hashtable getAttributesToDedicatedArchiver ( boolean historic , boolean refreshArchivers ) throws ArchivingException;

    public Vector loadDomains(boolean isHistoric, boolean forceReload);
}