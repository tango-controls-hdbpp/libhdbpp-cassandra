...
//        TDBdifferencePrecisionField = new JTextField("0");
    ...
    private void initCenterSubPanel ( final boolean isHistoric )
    {
        ...
        if ( isHistoric )
        {
            ...
            SpringUtilities.makeCompactGrid(panelM, 
            		1, 1, //rows, cols
            		3, 3,//initX, initY
            		3, 5,//xPad, yPad
            		true); 
            ...
            SpringUtilities.makeCompactGrid(panelP, 
            		1, 2, //rows, cols
            		3, 3,//initX, initY
            		3, 5,//xPad, yPad
            		true); 
            ...
            SpringUtilities.makeCompactGrid(panelA, 
            		3, 5, //rows, cols
            		3, 3,//initX, initY
            		3, 5,//xPad, yPad
            		true); 
            ...
            SpringUtilities.makeCompactGrid(panelR, 
            		3, 5, //rows, cols
            		3, 3,//initX, initY
            		3, 5,//xPad, yPad
            		true); 
            
            setRelativeModeParameters(HDBThresholdCheck.isSelected(), isHistoric);
            HDBRelativeCheck.addChangeListener(new ChangeListener(){

    			public void stateChanged(ChangeEvent e) {
    				setRelativeModeParameters(HDBRelativeCheck.isSelected(), isHistoric);
    				// TODO Auto-generated method stub
    			}
            ...
            SpringUtilities.makeCompactGrid(panelT, 
            		3, 5, //rows, cols
            		3, 3,//initX, initY
            		3, 5,//xPad, yPad
            		true); 

            setThresholdModeParameters(HDBThresholdCheck.isSelected(), isHistoric);
            ...
            SpringUtilities.makeCompactGrid(panelD, 
            		2, 5, //rows, cols
            		3, 3,//initX, initY
            		3, 5,//xPad, yPad
            		true); 
            setDifferenceModeParameters(HDBDifferenceCheck.isSelected(), isHistoric);
        ...
        else
        {
            ...
            setRelativeModeParameters(TDBThresholdCheck.isSelected(), isHistoric);
            TDBRelativeCheck.addChangeListener(new ChangeListener(){

    			public void stateChanged(ChangeEvent e) {
    				setRelativeModeParameters(TDBRelativeCheck.isSelected(), isHistoric);
    				// TODO Auto-generated method stub
    			}
            ...
            setThresholdModeParameters(TDBThresholdCheck.isSelected(), isHistoric);
...
//            panelD.add( Box.createHorizontalGlue() );
            SpringUtilities.makeCompactGrid(panelD, 
            		...
            		3, 5,//xPad, yPad
            		true); 
            setDifferenceModeParameters(TDBDifferenceCheck.isSelected(), isHistoric);
           ...
           //-------------------------
            ...
            //Lay out the panels.
            SpringUtilities.makeCompactGrid( TDBPeriodPanel ,
                    1 , TDBPeriodPanel.getComponentCount() , //rows, cols
                    0 , 0 , //initX, initY
                    0 , 5 , //xPad, yPad
                    true
            );
            SpringUtilities.makeCompactGrid( TDBPanel ,
