...
public class DTPrinter
{
    ...
    public static void printText ( String title , String content )
    {
        ...
        /*Enumeration enum = contentParts.elements ();
        System.out.println ( "----------------------" );
        while ( enum.hasMoreElements () )
{
            String nextPart = (String) enum.nextElement ();
            System.out.println ( "*********" );
            System.out.println ( nextPart );
            System.out.println ( "*********" );
JTextPane component = new JTextPane ( new HTMLDocument() );
            component.setContentType ("text/xml");
            component.setText (nextPart);
     ...
     * @param title
     * @param b
     * @param printerResolution 31 août 2005
     */
...
//          Get image dimension
            ...
            Enumeration enumeration = contentParts.elements();
            //System.out.println ( "----------------------" );
            while ( enumeration.hasMoreElements() )
            {
                String nextPart = ( String ) enumeration.nextElement();
                //System.out.println ( "*********" );
                //System.out.println ( nextPart );
                //System.out.println ( "*********" );
...
//              Make a screenshot of the graph
     ...
     * @param printerResolution Printer resolution when fitToPage is not enabled.
     */
    /*private static void printComponent ( JComponent comp , String title , boolean fitToPage , int printerResolution )
    {
        PageAttributes pa = new PageAttributes();
        JobAttributes ja = new JobAttributes();
        pa.setPrintQuality( PageAttributes.PrintQualityType.HIGH );
        ...
        if ( printJob != null )
        {
            ...
            catch ( Exception e )
            {
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog( parent , "Exception occured while printing" + GUIUtilities.CRLF + e.getMessage() ,
