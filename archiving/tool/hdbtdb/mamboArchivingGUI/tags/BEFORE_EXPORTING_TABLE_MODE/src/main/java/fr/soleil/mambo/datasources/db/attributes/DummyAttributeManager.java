//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/datasources/db/attributes/DummyAttributeManager.java,v $
//
...
public class DummyAttributeManager implements IAttributeManager
{
    ...
    /* (non-Javadoc)
     * @see mambo.datasources.db.IAttrDBManager#isScalar(java.lang.String, boolean)
     */
    ...
    /* (non-Javadoc)
     * @see mambo.datasources.db.IAttrDBManager#isImage(java.lang.String, boolean)
     */
    ...
    public Vector loadDomains(boolean b, boolean c) {
        // TODO Auto-generated method stub
        return null;
    }
