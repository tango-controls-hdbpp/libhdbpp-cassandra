//+======================================================================
//$Source: /cvsroot/tango-cs/tango/tools/mambo/components/editors/AttributesSelectTableEditor.java,v $
//
...
//
//-======================================================================
package fr.soleil.mambo.components.editors;
...
/**
 * Cell editor used by SnapshotDetailTable.
 * The used component for scalar attributes is a TextField. *
 */
