...
public class ImagesListSelectionListener implements ListSelectionListener 
{
    ...
    public ImagesListSelectionListener ( PartialImageDataTableModel _model, String _displayFormat ) 
    {
        super();
        this.model = _model;
    ...
    public void valueChanged(ListSelectionEvent event) 
    {
        ...
        else 
        {
            ...
            //System.out.println ( "CLA/dqsdqsdsqdqsdq/selectedRow/"+selectedRow );
            ImageData imageData = this.model.getRow ( selectedRow );
            ViewImageTableAction viewImageAction = new ViewImageTableAction ( viewReadMsg , imageData, displayFormat );
