...
public class ViewConfigurationAttributes
{
    ...
    {
        TreeMap<String, ViewConfigurationAttribute> spectrums = new TreeMap<String, ViewConfigurationAttribute>(Collator.getInstance(Locale.FRENCH));
        if ( attributes != null )
        {
            Set keySet = attributes.keySet();
            Iterator keyIterator = keySet.iterator();
     ...
     */
    public TreeMap<String, ViewConfigurationAttribute> getStringStateScalarAttributes (boolean historic)
    {
        TreeMap<String, ViewConfigurationAttribute> strings = new TreeMap<String, ViewConfigurationAttribute>(Collator.getInstance(Locale.FRENCH));
        if ( attributes != null )
        {
            Set keySet = attributes.keySet();
            Iterator keyIterator = keySet.iterator();
    ...
    {
        TreeMap<String, ViewConfigurationAttribute> images = new TreeMap<String, ViewConfigurationAttribute>(Collator.getInstance(Locale.FRENCH));
        if ( attributes != null )
        {
            Set keySet = attributes.keySet();
            Iterator keyIterator = keySet.iterator();
...
//        if ( propTree  != null ) propTree.openExpandedPath();
    ...
    public StaticChartMathExpression setChartAttributes ( StaticChartMathExpression chart , String startDate , String endDate , boolean historic, SamplingType samplingType ) throws DevFailed , ParseException
    {
        ...
        if ( attributes != null )
        {
            ...
            TreeMap<String, ExpressionAttribute> expressions = ViewConfiguration.getSelectedViewConfiguration().getExpressions();
