...
{
    private static ViewAttributesGraphPanel instance = null;
    ...
    public static ViewAttributesGraphPanel getInstance ()
    {
        if ( instance == null)
        {
        	instance = new ViewAttributesGraphPanel();
        }

        return instance;
    }

    public ViewAttributesGraphPanel()
    {
    ...
    private void addComponents ()
    {
    	support.firePropertyChange(
    			new PropertyChangeEvent(this, ADDING_PANELS, null, null)
    	);
    	...
    	support.firePropertyChange(
    			new PropertyChangeEvent(this, PANELS_ADDED, null, null)
    	);
    ...
    {
    	support.firePropertyChange(
    			new PropertyChangeEvent(this, SETTING_PANELS, null, null)
    	);
    	...
    	ViewConfiguration vc = ViewConfiguration.getSelectedViewConfiguration();
        TreeMap<String, ViewConfigurationAttribute> stringTable = vc.getAttributes().getStringStateScalarAttributes(vc.getData().isHistoric());
        ...
        TreeMap<String, ViewConfigurationAttribute> imageTable = vc.getAttributes ().getImageAttributes ( vc.getData ().isHistoric () );
        ...
        TreeMap<String, ViewConfigurationAttribute> spectrumTable = vc.getAttributes().getSpectrumAttributes(vc.getData().isHistoric());
...
//        chart = new StaticChartMathExpression();
    	...
    	support.firePropertyChange(
    			new PropertyChangeEvent(this, PANELS_SET, null, null)
    	);
    }
...
//        String msg = Messages.getMessage( "View" );
    ...
    {
        support.firePropertyChange(
                new PropertyChangeEvent(this, CANCELING, null, null)
        );
        ...
        this.removeAll();
        support.firePropertyChange(
                new PropertyChangeEvent(this, CANCELED, null, null)
        );
    }
    ...
    {
        support.firePropertyChange(
                new PropertyChangeEvent(this, LOADING_PANELS, null, null)
        );
        if (numberScalarsPanel != null)
        {
        ...
        support.firePropertyChange(
                new PropertyChangeEvent(this, PANELS_LOADED, null, null)
        );
    }
	...
	public static void setInstance(ViewAttributesGraphPanel instance) {
		ViewAttributesGraphPanel.instance = instance;
	}
