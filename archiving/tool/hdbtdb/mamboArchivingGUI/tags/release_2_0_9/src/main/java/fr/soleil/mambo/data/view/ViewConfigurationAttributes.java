...
public class ViewConfigurationAttributes {
    ...
    public void push() {
        // Save expanded Row
        TreeMap<String, ViewConfigurationAttribute> attributesHash = this
                .getAttributes();
        ...
        while (keyIterator.hasNext()) {
            ...
            /*
             * String cmpltNam = next.getCompleteName(); System.out.println (
             * "ArchivingConfigurationAttribute/push/cmpltNam/"+cmpltNam+"/" );
             * System.out.println (
             * "ArchivingConfigurationAttribute/push/domain_s/"
             * +domain_s+"/family_s/"
             * +family_s+"/member_s/"+member_s+"/attr_s/"+attr_s+"/" );
             */
        ...
        AttributesPlotPropertiesPanel.setColorIndex(getColorIndex());
        AttributesPlotPropertiesTab.getInstance().getPropertiesPanel()
                .rotateCurveColor();
        // ---------- put expanded Row
     ...
     * @throws DevFailed
     */
    public StaticChartMathExpression setChartAttributes(
            StaticChartMathExpression chart, String startDate, String endDate,
        ...
        if (attributes != null) {
            ...
            TreeMap<String, ExpressionAttribute> expressions = ViewConfiguration
                    .getSelectedViewConfiguration().getExpressions();
            ...
            while (keyIterator.hasNext()) {
                ...
                if (attr.getVariables() != null) {
                    ...
                    chart.applyExpressionToChart(attr.getExpression(), attr
                            .prepareView(), axis, attr.getVariables(), attr
                            .isX());
                }
            }
        }
    ...
    public void addAttributes(TreeMap<String, ViewConfigurationAttribute> attrs) {
        ...
        while (keyIterator.hasNext()) {
            ...
            if (needsColor) {
                AttributesPlotPropertiesPanel panel = new AttributesPlotPropertiesPanel();
                panel.reset();
                AttributesPlotPropertiesPanel.setColorIndex(getColorIndex());
