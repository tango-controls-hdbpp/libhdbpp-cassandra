//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/components/archiving/ACAttributesSelectTree.java,v $
//
...
public class ACAttributesSelectTree extends AttributesTree
{
     ...
     * @param newModel
     */
    private ACAttributesSelectTree ( TreeModel newModel )
    {
        super( newModel );
     ...
     * @return 8 juil. 2005
     */
    public static ACAttributesSelectTree getInstance ( TreeModel newModel )
    {
        if ( instance == null )
        {
