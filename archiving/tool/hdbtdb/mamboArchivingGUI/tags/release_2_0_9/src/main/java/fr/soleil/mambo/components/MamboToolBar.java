...
public class MamboToolBar extends JMenuBar {
    ...
    private final static ImageIcon    newActionIcon           = new ImageIcon(
                                                                      Mambo.class
                                                                              .getResource("icons/New.gif"));
    private final static ImageIcon    loadActionIcon          = new ImageIcon(
                                                                      Mambo.class
    ...
    private final static ImageIcon    saveAllToDiskActionIcon = new ImageIcon(
                                                                      Mambo.class
                                                                              .getResource("icons/Quick_Save_All.gif"));
    private final static ImageIcon    printActionIcon         = new ImageIcon(
                                                                      Mambo.class
                                                                              .getResource("icons/Print.gif"));
    private final static ImageIcon    resetActionIcon         = new ImageIcon(
                                                                      Mambo.class
