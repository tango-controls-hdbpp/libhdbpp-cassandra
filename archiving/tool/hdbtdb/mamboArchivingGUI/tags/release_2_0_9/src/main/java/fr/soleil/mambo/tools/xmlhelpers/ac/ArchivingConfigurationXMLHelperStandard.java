...
public class ArchivingConfigurationXMLHelperStandard 
{
    ...
    public ArchivingConfiguration loadArchivingConfigurationIntoHashFromRoot ( Node rootNode ) throws Exception
    {
        ...
        if ( rootNode.hasChildNodes() )
        {
            ...
            try
            {
                String creationDate_s = ( String ) ACProperties.get( ArchivingConfigurationData.CREATION_DATE_PROPERTY_XML_TAG );
                String lastUpdateDate_s = ( String ) ACProperties.get( ArchivingConfigurationData.LAST_UPDATE_DATE_PROPERTY_XML_TAG );
                String name_s = ( String ) ACProperties.get( ArchivingConfigurationData.NAME_PROPERTY_XML_TAG );
                String path_s = ( String ) ACProperties.get( ArchivingConfigurationData.PATH_PROPERTY_XML_TAG );
                String isModified_s = ( String ) ACProperties.get( ArchivingConfigurationData.IS_MODIFIED_PROPERTY_XML_TAG );
                String isHistoric_s = ( String ) ACProperties.get( ArchivingConfigurationData.IS_HISTORIC_PROPERTY_XML_TAG );
...
//as many loops as there are attributes in the AC
            {
                ...
                String currentAttributeType = currentAttributeNode.getNodeName().trim();//has to be "attribute"
                if ( !currentAttributeType.equals( ArchivingConfigurationAttribute.XML_TAG ) )
                {
                    //System.out.println ( "currentAttributeType/"+currentAttributeType+"/" );
                    throw new Exception();
                }

                Hashtable attributeProperties = XMLUtils.loadAttributes( currentAttributeNode );
                String attributeCompleteName = ( String ) attributeProperties.get( ArchivingConfigurationAttribute.COMPLETE_NAME_PROPERTY_XML_TAG );
        ...
        /*System.out.println ( "----------loadArchivingConfigurationIntoHashFromRoot------------" );
System.out.println ( archConf.toString () );
System.out.println ( "----------loadArchivingConfigurationIntoHashFromRoot------------" );*/
     ...
     * @throws Exception
     */
    private ArchivingConfigurationAttribute loadCurrentAttributeModes ( ArchivingConfigurationAttribute _currentAttribute , Node _currentAttributeNode ) throws Exception
    {
        ArchivingConfigurationAttribute ret = _currentAttribute;

        if ( _currentAttributeNode.hasChildNodes() )
        {
            NodeList attributeModesNodes = _currentAttributeNode.getChildNodes();
...
//as many loops as there are modes types for this attributes ( at most 2, HDBModes and TDBModes )
            {
                ...
                String currentModesType = currentModesNode.getNodeName().trim();//has to be "HDBModes" or "TDBModes"
                boolean currentModeIsHDB = currentModesType.equals( ArchivingConfigurationAttributeHDBProperties.XML_TAG );
                boolean currentModeIsTDB = currentModesType.equals( ArchivingConfigurationAttributeTDBProperties.XML_TAG );
                Hashtable DBmodeProperties = XMLUtils.loadAttributes( currentModesNode );
                
                if ( currentModeIsHDB )
                {
                    ArchivingConfigurationAttributeHDBProperties HDBProperties = new ArchivingConfigurationAttributeHDBProperties();
                    
                    String dedicatedArchiver_s = ( String ) DBmodeProperties.get( ArchivingConfigurationAttributeDBProperties.DEDICATED_ARCHIVER_PROPERTY_XML_TAG );
                    ...
                    HDBProperties = ( ArchivingConfigurationAttributeHDBProperties ) loadCurrentDBTypeModes( HDBProperties , currentModesNode );
                ...
                else if ( currentModeIsTDB )
                {
                    ...
                    /*String exportPeriod_s = ( String ) DBmodeProperties.get( ArchivingConfigurationAttributeTDBProperties.TDB_SPEC_EXPORT_PERIOD_XML_TAG );
                    long exportPeriod =  exportPeriod_s==null ? 0 : Long.parseLong( exportPeriod_s );                           
                    ...
                    /*String keepingPeriod_s = ( String ) DBmodeProperties.get( ArchivingConfigurationAttributeTDBProperties.TDB_SPEC_KEEPING_PERIOD_XML_TAG );
                    long keepingPeriod = keepingPeriod_s==null ? 0 : Long.parseLong( keepingPeriod_s );*/
                    ...
                    TDBProperties = ( ArchivingConfigurationAttributeTDBProperties ) loadCurrentDBTypeModes( TDBProperties , currentModesNode );
        ...
        /*System.out.println ( "----------loadCurrentAttributeModes------------" );
    ...
    protected long defineTdbExportPeriodForCurrentAttributeModes(Hashtable DBmodeProperties)
    {
        ...
        return (exportPeriod_s == null ? IACDefaultsManager.DEFAULT_TDB_EXPORT_PERIOD_WHEN_BAD_VALUE : Long.parseLong( exportPeriod_s ));
    }
     ...
     * @throws Exception
     */
    private ArchivingConfigurationAttributeDBProperties loadCurrentDBTypeModes ( ArchivingConfigurationAttributeDBProperties properties , Node currentModesNode ) throws Exception
    {
...
//as many loops as there are modes types for the current mode type for the current attribute
            {
                ...
                String currentModeType = currentModeNode.getNodeName().trim();//has to be "modes"
                if ( !currentModeType.equals( ArchivingConfigurationMode.XML_TAG ) )
                {
                    throw new Exception();
                }

                Hashtable modeProperties = XMLUtils.loadAttributes( currentModeNode );
    ...
    {
        String type_s = ( String ) modeProperties.get( ArchivingConfigurationMode.TYPE_PROPERTY_XML_TAG );
        String period_s = ( String ) modeProperties.get( ArchivingConfigurationMode.PERIOD_PROPERTY_XML_TAG );
        ...
        switch ( type )
        {
            case ArchivingConfigurationMode.TYPE_A:
                String inf_s = ( String ) modeProperties.get( ArchivingConfigurationMode.VAL_INF_PROPERTY_XML_TAG );
                String sup_s = ( String ) modeProperties.get( ArchivingConfigurationMode.VAL_SUP_PROPERTY_XML_TAG );
                String is_ab_slow_drift = ( String ) modeProperties.get( ArchivingConfigurationMode.VAL_ABS_SLOW_DRIFT_XML_TAG );
            ...
            case ArchivingConfigurationMode.TYPE_C:
                String range_s = ( String ) modeProperties.get( ArchivingConfigurationMode.RANGE_PROPERTY_XML_TAG );
                String calculationType_s = ( String ) modeProperties.get( ArchivingConfigurationMode.CALC_TYPE_PROPERTY_XML_TAG );
            ...
            case ArchivingConfigurationMode.TYPE_R:
                String inf_s1 = ( String ) modeProperties.get( ArchivingConfigurationMode.PERCENT_INF_PROPERTY_XML_TAG );
                String sup_s1 = ( String ) modeProperties.get( ArchivingConfigurationMode.PERCENT_SUP_PROPERTY_XML_TAG );
                String is_rel_slow_drift = ( String ) modeProperties.get( ArchivingConfigurationMode.VAL_REL_SLOW_DRIFT_XML_TAG );
            ...
            case ArchivingConfigurationMode.TYPE_T:
                String inf_s2 = ( String ) modeProperties.get( ArchivingConfigurationMode.THRESHOLD_INF_PROPERTY_XML_TAG );
                String sup_s2 = ( String ) modeProperties.get( ArchivingConfigurationMode.THRESHOLD_SUP_PROPERTY_XML_TAG );
