...
public class XMLArchivingConfigurationManagerImpl implements IArchivingConfigurationManager
{
    ...
    /* (non-Javadoc)
     * @see mambo.datasources.file.IArchivingConfigurationManager#saveArchivingConfiguration(mambo.data.archiving.ArchivingConfiguration, java.lang.String, java.util.Hashtable)
     */
    ...
    /* (non-Javadoc)
     * @see mambo.datasources.file.IArchivingConfigurationManager#loadArchivingConfigurations(fr.soleil.snapArchivingApi.SnapshotingTools.Tools.Criterions)
     */
    ...
    /* (non-Javadoc)
     * @see mambo.datasources.file.IArchivingConfigurationManager#findArchivingConfigurations(mambo.data.archiving.ArchivingConfiguration[], fr.soleil.snapArchivingApi.SnapshotingTools.Tools.Criterions)
     */
    ...
    public void startUp () throws IllegalStateException
    {
        ...
        //System.out.println ( "CLA/XMLArchivingConfigurationManagerImpl/startUp/defaultSaveLocation/"+defaultSaveLocation+"/" );
    }
    ...
    /* (non-Javadoc)
     * @see mambo.datasources.file.IArchivingConfigurationManager#loadArchivingConfiguration(java.lang.String)
     */
    public ArchivingConfiguration loadArchivingConfiguration ( /*String location*/ ) throws Exception
    {
        String _location = this.getSaveLocation();
        ArchivingConfiguration ac = ArchivingConfigurationXMLHelperFactory.getCurrentImpl().loadArchivingConfigurationIntoHash( _location ); 
        //ArchivingConfiguration ac = ArchivingConfigurationXMLHelper.loadArchivingConfigurationIntoHash( _location );
