...
{
    private static VCVariationAction instance;

    public static VCVariationAction getInstance () {
        return instance;
    }

    public static VCVariationAction getInstance (String name) {
        if (instance == null) {
            instance = new VCVariationAction(name);
        }
        return instance;
    }
     ...
     * @param name
     */
    private VCVariationAction ( String name )
    {
