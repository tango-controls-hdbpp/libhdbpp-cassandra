...
import fr.soleil.mambo.datasources.db.extracting.DbDataExtractor;
...
public class ViewConfigurationAttribute extends Attribute {
    ...
    public void addToChart(JLChart chart, String startDate, String endDate,
        ...
        if (recoveredData != null) {
            JLDataView[] views = DbDataExtractor
                    .extractScalarData(recoveredData);
            if (views != null) {
                JLDataView theReadView = views[0];
                JLDataView theWriteView = views[1];
                ...
                if (hasWrite) {
                    theWriteView = this.prepareView(theWriteView, false,
                            hasBoth);
