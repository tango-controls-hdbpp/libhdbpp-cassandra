...
public class SaveToDiskAction extends AbstractAction
{
    ...
    public void actionPerformed ( ActionEvent arg0 )
    {
        ...
        if ( this.type == NO_PRESET_TYPE )
        {
            ...
            String currentACLabel = Messages.getMessage( "ACTION_SAVE_CURRENT_AC" );
            String currentVCLabel = Messages.getMessage( "ACTION_SAVE_CURRENT_VC" );
    ...
    private void saveVc ()
    {
        ...
        selectedViewConfiguration.save( manager , false );
    }
