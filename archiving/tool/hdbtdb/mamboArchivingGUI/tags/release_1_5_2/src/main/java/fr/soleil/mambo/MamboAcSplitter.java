...
public class MamboAcSplitter
{
	 ...
	 public static void main ( String[] args )
	 {
        ...
        {
	         System.out.println( "Incorrect arguments. Correct syntax: java MamboAcSplitter pathToMixedAC" );
            System.exit( 1 );
        }
	    ...
	    try 
	    {
	        //ArchivingConfiguration ac = ArchivingConfigurationXMLHelper.loadArchivingConfigurationIntoHash( pathToMixedAC );
	        ArchivingConfigurationXMLHelperFactory.getImpl(ArchivingConfigurationXMLHelperFactory.STANDARD_IMPL_TYPE);
	        ArchivingConfiguration ac = ArchivingConfigurationXMLHelperFactory.getCurrentImpl().loadArchivingConfigurationIntoHash( pathToMixedAC );
            ...
            IArchivingConfigurationManager manager = ArchivingConfigurationManagerFactory.getImpl ( ArchivingConfigurationManagerFactory.XML_IMPL_TYPE );
	    ...
	    catch (Throwable t) 
	    {
	        ...
	        //System.out.println( "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX ZZZZZZZZZZ2" );
        }
