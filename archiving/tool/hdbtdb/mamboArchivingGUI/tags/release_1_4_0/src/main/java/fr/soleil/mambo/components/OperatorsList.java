...
public class OperatorsList extends JComboBox
{
 ...
 //   private String[] idOperators = {NO_SELECTION, GlobalConst.OP_EQUALS, GlobalConst.OP_LOWER_THAN_STRICT, GlobalConst.OP_GREATER_THAN_STRICT, GlobalConst.OP_LOWER_THAN, GlobalConst.OP_LOWER_THAN};
   // private String[] afterTimeOperators = {NO_SELECTION, GlobalConst.OP_GREATER_THAN, GlobalConst.OP_GREATER_THAN_STRICT};
     ...
     */
    public OperatorsList ( int type ) throws IllegalStateException
    {
        super();
...
*/
            ...
            default :
                throw new IllegalStateException( "Expected either of " + ID_TYPE + "," + BEFORE_TIME_TYPE + "," + AFTER_TIME_TYPE + "," + COMMENT_TYPE + " as a parameter. Received " + type + " instead." );
        }
