...
public class AxisPanel extends JPanel
{
    ...
    protected AxisPanel ( int axisType )
    {
        ...
        AutoScaleCheck.setIcon( checkedNoIcon );
        AutoScaleCheck.setSelectedIcon( checkedYesIcon );
        AutoScaleCheck.setPressedIcon( checkedPressedIcon );
        ...
        SubGridCheck.setIcon( checkedNoIcon );
        SubGridCheck.setSelectedIcon( checkedYesIcon );
        SubGridCheck.setPressedIcon( checkedPressedIcon );
        ...
        VisibleCheck.setIcon( checkedNoIcon );
        VisibleCheck.setSelectedIcon( checkedYesIcon );
        VisibleCheck.setPressedIcon( checkedPressedIcon );
        ...
        OppositeCheck.setIcon( checkedNoIcon );
        OppositeCheck.setSelectedIcon( checkedYesIcon );
        OppositeCheck.setPressedIcon( checkedPressedIcon );
        ...
        ColorBtn.addMouseListener( new YAxisMouseListener( this.type ) );
