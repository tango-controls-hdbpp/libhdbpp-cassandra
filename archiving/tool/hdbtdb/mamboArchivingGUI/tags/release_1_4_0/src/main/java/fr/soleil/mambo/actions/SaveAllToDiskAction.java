//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/mambo/actions/SaveAllToDiskAction.java,v $
//
...
public class SaveAllToDiskAction extends AbstractAction
{
    ...
    public void actionPerformed ( ActionEvent actionEvent )
    {
        ...
        {
            IArchivingConfigurationManager archivingManager = ArchivingConfigurationManagerFactory.getCurrentImpl();
        ...
        {
            IViewConfigurationManager viewManager = ViewConfigurationManagerFactory.getCurrentImpl();
            ILogger logger = LoggerFactory.getCurrentImpl();
