...
public class ACTreeRenderer extends DefaultTreeCellRenderer {
    ...
    protected final ImageIcon rootIcon        = new ImageIcon(
                                                      Mambo.class
                                                              .getResource("icons/host.gif"));
    protected final ImageIcon disabledIcon    = new ImageIcon(
                                                      Mambo.class
                                                              .getResource("icons/bulbDisabled.gif"));
    protected final ImageIcon enabledHIcon    = new ImageIcon(
                                                      Mambo.class
                                                              .getResource("icons/bulbEnabled.gif"));
    protected final ImageIcon enabledTIcon    = new ImageIcon(
                                                      Mambo.class
                                                              .getResource("icons/bulbEnabledTemp.gif"));
    protected final ImageIcon enabledBothIcon = new ImageIcon(
                                                      Mambo.class
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value,
        ...
        if (node.getLevel() == 4) {
            ...
            if (currentArchivingConfiguration.containsAttribute(name)) {
                if (currentArchivingConfiguration.getAttributes().getAttribute(
                        name).isEmpty()) {
