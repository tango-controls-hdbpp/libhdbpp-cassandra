...
public class BufferedTangoManagerImpl extends BasicTangoManagerImpl 
{
    ...
    {
        super();
        this.buffer = new Hashtable<Criterions, Vector<Domain>>( MAX_BUFFER_SIZE );
    ...
    public Vector<Domain> loadDomains ( Criterions searchCriterions, boolean forceReload )
    {
        ...
        {
            Vector<Domain> newResult = super.loadDomains ( searchCriterions, forceReload );
            return newResult;   
        }
        ...
        Vector<Domain> bufferisedResult = (Vector<Domain>) this.buffer.get ( conditionsHT );
    ...
    private void bufferResult(Criterions searchCriterions, Vector<Domain> newResult) 
    {
