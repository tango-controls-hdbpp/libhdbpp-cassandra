...
public class GeneralTab extends JPanel {
    ...
    private final static ImageIcon checkedYesIcon     = new ImageIcon(
                                                              Mambo.class
                                                                      .getResource("icons/checked_yes.gif"));
    private final static ImageIcon checkedNoIcon      = new ImageIcon(
                                                              Mambo.class
                                                                      .getResource("icons/checked_no.gif"));
    private final static ImageIcon checkedPressedIcon = new ImageIcon(
                                                              Mambo.class
    ...
    public GeneralTab(ViewConfigurationBean viewConfigurationBean,
    ...
    private void setLayout() {
        ...
        // Lay out the panel.
        SpringUtilities.makeCompactGrid(dataSubPanel, 3, 1, // rows, cols
                6, 6, // initX, initY
                6, 6, true); // xPad, yPad
    ...
    private void addComponents() {
        ...
        this.add(chartGeneralTabbedPane);
    ...
    private void initBoxes() {
        ...
        SpringUtilities.makeCompactGrid(vcIdentificationBox, 4, 2, // rows, cols
                6, 6, // initX, initY
                6, 6, true); // xPad, yPad

        msg = Messages
                .getMessage("DIALOGS_EDIT_VC_GENERAL_BOXES_VC_IDENTIFICATION");
        ...
        SpringUtilities.makeCompactGrid(samplingOptionsBox, 1, 4, // rows, cols
                6, 6, // initX, initY
                6, 6, true); // xPad, yPad

        msg = Messages
                .getMessage("DIALOGS_EDIT_VC_GENERAL_BOXES_VC_AVERAGING_OPTIONS");
        tb = BorderFactory.createTitledBorder(BorderFactory
                .createEtchedBorder(EtchedBorder.LOWERED), msg,
                TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.TOP,
                GUIUtilities.getTitleFont());
    ...
    public SamplingType getSamplingType() {
        SamplingType ret = (SamplingType) samplingTypeComboBox
                .getSelectedItem();
        short factor = 0;
