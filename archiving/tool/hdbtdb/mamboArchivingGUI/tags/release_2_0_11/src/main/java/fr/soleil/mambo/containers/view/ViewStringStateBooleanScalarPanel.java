...
public class ViewStringStateBooleanScalarPanel extends MamboCleanablePanel {
    ...
    private final static Insets          gapBetweenTables = new Insets(20, 5,
                                                                  0, 5);
    private final static Dimension       refSize          = new Dimension(50,
                                                                  50);
    private final static Insets          DEFAULT_INSETS   = new Insets(5, 5, 0,
                                                                  5);
