...
{
	protected final static ImageIcon trueIcon = new ImageIcon(Mambo.class.getResource("icons/true.gif"));
    protected final static ImageIcon falseIcon = new ImageIcon(Mambo.class.getResource("icons/false.gif"));
    protected final static ImageIcon offIcon = new ImageIcon(Mambo.class.getResource("icons/double_off.gif"));
	...
	{
		super( (value == null)? Messages.getMessage("VIEW_ATTRIBUTES_NO_DATA"):value.toString() );
		setIcon(falseIcon);
