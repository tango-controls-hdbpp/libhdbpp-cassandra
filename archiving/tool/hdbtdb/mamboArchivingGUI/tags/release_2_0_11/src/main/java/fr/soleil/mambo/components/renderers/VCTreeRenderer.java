...
public class VCTreeRenderer extends DefaultTreeCellRenderer {
    ...
    protected final static ImageIcon rootIcon         = new ImageIcon(
                                                              Mambo.class
                                                                      .getResource("icons/database.gif"));
    protected final static ImageIcon disabledIcon     = new ImageIcon(
                                                              Mambo.class
                                                                      .getResource("icons/bulbDisabled.gif"));
    protected final static ImageIcon enabledHIcon     = new ImageIcon(
                                                              Mambo.class
                                                                      .getResource("icons/bulbEnabled.gif"));
    protected final static ImageIcon enabledTIcon     = new ImageIcon(
                                                              Mambo.class
