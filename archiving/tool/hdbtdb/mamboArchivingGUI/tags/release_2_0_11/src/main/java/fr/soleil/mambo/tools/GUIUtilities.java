...
public class GUIUtilities {
    ...
    public final static Color      selectionColor       = new Color(200, 180,
                                                                255);
    public final static Insets     zInset               = new Insets(0, 0, 0, 0);
    public final static Font       labelFont            = new Font("Dialog",
                                                                Font.PLAIN, 12);
    public final static Font       labeliFont           = new Font("Dialog",
                                                                Font.ITALIC, 12);
    public final static Font       labelbFont           = new Font("Dialog",
                                                                Font.BOLD, 12);
    public final static Font       expandButtonFont     = new Font(
                                                                "Dialog",
                                                                Font.BOLD
                                                                        | Font.ITALIC,
                                                                12);
    ...
    private final static Color     archivingColor       = new Color(210, 190,
                                                                190);
    private final static Color     archivingCopyColor   = new Color(255, 150,
                                                                255);
    private final static Color     viewColor            = new Color(180, 200,
                                                                200);
    private final static Color     viewSelectionColor   = new Color(200, 240,
                                                                255);
    private final static Color     viewCopyColor        = new Color(150, 255,
                                                                255);
    ...
    private final static Font      expressionTitleFont  = new Font(
                                                                "Times New Roman",
                                                                Font.BOLD, 20);

    private final static Dimension editScrollPaneSize   = new Dimension(700,
                                                                600);
     ...
     *            8 juil. 2005
     */
    public static void addDebugBorderToPanel(JComponent panelToDebug,
    ...
    public static TitledBorder getPlotSubPanelsEtchedBorder(String name) {
        ...
        return BorderFactory.createTitledBorder(BorderFactory
                ...
                TitledBorder.DEFAULT_POSITION, labelbFont, fColor);
    }
    ...
    public static TitledBorder getPlotSubPanelsEtchedBorder(String name,
        ...
        return BorderFactory.createTitledBorder(BorderFactory
                .createEtchedBorder(), name, TitledBorder.LEFT,
                TitledBorder.DEFAULT_POSITION, labelbFont, color);
    }
    ...
    public static TitledBorder getPlotSubPanelsLineBorder(String name) {
        ...
        return BorderFactory.createTitledBorder(BorderFactory.createLineBorder(
                fColor, 1), name, TitledBorder.LEFT,
                TitledBorder.DEFAULT_POSITION, labelbFont, fColor);
    }
    ...
    public static TitledBorder getPlotSubPanelsLineBorder(String name,
        ...
        return BorderFactory.createTitledBorder(BorderFactory.createLineBorder(
                lineColor, 1), name, TitledBorder.LEFT,
                TitledBorder.DEFAULT_POSITION, labelbFont, fColor);
    }
    ...
    public static TitledBorder getPlotSubPanelsLineBorder(String name,
        ...
        return BorderFactory.createTitledBorder(BorderFactory.createLineBorder(
                lineColor, 1), name, TitledBorder.LEFT,
                TitledBorder.DEFAULT_POSITION, labelbFont, textColor);
    }
    ...
    public static Vector<String> getContentParts(String content) {
        ...
        // XMLLine line =
        new XMLLine(ArchivingConfigurationAttribute.XML_TAG,
     ...
     *            14 sept. 2005
     */
    public static void removeVectorElements(Map<?, ?> attrs,
            Vector<?> attrsToRemove) {
    ...
    public static Criterions getAttributesSearchCriterions(String pattern) {
        ...
        cond = new Condition(ITangoManager.FIELD_ATTRIBUTE_DOMAIN,
                ITangoManager.OP_EQUALS, domain);
        ret.addCondition(cond);

        cond = new Condition(ITangoManager.FIELD_ATTRIBUTE_FAMILY,
                ITangoManager.OP_EQUALS, family);
        ret.addCondition(cond);

        cond = new Condition(ITangoManager.FIELD_ATTRIBUTE_MEMBER,
                ITangoManager.OP_EQUALS, member);
        ret.addCondition(cond);

        cond = new Condition(ITangoManager.FIELD_ATTRIBUTE_NAME,
                ITangoManager.OP_EQUALS, attribute);
        ret.addCondition(cond);
