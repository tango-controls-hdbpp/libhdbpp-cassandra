...
//
// $Log$
// Revision 1.1  2006/08/09 10:35:27  ounsy
...
public class ACRecapTableRenderer implements TableCellRenderer {
	...
	public ACRecapTableRenderer(boolean _forceTitle) {
	...
	public Component getTableCellRendererComponent(JTable table, Object value,
		...
		if (value instanceof Boolean) {
			...
			if (hasMode) {
				/*
				 * ret.setText ( "O" ); Font font = new Font( "SansSerif" ,
				 * Font.BOLD , 14 ); ret.setFont ( font );
				 */
			...
			if (forceTitle
					|| ((table instanceof ACAttributeDetailHdbTitleTable || table instanceof ACAttributeDetailTdbTitleTable) && row == 0)) {
				label.setFont(titleFont);
			} else {
				label.setFont(font);
				if (value != null && column == 4
						&& !value.equals(table.getModel().getValueAt(row, 3))) {
