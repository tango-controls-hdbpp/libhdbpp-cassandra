...
public class AttributesPropertiesPanel extends JPanel
{
    ...
    private final static Dimension classicMaxDimension = new Dimension(Integer.MAX_VALUE, 21);
    ...
    private void initComponents ( boolean isHistoric )
    {
        ...
        String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_SET" );
    ...
    private void initKeepingPeriodsTable ()
    {
        ...
        reverseKeepingPeriodsTable.put( new Long( keepingPeriodsTable[ 0 ] ) , new Integer( 0 ) );
        reverseKeepingPeriodsTable.put( new Long( keepingPeriodsTable[ 1 ] ) , new Integer( 1 ) );
        reverseKeepingPeriodsTable.put( new Long( keepingPeriodsTable[ 2 ] ) , new Integer( 2 ) );
        reverseKeepingPeriodsTable.put( new Long( keepingPeriodsTable[ 3 ] ) , new Integer( 3 ) );
        reverseKeepingPeriodsTable.put( new Long( keepingPeriodsTable[ 4 ] ) , new Integer( 4 ) );
        reverseKeepingPeriodsTable.put( new Long( keepingPeriodsTable[ 5 ] ) , new Integer( 5 ) );
        reverseKeepingPeriodsTable.put( new Long( keepingPeriodsTable[ 6 ] ) , new Integer( 6 ) );
        reverseKeepingPeriodsTable.put( new Long( keepingPeriodsTable[ 7 ] ) , new Integer( 7 ) );
    }
   ...
   /* private void initExportPeriodsTable ()
    ...
    private void initCenterPanel ( boolean isHistoric )
    {
        ...
        SpringUtilities.makeCompactGrid(
                centerPanel,
                centerPanel.getComponentCount(), 1,
                0, 0,
                0, 0,
                true
        );
    ...
    private class ArchiverChoiceDefaultCheckBoxActionListener implements ActionListener
    {
        ...
        {
            boolean isDefault = AttributesPropertiesPanel.this.archiverChoiceDefaultCheckBox.isSelected ();
            //System.out.println ( "CLA/ArchiverChoiceDefaultCheckBoxActionListener/isDefault/"+isDefault );
    ...
    private void initCenterComponents ( boolean isHistoric )
    {
        ...
        /*msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_KEEPING_PERIOD" );
 ...
 /*       TDBexportPeriodComboBox = new JComboBox();
        msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_EXPORT_PERIOD_5MN" );
...
*/
        /*TDBkeepingPeriodComboBox = new JComboBox();
        msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_KEEPING_PERIOD_1H" );
        TDBkeepingPeriodComboBox.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_KEEPING_PERIOD_2H" );
        TDBkeepingPeriodComboBox.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_KEEPING_PERIOD_4H" );
        TDBkeepingPeriodComboBox.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_KEEPING_PERIOD_6H" );
        TDBkeepingPeriodComboBox.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_KEEPING_PERIOD_8H" );
        TDBkeepingPeriodComboBox.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_KEEPING_PERIOD_1D" );
        TDBkeepingPeriodComboBox.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_KEEPING_PERIOD_3D" );
        TDBkeepingPeriodComboBox.addItem( msg );
     ...
     * 20 juil. 2005
     */
    private void initCenterSubPanel ( boolean isHistoric )
    {
        ...
        if ( isHistoric )
        {
            ...
            HDBModePanel.add( HDBmodesLabel );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            ...
            HDBModePanel.add( HDBPeriodicalLabel );
            HDBModePanel.add( HDBPeriodicalCheck );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            ...
            HDBModePanel.add( HDBAbsoluteLabel );
            HDBModePanel.add( HDBAbsoluteCheck );
            HDBModePanel.add( HDBabsolutePeriodLabel );
            HDBModePanel.add( HDBabsolutePeriodField );
            HDBModePanel.add( HDBabsoluteLowerLabel );
            HDBModePanel.add( HDBabsoluteLowerField );
            HDBModePanel.add( HDBabsoluteUpperLabel );
            HDBModePanel.add( HDBabsoluteUpperField );

            HDBModePanel.add( HDBRelativeLabel );
            HDBModePanel.add( HDBRelativeCheck );
            HDBModePanel.add( HDBrelativePeriodLabel );
            HDBModePanel.add( HDBrelativePeriodField );
            HDBModePanel.add( HDBrelativeLowerLabel );
            HDBModePanel.add( HDBrelativeLowerField );
            HDBModePanel.add( HDBrelativeUpperLabel );
            HDBModePanel.add( HDBrelativeUpperField );

            HDBModePanel.add( HDBThresholdLabel );
            HDBModePanel.add( HDBThresholdCheck );
            HDBModePanel.add( HDBthresholdPeriodLabel );
            HDBModePanel.add( HDBthresholdPeriodField );
            HDBModePanel.add( HDBthresholdLowerLabel );
            HDBModePanel.add( HDBthresholdLowerField );
            HDBModePanel.add( HDBthresholdUpperLabel );
            HDBModePanel.add( HDBthresholdUpperField );

            HDBModePanel.add( HDBDifferenceLabel );
            HDBModePanel.add( HDBDifferenceCheck );
            HDBModePanel.add( HDBdifferencePeriodLabel );
            HDBModePanel.add( HDBdifferencePeriodField );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            HDBModePanel.add( Box.createHorizontalGlue() );
            ...
            //Lay out the panels.
            SpringUtilities.makeCompactGrid( HDBPeriodPanel ,
                    1 , HDBPeriodPanel.getComponentCount() , //rows, cols
                    0 , 0 , //initX, initY
                    0 , 5 , //xPad, yPad
                    true
            );
            SpringUtilities.makeCompactGrid( HDBModePanel ,
                    6 , 8 , //rows, cols
                    0 , 0 , //initX, initY
                    10 , 5 , //xPad, yPad
                    true
            );
            SpringUtilities.makeCompactGrid( HDBPanel ,
                    HDBPanel.getComponentCount() , 1 , //rows, cols
                    0 , 0 , //initX, initY
                    0 , 0 , //xPad, yPad
                    true
            );
        ...
        else
        {
            ...
            TDBPeriodPanel.add( TDBexportPeriodLabel );
            TDBPeriodPanel.add( TDBexportPeriodComboBox );
            TDBPeriodPanel.add( Box.createHorizontalGlue() );

            /*TDBPeriodPanel.add( TDBkeepingPeriodLabel );
            TDBPeriodPanel.add( TDBkeepingPeriodComboBox );
            TDBPeriodPanel.add( Box.createHorizontalGlue() );*/


            //-------------------------
            TDBModePanel.add( TDBmodesLabel );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            ...
            TDBModePanel.add( TDBPeriodicalLabel );
            TDBModePanel.add( TDBPeriodicalCheck );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            ...
            TDBModePanel.add( TDBAbsoluteLabel );
            TDBModePanel.add( TDBAbsoluteCheck );
            TDBModePanel.add( TDBabsolutePeriodLabel );
            TDBModePanel.add( TDBabsolutePeriodField );
            TDBModePanel.add( TDBabsoluteLowerLabel );
            TDBModePanel.add( TDBabsoluteLowerField );
            TDBModePanel.add( TDBabsoluteUpperLabel );
            TDBModePanel.add( TDBabsoluteUpperField );

            TDBModePanel.add( TDBRelativeLabel );
            TDBModePanel.add( TDBRelativeCheck );
            TDBModePanel.add( TDBrelativePeriodLabel );
            TDBModePanel.add( TDBrelativePeriodField );
            TDBModePanel.add( TDBrelativeLowerLabel );
            TDBModePanel.add( TDBrelativeLowerField );
            TDBModePanel.add( TDBrelativeUpperLabel );
            TDBModePanel.add( TDBrelativeUpperField );

            TDBModePanel.add( TDBThresholdLabel );
            TDBModePanel.add( TDBThresholdCheck );
            TDBModePanel.add( TDBthresholdPeriodLabel );
            TDBModePanel.add( TDBthresholdPeriodField );
            TDBModePanel.add( TDBthresholdLowerLabel );
            TDBModePanel.add( TDBthresholdLowerField );
            TDBModePanel.add( TDBthresholdUpperLabel );
            TDBModePanel.add( TDBthresholdUpperField );

            TDBModePanel.add( TDBDifferenceLabel );
            TDBModePanel.add( TDBDifferenceCheck );
            TDBModePanel.add( TDBdifferencePeriodLabel );
            TDBModePanel.add( TDBdifferencePeriodField );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            TDBModePanel.add( Box.createHorizontalGlue() );
            ...
            SpringUtilities.makeCompactGrid(
                    TDBPanel ,
                    TDBPanel.getComponentCount() , 1 , //rows, cols
                    0 , 0 , //initX, initY
                    0 , 0 , //xPad, yPad
                    true );
    ...
    private JPanel getWarningPanel() 
    {
        ...
        SpringUtilities.makeCompactGrid(
                warningPanel ,
                1 , warningPanel.getComponentCount() , //rows, cols
                0 , 0 , //initX, initY
                0 , 0 , //xPad, yPad
                true );
        return warningPanel;
    ...
    private JPanel getArchiverChoicePanel () 
    {
        ...
        String dedicatedArchiverLabelMessage = Messages.getMessage ( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_DEDICATED_ARCHIVER" );
        JLabel dedicatedArchiverLabel = new JLabel ( dedicatedArchiverLabelMessage );
        String currentArchiverLabelMessage = Messages.getMessage ( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_CURRENT_ARCHIVER" );
        JLabel currentArchiverLabel = new JLabel ( currentArchiverLabelMessage );
        String archiverDefaultLabelMessage = Messages.getMessage ( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_ARCHIVER_DEFAULT" );
        JLabel archiverDefaultLabel = new JLabel ( archiverDefaultLabelMessage );
        String archiverRunningLabelMessage = Messages.getMessage ( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_ARCHIVER_RUNNING" );
        JLabel archiverRunningLabel = new JLabel ( archiverRunningLabelMessage );
        String archiverNameLabelMessage = Messages.getMessage ( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_ARCHIVER_NAME" );
        ...
        String archiverTitleLabelMessage = Messages.getMessage ( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_ARCHIVER_TITLE" );
        TitledBorder tb = BorderFactory.createTitledBorder
        ( BorderFactory.createEtchedBorder( EtchedBorder.LOWERED ) ,
          archiverTitleLabelMessage ,
    ...
    public long getExportPeriod ()
    {
        ...
        /*int selected = TDBexportPeriodComboBox.getSelectedIndex();
    ...
    {
        /*int selected = TDBkeepingPeriodComboBox.getSelectedIndex();
        return keepingPeriodsTable[ selected ];*/
        return 0;
    }

    /**
     * @param historic
     * @param type_a   22 juil. 2005
     */
    ...
    public void setSelectedModes ( boolean _historic , Vector modesTypes )
    {
        ...
        while ( enumeration.hasMoreElements() )
        {
            ...
            //System.out.println( "AttributesPropertiesPanel/setSelectedModes/nextModeType/"+nextModeType+"/" );
    ...
    public void setExportPeriod ( long period )
    {
        ...
        /*int idx = 1;
        //default 10 minutes
        //System.out.println ( "setExportPeriod/period/"+period+"/" );
        try
        {
            Integer key = ( Integer ) reverseExportPeriodsTable.get( new Long( period ) );
            if ( key == null )
            {
                idx = 1;
            }
    ...
    /**
     * @param reverseExportPeriodsTable2 6 sept. 2005
     */
    /*private void traceHT ( Hashtable ht )
    {
    ...
    public void setKeepingPeriod ( long period )
    {
        ...
        try
        {
            Integer key = ( Integer ) reverseKeepingPeriodsTable.get( new Long( period ) );
            if ( key == null )
            {
                idx = 2;
            }
    ...
    {
        boolean firstTests = verifyThatSelectedModesAreCoherent() && verifyEachMode();
        if ( firstTests )
        {
            try 
            {
            ...
            {
                String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_MODES_TITLE" );
	            String msgGeneral = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_MODES_MESSAGE" );
    ...
    private boolean verifyEachMode ()
    {
        ...
        if ( this.isHistoric )
        {
            if ( HDBPeriodicalCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_PERIODIC_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_PERIODIC_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
            ...
            if ( HDBDifferenceCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_DIFFERENCE_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_DIFFERENCE_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
            ...
            if ( HDBAbsoluteCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_ABSOLUTE_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_ABSOLUTE_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
                    return false;
                }
            ...
            if ( HDBRelativeCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_RELATIVE_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_RELATIVE_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
            ...
            if ( HDBThresholdCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_THRESHOLD_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_HDB_THRESHOLD_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
                ...
                modeS.setThresholdInf ( Double.parseDouble( this.getHDBThresholdLower () ) );
                modeS.setThresholdSup ( Double.parseDouble( this.getHDBThresholdUpper () ) );
                mode.setModeT ( modeS );
            }
        } 
        else
        {
            if ( TDBPeriodicalCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_PERIODIC_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_PERIODIC_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
            ...
            if ( TDBDifferenceCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_DIFFERENCE_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_DIFFERENCE_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
            ...
            if ( TDBAbsoluteCheck.isSelected() )
            {
                ...
                {
                    e.printStackTrace ();
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_ABSOLUTE_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_ABSOLUTE_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
                ...
                modeA.setValInf ( Math.abs ( Double.parseDouble( this.getTDBAbsoluteLower () ) ) );
                modeA.setValSup ( Math.abs ( Double.parseDouble( this.getTDBAbsoluteUpper () ) ) );
                mode.setModeA ( modeA );
            }
            ...
            if ( TDBRelativeCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_RELATIVE_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_RELATIVE_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
                ...
                modeR.setPercentInf ( Double.parseDouble( this.getTDBRelativeLower () ) );
                modeR.setPercentSup ( Double.parseDouble( this.getTDBRelativeUpper () ) );
                mode.setModeR ( modeR );
            }
            ...
            if ( TDBThresholdCheck.isSelected() )
            {
                ...
                {
                    String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_THRESHOLD_MODE_TITLE" );
                    String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INVALID_TDB_THRESHOLD_MODE_MESSAGE" );
                    JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
                ...
                modeS.setThresholdInf ( Double.parseDouble( this.getTDBThresholdLower () ) );
                modeS.setThresholdSup ( Double.parseDouble( this.getTDBThresholdUpper () ) );
                mode.setModeT ( modeS );
            }
        }
    ...
    public boolean verifyThatSelectedModesAreCoherent ()
    {
        if ( this.isHistoric )
        {
            boolean hasHDBNonPeriodicMode =
                HDBAbsoluteCheck.isSelected() ||
	        ...
	        {
	            String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INCOHERENT_HDB_MODES_TITLE" );
	            String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INCOHERENT_HDB_MODES_MESSAGE" );
	            JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
        ...
        {
            boolean hasTDBNonPeriodicMode =
                TDBAbsoluteCheck.isSelected() ||
	        ...
	        {
	            String title = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INCOHERENT_TDB_MODES_TITLE" );
	            String msg = Messages.getMessage( "DIALOGS_EDIT_AC_ATTRIBUTES_PROPERTIES_INCOHERENT_TDB_MODES_MESSAGE" );
	            JOptionPane.showMessageDialog( null , msg , title , JOptionPane.ERROR_MESSAGE );
...
//   ------------
    ...
    private class ArchiverChoiceDefaultCheckBox extends JCheckBox
    {
        ...
        {
            super ();
            this.addActionListener ( new ArchiverChoiceDefaultCheckBoxActionListener () );
        }
    }
    ...
    public String getDedicatedArchiver() 
    {
        ...
        if ( rawValue == null || rawValue.equals ( "" ) || rawValue.equals ( ArchiversComboBox.DEFAULT ) )
        {
            return ""; 
        }
    ...
    {
        boolean archiverDefaultIsEmpty = dedicatedArchiver == null || dedicatedArchiver.equals ( "" ) || dedicatedArchiver.equals ( ArchiversComboBox.DEFAULT );
        //System.out.println ( "/pushDefaultArchiver/pushDefaultArchiver/dedicatedArchiver|"+dedicatedArchiver+"|archiverDefaultIsEmpty|"+archiverDefaultIsEmpty );
    ...
    public void pushCurrentArchiver(Archiver currentArchiver , String attributeCompleteName) 
    {
        String name = currentArchiver == null ? "" : currentArchiver.getName ();
		//System.out.println ( "AttributesPropertiesPanel/pushCurrentArchiver/currentArchiver|"+ name+"|");
        ...
        this.archiverChoiceRunningComboBox.setCurrentlySelectedAttribute ( attributeCompleteName );
    }
    
    public void pushDedicatedArchiver(String attributeCompleteName) 
    {
        //System.out.println ( "CLA/pushDedicatedArchiver/attributeCompleteName|"+attributeCompleteName );
        String text = "";
        Hashtable attributesToDedicatedArchiver = Archiver.getAttributesToDedicatedArchiver ( this.isHistoric );
        if ( attributesToDedicatedArchiver != null && attributeCompleteName != null )
        {
            //System.out.println ( "CLA/pushDedicatedArchiver/1" );
            Archiver dedicatedArch = (Archiver) attributesToDedicatedArchiver.get ( attributeCompleteName );
            if ( dedicatedArch != null )
            {
                text = dedicatedArch.getName ();
                String dedicatedStatusDescription = dedicatedArch.isExported () ? " (EXPORTED)" : " (NOT EXPORTED)" ;
                text += dedicatedStatusDescription;
                //System.out.println ( "CLA/pushDedicatedArchiver/2/text|"+text );
            }
            /*else
            {
                System.out.println ( "CLA/pushDedicatedArchiver/3" );
            }*/
        }
    ...
    private class ArchiverChoiceNameTextField extends JTextField
    {
        ...
        public void setColorForAttribute(String completeName) 
        {
            ...
            if ( archiver == null || archiver.equals ( "" ) || archiver.equals ( ArchiversComboBox.DEFAULT ) )
            {
                //do nothing
                return;
            }
            else
            {
                try
                {
                    Archiver arch = new Archiver ( archiver , AttributesPropertiesPanel.this.isHistoric () );
