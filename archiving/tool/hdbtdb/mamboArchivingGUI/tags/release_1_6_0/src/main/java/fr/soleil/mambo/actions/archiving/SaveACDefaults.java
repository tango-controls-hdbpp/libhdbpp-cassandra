...
//open file chooser
        ...
        try
        {
            ...
            String msg = Messages.getLogMessage( "SAVE_ARCHIVING_CONFIGURATION_DEFAULTS_ACTION_OK" );
            logger.trace( ILogger.LEVEL_DEBUG , msg );
        }
        catch ( FileNotFoundException fnfe )
        {
            String msg = Messages.getLogMessage( "SAVE_ARCHIVING_CONFIGURATION_DEFAULTS_ACTION_WARNING" );
        ...
        {
            String msg = Messages.getLogMessage( "SAVE_ARCHIVING_CONFIGURATION_DEFAULTS_ACTION_KO" );
