...
public class VCNextAction extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (oldValue == 2) {
            editDialog.getAttributesPlotPropertiesTab().getVcAttributesPropertiesTree()
        ...
        if (oldValue == 3) {
            ...
            editDialog.getExpressionTab().getExpressionTree().getExpressionTreeListener()
                    .treeSelectionSave();
            editDialog.getExpressionTab().getExpressionTree().clearSelection();
        }
        ...
        switch (newValue) {
            ...
            case 3:
                ...
                tabbedPane.setEnabledAt(2, false);
                if (editDialog != null) {
                    editDialog.getExpressionTab().getExpressionTree().reloadSelection();
                }
                break;
