...
public class VCAttributesTreeModel extends VCTreeModel {
	...
	private static final long serialVersionUID = -4362208935628950518L;
	private VCAttributesSelectTree treeInstance = null;
	private boolean historic;
	private VCPossibleAttributesTreeModel possibleAttributesTreeModel;

	public VCAttributesTreeModel(
			VCPossibleAttributesTreeModel possibleAttributesTreeModel) {
		super();
		this.possibleAttributesTreeModel = possibleAttributesTreeModel;
		setHistoric(Mambo.isHdbAvailable());
	}
	...
	public void addSelectedAttibutes(Vector<TreePath> validSelected) {
		TreeMap<String, ViewConfigurationAttribute> possibleAttr = possibleAttributesTreeModel
				.getAttributes();
		TreeMap<String, ViewConfigurationAttribute> htAttr = this
				.getAttributes();
			...
			for (int depth = 0; depth < CONTEXT_TREE_DEPTH; depth++) {
				...
				if (vect.contains(currentPathObject.toString())) {
					...
					if (depth == CONTEXT_TREE_DEPTH - 1) {
						...
						ViewConfigurationAttribute attribute = possibleAttr
