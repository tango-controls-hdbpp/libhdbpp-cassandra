...
// corected so that the tree/table selection works in the menu/tool bar too and
// not only in the bottom buttons
//
...
public class MamboToolBar extends JMenuBar {
	...
	private final static String newActionName = Messages
			.getMessage("TOOLBAR_NEW");
	private final static String loadActionName = Messages
			.getMessage("TOOLBAR_LOAD");
	private final static String ACActionName = Messages
			.getMessage("TOOLBAR_ARCHIVING_CONFIGURATION");
	private final static String VCActionName = Messages
			.getMessage("TOOLBAR_VIEW_CONFIGURATION");
	private final static String saveToDiskActionName = Messages
			.getMessage("TOOLBAR_SAVE_TO_DISK");
	private final static String saveAllToDiskActionName = Messages
			.getMessage("TOOLBAR_SAVE_ALL_TO_DISK");
	private final static String printActionName = Messages
			.getMessage("TOOLBAR_PRINT");
	private final static String resetActionName = Messages
			.getMessage("TOOLBAR_RESET");

	private final static ImageIcon newActionIcon = new ImageIcon(Mambo.class
			.getResource("icons/New.gif"));
	private final static ImageIcon loadActionIcon = new ImageIcon(Mambo.class
			.getResource("icons/Open.gif"));
	private final static ImageIcon saveToDiskActionIcon = new ImageIcon(
			Mambo.class.getResource("icons/Save.gif"));
	private final static ImageIcon saveAllToDiskActionIcon = new ImageIcon(
			Mambo.class.getResource("icons/Quick_Save_All.gif"));
	private final static ImageIcon printActionIcon = new ImageIcon(Mambo.class
			.getResource("icons/Print.gif"));
	private final static ImageIcon resetActionIcon = new ImageIcon(Mambo.class
			.getResource("icons/Trash_-_Reset.gif"));
	...
	private MamboToolBar() {
		...
		newACAction = new OpenACEditDialogAction(Messages
				.getMessage("TOOLBAR_NEW_ARCHIVING_CONFIGURATION"), true,
				acOptions.isAlternateSelectionMode());

		newVCAction = OpenVCEditDialogNewAction.getInstance(Messages
				.getMessage("TOOLBAR_NEW_VIEW_CONFIGURATION"));
		...
		newVCButton = new ToolBarButton(newVCAction, true);
		newVCButton.setIcon(newActionIcon);
		newVCButton.setToolTipText(Messages
				.getMessage("TOOLBAR_NEW_VIEW_CONFIGURATION"));
		GUIUtilities.setObjectBackground(newVCButton,
				GUIUtilities.TOOLBAR_COLOR);
		...
		GUIUtilities
				.setObjectBackground(loadACItem, GUIUtilities.TOOLBAR_COLOR);

		loadVCItem = new JMenuItem(VCActionName);
		loadVCAction = new LoadVCAction(Messages
				.getMessage("TOOLBAR_LOAD_VIEW_CONFIGURATION"), false);
		loadVCItem.addActionListener(loadVCAction);
		GUIUtilities
				.setObjectBackground(loadVCItem, GUIUtilities.TOOLBAR_COLOR);

		loadVCButton = new ToolBarButton(loadVCAction, true);
		loadVCButton.setIcon(loadActionIcon);
		GUIUtilities.setObjectBackground(loadVCButton,
				GUIUtilities.TOOLBAR_COLOR);
		...
		saveACAction = new SaveToDiskAction(Messages
				.getMessage("TOOLBAR_SAVE_ARCHIVING_CONFIGURATION"),
				saveToDiskActionIcon, SaveToDiskAction.AC_TYPE);
		saveACItem.addActionListener(saveACAction);
		GUIUtilities
				.setObjectBackground(saveACItem, GUIUtilities.TOOLBAR_COLOR);

		saveVCItem = new JMenuItem(VCActionName);
		saveVCAction = new SaveToDiskAction(Messages
				.getMessage("TOOLBAR_SAVE_VIEW_CONFIGURATION"),
				saveToDiskActionIcon, SaveToDiskAction.VC_TYPE);
		saveVCItem.addActionListener(saveVCAction);
		GUIUtilities
				.setObjectBackground(saveVCItem, GUIUtilities.TOOLBAR_COLOR);
		saveVCButton = new ToolBarButton(saveVCAction, true);
		saveVCButton.setIcon(saveToDiskActionIcon);
		GUIUtilities.setObjectBackground(saveVCButton,
				GUIUtilities.TOOLBAR_COLOR);
		...
		saveAllAction = new SaveAllToDiskAction(saveAllToDiskActionName,
				saveAllToDiskActionIcon, SaveAllToDiskAction.BOTH_TYPE);
		saveAllButton = new ToolBarButton(saveAllAction, true);
		GUIUtilities.setObjectBackground(saveAllButton,
				GUIUtilities.TOOLBAR_COLOR);
		add(saveAllButton);
		...
		printACAction = new PrintAction(Messages
				.getMessage("TOOLBAR_PRINT_ARCHIVING_CONFIGURATION"),
				printActionIcon, PrintAction.AC_TYPE);
		printACItem.addActionListener(printACAction);
		GUIUtilities.setObjectBackground(printACItem,
				GUIUtilities.TOOLBAR_COLOR);

		printVCItem = new JMenuItem(VCActionName);
		printVCAction = new PrintAction(Messages
				.getMessage("TOOLBAR_PRINT_VIEW_CONFIGURATION"),
				printActionIcon, PrintAction.VC_TYPE);
		printVCItem.addActionListener(printVCAction);
		GUIUtilities.setObjectBackground(printVCItem,
				GUIUtilities.TOOLBAR_COLOR);

		printVCButton = new ToolBarButton(printVCAction, true);
		printVCButton.setIcon(printActionIcon);
		GUIUtilities.setObjectBackground(printVCButton,
				GUIUtilities.TOOLBAR_COLOR);
	...
	private class ToolBarButton extends JButton {
		...
		private static final long serialVersionUID = -4584811953099497793L;
	...
	private class ToolBarMenu extends JMenu {
		...
		private static final long serialVersionUID = 4421696933671442012L;
