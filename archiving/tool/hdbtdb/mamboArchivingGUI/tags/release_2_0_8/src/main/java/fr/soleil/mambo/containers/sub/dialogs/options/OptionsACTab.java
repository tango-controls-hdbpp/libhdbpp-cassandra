...
public class OptionsACTab extends JPanel
{
    ...
    private void initLayout() {
		...
		String msg1 = Messages.getMessage("DIALOGS_OPTIONS_AC_SELECTION_BORDER");
		...
		stackDepthField.setPreferredSize(new Dimension(50,
				stackDepthField.getPreferredSize().height));
		stackDepthField
				.setMaximumSize(new Dimension(50, stackDepthField.getPreferredSize().height));
