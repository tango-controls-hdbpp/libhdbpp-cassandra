...
/*
        ...
        centerPanel.add( HDBperiodLabel );
        centerPanel.add( HDBperiodField );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        ...
        centerPanel.add( HDBPeriodicalLabel );
        centerPanel.add( HDBPeriodicalCheck );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        ...
        centerPanel.add( HDBAbsoluteLabel );
        centerPanel.add( HDBAbsoluteCheck );
        centerPanel.add( HDBabsolutePeriodLabel );
        centerPanel.add( HDBabsolutePeriodField );
        centerPanel.add( HDBabsoluteLowerLabel );
        centerPanel.add( HDBabsoluteLowerField );
        centerPanel.add( HDBabsoluteUpperLabel );
        centerPanel.add( HDBabsoluteUpperField );

        centerPanel.add( HDBRelativeLabel );
        centerPanel.add( HDBRelativeCheck );
        centerPanel.add( HDBrelativePeriodLabel );
        centerPanel.add( HDBrelativePeriodField );
        centerPanel.add( HDBrelativeLowerLabel );
        centerPanel.add( HDBrelativeLowerField );
        centerPanel.add( HDBrelativeUpperLabel );
        centerPanel.add( HDBrelativeUpperField );

        centerPanel.add( HDBThresholdLabel );
        centerPanel.add( HDBThresholdCheck );
        centerPanel.add( HDBthresholdPeriodLabel );
        centerPanel.add( HDBthresholdPeriodField );
        centerPanel.add( HDBthresholdLowerLabel );
        centerPanel.add( HDBthresholdLowerField );
        centerPanel.add( HDBthresholdUpperLabel );
        centerPanel.add( HDBthresholdUpperField );

        centerPanel.add( HDBDifferenceLabel );
        centerPanel.add( HDBDifferenceCheck );
        centerPanel.add( HDBdifferencePeriodLabel );
        centerPanel.add( HDBdifferencePeriodField );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        ...
        centerPanel.add( TDBperiodLabel );
        centerPanel.add( TDBperiodField );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        ...
        centerPanel.add( TDBexportPeriodLabel );
        centerPanel.add( TDBexportPeriodComboBox );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        ...
        centerPanel.add( TDBkeepingPeriodLabel );
        centerPanel.add( TDBkeepingPeriodComboBox );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        ...
        centerPanel.add( TDBPeriodicalLabel );
        centerPanel.add( TDBPeriodicalCheck );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        ...
        centerPanel.add( TDBAbsoluteLabel );
        centerPanel.add( TDBAbsoluteCheck );
        centerPanel.add( TDBabsolutePeriodLabel );
        centerPanel.add( TDBabsolutePeriodField );
        centerPanel.add( TDBabsoluteLowerLabel );
        centerPanel.add( TDBabsoluteLowerField );
        centerPanel.add( TDBabsoluteUpperLabel );
        centerPanel.add( TDBabsoluteUpperField );

        centerPanel.add( TDBRelativeLabel );
        centerPanel.add( TDBRelativeCheck );
        centerPanel.add( TDBrelativePeriodLabel );
        centerPanel.add( TDBrelativePeriodField );
        centerPanel.add( TDBrelativeLowerLabel );
        centerPanel.add( TDBrelativeLowerField );
        centerPanel.add( TDBrelativeUpperLabel );
        centerPanel.add( TDBrelativeUpperField );

        centerPanel.add( TDBThresholdLabel );
        centerPanel.add( TDBThresholdCheck );
        centerPanel.add( TDBthresholdPeriodLabel );
        centerPanel.add( TDBthresholdPeriodField );
        centerPanel.add( TDBthresholdLowerLabel );
        centerPanel.add( TDBthresholdLowerField );
        centerPanel.add( TDBthresholdUpperLabel );
        centerPanel.add( TDBthresholdUpperField );

        centerPanel.add( TDBDifferenceLabel );
        centerPanel.add( TDBDifferenceCheck );
        centerPanel.add( TDBdifferencePeriodLabel );
        centerPanel.add( TDBdifferencePeriodField );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        centerPanel.add( Box.createRigidArea( emptyBoxDimension ) );
...
*/
        ...
        /*TDBPanel.add( TDBkeepingPeriodLabel );
        TDBPanel.add( TDBkeepingPeriodComboBox );
        TDBPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        TDBPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        TDBPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        TDBPanel.add( Box.createRigidArea( emptyBoxDimension ) );
        ...
        SpringUtilities.makeCompactGrid( warningPanel ,
                1 , 2 , //rows, cols
                6 , 6 , //initX, initY
                6 , 6 ,
                true );       //xPad, yPad
