...
public interface IAttributeManager {
    ...
    public Vector<Domain> loadDomains(Criterions searchCriterions, boolean historic, boolean forceReload)
    ...
    public boolean isScalar(String completeName, boolean _historic) throws ArchivingException;

    public boolean isSpectrum(String completeName, boolean _historic);

    public int getDataType(String completeName, boolean _historic) throws SQLException, ArchivingException;
