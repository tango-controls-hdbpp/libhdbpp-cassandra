...
public class ACAttributeDetailTdbATableModel extends DefaultTableModel {
	 ...
	 *
	 */
	private static final long serialVersionUID = 5322489570750094728L;
	...
	private Object getACColumnValue(int rowIndex) {
		...
		if (TDBProperties != null) {
			ArchivingConfigurationMode ACAMode = TDBProperties
			...
			if (ACAMode != null) {
				...
				case 2:
					...
					break;
				case 3:
					ret = Boolean.toString(ACAMode.getMode().getModeA()
							.isSlow_drift());
					break;
