//+======================================================================
//$Source: /cvsroot/tango-cs/tango/tools/mambo/containers/view/dialogs/GeneralTabbedPane.java,v $
//
 ...
 * @author JL Pons
 */
public class GeneralTabbedPane extends JPanel
{
    protected final static Color     fColor     = new Color( 99, 97, 156 );
    protected final static Insets    zInset     = new Insets( 0, 0, 0, 0 );
    protected final static Font      jLabelFont = new Font( "Dialog",
                                                        Font.PLAIN, 12 );
    protected Font                   labelFont  = new Font( "Dialog",
                                                        Font.PLAIN, 12 );
    protected Font                   headerFont = new Font( "Dialog",
                                                        Font.PLAIN, 12 );
    ...
    private static Y1AxisPanel y1Panel;
    private static Y2AxisPanel y2Panel;

    private static GeneralTabbedPane instance = null;


    /**
     * @return 8 juil. 2005
     */
    public static GeneralTabbedPane getInstance ()
    {
        if ( instance == null )
        {
            instance = new GeneralTabbedPane();
        }
    ...
    private void initComponents ()
    {
        ...
        TitledBorder legendBorder = GUIUtilities.getPlotSubPanelsEtchedBorder( msg );
        ...
        TitledBorder colorFontBorder = GUIUtilities.getPlotSubPanelsEtchedBorder( msg );
        ...
        TitledBorder gridBorder = GUIUtilities.getPlotSubPanelsEtchedBorder( msg );
        ...
        TitledBorder miscBorder = GUIUtilities.getPlotSubPanelsEtchedBorder( msg );
        gMiscPanel.setBorder( miscBorder );

        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_MISC_CHART_TITLE" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_LEGENDS_VISIBLE" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_COLORSANDFONT_CHARTBACKGROUND" );
        ...
        generalBackColorBtn.addMouseListener( new GeneralPanelMouseListener() );
        generalBackColorBtn.setMargin( zInset );

        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_LEGENDS_PLACEMENT" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_LEGENDS_PLACEMENT_BOTTOM" );
        generalLabelPCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_LEGENDS_PLACEMENT_TOP" );
        generalLabelPCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_LEGENDS_PLACEMENT_RIGHT" );
        generalLabelPCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_LEGENDS_PLACEMENT_LEFT" );
        generalLabelPCombo.addItem( msg );
        ...
        generalGridCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_AXISGRID_ONXANDY1" );
        generalGridCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_AXISGRID_ONXANDY2" );
        generalGridCombo.addItem( msg );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_AXISGRID_STYLE" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_AXISGRID_STYLE_SOLID" );
        generalGridStyleCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_AXISGRID_STYLE_DOT" );
        generalGridStyleCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_AXISGRID_STYLE_SHORT_DASH" );
        generalGridStyleCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_AXISGRID_STYLE_LONG_DASH" );
        generalGridStyleCombo.addItem( msg );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_AXISGRID_STYLE_DOT_DASH" );
        generalGridStyleCombo.addItem( msg );
        //generalGridStyleCombo.setSelectedIndex(chart.getY1Axis().getGridStyle());
        //generalGridStyleCombo.addActionListener(this);

        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_MISC_DISPLAY_DURATION" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_MISC_TIME_PRECISION" );
        timePrecisionLabel = new JLabel( msg );
        timePrecisionLabel.setFont( jLabelFont );
        timePrecisionLabel.setForeground( fColor );
        timePrecisionText = new NumberTextField(NumberTextField.POSITIVE_INTEGER_LIKE);
        timePrecisionText.setEditable( true );
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_MISC_DISPLAY_DURATION_TOOLTIP" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_COLORSANDFONT_HEADERFONT" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_COLORSANDFONT_SAMPLETEXT" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_COLORSANDFONT_LABELFONT" );
        ...
        msg = Messages.getMessage( "DIALOGS_EDIT_VC_GENERAL_MAIN_COLORSANDFONT_SAMPLE0123" );
        ...
        generalFontLabelBtn.addMouseListener( new GeneralPanelMouseListener() );
        generalFontHeaderBtn.setMargin( zInset );
        ...
        y1Panel = Y1AxisPanel.getInstance();
        y2Panel = Y2AxisPanel.getInstance();
    ...
    public GeneralChartProperties getGeneralChartProperties ()
    {
        ...
        try
        {
            ret.setDisplayDuration( Long.parseLong( generalDurationText.getText() ) );
        }
        ...
        ret.setTitle( generalLegendText.getText() );
    ...
    /**
     * @param axisGridStyle 25 août 2005
     */
    ...
    /**
     * @param legendsPlacement 25 août 2005
     */
    ...
    /**
     * @param backgroundColor 25 août 2005
     */
    ...
    /**
     * @param displayDuration 25 août 2005
     */
    ...
    /**
     * @param title 29 août 2005
     */
    public void setTitle ( String title )
    {
        generalLegendText.setText( title );
    }
