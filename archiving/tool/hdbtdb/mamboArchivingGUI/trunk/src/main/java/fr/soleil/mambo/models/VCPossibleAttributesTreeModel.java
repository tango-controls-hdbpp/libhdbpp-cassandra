...
public class VCPossibleAttributesTreeModel extends VCTreeModel {
    ...
    public VCPossibleAttributesTreeModel(final boolean _historic) {
	super();
	setHistoric(_historic);
    }

    public void setRootName(final boolean b) {
    ...
    public void build(final IAttributeManager source, final Criterions searchCriterions,
