...
public class AxisPanel extends JPanel {
    ...
    final static Font         labelFont        = new Font("Dialog", Font.PLAIN,
                                                       12);
    final static Font         labelbFont       = new Font("Dialog", Font.BOLD,
                                                       12);
    ...
    public void setLabelFormat(int labelFormat) {
        if (labelFormat < formatCombo.getItemCount()) {
    ...
    public void setPosition(int position) {
        if (position < positionCombo.getItemCount()) {
    ...
    public void setScaleMode(int scaleMode) {
        if (scaleMode < scaleCombo.getItemCount()) {
