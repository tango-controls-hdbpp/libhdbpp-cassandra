...
public class CopyOfGUIUtilities {
     ...
     *            8 juil. 2005
     */
    public static void addDebugBorderToPanel(final JComponent panelToDebug, final boolean debug,
     ...
     * @return 31 ao�t 2005
     */
    public static Vector<String> getContentParts(final String content) {
	...
	final StringTokenizer st = new StringTokenizer(pattern, CopyOfGUIUtilities.TANGO_DELIM);

	String domain = CopyOfGUIUtilities.TANGO_JOKER;
	String family = CopyOfGUIUtilities.TANGO_JOKER;
	String member = CopyOfGUIUtilities.TANGO_JOKER;
	String attribute = CopyOfGUIUtilities.TANGO_JOKER;
