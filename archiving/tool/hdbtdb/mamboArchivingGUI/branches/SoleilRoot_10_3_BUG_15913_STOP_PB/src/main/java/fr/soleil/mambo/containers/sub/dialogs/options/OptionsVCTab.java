// +======================================================================
// $Source:
// /cvsroot/tango-cs/tango/tools/mambo/containers/sub/dialogs/options/OptionsVCTab.java,v
// $
//
...
public class OptionsVCTab extends JPanel {
    ...
    private static final long       serialVersionUID    = -9124914331949258883L;
    ...
    protected final static String[] noValueStringChoice = { "*", ".", "-", "+",
            "#", "X", "!"                              };
    ...
    private void initLayout() {
        ...
        String msg1 = Messages
                .getMessage("DIALOGS_OPTIONS_VC_DISPLAY_READ_BORDER");
        ...
        String msg2 = Messages
                .getMessage("DIALOGS_OPTIONS_VC_DISPLAY_WRITE_BORDER");
        ...
        String msg3 = Messages
                .getMessage("DIALOGS_OPTIONS_VC_FORCE_TDB_EXPORT_BORDER");
        ...
        maxDisplayedViewsField.setPreferredSize(new Dimension(50,
                maxDisplayedViewsField.getPreferredSize().height));
        maxDisplayedViewsField.setMaximumSize(new Dimension(50,
                maxDisplayedViewsField.getPreferredSize().height));
        ...
        TitledBorder tb4 = BorderFactory.createTitledBorder(BorderFactory
                ...
                TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.TOP);
        CompoundBorder cb4 = BorderFactory.createCompoundBorder(tb4,
                BorderFactory.createEmptyBorder(2, 4, 4, 4));
        ...
        noValueCombo.setPreferredSize(new Dimension(40, noValueCombo
                .getPreferredSize().height));
        noValueCombo.setMaximumSize(new Dimension(40, noValueCombo
                .getPreferredSize().height));
        ...
        TitledBorder tb5 = BorderFactory.createTitledBorder(BorderFactory
                ...
                TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.TOP);
        CompoundBorder cb5 = BorderFactory.createCompoundBorder(tb5,
                BorderFactory.createEmptyBorder(2, 4, 4, 4));
        chartPropertiesBox.setBorder(cb5);

        // ---

        Box spectrumViewTypeBox = new Box(BoxLayout.X_AXIS);
        spectrumViewTypeBox.add(spectrumViewTypeLabel);
        spectrumViewTypeBox.add(Box.createRigidArea(new Dimension(5, 0)));
        spectrumViewTypeBox.add(spectrumViewTypeCombo);
        spectrumViewTypeBox.add(Box.createHorizontalGlue());

        spectrumViewTypeCombo.setPreferredSize(new Dimension(100,
                spectrumViewTypeCombo.getPreferredSize().height));
        spectrumViewTypeCombo.setMaximumSize(new Dimension(100,
                spectrumViewTypeCombo.getPreferredSize().height));

        String msg6 = Messages
                .getMessage("DIALOGS_OPTIONS_VC_SPECTRUM_VIEW_TYPE_BORDER");
        TitledBorder tb6 = BorderFactory.createTitledBorder(BorderFactory
                .createEtchedBorder(EtchedBorder.LOWERED), msg6,
                TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.TOP);
        CompoundBorder cb6 = BorderFactory.createCompoundBorder(tb6,
                BorderFactory.createEmptyBorder(2, 4, 4, 4));
        spectrumViewTypeBox.setBorder(cb6);
    ...
    private void initComponents() {
        ...
        displayReadYes.setActionCommand(String
                .valueOf(VCOptions.DISPLAY_READ_YES));

        msg = Messages.getMessage("DIALOGS_OPTIONS_VC_DISPLAY_READ_NO");
        displayReadNo = new JRadioButton(msg, false);
        displayReadNo.setActionCommand(String
                .valueOf(VCOptions.DISPLAY_READ_NO));
        ...
        displayWriteYes.setActionCommand(String
                .valueOf(VCOptions.DISPLAY_WRITE_YES));

        msg = Messages.getMessage("DIALOGS_OPTIONS_VC_DISPLAY_WRITE_NO");
        displayWriteNo = new JRadioButton(msg, false);
        displayWriteNo.setActionCommand(String
                .valueOf(VCOptions.DISPLAY_WRITE_NO));
        ...
        forceTdbExportYes.setActionCommand(String
                .valueOf(VCOptions.FORCE_TDB_EXPORT_YES));

        msg = Messages.getMessage("DIALOGS_OPTIONS_VC_FORCE_TDB_EXPORT_NO");
        forceTdbExportNo = new JRadioButton(msg, false);
        forceTdbExportNo.setActionCommand(String
                .valueOf(VCOptions.FORCE_TDB_EXPORT_NO));
        ...
        msg = Messages
                .getMessage("DIALOGS_OPTIONS_VC_MISC_MAX_DISPLAYED_VIEWS");
        maxDisplayedViewsLabel = new JLabel(msg);
        maxDisplayedViewsLabel.setLabelFor(maxDisplayedViewsField);

        msg = Messages
                .getMessage("DIALOGS_OPTIONS_VC_MISC_MAX_DISPLAYED_VIEWS_WARNING");
        ...
        spectrumViewTypeCombo = new JComboBox(new DefaultComboBoxModel(
                msgListItem));
        msg = Messages
                .getMessage("DIALOGS_OPTIONS_VC_SPECTRUM_VIEW_TYPE_STRING");
    ...
    public void selectForceTdbExport(int displayCase) {
        // System.out.println (
        // "CLA/OptionsVCTab/selectForceTdbExport/displayCase/"+displayCase );
        switch (displayCase) {
            case VCOptions.FORCE_TDB_EXPORT_YES:
                // System.out.println (
                // "CLA/OptionsVCTab/selectForceTdbExport/0" );
                forceTdbExportYes.setSelected(true);
                break;

            case VCOptions.FORCE_TDB_EXPORT_NO:
                // System.out.println (
                // "CLA/OptionsVCTab/selectForceTdbExport/1" );
                forceTdbExportNo.setSelected(true);
                break;

            default:
                // System.out.println (
                // "CLA/OptionsVCTab/selectForceTdbExport/2" );
                forceTdbExportNo.setSelected(true);
                break;
        }
    }
