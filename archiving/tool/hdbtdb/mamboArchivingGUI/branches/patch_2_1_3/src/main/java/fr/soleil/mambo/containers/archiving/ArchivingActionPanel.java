...
public class ArchivingActionPanel extends JPanel implements
	...
	private final static ImageIcon quickLoadIcon = new ImageIcon(Mambo.class
			.getResource("icons/Quick_Open.gif"));
	private final static ImageIcon quickLoadDisabledIcon = new ImageIcon(
			Mambo.class.getResource("icons/Quick_Open_Disabled.gif"));
	private final static ImageIcon quickSaveIcon = new ImageIcon(Mambo.class
			.getResource("icons/Quick_Save.gif"));
	private final static ImageIcon quickSaveDisabledIcon = new ImageIcon(
			Mambo.class.getResource("icons/Quick_Save_Disabled.gif"));
	private final static ImageIcon startIcon = new ImageIcon(Mambo.class
			.getResource("icons/Play.gif"));
	private final static ImageIcon startDisabledIcon = new ImageIcon(
			Mambo.class.getResource("icons/Play_Disabled.gif"));
	private final static ImageIcon stopIcon = new ImageIcon(Mambo.class
			.getResource("icons/Stop.gif"));
	private final static ImageIcon stopDisabledIcon = new ImageIcon(Mambo.class
			.getResource("icons/Stop_Disabled.gif"));
	private final static ImageIcon modifyIcon = new ImageIcon(Mambo.class
			.getResource("icons/Modify.gif"));
	private final static ImageIcon modifyDisabledIcon = new ImageIcon(
			Mambo.class.getResource("icons/Modify_Disabled.gif"));
	private final static ImageIcon transferIcon = new ImageIcon(Mambo.class
			.getResource("icons/Transfer.gif"));
	private final static ImageIcon transferDisabledIcon = new ImageIcon(
			Mambo.class.getResource("icons/Transfer_Disabled.gif"));
	private final static ImageIcon recapIcon = new ImageIcon(Mambo.class
			.getResource("icons/Variation.gif"));
	private final static ImageIcon recapDisabledIcon = new ImageIcon(
			Mambo.class.getResource("icons/Variation_Disabled.gif"));
