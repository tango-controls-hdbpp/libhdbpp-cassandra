...
public class ViewConfiguration {
    ...
    private String getPathToUse(IViewConfigurationManager manager, boolean saveAs) {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (f.exists()) {
                int choice = JOptionPane.showConfirmDialog(MamboFrame.getInstance(), Messages
    ...
    /**
     * Adds a new expression to the ViewConfiguration. Useful when loading a VC from XML.
     * 
    ...
    public void setChartAttributeExpressionOfString(
            ViewStringStateBooleanScalarPanel otherScalarsPanel, ChartViewer chart) {
        attributes.setChartAttributeExpressionOfString(otherScalarsPanel, data.isHistoric(), chart);
