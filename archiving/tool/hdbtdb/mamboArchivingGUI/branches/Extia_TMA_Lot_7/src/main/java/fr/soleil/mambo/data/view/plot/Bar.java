...
public class Bar extends BarProperties {
    ...
    public String toString() {
        ...
        openingLine.setAttribute(COLOR_PROPERTY_XML_TAG, GUIUtilities
                .colorToString(getFillColor().getAwtColor()));
        openingLine.setAttribute(WIDTH_PROPERTY_XML_TAG, String
                .valueOf(getWidth()));
        openingLine.setAttribute(FILL_STYLE_PROPERTY_XML_TAG, String
                .valueOf(getFillStyle()));
        openingLine.setAttribute(FILL_METHOD_PROPERTY_XML_TAG, String
                .valueOf(getFillingMethod()));
