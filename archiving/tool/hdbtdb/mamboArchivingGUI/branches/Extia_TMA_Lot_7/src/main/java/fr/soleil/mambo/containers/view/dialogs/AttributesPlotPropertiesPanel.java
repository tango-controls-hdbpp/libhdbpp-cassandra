...
public class AttributesPlotPropertiesPanel extends JLDataViewOption {
    ...
    public AttributesPlotPropertiesPanel(ViewConfigurationBean viewConfigurationBean,
    ...
    private JPanel initSpectrumViewTypePanel() {
        ...
        TitledBorder viewTypePanelBorder = GUIUtilities.getPlotSubPanelsLineBorder(msg, new Color(
                100, 100, 100));
        CompoundBorder cb = BorderFactory.createCompoundBorder(viewTypePanelBorder, BorderFactory
        ...
        setSpectrumViewTypeChoice(Options.getInstance().getVcOptions().getSpectrumViewType());
    ...
    public void applyColorIndex() {
        ...
        plotProperties.getCurve().setColor(CometeColor.getColor(defaultColor[colorIndex]));
        plotProperties.getBar().setFillColor(CometeColor.getColor(defaultColor[colorIndex]));
        plotProperties.getMarker().setColor(CometeColor.getColor(defaultColor[colorIndex]));
    ...
    public static Bar getDefaultBar(Color color) {
        return new Bar(CometeColor.getColor(color), 1, DEFAULT_BAR_FILL_STYLE, 0);
    }
    ...
    public static Marker getDefaultMarker(Color color) {
        return new Marker(CometeColor.getColor(color), DEFAULT_MARKER_SIZE, DEFAULT_MARKER_STYLE,
                true);
    }

    public static Polynomial2OrderTransform getDefaultTransform() {
        return new Polynomial2OrderTransform(DEFAULT_TRANSFORM_A0, DEFAULT_TRANSFORM_A1,
                DEFAULT_TRANSFORM_A2);
    }
    ...
    public static Smoothing getDefaultSmoothing() {
        return new Smoothing(DEFAULT_SMOOTHING_METHOD, DEFAULT_SMOOTHING_NEIGHBORS,
                DEFAULT_SMOOTHING_GAUSS_SIGMA, DEFAULT_SMOOTHING_EXTRAPOLATION);
    }
