...
public class ExpressionTab extends JPanel {
        ...
        if (nameField.getText() == null
            ...
            ViewConfigurationAttributePlotProperties plotProperties = new ViewConfigurationAttributePlotProperties(
                    propertiesPanel.getViewType(), propertiesPanel
                            .getAxisChoice(), propertiesPanel
                            .getSpectrumViewTypeChoice(), propertiesPanel
                            .getBar(), propertiesPanel.getCurve(),
    ...
    public void setParametersLight(ExpressionAttribute attr) {
        ...
        ViewConfigurationAttributePlotProperties plotProperties = new ViewConfigurationAttributePlotProperties(
                ...
                propertiesPanel.getSpectrumViewTypeChoice(), propertiesPanel
                        .getBar(), propertiesPanel.getCurve(), propertiesPanel
                        .getMarker(), propertiesPanel.getTransform(),
    ...
    protected void reloadPropertiesPanel() {
        ...
        propertiesPanel.setSpectrumViewTypeChoice(properties
                .getSpectrumViewType());
