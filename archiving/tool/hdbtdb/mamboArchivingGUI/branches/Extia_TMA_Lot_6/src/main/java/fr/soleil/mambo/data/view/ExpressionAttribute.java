...
public class ExpressionAttribute {
    ...
    public ExpressionAttribute(String name, String expression,
        ...
        this.x = x;
        this.id = CometeUtils.generateIdForClass(ExpressionAttribute.class,
                5000);
    }
    ...
    public ExpressionAttribute duplicate() {
        ...
        ViewConfigurationAttributePlotProperties properties2 = new ViewConfigurationAttributePlotProperties(
                properties.getViewType(), properties.getAxisChoice(),
                properties, properties.getSpectrumViewType(), properties
                        .isHidden());
        attribute.setId(id);
    ...
    public void prepareView(ChartViewer chart) {
        if (properties != null) {
            ...
            if (properties.isHidden()) {
                ...
                chartComponent.setDataViewMarkerStyle(getId(),
                        JLDataView.MARKER_NONE);
                chartComponent.setDataViewBarWidth(getId(), 0);
                chartComponent.setDataViewFillStyle(getId(),
