...
public class ACAttributesPropertiesTree extends AttributesTree {
    ...
    private static final long serialVersionUID = -484439252329915402L;
	...
	public Vector<ArchivingConfigurationAttribute> getListOfAttributesToSet() {
		TreePath[] selectedPath = this.getSelectionPaths();
		if (selectedPath == null || selectedPath.length == 0) {
			return null;
		}

		Vector<ArchivingConfigurationAttribute> attributes = new Vector<ArchivingConfigurationAttribute>();
