...
public class GeneralChartProperties extends ChartProperties {
    ...
    public GeneralChartProperties(ChartProperties chartProperties) {
        ...
        if (chartProperties != null) {
            try {
                GeneralChartProperties clone = (GeneralChartProperties) chartProperties
                        .clone();
    ...
    public String toString() {
        ...
        openingLine.setAttributeIfNotNull(AXIS_GRID_STYLE_PROPERTY_XML_TAG,
                String.valueOf(getXAxisProperties().getGridStyle()));
        ...
        openingLine.setAttributeIfNotNull(DISPLAY_DURATION_PROPERTY_XML_TAG,
                String.valueOf(getDisplayDuration()));
    ...
    public GeneralChartProperties cloneGeneralChartProperties() {
        ...
        ret.setBackgroundColor(this.getBackgroundColor() == null ? null
                : new CometeColor(this.getBackgroundColor().getRed(), this
                        .getBackgroundColor().getGreen(), this
                        .getBackgroundColor().getBlue()));
        ret.setDisplayDuration(this.getDisplayDuration());
        ret.setHeaderFont(this.getHeaderFont() == null ? null
                : new CometeFont(this.getHeaderFont().getName(), this
                        .getHeaderFont().getStyle(), this.getHeaderFont()
                        .getSize()));
        ret.setLabelFont(this.getLabelFont() == null ? null : new CometeFont(
                this.getLabelFont().getName(), this.getLabelFont().getStyle(),
                this.getLabelFont().getSize()));
    ...
    public void setGeneralChartProperties(ChartProperties generalChartProperties) {
        if (generalChartProperties != null) {
            try {
                ChartProperties clone = (ChartProperties) generalChartProperties
                        .clone();
                setLegendsAreVisible(clone.isLegendsAreVisible());
                setLegendsPlacement(clone.getLegendsPlacement());
                setBackgroundColor(clone.getBackgroundColor());
    ...
    public int getAxisGrid() {
        ...
        if ((getXAxisProperties().isGridVisible())
