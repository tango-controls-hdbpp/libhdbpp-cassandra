...
public class ViewConfigurationAttribute extends Attribute {
    ...
    public void addToChart(ChartViewer chart, String startDate, String endDate,
        ...
        if (recoveredData != null) {
            ...
            if (dao != null) {
                ...
                ((JComponent)chart.getComponent()).repaint();
            }
        }
        recoveredData = null;
    }
    ...
    private void prepareView(DbData recoveredData, ChartViewer chart) {
        ...
        ViewConfigurationAttributePlotProperties plotPropertie = properties
                .getPlotProperties();
        String displayName = plotPropertie.getCurve().getName();
        if (hasWrite) {
            setAttributeDataView(chart, displayName, recoveredData.getName(),
                    true, hasWriteRead);
        }
        if (hasRead) {
            setAttributeDataView(chart, displayName, recoveredData.getName(),
    ...
    private void setAttributeDataView(ChartViewer chart, String displayName,
            String nameId, boolean hasWrite, boolean hasWriteRead) {
        ViewConfigurationAttributePlotProperties plotProperties = properties
                .getPlotProperties();
