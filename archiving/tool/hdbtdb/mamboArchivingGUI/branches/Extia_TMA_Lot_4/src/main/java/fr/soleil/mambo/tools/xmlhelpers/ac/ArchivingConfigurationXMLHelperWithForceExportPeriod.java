...
public class ArchivingConfigurationXMLHelperWithForceExportPeriod extends
		ArchivingConfigurationXMLHelperStandard implements
		IArchivingConfigurationXMLHelper {
	...
	protected long defineTdbExportPeriodForCurrentAttributeModes(
		...
		try {
			defaultExportValue = Long.parseLong(ACDefaultsManagerFactory
					.getCurrentImpl().getACDefaultsPropertyValue(
							"TDB_EXPORT_PERIOD"));
