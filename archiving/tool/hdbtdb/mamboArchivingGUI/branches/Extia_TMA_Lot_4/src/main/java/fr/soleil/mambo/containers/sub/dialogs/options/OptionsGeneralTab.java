...
public class OptionsGeneralTab extends JPanel {
	...
	private void initLayout() {
		...
		separatorCombo.setPreferredSize(new Dimension(100, separatorCombo
				.getPreferredSize().height));
		separatorCombo.setMaximumSize(new Dimension(100, separatorCombo
				.getPreferredSize().height));

		String msg1 = Messages
				.getMessage("DIALOGS_OPTIONS_GENERAL_TABLE_TITLE");
		...
		String msg2 = Messages
				.getMessage("DIALOGS_OPTIONS_GENERAL_BUFFER_TANGO_ATTRIBUTES_BORDER");
	...
	private void initComponents() {
		...
		String msg = Messages
				.getMessage("DIALOGS_OPTIONS_GENERAL_TABLE_SEPARATOR");
		...
		msg = Messages
				.getMessage("DIALOGS_OPTIONS_GENERAL_BUFFER_TANGO_ATTRIBUTES_YES");
		...
		msg = Messages
				.getMessage("DIALOGS_OPTIONS_GENERAL_BUFFER_TANGO_ATTRIBUTES_NO");
