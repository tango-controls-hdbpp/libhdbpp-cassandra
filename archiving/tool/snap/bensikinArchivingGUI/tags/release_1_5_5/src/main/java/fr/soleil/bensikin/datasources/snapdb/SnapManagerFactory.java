...
public class SnapManagerFactory {
	 ...
	 * <code>ISnapManager<code> described by <code>typeOfImpl<code>
	 * 
	 * @param typeOfImpl
	 *            The type of implementation of ISnapManager
	...
	public static ISnapManager getImpl(int typeOfImpl) {
		...
		case REAL_IMPL_TYPE:
			System.out.println("SnapManagerFactory/getImpl/user/" + user
					+ "/password/" + password);
