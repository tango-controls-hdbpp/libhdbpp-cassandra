...
public class BensikinTreeCellRenderer extends DefaultTreeCellRenderer {
	...
	private ImageIcon hostIcon = new ImageIcon(Bensikin.class
			.getResource("icons/host.gif"));
	private ImageIcon deviceIcon = new ImageIcon(Bensikin.class
			.getResource("icons/device.gif"));
	private ImageIcon bigDeviceIcon = new ImageIcon(Bensikin.class
			.getResource("icons/big_device.gif"));
