...
public class BensikinMainPanel extends JPanel {
	...
	private BensikinMainPanel() {
		...
		JSplitPane contextSplit = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,
				true);
		...
		contextSplit.setLeftComponent(new JScrollPane(ContextPanel
				.getInstance()));
		contextSplit.setRightComponent(new JScrollPane(SnapshotPanel
				.getInstance()));
