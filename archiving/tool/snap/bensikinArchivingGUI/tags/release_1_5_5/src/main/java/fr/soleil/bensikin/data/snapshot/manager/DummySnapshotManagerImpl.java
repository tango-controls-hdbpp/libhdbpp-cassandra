...
public class DummySnapshotManagerImpl implements ISnapshotManager {
	 ...
	 * (non-Javadoc)
	 * 
	 * @seebensikin.bensikin.data.snapshot.manager.ISnapshotManager#
	 ...
	 * 
	 * @see
	 * bensikin.bensikin.data.snapshot.manager.ISnapshotManager#getSaveLocation
	 * ()
	 */
	 ...
	 * 
	 * @see
	 * bensikin.bensikin.data.snapshot.manager.ISnapshotManager#setSaveLocation
	 * (java.lang.String)
	 */
