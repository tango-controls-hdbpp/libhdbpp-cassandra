// +======================================================================
// $Source:
// /cvsroot/tango-cs/tango/tools/bensikin/bensikin/containers/sub/dialogs/open/SearchContextsInDBDialog.java,v
// $
//
 ...
 * @author CLAISSE
 */
public class SearchContextsInDBDialog extends CancelableDialog {
    ...
    private SearchContextsInDBDialog() {
        super(BensikinFrame.getInstance(), Messages
                .getMessage("DIALOGS_SEARCH_CONTEXT_TITLE"), true);
    ...
    private void initLayout() {
        ...
        SpringUtilities.makeCompactGrid(myPanel, numCriterions, 9, // rows, cols
                6, 6, // initX, initY
                6, 6, // xPad, yPad
                true);
    }
    ...
    private void addComponents() {
        ...
        String msgSince = Messages
                .getMessage("DIALOGS_SEARCH_CONTEXT_LABELS_SINCE");
        String msgTime = Messages
                .getMessage("DIALOGS_SEARCH_CONTEXT_LABELS_TIME");
        String msgName = Messages
                .getMessage("DIALOGS_SEARCH_CONTEXT_LABELS_NAME");
        String msgAuthor = Messages
                .getMessage("DIALOGS_SEARCH_CONTEXT_LABELS_AUTHOR");
        String msgReason = Messages
                .getMessage("DIALOGS_SEARCH_CONTEXT_LABELS_REASON");
        String msgDescription = Messages
                .getMessage("DIALOGS_SEARCH_CONTEXT_LABELS_DESCRIPTION");

        String[] labels = { msgId, msgSince, msgTime, msgName, msgAuthor,
                msgReason, msgDescription };
