//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/components/context/detail/AttributesTree.java,v $
//
...
public class AttributesTree extends BensikinTree
{
	...
	public Vector getListOfAttributesTreePathUnderSelectedNodes(boolean remove)
	{
		        ...
		        //as many loops as there are selected nodes
		{
			...
			{
				DefaultMutableTreeNode currentTraversedNode = ( DefaultMutableTreeNode ) enumer.nextElement();
