...
public class Bensikin {
    ...
    private static void createAndShowGUI(String user, String password) {
        ...
        LoggerFactory.getCurrentImpl().trace(ILogger.LEVEL_DEBUG,
                Messages.getLogMessage("APPLICATION_STARTED_OK"));
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            if (userRights_s.compareToIgnoreCase(USER_PROFILE_VIEWER) == 0) userRights = USER_RIGHTS_RESTRICTED;
            else if (userRights_s.compareToIgnoreCase(USER_PROFILE_EXPERT) == 0) userRights = USER_RIGHTS_ALL;
            else {
                throw new Exception(
        ...
        setAccountManager(new AccountManager(pathToResources, "Bensikin", null,
                false));
