...
public class ValidateSetEquipmentwithCommandAction extends BensikinAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		String msgTitle = Messages
				.getMessage("DIALOGS_SET_EQUIPMENTS_CONFIRM_TITLE");
		...
		String msgValidate = Messages
				.getMessage("DIALOGS_SET_EQUIPMENTS_VALIDATE");
		...
		try {
			...
			if (confirm == JOptionPane.OK_OPTION) {
				...
				String Result = snapshotToUse.setEquipmentWithCommand(
						setEquipmentArgumentsDialog.getCommandName(),
						setEquipmentArgumentsDialog.getOption());
				String msg = Messages
						.getLogMessage("SET_EQUIPMENTS_Command_ACTION_OK");
				if (Result != null)
					msg += "\n" + Result;
				else {
					msg = Messages
							.getLogMessage("SET_EQUIPMENTS_COMMAND_ACTION_KO");
				}
