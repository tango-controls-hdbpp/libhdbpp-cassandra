...
public class SnapshotDetailTableModel extends SortedTableModel {
    ...
    private static Hashtable<Snapshot, SnapshotDetailTableModel> snapshotDetailTableModelHashtable = null;
    ...
    public static SnapshotDetailTableModel getInstance(Snapshot snapshot) {
        if (snapshotDetailTableModelHashtable == null) {
            snapshotDetailTableModelHashtable = new Hashtable<Snapshot, SnapshotDetailTableModel>();
        }
