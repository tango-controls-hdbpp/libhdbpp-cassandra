...
/**
 * Defines everything that has to with logging in Bensikin. Logs are divided in
 * two categories:
 * <UL>
 * <LI>Messages that are logged into the application diary for future debugging
 * and control
 * <LI>Confirmation and error messages displayed to the user upon the
 * realisation of an action
 * </UL>
 * All messages have a criticity level; the most critic messages have the lowest
 * criticity index. A message will be logged if and only if its criticity is
 * under the criticity threshold of the logger.
 * 
 * @author CLAISSE
 */
public interface ILogger {
	 ...
	 * 
	 * @param level
	 *            The new criticity threshold, under which a message will be
	 *            logged
	 */
	public void setTraceLevel(int level);

	/**
	 * Logs a message, if its criticity is under the current criticity
	 * threshold; otherwise does nothing.
	 * 
	 * @param level
	 *            The message's criticity
	 * @param o
