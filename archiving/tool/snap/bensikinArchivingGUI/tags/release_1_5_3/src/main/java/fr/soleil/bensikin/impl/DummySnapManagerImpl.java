...
public class DummySnapManagerImpl implements ISnapManager {
	 ...
	 * 
	 * @see
	 * fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#findContexts(fr
	 * .soleil.snapArchivingApi.SnapshotingTools.Tools.Criterions)
	 */
	public SnapContext[] findContexts(Criterions searchCriterions)
			throws SnapshotingException {
		SnapContext data1 = new SnapContext("CLA", "Context 1", 1,
				java.sql.Date.valueOf("2005-08-20"), "Reason 1",
				"Description 1");
		SnapContext data2 = new SnapContext("CLA", "Context 2", 2,
				java.sql.Date.valueOf("2004-07-13"), "Reason 2",
				"Description 2");
		SnapContext[] val = null;
		Condition[] idConditions = searchCriterions
				.getConditions(GlobalConst.TAB_CONTEXT[0]);
	 ...
	 */
	public SnapShotLight[] findSnapshots(Criterions searchCriterions)
			throws SnapshotingException {
		SnapShotLight data1 = new SnapShotLight(1, java.sql.Timestamp
				.valueOf("2005-08-20 16:24:44"), "Snapshot de référence");
		SnapShotLight data2 = new SnapShotLight(2, java.sql.Timestamp
				.valueOf("2005-07-19 15:11:33"),
				"Snapshot sur équipement en panne");

		Condition[] idConditions = searchCriterions
				.getConditions(GlobalConst.TAB_SNAP[0]);
		SnapShotLight[] val;
	 ...
	 * 
	 * @see
	 * manager.ISnapManager#findSnapshotAttributes(fr.soleil.snapArchivingApi
	 * .SnapshotingTools.Tools.SnapShotLight)
	 */
	public SnapAttributeExtract[] findSnapshotAttributes(SnapShotLight snapshot)
			throws SnapshotingException {

		String[] argin1 = { "tango/tangotest/1/attr1", "10",
				String.valueOf(TangoConst.Tango_DEV_DOUBLE),
				String.valueOf(SnapshotAttributeValue.SCALAR_DATA_FORMAT),
				String.valueOf(AttrWriteType._READ_WRITE) };
		String[] argin2 = { "tango/tangotest/1/attr2", "11",
				String.valueOf(TangoConst.Tango_DEV_DOUBLE),
				String.valueOf(SnapshotAttributeValue.SCALAR_DATA_FORMAT),
				String.valueOf(AttrWriteType._READ) };
		String[] argin3 = { "tango/tangotest/1/attr3", "12",
				String.valueOf(TangoConst.Tango_DEV_STRING),
				String.valueOf(SnapshotAttributeValue.SCALAR_DATA_FORMAT),
				String.valueOf(AttrWriteType._READ_WRITE) };
		...
		SnapAttributeExtract data1 = new SnapAttributeExtract(
				snapAttributeLight1);
		SnapAttributeExtract data2 = new SnapAttributeExtract(
				snapAttributeLight2);
		SnapAttributeExtract data3 = new SnapAttributeExtract(
				snapAttributeLight3);
		data1.setId_snap(1);
	 ...
	 * 
	 * @see
	 * manager.ISnapManager#saveContext(fr.soleil.snapArchivingApi.SnapshotingTools
	 * .Tools.SnapContext, java.util.Hashtable)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @seemanager.ISnapManager#launchSnapshot(fr.soleil.snapArchivingApi.
	 * SnapshotingTools.Tools.SnapContext)
	 */
	 ...
	 * 
	 * @see
	 * manager.ISnapManager#updateCommentOfSnapshot(fr.soleil.snapArchivingApi
	 * .SnapshotingTools.Tools.SnapShotLight, java.lang.String)
	 */
	public SnapShotLight updateCommentOfSnapshot(SnapShotLight snapshot,
	 ...
	 * 
	 * @see
	 * manager.ISnapManager#setEquipmentsWithSnapshot(fr.soleil.snapArchivingApi
	 ...
	 * 
	 * @see
	 * manager.ISnapManager#findContextAttributes(fr.soleil.snapArchivingApi
	 * .SnapshotingTools.Tools.SnapContext, java.lang.String)
	 */
	public SnapAttributeHeavy[] findContextAttributes(SnapContext context,
			Criterions searchCriterions) throws SnapshotingException {
