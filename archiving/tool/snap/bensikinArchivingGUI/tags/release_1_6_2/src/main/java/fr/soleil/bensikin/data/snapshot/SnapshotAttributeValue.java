                ...
                if (scalarValue != null) {
                    ...
                    if (scalarValue instanceof String) {
                        ret += StringFormater.formatStringToRead(new String(
                            ...
                            /*|| ("No format").equals(display_format)*/
                            || this.dataType == TangoConst.Tango_DEV_BOOLEAN
                            || !(scalarValue instanceof Number)) {
                        ret += scalarValue;
                    } else {
                        try {
                            formatedValue = Format.format(Locale.UK,
                                    display_format, (Number) scalarValue);
                ...
                if (value instanceof String) {
                    try {
                        ...
                        switch (dataType) {
                            ...
                            case TangoConst.Tango_DEV_FLOAT:
                                this.scalarValue = new Float(doubleValue
                                        .floatValue());
                                break;

                            case TangoConst.Tango_DEV_USHORT:
                            case TangoConst.Tango_DEV_SHORT:
                                this.scalarValue = new Short(doubleValue
                                        .shortValue());
                                break;
                            ...
                            case TangoConst.Tango_DEV_ULONG:
                            case TangoConst.Tango_DEV_LONG:
                                this.scalarValue = new Integer(doubleValue
                                        .intValue());
                                break;
                            ...
                            case TangoConst.Tango_DEV_SHORT:
                                ...
                                for (int i = 0; i < length; i++) {
                                    ...
                                    if ("".equals(token)
                                        ...
                                        shArray[i] = new Short(Double.valueOf(
                                                token).shortValue());
                                    }
                                    token = null;
                                }
                            ...
                            case TangoConst.Tango_DEV_LONG:
                                ...
                                for (int i = 0; i < length; i++) {
                                    ...
                                    if ("".equals(token)
                                        ...
                                        intArray[i] = new Integer(Double
                                                .valueOf(token).intValue());
                                    }
                                    token = null;
                                }
