...
/**
 * An object representation of an XML line.
 * The line can either be an opening line <tag>, a closing line </tag>, or an empty line <tag />.
 * The XML attributes can be set one by one, then a call to toString gives the String representation.
 *
 * @author CLAISSE
 */
public class XMLLine
{
	 ...
	 * By default the line is an empty line.
	 *
	 ...
	 *
	 * @param _name        The tag name
	 * @param _tagCategory The line category
	 * @throws IllegalArgumentException If _tagCategory is not in (EMPTY_TAG_CATEGORY, OPENING_TAG_CATEGORY, CLOSING_TAG_CATEGORY)
	 */
	public XMLLine(String _name , int _tagCategory) throws IllegalArgumentException
	{
		name = _name;
		attributes = new Hashtable();
		tagCategory = _tagCategory;

		if ( _tagCategory != EMPTY_TAG_CATEGORY && _tagCategory != OPENING_TAG_CATEGORY && _tagCategory != CLOSING_TAG_CATEGORY )
		{
	...
	/**
	 * Builds a XMLLine with this name, and pre-filled attributes.
	 * By default the line is an empty line.
	 *
	 * @param _name
	 * @param _attributes
