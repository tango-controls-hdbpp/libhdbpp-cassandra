...
/**
* Implements a Comparator on SnapshotAttribute objects, useful to sort the snapshot details list.
* The comparison can be on any one of the SnapshotAttribute fields, depending on the type specified on constructing the comparator.
* Empty or null values are considered lowest.
*
* @author CLAISSE
*/
public class SnapshotComparisonComparator extends BensikinComparator
{
	/**
    ...
    /**
     * The comparison will be on the second SnapshotAttribute's write value field
     */
    public static final int COMPARE_SECOND_WRITE_VALUE = 4;
    /**
     * The comparison will be on the difference SnapshotAttribute's write value field
     */
    ...
    /**
     * The comparison will be on the difference SnapshotAttribute's read value field
     */
    ...
    /**
     * The comparison will be on the second SnapshotAttribute's delta value field
     */
    public static final int COMPARE_SECOND_DELTA_VALUE = 10;
    /**
     * The comparison will be on the difference SnapshotAttribute's delta value field
     */
	 ...
	 * @throws IllegalArgumentException If _fieldToCompare isn't in (COMPARE_ID, COMPARE_TIME, COMPARE_COMMENT)
	 */
	...
	public int compare (Object arg0, Object arg1) {
        SnapshotComparison data1 = (SnapshotComparison) arg0;
        SnapshotComparison data2 = (SnapshotComparison) arg1;
        ...
        switch (fieldToCompare) {
            ...
            case COMPARE_FIRST_NAME:
                attr1 = data1.getSnapshotAttribute(SnapshotComparison.SNAPSHOT_TYPE_1);
                ret = compareNames(data1, data2, SnapshotComparison.SNAPSHOT_TYPE_1);
                break;
            case COMPARE_SECOND_NAME:
                attr1 = data1.getSnapshotAttribute(SnapshotComparison.SNAPSHOT_TYPE_2);
                ret = compareNames(data1, data2, SnapshotComparison.SNAPSHOT_TYPE_2);
                break;
            case COMPARE_DIFF_NAME:
                attr1 = data1.getSnapshotAttribute(SnapshotComparison.SNAPSHOT_TYPE_DIFF);
                ret = compareNames(data1, data2, SnapshotComparison.SNAPSHOT_TYPE_DIFF);
                break;
    ...
    protected int compareFormats(SnapshotComparison comp1, SnapshotComparison comp2, int comparedAttribute) {
    ...
    protected int compareNumberScalars(SnapshotComparison comp1, SnapshotComparison comp2, int comparedAttribute, int valueType) {
        SnapshotAttribute attr1 = comp1.getSnapshotAttribute(comparedAttribute);
        SnapshotAttribute attr2 = comp2.getSnapshotAttribute(comparedAttribute);
        Number value1 = null;
        Number value2 = null;
    ...
    protected int compareStringScalars(SnapshotComparison comp1, SnapshotComparison comp2, int comparedAttribute, int valueType) {
        SnapshotAttribute attr1 = comp1.getSnapshotAttribute(comparedAttribute);
        SnapshotAttribute attr2 = comp2.getSnapshotAttribute(comparedAttribute);
        String value1 = null;
        String value2 = null;
    ...
    protected int compareBooleanScalars(SnapshotComparison comp1, SnapshotComparison comp2, int comparedAttribute, int valueType) {
        SnapshotAttribute attr1 = comp1.getSnapshotAttribute(comparedAttribute);
        SnapshotAttribute attr2 = comp2.getSnapshotAttribute(comparedAttribute);
        Boolean value1 = null;
        Boolean value2 = null;
    ...
    protected int compareNames(SnapshotComparison comp1, SnapshotComparison comp2, int comparedAttribute) {
        SnapshotAttribute attr1 = comp1.getSnapshotAttribute(comparedAttribute);
        SnapshotAttribute attr2 = comp2.getSnapshotAttribute(comparedAttribute);
    ...
    protected int compareSpectrums(SnapshotComparison comp1, SnapshotComparison comp2, int comparedAttribute, int valueType) {
        SnapshotAttribute attr1 = comp1.getSnapshotAttribute(comparedAttribute);
        SnapshotAttribute attr2 = comp2.getSnapshotAttribute(comparedAttribute);
        Object[] value1 = null;
        Object[] value2 = null;
    ...
    protected int compareImages(SnapshotComparison comp1, SnapshotComparison comp2, int comparedAttribute, int valueType) {
        SnapshotAttribute attr1 = comp1.getSnapshotAttribute(comparedAttribute);
        SnapshotAttribute attr2 = comp2.getSnapshotAttribute(comparedAttribute);
        Object[][] value1 = null;
        Object[][] value2 = null;
