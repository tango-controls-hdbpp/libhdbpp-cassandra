...
/**
 * A factory used to instantiate ISnapshotManager of 2 types: DUMMY_IMPL_TYPE or XML_IMPL_TYPE
 *
 * @author CLAISSE
 */
public class SnapshotManagerFactory
{
	...
	/**
	 * Instantiates and returns an implementation the <code>ISnapshotManager<code> described by <code>typeOfImpl<code>
	 *
	 * @param typeOfImpl The type of implementation of ISnapshotManager
