//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/containers/sub/dialogs/open/AddFavoriteContextDialog.java,v $
//
 ...
 * @author CLAISSE
 */
public class AddFavoriteContextDialog extends JDialog
{
	...
	{
		super(BensikinFrame.getInstance() , Messages.getMessage("DIALOGS_ADD_FAVORITE_CONTEXT_TITLE") , true);
	...
	/*private class FavoritesWindowListener extends WindowAdapter
	{

	    private AddFavoriteContextDialog dialog;

	    public FavoritesWindowListener(AddFavoriteContextDialog dial)
	    {
	        super();
	        dialog = dial;
	    }
	    ...
	    {
	        System.out.println ( "CLA/windowClosed!!" );
	...
	/**
	 * @param model The new model to use for the favorites tree.
	 */
	...
	private void addComponents()
	{
		...
		String labelMsg = Messages.getMessage("DIALOGS_ADD_FAVORITE_CONTEXT_LABEL");
		...
		String newFavoritesDirectoryMsg = Messages.getMessage("DIALOGS_ADD_FAVORITE_CONTEXT_NEW_FILE");
		JButton newFavoritesDirectoryButton = new JButton ( new NewFavoritesDirectoryAction ( newFavoritesDirectoryMsg ) );
		
		String removeFavoritesItemMsg = Messages.getMessage("DIALOGS_ADD_FAVORITE_CONTEXT_REMOVE");
		JButton removeFavoritesItemButton = new JButton ( new RemoveFavoriteContextItemAction ( removeFavoritesItemMsg ) );
		...
		String cancelMsg = Messages.getMessage("DIALOGS_ADD_FAVORITE_CONTEXT_CANCEL");
	...
	/**
	 * Returns the selected path in the favorites tree, eg. where to add the new context.
	 *
	 * @return The selected path in the favorites tree, eg. where to add the new context
	 */
