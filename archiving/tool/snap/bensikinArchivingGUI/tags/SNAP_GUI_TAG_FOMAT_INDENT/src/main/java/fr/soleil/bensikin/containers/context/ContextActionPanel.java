...
public class ContextActionPanel extends JPanel {
	private ImageIcon registerIcon = new ImageIcon(Bensikin.class
			.getResource("icons/register.gif"));
	private ImageIcon launchIcon = new ImageIcon(Bensikin.class
			.getResource("icons/launch.gif"));
	...
	private ContextActionPanel() {
		...
		GUIUtilities.setObjectBackground(printContextButton,
				GUIUtilities.CONTEXT_CLIPBOARD_COLOR);
		...
		GUIUtilities.setObjectBackground(launchSnapshotButton,
		...
		GUIUtilities.setObjectBackground(registerContextButton,
				GUIUtilities.CONTEXT_COLOR);

		msg = Messages.getMessage("CONTEXT_DETAIL_SAVE_CONTEXT");
		SaveSelectedContextAction saveSnapshotAction = new SaveSelectedContextAction(
				msg, true);
		...
		GUIUtilities.setObjectBackground(saveSnapshotButton,
				GUIUtilities.CONTEXT_COLOR);
