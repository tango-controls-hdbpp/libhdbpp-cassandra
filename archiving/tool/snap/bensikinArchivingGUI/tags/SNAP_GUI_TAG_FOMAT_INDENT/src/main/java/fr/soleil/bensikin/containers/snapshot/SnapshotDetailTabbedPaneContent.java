...
public class SnapshotDetailTabbedPaneContent extends JPanel {
	...
	private ImageIcon modifiedIcon = new ImageIcon(Bensikin.class
			.getResource("icons/modified.gif"));
	private ImageIcon downIcon = new ImageIcon(Bensikin.class
			.getResource("icons/down.gif"));
	private ImageIcon editIcon = new ImageIcon(Bensikin.class
			.getResource("icons/edit.gif"));
	private ImageIcon setIcon = new ImageIcon(Bensikin.class
	...
	private ImageIcon closeTabIcon = new ImageIcon(Bensikin.class
			.getResource("icons/delete.gif"));
	private ImageIcon docIcon = new ImageIcon(Bensikin.class
	...
	private ImageIcon warningIcon = new ImageIcon(Bensikin.class
	...
	private ImageIcon printIcon = new ImageIcon(Bensikin.class
