...
public class History {
	 ...
	 * @throws Exception
	 */
	private Hashtable loadOpenedContextsFromHistory()
	 ...
	 * @throws Exception
	 */
	private Hashtable loadOpenedSnapshotsFromHistory(Context selectedContext)
			throws SnapshotingException, Exception {
	 ...
	 * @throws Exception
	 */
	private Hashtable loadSelectedSnapshotsFromHistory(Context selectedContext)
			throws SnapshotingException, Exception {
	...
	/**
	 * Displays onscreen the selected state of snapshots contained in this
	 * History.
	 */
