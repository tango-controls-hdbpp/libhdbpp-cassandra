...
public class MatchContextAttributesAction extends BensikinAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		String pattern = ContextAttributesPanel.getInstance().getRightTreeBox()
				.getRegExp();
		Context selectedContext = Context.getSelectedContext();
		if (selectedContext == null) {
			return;
	 ...
	 */
	static Criterions getAttributesSearchCriterions(String pattern)
		...
		cond = new Condition(GlobalConst.TAB_DEF[4], GlobalConst.OP_EQUALS,
				domain);
		ret.addCondition(cond);

		cond = new Condition(GlobalConst.TAB_DEF[5], GlobalConst.OP_EQUALS,
				family);
		ret.addCondition(cond);

		cond = new Condition(GlobalConst.TAB_DEF[6], GlobalConst.OP_EQUALS,
				member);
		ret.addCondition(cond);

		cond = new Condition(GlobalConst.TAB_DEF[7], GlobalConst.OP_EQUALS,
				attribute);
		ret.addCondition(cond);
