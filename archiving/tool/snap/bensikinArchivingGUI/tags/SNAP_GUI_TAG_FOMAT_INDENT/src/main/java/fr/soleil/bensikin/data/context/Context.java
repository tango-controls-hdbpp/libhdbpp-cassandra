...
public class Context {
	...
	public void loadAttributes(Criterions searchCriterions)
		...
		searchCriterions.addCondition(new Condition(GlobalConst.TAB_CONTEXT[0],
				GlobalConst.OP_EQUALS, "" + this.getContextData().getId()));
	 ...
	 * @throws Exception
	 */
	public static Context save(SnapContext context, Hashtable saveOptions)
			throws Exception {
		ISnapManager source = SnapManagerFactory.getCurrentImpl();
	...
	public static Context findContext(String id) throws Exception {
		...
		Condition idCondition = new Condition(GlobalConst.TAB_CONTEXT[0],
				GlobalConst.OP_EQUALS, id);
		...
		ContextData data = new ContextData(requestResult[0]);// there is only
		// one context with
		// a given id
