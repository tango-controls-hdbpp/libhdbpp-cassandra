...
public interface ISnapshotManager
{
     ...
     * @param saveParameters Additional parameters if needed
     * @throws Exception
     */
    public void saveSnapshot ( Snapshot snapshot , Hashtable saveParameters ) throws Exception;
    ...
    /**
     * Returns the file name of the current save location, without the path part nor the file extension.
     *
     * @return The current save location, without the path part nor the file extension.
     */
     ...
     * @param location the non default save location
     */
