...
/**
 * The attic class of the application, with various static methods that don't fit anywhere else
 *
 * @author CLAISSE
 */
public class GUIUtilities
{
    ...
    /**
     * Paint a container's background with the default color defined for contexts
     */
    public static final int CONTEXT_COLOR = 0;
    /**
     * Paint a container's background with the default color defined for snapshots
     */
    public static final int SNAPSHOT_COLOR = 1;
    /**
     * Paint a container's background with the default color defined for messages
     */
    public static final int MESSAGE_COLOR = 2;
    /**
     * Paint a container's background with the default color defined for the toolbar
     */
    public static final int TOOLBAR_COLOR = 3;
    /**
     * Paint a container's background with the default color defined for profiles
     */
    public static final int PROFILE_COLOR = 4;
    
    /**
     * Paint a container's background with the default color defined for snapshot clipboard buttons
     */
    public static final int SNAPSHOT_CLIPBOARD_COLOR = 5;
    
    /**
     * Paint a container's background with the default color defined for select buttons
     */
    public static final int SELECT_COLOR = 6;
    
    /**
     * Paint a container's background with the default color defined for context clipboard buttons
     */
     ...
     * @param hasNewLine True if a carriage return has to be inserted at the end of the line
     * @throws Exception
     */
    public static void write ( BufferedWriter bw , String s , boolean hasNewLine ) throws Exception
    {
     ...
     *
     * @param panelToDebug The panel to add the colored border to
     * @param debug        If false, the methods does nothing
     * @param borderColor  The desired border color
     * @param thickness    The desired border thickness
     */
    public static void addDebugBorderToPanel ( JPanel panelToDebug , boolean debug , Color borderColor , int thickness )
    {
        if ( debug )
        {
    ...
    /**
     * Divides a String content into smaller parts (about 100 lines), and puts those parts into a Vector.
     *
    ...
    /**
     * Replaces all occurences of <CODE>toReplace</CODE>
    ...
    /**
     * Returns the font used for title borders in the options dialog's snapshots tab.
     *
     * @return The font used for title borders in the options dialog's snapshots tab
     */
     ...
     * @param colorCase The color type; can be any of (CONTEXT_COLOR, SNAPSHOT_COLOR, MESSAGE_COLOR, TOOLBAR_COLOR)
     */
