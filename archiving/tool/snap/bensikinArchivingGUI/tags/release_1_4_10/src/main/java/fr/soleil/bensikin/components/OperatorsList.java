...
{
	/**
	 * The default ComboBox element displayed before any selection is made; common to all types of <code>OperatorsList<code>
	 */
	public static final String NO_SELECTION = "---";

	private String[] idOperators = {NO_SELECTION, GlobalConst.OP_EQUALS, GlobalConst.OP_LOWER_THAN_STRICT, GlobalConst.OP_GREATER_THAN_STRICT, GlobalConst.OP_LOWER_THAN, GlobalConst.OP_GREATER_THAN};
	private String[] afterTimeOperators = {NO_SELECTION, GlobalConst.OP_GREATER_THAN, GlobalConst.OP_GREATER_THAN_STRICT};
	private String[] beforeTimeOperators = {NO_SELECTION, GlobalConst.OP_LOWER_THAN, GlobalConst.OP_LOWER_THAN_STRICT};
	private String[] commentOperators = {NO_SELECTION, "Contains", "Starts with", "Ends with"};
	private String[] sinceOperators = {NO_SELECTION, "Today", "Yesterday", "Last week", "Last month"};
	private String[] logsOperators = {ILogger.DEBUG, ILogger.INFO, ILogger.WARNING, ILogger.ERROR, ILogger.CRITIC};
	 ...
	 *
	 * @param type The desired type of ComboBox
	 * @throws IllegalArgumentException If type isn't in (ID_TYPE, BEFORE_TIME_TYPE, AFTER_TIME_TYPE,
	...
	public OperatorsList(int type) throws IllegalArgumentException
	{
		...
		switch ( type )
		{
			...
			default :
				throw new IllegalArgumentException("Expected either of " + ID_TYPE + "," + BEFORE_TIME_TYPE + "," + AFTER_TIME_TYPE + "," + COMMENT_TYPE + " as a parameter. Received " + type + " instead.");
		}
