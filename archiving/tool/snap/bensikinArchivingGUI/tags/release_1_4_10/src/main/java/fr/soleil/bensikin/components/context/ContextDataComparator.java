//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/components/context/ContextDataComparator.java,v $
//
 ...
 * @author CLAISSE
 */
public class ContextDataComparator extends BensikinComparator
{
	/**
	 ...
	 */
	public ContextDataComparator(int _fieldToCompare) throws IllegalArgumentException
	{
	...
	{
		ContextData data1 = ( ContextData ) arg0;
		ContextData data2 = ( ContextData ) arg1;
