//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/containers/BensikinFrame.java,v $
//
...
/**
 * The top level container of the whole application, BensikinFrame is a singleton.
 *
 * @author CLAISSE
 */
public class BensikinFrame extends JFrame
{
	 ...
	 *
	 * @param lifeCycleManager The object in charge of startup and shutdown
	 * @return The instance
	 */
	 ...
	 * <LI> Tells the application to do nothing on window closing, instead delegating shutdown to <code>lifeCycleManager</code>
	 * <LI> Sets up the application's window opening/closing events treatment (see <code>initOpeningListener (lifeCycleManager)</code>)
	 * </UL>
	 *
	...
	private BensikinFrame(LifeCycleManager lifeCycleManager)
	{
		...
		String name = ProfileManagerFactory.getCurrentImpl().getSelectedProfileName();
		if ( name != null )
		{
			setTitle(title + " - " + name);
		}
