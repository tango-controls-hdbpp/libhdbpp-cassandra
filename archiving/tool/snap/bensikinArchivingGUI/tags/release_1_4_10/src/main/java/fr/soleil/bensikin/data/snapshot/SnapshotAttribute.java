...
/**
 * Represents an attribute attached to a snapshot.
 * A SnapshotAttribute belongs to a SnapshotAttributes group, and has 3 kinds of value:
 * <UL>
...
public class SnapshotAttribute
{
    ...
    /**
     * Builds a SnapshotAttribute with the data from the SnapAttributeExtract, keeping a reference to the SnapshotAttributes
     * group this attribute is rattached to.
     *
     * @param extract The object containing the attribute fields.
     * @param attrs   The SnapshotAttributes group this attribute belongs to.
     */
    public SnapshotAttribute ( SnapAttributeExtract extract , SnapshotAttributes attrs )
    {
    ...
    /**
     * Only initializes the reference to the SnapshotAttributes group this attribute belongs to.
     *
     * @param attrs
     */
    ...
    /**
     * Initializes the reference to the SnapshotAttributes group this attribute belongs to,
     * sets the name of the attribute and calculates its display format.
     *
     * @param name  the name of the attribute
     * @param attrs the reference to the SnapshotAttributes group
     */
    ...
    /**
     * Sets the display format, reading it from Tango.
     * Uses a Thread to avoid freezing
     */
     ...
     * First, value is cast to an Object []; the index is used to tell the method whether one wants the read value, or the write value.
     *
     * @param value The Object containing the read/write values
     * @param pos   The index to take the value at, once <code>value</code> has been cast to an Object []
    ...
    /**
     * Casts all elements of <code>valueIn</code> to a type depending of the attribute <code>data_type</code>, and returns the result.
     *
     * @param valueIn The raw Object[] value
    ...
    /**
     * @param attribute_complete_name The attribute_complete_name to set.
     */
    ...
    public String toUserFriendlyString() 
    {
        ...
        String separator = snapshotOptions.getSeparator ();
     ...
     * @return
     */
    public static SnapshotAttribute createDummyAttribute(SnapshotAttribute attribute) 
    {
