 ...
 * Based on code of MPanelPrinter developped by mep<br>
 * {@link http://www.javafr.com/codes/IMPRESSION-JPANEL-SANS-COUPURE-COMPOSANTS-BAS-PAGE_31743.aspx}
 * <br>
 * <b><u>Use example:</u></b> <i>( myComponent represents the component you
 * want to print )</i> <code>
...
public class ComponentPrinter implements Printable, Pageable {
    ...
    /**
     * Sets whether your Component should be scaled (and how) before printing.
     * <br>
...
//    }
    ...
    /**
     * Sets a title to your page. This title is used with bottom assessment :
     * <br>
    ...
    public int print (Graphics g, PageFormat pf, int pageIndex) throws PrinterException {
        ...
        if (pageIndex >= pageCount) {
        	...
        	Font newPrintFont = new Font(
        			g2d.getFont().getName(),
        			g2d.getFont().getStyle(),
        			(int)Math.rint( g2d.getFont().getSize()/ratio )
        	);
...
//                printJob.print();
    ...
    protected void calculatePages () {
        ...
        if (documentScaledWidth > pageWidth) {
            xCount = (int) Math.ceil(
                    documentScaledWidth / pageWidth
            );
        }
        else {
            xCount = 1;
        ...
        if (documentScaledHeight > pageHeight) {
            yCount = (int) Math.ceil(
                    documentScaledHeight / pageHeight
            );
        }
        else {
            yCount = 1;
