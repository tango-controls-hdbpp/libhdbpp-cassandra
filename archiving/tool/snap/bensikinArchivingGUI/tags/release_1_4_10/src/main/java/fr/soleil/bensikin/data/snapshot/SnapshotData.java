...
public class SnapshotData
{
     ...
     *
     * @param _id      The snapshot's id
     * @param _time    The snapshot's time
     * @param _comment The snapshot's comment
     */
     ...
     *
     * @return A SnapShotLight equivalent
     *         24 juin 2005
     */
    SnapShotLight getAsSnapShotLight ()
    {
        SnapShotLight ret = new SnapShotLight( this.getId() , this.getTime() , this.getComment() );
        return ret;
    }
