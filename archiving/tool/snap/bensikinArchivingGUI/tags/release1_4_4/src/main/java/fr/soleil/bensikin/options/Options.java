//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/options/Options.java,v $
//
...
/**
 * The model for the application's options, this class is a singleton.
 * Contains all the options that can be saved/loaded in the life cycle.
 *
 * @author CLAISSE
 */
public class Options
{
    ...
    /**
     * Default constructor
     * Display, print, logs , save, wordlist, and snapshot options are initialized.
     */
    private Options ()
    {
    ...
    /**
     * Delegates push to each option part:
     * Display, print, logs , save, wordlist, and snapshot options are pushed.
     *
     * @throws Exception
     */
    ...
    public String toString ()
    {
        ...
        XMLLine openingLine = new XMLLine( OPTIONS_TAG , XMLLine.OPENING_TAG_CATEGORY );
        ...
        XMLLine closingLine = new XMLLine( OPTIONS_TAG , XMLLine.CLOSING_TAG_CATEGORY );
    ...
    /**
     * @param _snapshotOptions The _snapshotOptions to set.
     */
    ...
    /**
     * @param logsOptions The logsOptions to set.
     */
    ...
    /**
     * @param printOptions The printOptions to set.
     */
    ...
    /**
     * @param wordlistOptions The wordlistOptions to set.
     */
    ...
    /**
     * @param contextOptions The contextOptions to set.
     */
