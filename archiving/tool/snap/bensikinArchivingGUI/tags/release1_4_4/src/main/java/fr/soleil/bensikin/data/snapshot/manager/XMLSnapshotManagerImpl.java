...
public class XMLSnapshotManagerImpl implements ISnapshotManager
{
    ...
    private static final String DEFAULT_FILE = "default.snap";*/
     ...
     */
    public void saveSnapshot ( Snapshot _snapshot , Hashtable saveParameters ) throws Exception
    {
    ...
    public String getFileName ()
    {
        ...
        StringTokenizer st = new StringTokenizer( _location , System.getProperty( "file.separator" ) );
        String fileName = "";
        ...
        if ( fileName.indexOf( "/" ) != -1 ) //on windows the file.separator properties is "\", but "/" is also used
        {
        ...
        fileName = GUIUtilities.replace( fileName , "." + SnapshotFileFilter.FILE_EXTENSION , "" );

        return fileName;
    }
    
    /* (non-Javadoc)
     * @see bensikin.bensikin.data.context.manager.IContextManager#getDefaultSaveLocation()
     */
    ...
    /* (non-Javadoc)
     * @see bensikin.bensikin.data.context.manager.IContextManager#getNonDefaultSaveLocation()
     */
    ...
    /* (non-Javadoc)
     * @see bensikin.bensikin.data.context.manager.IContextManager#setNonDefaultSaveLocation(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see bensikin.bensikin.data.context.manager.IContextManager#getSaveLocation()
     */
