//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/context/SelectFavoriteContextAction.java,v $
//
...
public class SelectFavoriteContextAction extends BensikinAction
{
	 ...
	 */
	public SelectFavoriteContextAction ( String id , String name )
	{
	...
	public void actionPerformed(ActionEvent arg0)
	{
		...
		{
		    String id = this.id;
			Context selectedContext = Context.findContext(id);
			Context.setSelectedContext(selectedContext);
			selectedContext.push();
            ContextActionPanel.getInstance().allowPrint(true);

			String msg = Messages.getLogMessage("LOAD_FAVORITE_CONTEXT_ACTION_OK");
			logger.trace(ILogger.LEVEL_DEBUG , msg);
		}
		catch ( Exception e )
		{
			String msg = Messages.getLogMessage("LOAD_FAVORITE_CONTEXT_ACTION_KO");
