...
/**
 * Represents a tab of SnapshotDetailTabbedPane. This contains a snapshot's
 * data, and actions on this snapshot ( adding to a comparison, editing the
 * comment, quick save, and setting equipments with this snapshot's values).
 * 
 * @author CLAISSE
 */
public class SnapshotDetailTabbedPaneContent extends JPanel {

    private ImageIcon                       modifiedIcon           = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/modified.gif"));
    private ImageIcon                       downIcon               = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/down.gif"));
    private ImageIcon                       editIcon               = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/edit.gif"));
    private ImageIcon                       setIcon                = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/set.gif"));
    private ImageIcon                       setEquipCmdIcon        = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/device.gif"));
    private ImageIcon                       quickSaveIcon          = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/quick_save.gif"));
    private ImageIcon                       closeTabIcon           = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/delete.gif"));
    private ImageIcon                       docIcon                = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/document.gif"));
    private ImageIcon                       docModifiedIcon        = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/document_modified.gif"));
    private ImageIcon                       warningIcon            = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/warning.gif"));
    private ImageIcon                       modifiedWarningIcon    = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/modified_warning.gif"));
    private ImageIcon                       docModifiedWarningIcon = new ImageIcon(
                                                                           Bensikin.class
                                                                                   .getResource("icons/document_modified_warning.gif"));
    private ImageIcon                       docWarningIcon         = new ImageIcon(
                                                                           Bensikin.class
    ...
    public SnapshotDetailTabbedPaneContent(Snapshot _snapshot) {
        ...
        GUIUtilities.setObjectBackground(secondButtonPanel,
                GUIUtilities.SNAPSHOT_COLOR);
        ...
        GUIUtilities.setObjectBackground(setEquipmentsButton,
                GUIUtilities.SNAPSHOT_COLOR);

        msg = Messages.getMessage("SNAPSHOT_DETAIL_SET_EQUIPMENT_WITH_COMMAND");
        setEquipmentWithCommandButton = new JButton(
                new SetEquipmentwithCommandAction(msg));
        ...
        GUIUtilities.setObjectBackground(setEquipmentWithCommandButton,
                GUIUtilities.SNAPSHOT_COLOR);
        ...
        GUIUtilities.setObjectBackground(editCommentButton,
                GUIUtilities.SNAPSHOT_COLOR);
        ...
        GUIUtilities.setObjectBackground(toTextButton,
                GUIUtilities.SNAPSHOT_CLIPBOARD_COLOR);
        ...
        GUIUtilities.setObjectBackground(toTextAndEditButton,
                GUIUtilities.SNAPSHOT_CLIPBOARD_COLOR);
        ...
        selectNoneButton = new JButton(new SelectAllOrNoneAction(msg,
                SelectAllOrNoneAction.SELECT_NONE_TYPE,
        ...
        GUIUtilities.setObjectBackground(selectNoneButton,
                GUIUtilities.SELECT_COLOR);

        msg = Messages.getMessage("SNAPSHOT_DETAIL_READ_TO_WRITE");
        transferRWButton = new JButton(new TransferRToWAction(msg,
                this.snapshotDetailTable));
        ...
        GUIUtilities.setObjectBackground(transferRWButton,
                GUIUtilities.SELECT_COLOR);

        msg = Messages.getMessage("SNAPSHOT_DETAIL_SELECT_ALL_BUTTON");
        selectAllButton = new JButton(
                new SelectAllOrNoneAction(msg,
                        SelectAllOrNoneAction.SELECT_ALL_TYPE,
                        this.snapshotDetailTable));
        ...
        quickSaveButton = new JButton(new SaveSelectedSnapshotAction(msg,
                snapshot, true));
        ...
        timeTitleLabel = new JLabel(Messages
        ...
        if (snapshot.getSnapshotData().getTime() == null) {
            ...
            if (timeText == null) {
                ...
                if ("".equals(timeText)) {
                    timeText = Messages
                            .getMessage("SNAPSHOT_DETAIL_NO_TIMESTAMP");
                }
            }
        }
        ...
        contextTitleLabel = new JLabel(Messages
                .getMessage("SNAPSHOT_DETAIL_CONTEXT_TITLE")
                + ":");
        String contextText;
        if ((_snapshot.getContext() == null)
                || (_snapshot.getContext().getContextData() == null)) {
            contextText = Messages.getMessage("SNAPSHOT_DETAIL_CONTEXT_KO");
        }
        else {
            contextText = Integer.toString(_snapshot.getContext()
                    .getContextData().getId());
        }
        contextLabel = new JLabel(contextText);
        contextText = null;

        attrCountTitleLabel = new JLabel(Messages
                .getMessage("SNAPSHOT_DETAIL_ATTRIBUTE_COUNT_TITLE")
                + ":");
        String attrCountText;
        int count = 0;
        if ((_snapshot.getSnapshotAttributes() != null)
                && (_snapshot.getSnapshotAttributes().getSnapshotAttributes() != null)) {
            count = _snapshot.getSnapshotAttributes().getSnapshotAttributes().length;
        }
        attrCountText = Integer.toString(count);
        attrCountLabel = new JLabel(attrCountText);
        attrCountText = null;
    ...
    /**
     * Sets the enabled state of the EditComment Action for this tab. If this
     * tab has been modified, the action is disabled regardless of the value of
     * disabled.
     * 
     * @param disabled
    ...
    /**
     * Sets the "modified" state of the tab. A modified tab has a star on the
     * left of its title.
     * 
     * @param _modified
     *            True if the tab's snapshot has been modified
     */
    public void setModified(boolean _modified) {
        this.isModified = _modified;
        this.snapshot.setModified(_modified);

        SnapshotDetailTabbedPane parent = (SnapshotDetailTabbedPane) this
                .getParent();
    ...
    /**
     * Sets the "may Filter" state of the tab. When "may filter" is true, this
     * means that user unchecked an attribute in snapshot, so that this
     * attribute won't be used to set equipment. If true, a "!" icon will appear
     * 
     * @param filter
     *            True if user clicked on a checkbox to uncheck an attribute
     */
