...
public class OptionsPrintTab extends JPanel {
    ...
    private final static ImageIcon portraitIcon     = new ImageIcon(
                                                            Bensikin.class
                                                                    .getResource("icons/portrait.gif"));
    private final static ImageIcon landscapeIcon    = new ImageIcon(
                                                            Bensikin.class
                                                                    .getResource("icons/landscape.gif"));

    private final static ImageIcon fitPageIcon      = new ImageIcon(
                                                            Bensikin.class
                                                                    .getResource("icons/fitPage.gif"));
    private final static ImageIcon fitWidthIcon     = new ImageIcon(
                                                            Bensikin.class
                                                                    .getResource("icons/fitWidth.gif"));
    private final static ImageIcon noFitIcon        = new ImageIcon(
                                                            Bensikin.class
