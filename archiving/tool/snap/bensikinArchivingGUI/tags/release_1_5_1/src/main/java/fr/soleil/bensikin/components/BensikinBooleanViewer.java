...
{
	private final static ImageIcon trueIcon = new ImageIcon(Bensikin.class.getResource("icons/true.gif"));
	private final static ImageIcon falseIcon = new ImageIcon(Bensikin.class.getResource("icons/false.gif"));
	private final static ImageIcon offIcon = new ImageIcon(Bensikin.class.getResource("icons/double_off.gif"));
	...
	{
		super( (value == null)? Messages.getMessage("SNAPSHOT_DETAIL_NO_DATA"):value.toString() );
		setIcon(falseIcon);
