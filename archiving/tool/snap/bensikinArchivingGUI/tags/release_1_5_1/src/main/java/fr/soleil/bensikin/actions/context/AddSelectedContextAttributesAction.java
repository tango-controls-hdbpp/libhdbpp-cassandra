//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/context/AddSelectedContextAttributesAction.java,v $
//
// Project:      Tango Archiving Service
//
// Description:  Java source code for the class  AddSelectedContextAttributesAction.
...
// attributes added to the tree are automatically added to the attributes select table
//
...
/**
 * Adds the selected attributes (or attributes that are under selected nodes) to the current context.
 * <UL>
 * <LI>Gets the list of attributes that are under one of the selected tree nodes; if that list is empty, do nothing.
...
public class AddSelectedContextAttributesAction extends BensikinAction
{
     ...
     */
    public AddSelectedContextAttributesAction ( String name )
    {
    ...
    {
        PossibleAttributesTree leftTree = PossibleAttributesTree.getInstance();
        ...
        if ( listToAdd.size() != 0 )
        {
            ...
            try
            {
                ...
                String msg = Messages.getLogMessage( "ADD_SELECTED_CONTEXT_ATTRIBUTES_ACTION_OK" );
                logger.trace( ILogger.LEVEL_DEBUG , msg );

            }
            catch ( Exception e )
            {
                String msg = Messages.getLogMessage( "ADD_SELECTED_CONTEXT_ATTRIBUTES_ACTION_KO" );
