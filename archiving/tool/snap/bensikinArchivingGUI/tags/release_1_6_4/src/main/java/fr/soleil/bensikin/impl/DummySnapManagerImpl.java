...
public class DummySnapManagerImpl implements ISnapManager {
    ...
    public SnapContext[] findContexts(Criterions searchCriterions) throws SnapshotingException {
        SnapContext data1 = new SnapContext("CLA", "Context 1", 1, java.sql.Date
                .valueOf("2005-08-20"), "Reason 1", "Description 1");
        SnapContext data2 = new SnapContext("CLA", "Context 2", 2, java.sql.Date
                .valueOf("2004-07-13"), "Reason 2", "Description 2");
    ...
    public SnapShotLight[] findSnapshots(Criterions searchCriterions) throws SnapshotingException {
        ...
        SnapShotLight data2 = new SnapShotLight(2, java.sql.Timestamp
                .valueOf("2005-07-19 15:11:33"), "Snapshot sur �quipement en panne");
    ...
    @Override
    public SnapContext saveContext(SnapContext context) throws SnapshotingException {
        context.setId(10);
    ...
    @Override
    public SnapShotLight updateCommentOfSnapshot(SnapShotLight snapshot, String comment)
            throws SnapshotingException {
        return null;
    }
    ...
    @Override
    public SnapAttributeExtract[] findSnapshotAttributes(SnapShotLight snapshot, int contextID)
            throws SnapshotingException {
        return null;
    }
