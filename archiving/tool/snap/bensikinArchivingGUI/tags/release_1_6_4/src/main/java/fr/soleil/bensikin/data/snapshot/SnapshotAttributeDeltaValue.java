	...
	private Object getScalarDeltaValue(SnapshotAttributeWriteValue writeValue,
		...
		case TangoConst.Tango_DEV_SHORT:
			try {
				...
				return new Short((short) (readDouble.shortValue() - writeDouble
						.shortValue()));
				...
				if ("null".equals(writeDouble_s) || writeDouble_s.equals("")
				...
				/*
				 * short readDouble = Short.parseShort( readDouble_s ); short
				 * writeDouble = Short.parseShort( writeDouble_s );
				 */
		...
		case TangoConst.Tango_DEV_LONG:
			try {
				...
				if ("null".equals(writeLong_s) || writeLong_s.equals("")
						|| "null".equals(readLong_s) || readLong_s.equals("")) {
					if (manageAllTypes) {
		...
		case TangoConst.Tango_DEV_FLOAT:
			try {
				...
				if ("null".equals(writeFloat_s) || writeFloat_s.equals("")
						|| "null".equals(readFloat_s) || readFloat_s.equals("")) {
					if (manageAllTypes) {
