...
public class SnapshotAttributeWriteValue extends SnapshotAttributeValue {
	 ...
	 * @param _value
	 *            The write value, not cast yet
	 */
	public SnapshotAttributeWriteValue(int _dataFormat, int _dataType,
			Object _value) {
	...
	public String toXMLString() {
		...
		XMLLine openingLine = new XMLLine(SnapshotAttributeWriteValue.XML_TAG,
				XMLLine.OPENING_TAG_CATEGORY);
		XMLLine closingLine = new XMLLine(SnapshotAttributeWriteValue.XML_TAG,
	...
	/**
	 * @return a boolean value that tells wheather this WriteValue can be used
	 *         to set equipment or not
	 */
