...
/**
 * Removes the selected attributes (or attributes that are under selected nodes) from the current
 * context.
 * <UL>
 * <LI>Gets the list of attributes that are under one of the selected tree nodes; if that list is
 * empty, do nothing.
 * <LI>Removes those attributes to the current ContextAttributesTreeModel instance.
 * </UL>
 * 
 * @author CLAISSE
 */
public class RemoveSelectedContextAttributesAction extends BensikinAction {
    ...
    private static final long serialVersionUID = 4859451119892855166L;
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        ContextAttributesTreeModel model = (ContextAttributesTreeModel) rightTree.getModel();
