...
public class Snapshot {
     ...
     * @param _snapshotData
     */
    public Snapshot(SnapshotData _snapshotData) {
    ...
    public void loadAttributes() throws SnapshotingException {
        ...
        if (contextId < 0) {
            contextId = ContextDataManager.getInstance()
                    .getContextIdBySnapshotId(snapshotData.getId());
        }
    ...
    public static Snapshot findSnapshotById(int id) throws SnapshotingException {
        ...
        Snapshot ret = new Snapshot(snapshotData);
        return ret;
    }
    ...
    private SnapContext getAsSnapContext() throws Exception {
        ...
        ContextDataManager contextDataManager = ContextDataManager
                .getInstance();
        ContextData contextData = contextDataManager.getContextData(contextId);
