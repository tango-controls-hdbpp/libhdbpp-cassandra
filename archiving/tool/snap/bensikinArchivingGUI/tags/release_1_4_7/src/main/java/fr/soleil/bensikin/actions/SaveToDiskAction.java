...
public class SaveToDiskAction extends BensikinAction
{
    ...
    /**
     * Sets the action's name and icon for display, plus its type (none, context, or snapshot).
     *
     * @param name  The action name
     * @param icon  The action icon
     * @param _type Must be either NO_PRESET_TYPE, CONTEXT_TYPE, or SNAPSHOT_TYPE
     */
    ...
    public void actionPerformed ( ActionEvent arg0 )
    {
        ...
        if ( this.type == NO_PRESET_TYPE )
        {
            ...
            String currentContextLabel = Messages.getMessage( "ACTION_SAVE_CURRENT_CONTEXT" );
            String currentSnapshotLabel = Messages.getMessage( "ACTION_SAVE_CURRENT_SNAPSHOT" );

            String[] possibleValues = {currentContextLabel, currentSnapshotLabel};
     ...
     * <LI> Opens a file chooser dialog specialised in snapshot saving, gets the path to save to from it.
     ...
     * <LI> Opens a file chooser dialog specialised in context saving, gets the path to save to from it.
