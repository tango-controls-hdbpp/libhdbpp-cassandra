//+======================================================================
//$Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/snapshot/PrintSnapshotComparisonAction.java,v $
//
...
//Author: XP
//Mantis bug ID: 5629
//Comment : In the actionPerfomed method, change the state of the titlesDisplayed data before and after printing.
//
...
public class PrintSnapshotComparisonAction extends BensikinAction
{
	...
	/**
	 * Standard action constructor that sets the action's name, plus initializes the reference to the <code>SnapshotCompareTable</code> component to print on <code>actionPerformed</code>
	 *
	...
	*/
	public void actionPerformed (ActionEvent arg0) {
		SnapshotCompareTablePrintModel.getInstance().setTitlesDisplayed(true);
        ...
        printer = null;
        options = null;
		SnapshotCompareTablePrintModel.getInstance().setTitlesDisplayed(false);
	}
