...
public class Context {
     ...
     * @throws Exception
     */
    public static SnapContext fillSnapContext(final String name, final String author,
	    final String reason, final String description, final ContextAttributesTreeModel model) {
     ...
     * @throws Exception
     */
    public static Context fillContext(final String id_s, final String creationDate_s,
	    final String name, final String author, final String reason, final String description,
	    final ContextAttributesTreeModel model) {
	Iterator<String> enumer = model.getTreeAttributes().iterator();

	final int id = id_s == null || id_s.equals("") ? -1 : Integer.parseInt(id_s);
	final Date creationDate = creationDate_s == null || creationDate_s.equals("") ? null : Date
		.valueOf(creationDate_s);

	final ContextData data = new ContextData(id, creationDate, name, author, reason,
		description);
     ...
     */
    private static boolean verifyData(final String name, final String author, final String reason,
	...
	final Context ret = Context.fillContext(id_s, creationDate_s, name, author, reason,
		description, model);
	...
	try {
	    ...
	    final ContextData newData = new ContextData(contextData.getId(), contextData
		    .getCreation_date(), contextData.getName(), contextData.getAuthor_name(),
		    contextData.getReason(), contextData.getDescription());
