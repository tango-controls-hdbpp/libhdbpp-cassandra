...
public class DefaultLifeCycleManager implements LifeCycleManager {
    ...
    public DefaultLifeCycleManager(final String _user, final String _password) {
	user = _user;
	password = _password;
    }
	...
	final LogsOptions logsOptions = options.getLogsOptions();
	logsOptions.push();
    }
	...
	SnapManagerFactory.setUser(user);
	SnapManagerFactory.setPassword(password);
	System.out
