...
/**
 * A model for the historic of opened/selected contexts.
...
public class ContextHistory
{
	...
	/**
	 * Build directly from a reference to the selected context, and references to the opened contexts.
	 *
	 * @param _selectedContextRef A reference to the selected context
	 * @param _openedContextRefs  Reference to the opened contexts
	 */
	public ContextHistory(SelectedContextRef _selectedContextRef , OpenedContextRef[] _openedContextRefs)
	{
	...
	/**
	 * Build indirectly from the selected context and the opened contexts.
