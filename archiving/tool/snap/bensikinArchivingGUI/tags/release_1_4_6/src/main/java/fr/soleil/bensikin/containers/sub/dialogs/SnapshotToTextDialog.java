...
* @author CLAISSE
*/
public class SnapshotToTextDialog extends JDialog
{
	 ...
	 private Snapshot snapshotToUse;

	 /**
	  * Builds the dialog.
	  */
	 public SnapshotToTextDialog (Snapshot _snapshotToUse) 
	 {
	     super( BensikinFrame.getInstance() , Messages.getMessage( "DIALOGS_SNAPSHOT_TO_TEXT" ) , true );
	     this.snapshotToUse = _snapshotToUse;

	     this.initComponents();
	     this.addComponents();

	     this.setSize( dim );
	     this.setLocation( SnapshotDetailTablePanel.getInstance().getLocationOnScreen() );
	 }
    ...
    /**
	 ...
	 private void initComponents ()
	 {
	     ...
	     String userFriendlyString = new SnapshotDetailPrintTable(snapshotToUse).toUserFriendlyString();
	     commentText.setText( userFriendlyString );
	     ...
	     validateButton = new JButton( new ValidateClipboardEditionAction(msg , this) );
