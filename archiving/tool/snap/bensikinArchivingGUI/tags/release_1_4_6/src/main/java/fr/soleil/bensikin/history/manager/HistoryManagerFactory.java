...
/**
 * A factory used to instantiate IHistoryManager of 2 types: DUMMY_IMPL_TYPE or XML_IMPL_TYPE
 *
 * @author CLAISSE
 */
public class HistoryManagerFactory
{
	...
	/**
	 * Instantiates and returns an implementation the <code>IHistoryManager<code> described by <code>typeOfImpl<code>
	 *
	 * @param typeOfImpl The type of implementation of IHistoryManager
