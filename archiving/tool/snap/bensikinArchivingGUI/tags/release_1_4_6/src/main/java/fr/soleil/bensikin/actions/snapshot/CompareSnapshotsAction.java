//+======================================================================
//$Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/snapshot/CompareSnapshotsAction.java,v $
//
 ...
 * <UL>
 * <LI>Gets the static references to both snapshots in Snapshot; if one is null, does nothing
    ...
    public void actionPerformed ( ActionEvent arg0 )
    {
        ...
        try
        {
            ...
            if ( sn2 == null )
            {
                ...
                System.out.println ( "-------------------CURRENT------------------" );*/
                String msg = Messages.getMessage( "SNAPSHOT_DETAIL_COMPARE_CURRENT_STATE_SN_NAME" );
                Snapshot.setSecondSnapshotOfComparisonTitle ( msg );
            }

            SnapshotCompareDialog snapshotCompareDialog = new SnapshotCompareDialog( sn1 , sn2 );
