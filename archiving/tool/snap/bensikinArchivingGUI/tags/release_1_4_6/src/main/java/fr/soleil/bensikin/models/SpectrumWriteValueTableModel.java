/*	Synchrotron Soleil 
 *  
 *   File          :  SpectrumWriteValueTableModel.java
 *  
 ...
 *   Date: 							State:  
 *  
 *   Log: SpectrumWriteValueTableModel.java,v 
 *
 */
...
public class SpectrumWriteValueTableModel extends AbstractTableModel {
                ...
                if (values != null && !"NaN".equals(values))
                {
                    switch (type)
                    {
                        case TangoConst.Tango_DEV_STRING:
                            ...
                            break;
                        case TangoConst.Tango_DEV_BOOLEAN:
                            ((Boolean[])values)[rowIndex] = new Boolean("true".equalsIgnoreCase(aValue.toString()));
                            break;
                        case TangoConst.Tango_DEV_UCHAR:
                        case TangoConst.Tango_DEV_CHAR:
                            ((Byte[])values)[rowIndex] = new Byte(Double.valueOf( aValue.toString() ).byteValue());
                            break;
                        case TangoConst.Tango_DEV_STATE:
                        case TangoConst.Tango_DEV_ULONG:
                        case TangoConst.Tango_DEV_LONG:
                            ((Integer[])values)[rowIndex] = new Integer(Double.valueOf( aValue.toString() ).intValue());
                            break;
                        case TangoConst.Tango_DEV_USHORT:
                        case TangoConst.Tango_DEV_SHORT:
                            ((Short[])values)[rowIndex] = new Short(Double.valueOf( aValue.toString() ).shortValue());
                            break;
                        case TangoConst.Tango_DEV_FLOAT:
                           ((Float[])values)[rowIndex] = Float.valueOf( aValue.toString() );
                           break;
                        case TangoConst.Tango_DEV_DOUBLE:
                            ((Double[])values)[rowIndex] = Double.valueOf( aValue.toString() );
                            break;
                    }
     ...
     * @param value
     *            the value
     * @return <code>true</code> if the value is valid and every element is
     *         set to this value, <code>false></code> otherwise
     */
