 ...
 * @author SOLEIL
 */
public class SpectrumDeltaValueDialog extends JDialog {
    ...
    public static SpectrumDeltaValueDialog getInstance(boolean forceReload, String name, SnapshotAttributeValue value)
    {
    ...
    private SpectrumDeltaValueDialog(String name, SnapshotAttributeValue value)
    {
        ...
        cancel = new JButton ( new CancelAction ( Messages.getMessage("DIALOGS_SPECTRUM_ATTRIBUTE_CANCEL" ) , this ) );
        ...
        SpringUtilities.makeCompactGrid( 
                cancelPanel,
                1, cancelPanel.getComponentCount(), //rows, cols
                0, 0, //initX, initY
                0, 0, //xPad, yPad
                true 
        );
        ...
        if (length > 0)
        {
            tableModel = new SpectrumDeltaValueTableModel(value.getDataType(),duplicata);
        ...
        SpringUtilities.makeCompactGrid( 
                myPanel,
                myPanel.getComponentCount(), 1, //rows, cols
                0, 0, //initX, initY
                0, 0, //xPad, yPad
                true );
