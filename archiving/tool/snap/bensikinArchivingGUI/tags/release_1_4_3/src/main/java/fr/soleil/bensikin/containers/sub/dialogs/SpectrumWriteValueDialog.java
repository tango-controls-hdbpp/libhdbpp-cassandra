...
public class SpectrumWriteValueDialog extends JDialog {
    ...
    private SpectrumWriteValueDialog(String name, SnapshotAttributeValue value)
    {
        ...
        if (val != null && !"NaN".equals(val) && !"[NaN]".equals(val))
        {
            switch(value.getDataType())
            {
                ...
                case TangoConst.Tango_DEV_STRING:
                    if (val != null && !"NaN".equals(val))
                    {
                        ...
                        {
                            ((String[])duplicata)[i] = new String(((String[])val)[i]);
                        }
                    }
                    break;
            ...
            tableModel = new SpectrumWriteValueTableModel(value.getDataType(),duplicata);
            ...
            else
            {
                ...
                table.setDefaultEditor(Object.class, new SnapSpectrumWriteTableEditor(table));
            }
            ...
            SpringUtilities.makeCompactGrid( 
                    setPanel,
                    1, setPanel.getComponentCount(), //rows, cols
                    0, 0, //initX, initY
                    0, 0, //xPad, yPad
                    true 
            );
