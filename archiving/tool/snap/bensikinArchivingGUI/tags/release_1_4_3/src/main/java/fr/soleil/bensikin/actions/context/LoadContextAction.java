//+======================================================================
//$Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/context/LoadContextAction.java,v $
//
...
/**
 * This action can be of 2 type: default (quick load from the default directory and file), or non-default (load from the user-defined directory and file, with prepositionning on the default directory).
 * Loads a context from a file
 * <UL>
 * <LI>if the load isn't a quick load,opens a file chooser dialog specialised in context loading,
 * gets the path to load from from it.
...
public class LoadContextAction extends BensikinAction
{
     ...
     * @param _isDefault True if the load action is a quick load from the working directory and default file, false otherwise
     */
    ...
    public void actionPerformed ( ActionEvent actionEvent )
    {
        ...
        if ( !this.isDefault )
        {
            ...
            String title = Messages.getMessage( "DIALOGS_FILE_CHOOSER_LOAD_CONTEXT_TITLE" );
