//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/context/MatchContextAttributesAction.java,v $
//
...
/**
 * Filters the current context attributes, keeping only those matching the pattern.
 * <UL>
...
public class MatchContextAttributesAction extends BensikinAction
{
     ...
     */
    private MatchContextAttributesAction ( String name )
    {
    ...
    public static MatchContextAttributesAction getInstance ( String name )
    {
        if ( instance == null )
        {
    ...
    {
        String pattern = ContextAttributesPanel.getInstance().getRightTreeBox().getRegExp();
        Context selectedContext = Context.getSelectedContext();
        if (selectedContext == null) {
            return;
        }
     ...
     *
     * @param pattern The user defined string pattern
     * @return The built Criterions object
     */
    static Criterions getAttributesSearchCriterions ( String pattern ) throws FieldFormatException
    {
        ...
        {
            //do nothing, not a problem (the user doesn't have to type up to attribute level)
        }
