                                                             ...
                                                             TableCellEditor
{
                                                   ...
                                                   int column )
    {
        ...
        return getScalarTableCellEditorComponent( table , value , isSelected ,
                                                      row , column );
    }
                                                          ...
                                                          int row , int column )
    {
        if ( value instanceof Boolean )
        {
            ...
            ( ( JCheckBox ) buffer ).addActionListener( new CheckBoxListener( ( ( JCheckBox ) buffer ) , correspondingTable , row , column ) );
        }
        else
        {
            if ( value instanceof SnapshotAttributeValue )
            {
                ...
                else
                {
                    ...
                    {
                        ( ( JTextField ) buffer ).setText( StringFormater.formatStringToRead( new String((String)val) ) );
                    }
                    else
                    {
