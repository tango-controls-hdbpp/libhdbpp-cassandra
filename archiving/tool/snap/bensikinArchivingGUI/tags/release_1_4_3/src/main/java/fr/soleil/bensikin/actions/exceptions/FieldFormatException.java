//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/exceptions/FieldFormatException.java,v $
//
...
// $Revision: 1.5 $
//
// $Log: FieldFormatException.java,v $
...
//
//-======================================================================
package fr.soleil.bensikin.actions.exceptions;

/**
 * An exception launched when the filtering parameters on contexts or snapshots are incorrect.
 *
 * @author CLAISSE
 */
public class FieldFormatException extends Exception
{
	...
	/**
	 * @param _code The Exception's code
	 */
