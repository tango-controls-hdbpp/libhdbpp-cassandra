...
public class LoggerFactory
{
	...
	/**
	 * Instantiates and returns an implementation the <code>ILogger<code> described by <code>typeOfImpl<code>
	 *
	 * @param typeOfImpl The type of implementation of ILogger
