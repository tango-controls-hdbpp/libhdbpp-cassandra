//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/listeners/SnapshotListTableListener.java,v $
//
...
/**
 * Listens to double clicks on the snapshots list table body. When a row is clicked, the selected snapshot
 * is added to the snapshots selection.
 * <UL>
...
public class SnapshotListTableListener extends MouseAdapter implements ActionListener
{
    ...
    private void selectSnapshot() {
        ...
        Snapshot selectedSnapshot = new Snapshot(selectedContext , selectedSnapshotData);
