//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/containers/snapshot/SnapshotDetailTabbedPaneContent.java,v $
//
...
// Author: XP
// Mantis bug ID: 6576
// Comment: In the SnapshotDetailTabbedPaneContent class, add a data timeLabel. timeLabel is defined in the SnapshotDetailTabbedPaneContent builder, to display the timestamp in the Snapshot details of Bensikin.
//
...
/**
 * Represents a tab of SnapshotDetailTabbedPane. This contains a snapshot's data, and actions on this snapshot
 * ( adding to a comparison, editing the comment, quick save, and setting equipments with this snapshot's values).
 *
 * @author CLAISSE
 */
public class SnapshotDetailTabbedPaneContent extends JPanel
{
    ...
    private ImageIcon setEquipCmdIcon = new ImageIcon( Bensikin.class.getResource( "icons/device.gif" ) );
    ...
    private ImageIcon docModifiedIcon = new ImageIcon( Bensikin.class.getResource( "icons/document_modified.gif" ) );
    private ImageIcon warningIcon = new ImageIcon( Bensikin.class.getResource( "icons/warning.gif" ) );
    private ImageIcon modifiedWarningIcon = new ImageIcon( Bensikin.class.getResource( "icons/modified_warning.gif" ) );
    private ImageIcon docModifiedWarningIcon = new ImageIcon( Bensikin.class.getResource( "icons/document_modified_warning.gif" ) );
    private ImageIcon docWarningIcon = new ImageIcon( Bensikin.class.getResource( "icons/document_warning.gif" ) );
    ...
    public SnapshotDetailTabbedPaneContent ( Snapshot _snapshot )
    {
        ...
        GUIUtilities.setObjectBackground( setEquipmentWithCommandButton , GUIUtilities.SNAPSHOT_COLOR );
        ...
        selectNoneButton = new JButton( new SelectAllOrNoneAction( msg , SelectAllOrNoneAction.SELECT_NONE_TYPE , this.snapshotDetailTable ) );
	    ...
	    selectAllButton = new JButton( new SelectAllOrNoneAction( msg , SelectAllOrNoneAction.SELECT_ALL_TYPE , this.snapshotDetailTable ) );
        ...
        String timeText = _snapshot.getSnapshotData().getTime().toString();
...
//        box.add( Box.createHorizontalStrut(10) );
    ...
    /**
     * Sets the enabled state of the EditComment Action for this tab. If this tab has been modified, the
     * action is disabled regardless of the value of disabled.
     *
    ...
    /**
     * Sets the "may Filter" state of the tab. When "may filter" is true,
     * this means that user unchecked an attribute in snapshot, so that this
     * attribute won't be used to set equipment.
     * If true, a "!" icon will appear
     *
