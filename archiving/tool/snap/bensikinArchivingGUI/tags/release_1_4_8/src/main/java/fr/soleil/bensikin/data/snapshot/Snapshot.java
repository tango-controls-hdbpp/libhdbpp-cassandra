//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/data/snapshot/Snapshot.java,v $
//
...
// Author: XP
// Mantis bug ID: 6695
// Comment: For the setEquipments method, change the Exception exception into a SnapshotingException exception, after the throws key-word.
//
...
// Bug corrected : when 1 attribute is modified, the other ones are not set modified
//
...
/**
 * A pivotal class of Bensikin, this class is the upper level modelisation of a snapshot.
 * <p/>
 * A Snapshot object has two main attributes:
 * - a SnapshotData attribute representing all non-attribute-dependant information
 * - a SnapshotAttributes attribute representing all attribute-dependant information
 * and a reference to the context of this snapshot.
 * <p/>
...
public class Snapshot
{
    ...
    private static Hashtable selectedSnapshots = new Hashtable();
    private static Hashtable openedSnapshots = new Hashtable();
    ...
    /**
     * Default constructor.
     * The snapshotData and snapshotAttributes attributes are null.
     */
    public Snapshot ()
    {
    ...
    /**
     * Looks up in database the referenced attributes for this snapshot.
     * Once the attributes are found ,they are converted to the SnasphotAttributes attribute.
     *
     * @throws Exception
     */
     ...
     * @throws Exception
     */
    public void updateComment ( String comment ) throws Exception
    {
    ...
    /**
     * Sets write values of equipments, using the values of this snapshot for each attribute.
     *
     * @throws Exception
     */
    ...
    /**
     * Sets equipment command input, using the values of this snapshot for each attribute.
     * @param option 
     * @param cmd_name 
     *
     * @throws Exception
     */
    public void setEquipmentWithCommand (String cmd_name, String option) throws SnapshotingException
    {
        ...
        source.setEquipmentsWithCommand( cmd_name, option, transformedSnap);
    }
    ...
    /**
     * Remove the snapshot with this id from the current list of opened snapshots.
     *
    ...
    /**
     * Remove the snapshot with this id from the current list of selected snapshots.
     *
     * @param id The id of the Snapshot to remove
     */
    ...
    {
        selectedSnapshots = new Hashtable();
    }

    /**
     * Empties all references to opened and selected snapshots,
     * and resets the snapshot displays, list and detail, accordingly.
     */
    public static void reset ( boolean hasToRemoveSelectedSnapshots, boolean resetContextFields )
    {
        SnapshotListTable table = SnapshotListTable.getInstance();
        table.setModel( SnapshotListTableModel.forceReset() );
        
        openedSnapshots = new Hashtable();
    ...
    /**
     * Looks up in database a particular Snapshot, defined by its id.
     * Loads only its ContextData.
     *
     * @param id The key of the snapshot
     * @return The snapshot with this id
     * @throws Exception
     */
    public static Snapshot findSnapshotById ( int id ) throws Exception
    {
    ...
    private SnapShot toSnapShot ()
    {
        ...
        {
            SnapshotAttributeWriteValue value = attributeList[ i ].getWriteValue();
            if ( value != null )
            {
                if ( value.isSettable() )
                {
        ...
        {
            SnapshotAttributeWriteValue value = attributeList[ i ].getWriteValue();
            //System.out.println("*****Name : " + attributeList[i].getAttribute_complete_name());
            if ( value != null )
            {
                /*if (value.getDataFormat() == AttrDataFormat._SPECTRUM){
                    System.out.println(attributeList[ i ].getAttribute_complete_name());
                    System.out.println("write value not null : " + value.getSpectrumValue().getClass());
                }*/
                if ( value.isSettable() )
                {
        ...
        ArrayList transformedAttrs = filteredSnapAttrs.toArrayList();
    ...
    public String toString ()
    {
        ...
        XMLLine openingLine = new XMLLine( Snapshot.XML_TAG , XMLLine.OPENING_TAG_CATEGORY );
        XMLLine closingLine = new XMLLine( Snapshot.XML_TAG , XMLLine.CLOSING_TAG_CATEGORY );
    ...
    /**
     * @param _firstSnapshotOfComparison The firstSnapshotOfComparison to set.
     */
    public static void setFirstSnapshotOfComparison ( Snapshot _firstSnapshotOfComparison )
    {
    ...
    /**
     * @param _secondSnapshotOfComparison The secondSnapshotOfComparison to set.
     */
    public static void setSecondSnapshotOfComparison ( Snapshot _secondSnapshotOfComparison )
    {
     ...
     *
     * @param snapshot The Snapshot to compare to
     * @return True if both snapshots have the same attributes (including a null list)
     */
    public boolean hasSameAttributesAs ( Snapshot snapshot )
    {
        SnapshotAttributes snapshotAttributes1 = this.getSnapshotAttributes();
        SnapshotAttributes snapshotAttributes2 = snapshot.getSnapshotAttributes();
     ...
     *
     * @param b True if the Snapshot has been modified
     */
    public void setModified ( boolean b )
    {
        ...
        snapshotAttributes1.setModified( b );*/
    }
    ...
    /**
     * @param firstSnapshotOfComparisonTitle The firstSnapshotOfComparisonTitle to set.
     */
    public static void setFirstSnapshotOfComparisonTitle ( String firstSnapshotOfComparisonTitle )
    {
     ...
     */
    public static void setSecondSnapshotOfComparisonTitle ( String secondSnapshotOfComparisonTitle )
    {
     ...
     */
    public static Hashtable getOpenedSnapshots ()
    {
        return openedSnapshots;
    }

    /**
     * @param openedSnapshots The openedSnapshots to set.
     */
    public static void setOpenedSnapshots ( Hashtable openedSnapshots )
    {
     ...
     */
    public static Hashtable getSelectedSnapshots ()
    {
        return selectedSnapshots;
    }

    /**
     * @param selectedSnapshots The selectedSnapshots to set.
     */
    public static void setSelectedSnapshots ( Hashtable selectedSnapshots )
    {
    ...
    /**
     * @param snapshotAttributes The snapshotAttributes to set.
     */
    ...
    /**
     * @param snapshotData The snapshotData to set.
     */
    ...
    /**
     * @param snapshotDefaultComment The snapshotDefaultComment to set.
     */
    ...
    private String getPathToUse ( ISnapshotManager manager , boolean saveAs )
    {
        ...
        //System.out.println ( "Snapshot/getPathToUse/pathToUse/"+pathToUse+"/saveAs/"+saveAs+"/" );
    ...
    /**
     * If the snapshot is a file snapshot, removes the "modified" mark (if there is one)
     */
     ...
     * @throws Exception
     */
    public static Snapshot getCurrentStateSnapshot(Snapshot sn1) throws Exception 
    {
        ISnapManager source = SnapManagerFactory.getCurrentImpl();
    ...
    private SnapContext getAsSnapContext() throws Exception 
    {
        ...
        {
            _context = new SnapContext( author , name , -1 , null , reason , description );
            _context.setCreation_date( new java.sql.Date( System.currentTimeMillis() ) );
            _context.setAttributeList( this.getAsAttributeList () );
            
            Hashtable saveOptions = null;
            Context ctx = Context.save( _context , saveOptions );
     ...
     * @return
     */
    private ArrayList getAsAttributeList() 
    {
        ArrayList attributeList = new ArrayList ();
        
        SnapshotAttribute [] attrs = this.getSnapshotAttributes().getSnapshotAttributes (); 
        if ( attrs == null )
        {
