...
/**
 * Listens to inserts in the SnapshotTableModel instance.
 * When a new SnapshotData row is inserted, notifies the static references of Snapshot.
 *
 * @author CLAISSE
 */
public class SnapshotTableModelListener implements TableModelListener
{
	...
	public void tableChanged(TableModelEvent event)
	{
		...
		SnapshotListTableModel model = ( SnapshotListTableModel ) event.getSource();
