...
/**
 * A class used to delegate the loading of a snapshot file into a Snapshot object
 *
 * @author CLAISSE
 */
public class SnapshotXMLHelper
{
     ...
     *
     * @param location The complete path to the snapshot file to load
     ...
     *
     * @param rootNode The XML root node
     ...
     *
     * @param snapshotAttributes   The group the attribute belongs to
     * @param currentAttributeNode An attribute node
    ...
    private static SnapshotAttribute loadCurrentAttribute ( SnapshotAttributes snapshotAttributes , Node currentAttributeNode ) throws Exception
    {
        ...
        if ( currentAttributeNode.hasChildNodes() )
        {
                    ...
                    // as many loops as there are attributes in the VC
            {
                ...
                String currentValueType = currentValueNode.getNodeName().trim();//has to be "ReadValue" or "WriteValue"
     ...
     *
     * @param _dataFormat      The attribute's data format (as precedently loaded)
     * @param _dataType        The attribute's data type (as precedently loaded)
     * @param currentValueNode A write value node
     ...
     * @param _dataFormat      The attribute's data format (as precedently loaded)
     * @param _dataType        The attribute's data type (as precedently loaded)
     * @param currentValueNode A read value node
     ...
     *
     * @param rootNode The root snapshot node
