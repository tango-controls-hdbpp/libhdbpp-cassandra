//+======================================================================
//$Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/snapshot/LoadSnapshotAction.java,v $
//
 ...
 * <UL>
 * <LI>if the load isn't a quick load,opens a file chooser dialog specialised in snapshot loading,
    ...
    */
    public void actionPerformed ( ActionEvent actionEvent )
    {
        ...
        if ( !this.isDefault )
        {
            ...
            String title = Messages.getMessage( "DIALOGS_FILE_CHOOSER_LOAD_SNAPSHOT_TITLE" );
