//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/containers/snapshot/SnapshotFilterPanel.java,v $
//
...
public class SnapshotFilterPanel extends JPanel
{
	...
	private ImageIcon filterIcon = new ImageIcon(Bensikin.class.getResource("icons/search.gif"));
	private ImageIcon resetIcon = new ImageIcon(Bensikin.class.getResource("icons/reload.gif"));
	 ...
	 */
	public OperatorsList selectComment;
	...
	private String msgId = Messages.getMessage("SNAPSHOT_LIST_LABELS_ID");
	private String msgTime = Messages.getMessage("SNAPSHOT_LIST_LABELS_TIME");
	private String msgComment = Messages.getMessage("SNAPSHOT_LIST_LABELS_COMMENT");
	private String[] labels = {msgId, msgTime, msgComment};
	...
	private void initComponents()
	{
		...
		GUIUtilities.setObjectBackground(filterButton , GUIUtilities.SNAPSHOT_COLOR);
		...
		GUIUtilities.setObjectBackground(resetButton , GUIUtilities.SNAPSHOT_COLOR);
		resetPanel = new JPanel();
		resetPanel.setLayout(new SpringLayout());
		resetPanel.add(resetButton);
		resetPanel.add(Box.createHorizontalGlue());
		GUIUtilities.setObjectBackground(resetPanel , GUIUtilities.SNAPSHOT_COLOR);
