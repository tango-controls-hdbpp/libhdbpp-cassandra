...
import fr.soleil.bensikin.session.manager.SessionManagerFactory;
...
public class Bensikin
{
    ...
    private static ImageIcon appliStart = new ImageIcon(Bensikin.class.getResource("icons/appli_start.jpg"));
     ...
     * @param user 
     */
    private static void createAndShowGUI (String user, String password)
    {
         //String title = "Bensikin v" + Messages.getMessage("ABOUT_RELEASE") + " (" + Messages.getMessage("ABOUT_RELEASE_DATE") + ")";
        ...
        JFrame frame = BensikinFrame.getInstance( lifeCycleManager );
//        frame.setUndecorated(false);
     ...
     * Launches Bensikin.
     *
     * @param args Must have 1 parameter, the working directory, which will be created if it doesn't exist
     */
    public static void main ( String[] args )
    {
        ...
        {
            System.out.println( "Incorrect arguments. Correct syntax: java Bensikin pathToResources userdb passdb userRights" );
            System.exit( 1 );
        }
        ...
        String userRights_s = args.length == 4 ? args[ 3 ] : USER_PROFILE_VIEWER;
        try
        {
    ...
    protected static void gettingStarted() {
        ...
        try {
            if (SessionManagerFactory.getImpl(SessionManagerFactory.XML_IMPL_TYPE).lockDirectory()) {
                ...
                new BensikinErrorDialog(ProfileSelectionDialog.getInstance(),
