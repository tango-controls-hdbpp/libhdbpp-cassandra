//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/containers/sub/dialogs/options/OptionsPrintTab.java,v $
//
...
public class OptionsPrintTab extends JPanel {
    ...
    private final static ImageIcon portraitIcon = new ImageIcon( Bensikin.class.getResource("icons/portrait.gif") );
    private final static ImageIcon landscapeIcon = new ImageIcon( Bensikin.class.getResource("icons/landscape.gif") );

    private final static ImageIcon fitPageIcon = new ImageIcon( Bensikin.class.getResource("icons/fitPage.gif") );
    private final static ImageIcon fitWidthIcon = new ImageIcon( Bensikin.class.getResource("icons/fitWidth.gif") );
    private final static ImageIcon noFitIcon = new ImageIcon( Bensikin.class.getResource("icons/noFit.gif") );
    ...
    private void initialize() {
        ...
        String msg = Messages.getMessage("DIALOGS_OPTIONS_PRINT_ORIENTATION_BORDER");
    ...
    private void initialisePortrait() {
        ...
        portraitButton = new JRadioButton(
                Messages.getMessage("DIALOGS_OPTIONS_PRINT_ORIENTATION_PORTRAIT")
        );
    ...
    private void initialiseLandscape() {
        ...
        landscapeButton = new JRadioButton(
                Messages.getMessage("DIALOGS_OPTIONS_PRINT_ORIENTATION_LANDSCAPE")
        );
    ...
    private void initialiseFitPage() {
        ...
        fitPageButton = new JRadioButton(
                Messages.getMessage("DIALOGS_OPTIONS_PRINT_FIT_PAGE")
        );
    ...
    private void initialiseFitWidth() {
        ...
        fitWidthButton = new JRadioButton(
                Messages.getMessage("DIALOGS_OPTIONS_PRINT_FIT_WIDTH")
        );
    ...
    private void initialiseNoFit() {
        ...
        noFitButton = new JRadioButton(
                Messages.getMessage("DIALOGS_OPTIONS_PRINT_FIT_NO")
        );
