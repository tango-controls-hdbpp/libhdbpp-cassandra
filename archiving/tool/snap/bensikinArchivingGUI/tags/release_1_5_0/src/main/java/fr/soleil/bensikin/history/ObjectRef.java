...
/**
 * A genereric object used to save/load to history.
 * The field used to reference the genereric object is its id.
 *
 * @author CLAISSE
 */
...
{
	/**
	 * The field used as reference to the favorite object. Coincides with the object's DB id.
	 */
	protected int id = -1;
	 ...
	 *
	 * @param tagName The XML tag to use
