...
public class XMLOptionsManager implements IOptionsManager
{
    ...
    /* (non-Javadoc)
     * @see bensikin.bensikin.options.manager.IOptionsManager#saveOptions(bensikin.bensikin.options.Options, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see bensikin.bensikin.options.manager.IOptionsManager#loadOptions(java.lang.String)
     */
     ...
     *
     * @param optionsResourceLocation The path of the XML file
     * @return A Hashtable which keys are each of the options books' XML_TAG and which values are those subclasses of ReadWriteOptionBook
     * @throws Exception
     */
    private Hashtable<String, Vector<Hashtable<String, String>>> loadOptionsIntoHash ( String optionsResourceLocation ) throws Exception
    {
     ...
     * @throws Exception
     */
    private Hashtable<String, Vector<Hashtable<String, String>>> loadOptionsIntoHashFromRoot ( Node rootNode )
    {
     ...
     *
     * @param currentBookNode The current book node, representing a particular option book's node (eg. a LogsOptions.XML_TAG="logs" node)
     * @return A Vector containing one Hashtable for each options book
     */
    private Vector<Hashtable<String, String>> loadOptionBook ( Node currentBookNode )
    {
        ...
        if ( currentBookNode.hasChildNodes() )
        {
                    ...
                    //as many loops as there are options in the current options sub-block
            {
                ...
                //String currentOptionChapterType = currentOptionChapterNode.getNodeName().trim();
