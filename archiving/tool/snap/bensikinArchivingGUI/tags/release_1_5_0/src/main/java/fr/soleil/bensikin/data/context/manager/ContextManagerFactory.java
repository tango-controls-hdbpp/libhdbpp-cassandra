...
/**
 * A factory used to instantiate IContextManager of 2 types: DUMMY_IMPL_TYPE or XML_IMPL_TYPE
 *
 * @author CLAISSE
 */
public class ContextManagerFactory
{
	...
	/**
	 * Instantiates and returns an implementation the <code>IContextManager<code> described by <code>typeOfImpl<code>
	 *
	 * @param typeOfImpl The type of implementation of IContextManager
	 ...
	 */
	public static IContextManager getImpl(int typeOfImpl) throws IllegalArgumentException
	{
		switch ( typeOfImpl )
		{
			...
			default:
				throw new IllegalArgumentException("Expected either DUMMY_IMPL_TYPE (1) or XML_IMPL_TYPE (2), got " + typeOfImpl + " instead.");
		}
