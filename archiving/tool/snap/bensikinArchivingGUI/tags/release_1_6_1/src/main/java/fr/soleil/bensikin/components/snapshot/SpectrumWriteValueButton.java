...
public class SpectrumWriteValueButton extends JLabel {
	...
	public SpectrumWriteValueButton(String name, SnapshotAttributeValue value,
	...
	public void actionPerformed() {
		SpectrumWriteValueDialog.getInstance(true, dialogTitle,
				spectrumAttribute).setVisible(true);
		if (!SpectrumWriteValueDialog.getInstance().isCanceled()) {
			spectrumAttribute.setSpectrumValue(SpectrumWriteValueDialog
