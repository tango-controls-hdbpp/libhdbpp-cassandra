//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/components/renderers/BensikinTableCellRenderer.java,v $
//
                                                     ...
                                                     boolean isSelected , boolean hasFocus , int row , int column )
    {
                ...
                )
        {
            ...
            if ( ((SnapshotAttributeValue)value).getDataType() == TangoConst.Tango_DEV_STATE )
            {
                try
                {
                    Integer valS = (Integer) ( ( SnapshotAttributeValue ) value ).getScalarValue();
            ...
            {
                String val = (String) ( ( SnapshotAttributeValue ) value ).getScalarValue();
                if (val != null)
                {
            ...
            {
                JLabel label = new JLabel( Messages.getMessage("SNAPSHOT_DETAIL_NO_DATA") );
