//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/context/NewContextAction.java,v $
//
...
public class NewContextAction extends BensikinAction
{
    ...
    public void actionPerformed ( ActionEvent arg0 )
    {
        ...
        ContextAttributesTreeModel model = ContextAttributesTreeModel.getInstance ( true );
        model.setTree( tree );
        tree.setModel( model );
