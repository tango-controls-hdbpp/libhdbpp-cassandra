//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/history/snapshot/SnapshotRef.java,v $
//
...
/**
 * The daughter class of ObjectRef for snapshot.
 * Generic for selected or opened snapshots.
 *
 * @author CLAISSE
 */
