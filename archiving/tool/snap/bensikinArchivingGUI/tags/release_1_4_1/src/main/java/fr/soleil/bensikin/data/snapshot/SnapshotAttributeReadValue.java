...
public class SnapshotAttributeReadValue extends SnapshotAttributeValue
{
     ...
     * @param _value      The read value, not cast yet
     */
    public SnapshotAttributeReadValue ( int _dataFormat , int _dataType , Object _value )
    {
    ...
    public String toXMLString ()
    {
        ...
        XMLLine openingLine = new XMLLine( SnapshotAttributeReadValue.XML_TAG , XMLLine.OPENING_TAG_CATEGORY );
        XMLLine closingLine = new XMLLine( SnapshotAttributeReadValue.XML_TAG , XMLLine.CLOSING_TAG_CATEGORY );
