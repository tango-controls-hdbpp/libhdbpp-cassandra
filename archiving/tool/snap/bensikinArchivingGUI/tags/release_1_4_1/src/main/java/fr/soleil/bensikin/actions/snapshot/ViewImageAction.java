...
public class ViewImageAction extends AbstractAction
{
    ...
    public ViewImageAction (String name, Object value, int data_type, String displayFormat)
    {
        super();
        this.putValue(Action.NAME , Messages.getMessage("DIALOGS_IMAGE_ATTRIBUTE_VIEW_IMAGE"));
        image = null;
