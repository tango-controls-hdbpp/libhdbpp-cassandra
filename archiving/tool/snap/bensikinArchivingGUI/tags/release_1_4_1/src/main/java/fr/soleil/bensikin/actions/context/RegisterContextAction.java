//+======================================================================
// $Source: /cvsroot/tango-cs/tango/tools/bensikin/bensikin/actions/context/RegisterContextAction.java,v $
//
...
public class RegisterContextAction extends BensikinAction
{
	...
	public void actionPerformed(ActionEvent arg0)
	{
		...
		try
		{
			SnapContext toSave = Context.fillSnapContext(name , author , reason , description , model);
			if ( toSave == null )
			{
				return;
				//this happens when the user didn't fill the context data or didn't choose attributes
			}
			Hashtable saveOptions = null;
			savedContext = Context.save(toSave , saveOptions);
