...
/**
 * This daughter of Exception is a "mute" Exception, that overrides printStackTrace with a do-nothing method.
 * Used when an Exeption is normal and expected but should be hidden from the end user.
 *
 * @author CLAISSE
 */
public class BensikinWarning extends Exception
{
	 ...
	 *
	 * @param arg0 The exception's message
	 */
