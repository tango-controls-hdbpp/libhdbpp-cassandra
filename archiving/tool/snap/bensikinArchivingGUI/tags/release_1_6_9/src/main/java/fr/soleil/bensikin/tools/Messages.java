...
public class Messages {
	...
	try {
	    myResources = ResourceBundle.getBundle(
		    "fr.soleil.bensikin.resources.messages.resources", currentLocale);
	    myLogResources = ResourceBundle.getBundle("fr.soleil.bensikin.resources.messages.logs",
		    currentLocale);
	    myAppProperties = ResourceBundle.getBundle("fr.soleil.bensikin.resources.application",
		    currentLocale);
