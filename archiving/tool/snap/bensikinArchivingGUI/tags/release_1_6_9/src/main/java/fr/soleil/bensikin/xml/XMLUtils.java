...
public class XMLUtils {
	 ...
	 * 
	 * @param file
	 *            The file we want to get the root of
	...
	/**
	 * Tests whether a Node has real child nodes, eg. child nodes that aren't
	 * fake according to isAFakeNode.
	 * 
	 * @param nodeToTest
	 *            The node to test
	...
	/**
	 * Saves a String content to a file using a BufferedWriter. Adds an XML file
	 * header.
	 * 
	 * @param string
	 *            The content to save
	...
	/**
	 * Returns the value of a XML node, ie. the value contained between the
	 * opening and the closing tag for this node
	 * 
	 * @param DOMnode
