...
public class XMLContextManagerImpl implements IContextManager
{
    ...
    private static final String DEFAULT_FILE = "default.ctx";*/
    ...
    /* (non-Javadoc)
     * @see bensikin.bensikin.data.context.manager.IContextManager#saveContext(bensikin.bensikin.data.context.Context, java.util.Hashtable)
     */
    public void saveContext ( Context _context , Hashtable saveParameters ) throws Exception
    {
        String _location = this.getSaveLocation();

        //System.out.println ( "XMLContextManagerImpl/saveContext/_location/"+_location+"/" );
