 ...
 * <LI> The application diary initialization (uses a daily diary like tomcat) and closing
 * <LI> The repartition of a message between the diary and the GUI messages display area
 * </UL>
 * but leaves the detail implementation of diary/GUI logging up to its daughters.
 *
 * @author CLAISSE
 */
public abstract class AbstractLogger implements ILogger
{
	...
	/**
	 * "Decorates" a GUI log message, that is adds informations/tags to it depending on its level.
	 *
	 ...
	 *
	 * @param level The criticity of the message to log
