...
/**
 * Overloads the setText method if JTextField so that it can intercept any
 * change in the content. Fires a PropertyChangeEvent when it happens (key
 * SelectedContextListener.ID_TEXT_PROPERTY)
 * 
 * @author CLAISSE
 */
