...
public class MatchPossibleContextAttributesAction extends BensikinAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		String pattern = ContextAttributesPanel.getInstance().getLeftTreeBox()
				.getRegExp();

		Criterions searchCriterions = null;
		try {
			searchCriterions = MatchContextAttributesAction
		...
		try {
			...
			PossibleAttributesTreeModel model = (PossibleAttributesTreeModel) tree
					.getModel();
