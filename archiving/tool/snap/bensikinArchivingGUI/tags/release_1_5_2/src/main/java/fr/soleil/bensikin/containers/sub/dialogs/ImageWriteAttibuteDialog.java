...
public class ImageWriteAttibuteDialog extends ImageAttibuteDialog {
	...
	protected void initOthers() {
		...
		GUIUtilities.setObjectBackground(setAllPanel,
				GUIUtilities.SNAPSHOT_COLOR);
		setAllField = new JTextField("0");
		setAllButton = new JButton(Messages
				.getMessage("DIALOGS_IMAGE_ATTRIBUTE_SETALL"));
	...
	protected void initLayout() {
		if (setAllPanel != null) {
			...
			SpringUtilities.makeCompactGrid(setAllPanel, 1, myPanel
