...
public class SetEquipmentsAction extends BensikinAction {
	 ...
	 *            The action name
	 */
	public SetEquipmentsAction(String _name) {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		String msgConfirm = Messages
				.getMessage("DIALOGS_SET_EQUIPMENTS_CONFIRM_LABEL");
		...
		try {
			...
			String msg = Messages.getLogMessage("SET_EQUIPMENTS_ACTION_OK");
			...
			String msg = Messages.getLogMessage("SET_EQUIPMENTS_ACTION_KO");
