 ...
 * Used twice in the application, once for Tango attributes
 * (PossibleAttributesTree) and once for the current context's attributes
 * (ContextAttributesTree)
 * 
 * @author CLAISSE
 */
public class TreeBox extends Box {
	 ...
	 * 
	 * @param tree
	 *            The attributes tree to display
	 * @param _regexpField
	 *            The attributes filtering pattern field
	 * @param searchButton
	 *            The button used to launch the attributes filtering
	 */
