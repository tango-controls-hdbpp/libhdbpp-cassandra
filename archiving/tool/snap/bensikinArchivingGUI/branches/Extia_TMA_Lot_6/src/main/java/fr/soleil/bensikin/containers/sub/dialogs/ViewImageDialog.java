...
public class ViewImageDialog extends JDialog {
    ...
    public ViewImageDialog(String name, Object value, String displayFormat,
            int data_type) {
    ...
    private void clean() {
        if (imageViewer != null) {
            imageViewer.removeKey(SpectrumDAOFactory.class.getName());
    ...
    private void prepareViewer() {
        ...
        imageViewer.getComponent().setCometeBackground(
                CometeColor.getColor(GUIUtilities.getSnapshotColor()));
    }
    ...
    public void updateContent() {
        ...
        imageViewer.addKey(SpectrumDAOFactory.class.getName(),
                new BensikinDAOKey(dao));
        imageViewer.switchDAOFactory(SpectrumDAOFactory.class.getName());
        myPanel.add((Component) imageViewer.getComponent());
    }
