...
/**
 * The display tab of OptionsDialog, used to set the look and feel of the
 * application.
 * 
 * @author CLAISSE
 */
public class OptionsDisplayTab extends JPanel {
	...
	/**
	 * @return The buttonGroup attribute, containing the JAVA and Windows
	 *         JRadioButtons
	 */
	...
	/**
	 * Selects a look and feel JRadioButton, depending on the plaf parameter
	 * value
	 * 
	 * @param plaf
	 *            Has to be either PLAF_WIN or PLAF_JAVA, otherwise a
