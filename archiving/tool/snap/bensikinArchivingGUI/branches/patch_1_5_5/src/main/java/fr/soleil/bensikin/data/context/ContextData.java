...
public class ContextData {
	 ...
	 * @param _description
	 */
	public ContextData(int _id, java.sql.Date _creation_date, String _name,
			String _author_name, String _reason, String _description) {
		this.id = _id;
	...
	public void push() {
		...
		String creation_date_s = this.getCreation_date() == null ? "" : this
