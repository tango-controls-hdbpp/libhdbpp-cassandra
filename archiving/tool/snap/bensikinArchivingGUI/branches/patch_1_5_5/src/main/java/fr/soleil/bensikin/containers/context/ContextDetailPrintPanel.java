...
public class ContextDetailPrintPanel extends JPanel {
	...
	private void initialise() {
		...
		pathTitleLabel.setText(Messages
				.getMessage("CONTEXT_DETAIL_LABELS_PATH"));
		pathLabel = new JLabel();

		timeTitleLabel = new JLabel();
		timeTitleLabel.setText(Messages
				.getMessage("CONTEXT_DETAIL_LABELS_TIME"));
		timeLabel = new JLabel();

		nameTitleLabel = new JLabel();
		nameTitleLabel.setText(Messages
				.getMessage("CONTEXT_DETAIL_LABELS_NAME"));
		nameLabel = new JLabel();

		authorTitleLabel = new JLabel();
		authorTitleLabel.setText(Messages
				.getMessage("CONTEXT_DETAIL_LABELS_AUTHOR"));
		authorLabel = new JLabel();

		reasonTitleLabel = new JLabel();
		reasonTitleLabel.setText(Messages
				.getMessage("CONTEXT_DETAIL_LABELS_REASON"));
		reasonLabel = new JLabel();

		descriptionTitleLabel = new JLabel();
		descriptionTitleLabel.setText(Messages
				.getMessage("CONTEXT_DETAIL_LABELS_DESRIPTION"));
		descriptionLabel = new JLabel();

		detailTitleLabel = new JLabel();
		detailTitleLabel.setText(Messages
				.getMessage("CONTEXT_DETAIL_LABELS_ATTRIBUTES"));

		boolean alternate = Options.getInstance().getContextOptions()
		...
		if (context != null && context.getContextData() != null) {
			...
			timeLabel.setText(context.getContextData().getCreation_date()
					.toString());
		...
		if (modeText) {
			...
			Enumeration<TreePath> expandedPaths = tree
