...
/**
 * This action can be of 2 type: default (quick load from the default directory and file), or
 * non-default (load from the user-defined directory and file, with prepositionning on the default
 * directory). Loads a context from a file
 * <UL>
...
public class LoadContextAction extends BensikinAction {
     ...
     * @param _isDefault True if the load action is a quick load from the working directory and
     *            default file, false otherwise
     */
