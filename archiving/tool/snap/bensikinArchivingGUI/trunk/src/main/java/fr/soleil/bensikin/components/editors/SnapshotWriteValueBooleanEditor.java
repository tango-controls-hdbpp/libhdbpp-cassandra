	...
	public Component getTableCellEditorComponent(JTable table, Object value,
		...
		if (value instanceof String) {
			if ("true".equalsIgnoreCase(value.toString().trim())
				...
				comp = new BensikinBooleanViewer(new Boolean("true"
						.equalsIgnoreCase(value.toString().trim())));
				((BensikinBooleanViewer) comp)
						.addActionListener(new BooleanListener(
								((BensikinBooleanViewer) comp), table, row,
								column));
...
class BooleanListener implements ActionListener {
	...
	public BooleanListener(BensikinBooleanViewer _checkbox, JTable table,
