			...
			if (isValidValue(aValue.toString())) {
				if (value != null) {
					...
					case TangoConst.Tango_DEV_CHAR:
						canSet = true;
						((Byte[][]) value)[rowIndex][columnIndex] = new Byte(
								Double.valueOf(aValue.toString()).byteValue());
						break;
					case TangoConst.Tango_DEV_STATE:
					case TangoConst.Tango_DEV_ULONG:
					case TangoConst.Tango_DEV_LONG:
						canSet = true;
						((Integer[][]) value)[rowIndex][columnIndex] = new Integer(
								Double.valueOf(aValue.toString()).intValue());
						break;
					case TangoConst.Tango_DEV_USHORT:
					case TangoConst.Tango_DEV_SHORT:
						canSet = true;
						((Short[][]) value)[rowIndex][columnIndex] = new Short(
								Double.valueOf(aValue.toString()).shortValue());
						break;
					case TangoConst.Tango_DEV_FLOAT:
						canSet = true;
						((Float[][]) value)[rowIndex][columnIndex] = Float
								.valueOf(aValue.toString());
						break;
					case TangoConst.Tango_DEV_DOUBLE:
						canSet = true;
						((Double[][]) value)[rowIndex][columnIndex] = Double
								.valueOf(aValue.toString());
						break;
					case TangoConst.Tango_DEV_STRING:
						canSet = true;
						((String[][]) value)[rowIndex][columnIndex] = aValue
								.toString();
						break;
					case TangoConst.Tango_DEV_BOOLEAN:
						canSet = true;
						((Boolean[][]) value)[rowIndex][columnIndex] = new Boolean(
								"true".equalsIgnoreCase(aValue.toString()));
						break;
					}
