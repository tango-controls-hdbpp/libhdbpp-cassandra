...
public class GetErrorArchiversLatestErrorClass extends Command implements
		TangoConst {
	// ===============================================================
	/**
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("GetErrorArchiversLatestErrorClass.execute(): arrived");
		return insert(((HdbArchivingWatcher) (device))
				.get_error_archivers_latest_error());
	}
