...
public class GetAttDataInfOrSupThanCountClass extends Command implements
		TangoConst {
	// ===============================================================
	/**
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("GetAttDataInfOrSupThanCountClass.execute(): arrived");
		String[] argin = extract_DevVarStringArray(in_any);
		return insert(((HdbExtractor) (device))
				.get_att_data_inf_or_sup_than_count(argin));
	}
