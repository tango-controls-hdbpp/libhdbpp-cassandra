...
public class BooleanSpectrum_RO extends TdbCollector implements
	 ...
	 *
	 */
	private static final long serialVersionUID = 1693497610765967485L;

	public BooleanSpectrum_RO(TdbModeHandler _modeHandler, String currentDsPath,
	 ...
	 public void removeSource(String attributeName)
			throws ArchivingException {
	...
	public void errorChange(ErrorEvent errorEvent) {
		...
		spectrumEvent_ro
				.setAttribute_complete_name(((IBooleanSpectrum) errorEvent
						.getSource()).getName());
