...
public abstract class BooleanScalar extends TdbCollector implements
		IBooleanScalarListener {
	/**
	 *
	 */
	private static final long serialVersionUID = -1894267866005715520L;
	/**
	...
	public BooleanScalar(TdbModeHandler modeHandler, String currentDsPath,
			String currentDbPath) {
		super(modeHandler, currentDsPath, currentDbPath);
	...
	public void processEventScalar(ScalarEvent scalarEvent, int try_number) {
		...
		try {
			...
			if (this.isFirstValue) {
				 ...
				 * super.m_logger.trace(ILogger.LEVEL_WARNING,
				 * "BooleanScalar/processEventScalar/scalarEvent.getReadValue() == null/for attribute/"
				 * +scalarEvent.getAttribute_complete_name()); } if (
				 * getLastValue(scalarEvent) == null ) {
				 * super.m_logger.trace(ILogger.LEVEL_WARNING,
				 * "BooleanScalar/processEventScalar/getLastValue(scalarEvent) == null/for attribute/"
