...
public abstract class StateScalar extends HdbCollector implements
		IDevStateScalarListener, ITangoArchiveListener {

	/**
	 *
	 */
	private static final long serialVersionUID = 815858541971398903L;
	...
	private void addSourceForEvents(AttributeLightMode attributeLightMode)
		...
		try {
			...
			if (attribute == null) {
				System.out
						.println("\033[1;31mStateScalar.java: the attribute \""
								+ attributeLightMode
			...
			System.out
					.println("\033[1;31mStateScalar.java: Failed to get the attribute from the AttributeFactory\033[0m");
