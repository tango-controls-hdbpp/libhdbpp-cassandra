...
public class HdbArchiver extends DeviceImpl implements TangoConst {
    ...
    private void launchStartArchivingTask(final ArchivingMessConfig archivingMessConfig,
	    final boolean forceThreadedMode, final boolean updateAMTTable) throws DevFailed {
	...
	final String[] propnames = { "DbHost", "DbName", "DbUser", "DbPassword", "RacConnection", "SafetyPeriod",
		"HasThreadedStartup", "IsDedicated", "ReservedAttributes", "DiaryPath", "HasDiary", "DiaryLogLevel",
		// --------------------------------------------------------------------------//
		// ELETTRA : Archiving Events
		// --------------------------------------------------------------------------//
	...
	try {
	    ...
	    logger.trace(ILogger.LEVEL_INFO, "retry_for_ko_attributes/calling retry_for_attributes");
