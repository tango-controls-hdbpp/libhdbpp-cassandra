...
/* WithShutdownRunnable */implements TangoConst {
	 ...
	 */
	// =========================================================
	HdbExtractor(final DeviceClass cl, final String s, final String version) throws DevFailed {
		super(cl, s);
		m_version = version;
		init_device();
	}
	 ...
	 */
	// =========================================================
	HdbExtractor(final DeviceClass cl, final String s, final String d, final String version) throws DevFailed {
		super(cl, s, d);
		m_version = version;
		init_device();
	}
	...
	public void get_device_property() throws DevFailed {
		...
		final HdbExtractorClass ds_class = (HdbExtractorClass) get_device_class();
		int i = -1;
	...
	public String[] get_att_name_filter_format(final short argin) throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = DbUtils.toStringArray(dbProxy.getDataBase().getAttribute().getNames().getAttributesNamesF(argin));
		} catch (final ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public String[] get_att_name_filter_type(final short argin) throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = DbUtils.toStringArray(dbProxy.getDataBase().getAttribute().getNames().getAttributesNamesT(argin));
		} catch (final ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public short get_att_count_filter_format(final short argin) throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = (short) dbProxy.getDataBase().getAttribute().getNames().getAttributesCountF(argin);
		} catch (final ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public short get_att_count_filter_type(final short argin) throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = (short) dbProxy.getDataBase().getAttribute().getNames().getAttributesCountT(argin);
		} catch (final ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public short get_families_by_domain_count(final String argin) throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = (short) dbProxy.getDataBase().getAttribute().getFamilies().get_familiesCount(argin);
		} catch (final ArchivingException e) {
			throw e.toTangoException();
		}
	 ...
	 */
	// =========================================================
	public short get_attributes_by_domain_family_members_count(final String[] argin) throws DevFailed {
		short argout = 0;
	...
	public DevVarLongStringArray get_att_data_last_n(final String[] argin) throws DevFailed {
		...
		if (argin.length != 2) {
			...
			try {
				// Get data from db.
				final DbData dbData = dbProxy.getDataBase().getExtractor().getDataGetters().getAttDataLast_n(argin);
				// Buid an attribute and gets its references
				argout = add_attribute(dbData);
			} catch (final ArchivingException e) {
				e.printStackTrace();
