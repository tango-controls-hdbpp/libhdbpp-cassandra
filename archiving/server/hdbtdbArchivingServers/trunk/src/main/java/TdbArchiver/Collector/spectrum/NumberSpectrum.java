...
public class NumberSpectrum extends TdbCollector implements ISpectrumListener {
    ...
    public NumberSpectrum(final TdbModeHandler modeHandler, final String currentDsPath,
	...
	spectrumEvent_ro.setAttribute_complete_name(((INumberSpectrum) errorEvent.getSource())
		.getName());
	...
	try {
		...
		final SpectrumEvent_RO spectrumEvent_ro = new SpectrumEvent_RO();
		spectrumEvent_ro.setAttribute_complete_name(((INumberSpectrum) event.getSource())
			.getName());
		...
		spectrumEvent_rw.setAttribute_complete_name(((INumberSpectrum) event.getSource())
			.getName());
