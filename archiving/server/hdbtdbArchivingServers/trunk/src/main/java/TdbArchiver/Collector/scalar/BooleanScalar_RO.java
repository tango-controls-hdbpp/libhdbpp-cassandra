...
public class BooleanScalar_RO extends BooleanScalar implements
		IBooleanScalarListener {

	/**
	 *
	 */
	private static final long serialVersionUID = 5716492661176162218L;

	public BooleanScalar_RO(TdbModeHandler _modeHandler, String currentDsPath,
