...
public class BooleanSpectrum_RW extends TdbCollector implements
		IBooleanSpectrumListener {
	/**
	 *
	 */
	private static final long serialVersionUID = -3791561269801119599L;

	public BooleanSpectrum_RW(TdbModeHandler _modeHandler,
			String currentDsPath, String currentDbPath) {
