...
public class GetAttDataInfThanBetweenDatesCountClass extends Command implements TangoConst
{
	 ...
	 */
	//===============================================================
	public GetAttDataInfThanBetweenDatesCountClass(String name , int in , int out)
	{
		super(name , in , out);
	}
	 ...
	 */
	//===============================================================
	public GetAttDataInfThanBetweenDatesCountClass(String name , int in , int out , String in_comments , String out_comments)
	{
	 ...
	 */
	//===============================================================
	public GetAttDataInfThanBetweenDatesCountClass(String name , int in , int out , String in_comments , String out_comments , DispLevel level)
	{
...
//-----------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/HdbExtractor/GetAttDataInfThanBetweenDatesCountClass.java,v $ */
