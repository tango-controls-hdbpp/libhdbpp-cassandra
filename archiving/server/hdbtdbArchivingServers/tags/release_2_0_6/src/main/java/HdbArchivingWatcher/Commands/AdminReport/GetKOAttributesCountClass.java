...
public class GetKOAttributesCountClass extends Command implements TangoConst
{
     ...
     */
    //===============================================================
    public GetKOAttributesCountClass(String name,int in,int out, String in_comments, String out_comments)
    {
     ...
     */
    //===============================================================
    public GetKOAttributesCountClass(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
    {
    ...
    public Any execute(DeviceImpl device,Any in_any) throws DevFailed
    {
        ...
        return insert(((HdbArchivingWatcher)(device)).get_ko_attributes_count());
    }
