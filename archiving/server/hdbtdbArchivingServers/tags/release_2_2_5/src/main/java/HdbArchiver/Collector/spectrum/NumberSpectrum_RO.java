...
public class NumberSpectrum_RO extends HdbCollector implements ISpectrumListener,
	...
	try {
	    ...
	    System.out
		    .println("\033[1;31mNumberSpectrum_RO.java: Failed to get the attribute from the AttributeFactory\033[0m");
	    print_exception(e);
	    final String message = GlobalConst.ARCHIVING_ERROR_PREFIX + " : " + "Failed adding '"
		    + attributeLightMode.getAttribute_complete_name() + "' as source";
	...
	System.out
		.print("\033[1;44mregistering\033[0m the \033[4mSPECTRUM\033[0m [RO] attribute \""
	...
	Util.out2.println("NumberSpectrum_RO.removeSource");
	System.out.print("\033[0;42mremoving\033[0m source for \033[4mspectrum\033[0m [RO]: "
		+ attributeName + "\"...\t");
	...
	try {
		...
		final Integer[] ushort = new Integer[dim];
		...
		final Integer[] lvalue = new Integer[dim];
	    ...
	    System.out.println(proxy.name() + ": " + attrib.getName()
		    + " {\033[4mspectrum\033[0m, RO} [\033[1;32mEVENT\033[0m]" + " (dim: "
		    + attrib.getDimX() + ")");
	    ...
	    print_exception("Spectrum_RO.java: archive() : " + GlobalConst.ARCHIVING_ERROR_PREFIX
		    + "\r\n\t" + "Problem while reading "
		    + spectrumEvent_ro.getAttribute_complete_name() + " values...", devFailed);
	...
	final int tryNumber = DEFAULT_TRY_NUMBER;
	Util.out3.println("NumberSpectrum_RO.errorChange : "
