...
{
	//private	int	state;
	private String m_version = GlobalConst.ARCHIVING_VERSION; 
 ...
 */
HdbArchivingWatcher(DeviceClass cl, String s) throws DevFailed
	{
		super(cl,s);
		init_device();
	}
 ...
 */
HdbArchivingWatcher(DeviceClass cl, String s, String d) throws DevFailed
	{
		super(cl,s,d);
		init_device();
	}
