...
public class HdbArchiverClass extends DeviceClass implements TangoConst
{
	...
	String dbName;
	/**
	 * true if the 'facility' information is appended to all device's (or attributes) name.
	 * false otherwise.<br>
...
//===================================================================
	...
	{
	    command_list.addElement(new GetErrorDomainsInternal("GetErrorDomainsInternal",
				Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY,
				"",
				"The list of all domains that have at least one attribute not correctly archiving",
				DispLevel.OPERATOR));
			
		command_list.addElement(new GetErrorsForDomainInternal("GetErrorsForDomainInternal",
			Tango_DEV_STRING, Tango_DEVVAR_STRINGARRAY,
			"The domain name",
			"The list of all KO attributes for this domain",
			DispLevel.OPERATOR));
		
		command_list.addElement(new GetErrorsForAttributeInternal("GetErrorsForAttributeInternal",
			Tango_DEV_STRING, Tango_DEVVAR_STRINGARRAY,
	    ...
	    command_list.addElement(new RetryForKOAttributes("RetryForKOAttributes" ,
	    ...
	    command_list.addElement(new RetryForAll("RetryForAll" ,
                Tango_DEV_VOID , Tango_DEV_SHORT ,
                "" ,
