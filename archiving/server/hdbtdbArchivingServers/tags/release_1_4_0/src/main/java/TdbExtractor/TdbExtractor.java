...
//=========================================================
     ...
     */
//=========================================================
    TdbExtractor(DeviceClass cl , String s) throws DevFailed
    {
        super(cl , s);
        init_device();
    }
//=========================================================
     ...
     */
//=========================================================
    TdbExtractor(DeviceClass cl , String s , String d) throws DevFailed
    {
        super(cl , s , d);
        init_device();
    }
...
//=========================================================
    public String[] get_current_archived_att() throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().getCurrentArchivedAtt(true);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public int get_att_data_count(String argin) throws DevFailed
    {
        ...
        try
        {
            this.dbProxy.getManager().ExportData2Tdb(argin);
...
//=========================================================
    public double get_att_data_avg_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ]);
    ...
    private DevVarLongStringArray add_attribute(DbData dbData) throws DevFailed, ArchivingException
    {
        ...
        switch ( dbData.getData_format() )
        {
            ...
            case AttrDataFormat._SPECTRUM:
                ...
                add_attribute(new SpectrumAttr(random_name_1 , dbData.getData_type() , dimX));
                if ( _2value )
                    add_attribute(new SpectrumAttr(random_name_2 , dbData.getData_type() , dimX));
                break;
