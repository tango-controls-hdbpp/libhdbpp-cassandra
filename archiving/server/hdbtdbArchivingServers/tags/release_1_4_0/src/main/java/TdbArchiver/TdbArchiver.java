...
public class TdbArchiver extends DeviceImpl/*WithShutdownRunnable*/ implements TangoConst, Warnable
{
    ...
    protected String m_version = GlobalConst.ARCHIVING_VERSION;
...
//=========================================================
     ...
     */
//=========================================================
    TdbArchiver(DeviceClass cl , String s) throws DevFailed
    {
        super(cl , s);
        init_device();
    }
//=========================================================
     ...
     */
//=========================================================
    TdbArchiver(DeviceClass cl , String s , String d) throws DevFailed
    {
        super(cl , s , d);
        init_device();
    }
