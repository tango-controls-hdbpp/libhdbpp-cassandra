...
//=========================================================
     ...
     */
//=========================================================
    HdbExtractor(DeviceClass cl , String s) throws DevFailed
    {
        super(cl , s);
        init_device();
    }
//=========================================================
     ...
     */
//=========================================================
    HdbExtractor(DeviceClass cl , String s , String d) throws DevFailed
    {
        super(cl , s , d);
        init_device();
    }
...
//=========================================================
    public String[] get_archiving_mode(String argin) throws DevFailed
    {
        ...
        try
        {
            argout = ( this.dbProxy.getDataBase().getCurrentArchivingMode(argin , true) ).toArray();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
