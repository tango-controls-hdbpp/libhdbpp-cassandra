...
public class HdbArchivingWatcher extends AbsArchivingWatcher {
	 ...
	 *            The device version
	 */
	HdbArchivingWatcher(DeviceClass cl, String s, String version)
			throws DevFailed {
		super(cl, s);
		m_version = version;
		init_device();
	 ...
	 *            The device version
	 */
	HdbArchivingWatcher(DeviceClass cl, String s, String d, String version)
			throws DevFailed {
		super(cl, s, d);
		m_version = version;
		init_device();
	...
	protected DbDatum getClassProperty(String name) {
		HdbArchivingWatcherClass ds_class = (HdbArchivingWatcherClass) super
				.get_device_class();
	 ...
	 */
	// =========================================================
	public synchronized boolean is_attribute_correctly_archived_current(
	 ...
	 */
	// =========================================================
	public synchronized boolean is_attribute_correctly_archived_latest_error(
			String argin) throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_LATEST_BAD_CYCLE);
	 ...
	 */
	// =========================================================
	public synchronized String[] get_error_archivers_latest_error()
			throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_LATEST_BAD_CYCLE);
	 ...
	 */
	// =========================================================
	public synchronized String[] get_errors_for_archiver_current(String argin)
			throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_ROLLOVER);
	 ...
	 */
	// =========================================================
	public synchronized String[] get_all_archiving_attributes()
			throws DevFailed {
		String[] ret = null;
		try {
			...
			this.logger.trace(ILogger.LEVEL_ERROR, df);
			this.logger.trace(ILogger.LEVEL_ERROR,
	 ...
	 */
	// =========================================================
	public synchronized String[] get_errors_for_archiver_latest_error(
			String argin) throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_LATEST_BAD_CYCLE);
	 ...
	 */
	// =========================================================
	public synchronized String[] get_error_domains_latest_error()
			throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_LATEST_BAD_CYCLE);
	 ...
	 */
	// =========================================================
	public synchronized String[] get_errors_for_domain_current(String argin)
			throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_ROLLOVER);
	 ...
	 */
	// =========================================================
	public synchronized String[] get_errors_for_domain_latest_error(String argin)
			throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_LATEST_BAD_CYCLE);
	 ...
	 */
	// =========================================================
	public synchronized String[] get_errors_for_attribute_current(String argin)
			throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_ROLLOVER);
	 ...
	 */
	// =========================================================
	public synchronized String[] get_errors_for_attribute_latest_error(
			String argin) throws DevFailed {
		IDelayManager delayManager = DelayManagerFactory.getCurrentImpl();
		ControlResult _controlResult = delayManager
				.getControlResult(IDelayManager.READ_LATEST_BAD_CYCLE);
	 ...
	 */
	public synchronized void start_archiving_report() throws DevFailed {
	 ...
	 */
	public synchronized String[] get_database_report() throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 */
	public synchronized int get_current_archiving_attributes_count()
			throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 */
	public synchronized int get_ko_attributes_count() throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 */
	public synchronized int get_ok_attributes_count() throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 */
	public synchronized String[] get_ko_attributes() throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 */
	public synchronized String[] get_partitions() throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 */
	public synchronized String[] get_job_status() throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 * @return Watcher list of oracle databse partitions
	 */
	public synchronized String[] get_job_errors() throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 * @return
	 */
	public synchronized int get_feedalive_progression_level() throws DevFailed {
		// TODO Auto-generated method stub
	 ...
	 * @return
	 */
	public synchronized String[] get_ko_attributes_count_by_device()
			throws DevFailed {
		// TODO Auto-generated method stub
	...
	public static void main(String[] argv) {
		try {
			Util tg = Util.init(argv, "HdbArchivingWatcher");
			tg.server_init();
