...
public class NumberSpectrum_RW extends TdbCollector implements ISpectrumListener
{
	...
	public void errorChange(ErrorEvent errorEvent)
	{
        ...
        Util.out3.println("NumberSpectrum_RW.errorChange : " + "Unable to read the attribute named " + errorEvent.getSource().toString());
		Double[] value = null;
		SpectrumEvent_RW spectrumEvent_rw = new SpectrumEvent_RW();
		spectrumEvent_rw.setAttribute_complete_name(( ( INumberSpectrum ) errorEvent.getSource() ).getName());
