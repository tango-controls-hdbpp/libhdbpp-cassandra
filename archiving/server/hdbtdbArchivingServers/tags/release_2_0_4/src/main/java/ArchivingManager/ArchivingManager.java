	...
	public void init_device() throws DevFailed
	{
        ...
        try
        {
            ...
            if(hdbHost==null || hdbName==null)
            	...
            	this.hdbManager.ArchivingConfigure(hdbHost, hdbName, hdbUser , hdbPassword, hdbRacConnection );
        }
        ...
        try
        {
        	...
        	if(tdbHost==null || tdbName==null)
        		...
        		this.tdbManager.ArchivingConfigure(tdbHost, tdbName, tdbUser , tdbPassword, tdbRacConnection);
        }
        catch ( ArchivingException e )
        {
            e.printStackTrace ();
		...
		if ( ( al = ( hdbManager.getArchiverListSize() == 0 && tdbManager.getArchiverListSize() == 0 ) ) ||
			     ( db = !( this.hdbManager.is_db_connected() ) && !( this.tdbManager.is_db_connected() ) ) )
		{
		...
		else if ( ( al = ( hdbManager.getArchiverListSize() == 0 || tdbManager.getArchiverListSize() == 0 ) ) ||
			     ( db = !( this.hdbManager.is_db_connected() ) || !( this.tdbManager.is_db_connected() ) ) )
		{
...
//=========================================================
	public void archiving_configure(String[] argin) throws DevFailed
	{
        ...
        /*try
        {
            ArchivingManagerApi.ArchivingConfigure(argin[ 0 ] , argin[ 1 ] , argin[ 2 ] , argin[ 3 ],  argin[ 4 ]);
        }
        catch ( ArchivingException e )
        {
            get_logger().warn(e.toString() , e);
...
//=========================================================
	        ...
	        (String[] argin) throws DevFailed
	{
		...
		try
		{
            this.hdbManager.ArchivingStopConf(archivingMessConfig.getAttributeList());
...
//=========================================================
	        ...
	        (String[] argin) throws DevFailed
	{
		...
		try
		{
            this.tdbManager.ArchivingStopConf(archivingMessConfig.getAttributeList());
