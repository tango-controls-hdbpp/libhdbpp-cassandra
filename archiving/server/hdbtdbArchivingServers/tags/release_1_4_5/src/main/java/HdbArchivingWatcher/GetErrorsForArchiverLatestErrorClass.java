...
public class GetErrorsForArchiverLatestErrorClass extends Command implements TangoConst
{
	...
	public Any execute(DeviceImpl device,Any in_any) throws DevFailed
	{
		...
		return insert(((HdbArchivingWatcher)(device)).get_errors_for_archiver_latest_error(argin));
	}
...
//-----------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/HdbArchivingWatcher/GetErrorsForArchiverLatestErrorClass.java,v $ */
