...
//=========================================================
    public int get_att_data_count(String argin) throws DevFailed
    {
        ...
        try
        {
            ((TDBDataBaseManager)this.dbProxy.getDataBase()).getTdbExport().ExportData2Tdb(argin, getTimeNow(), this.dbProxy.getDataBase().getMode(), this.dbProxy.getDataBase().getAttribute(), this.dbProxy.getDataBase().getDbUtil() );
...
//=========================================================
    public double get_att_data_avg_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
            	((TDBDataBaseManager)this.dbProxy.getDataBase()).getTdbExport().ExportData2Tdb(argin[ 0 ],  argin[ 2 ],
            			this.dbProxy.getDataBase().getMode(), this.dbProxy.getDataBase().getAttribute(), this.dbProxy.getDataBase().getDbUtil() );
    ...
    public DevVarLongStringArray get_att_data_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                ...
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getExtractor().getDataGettersBetweenDates().getAttDataBetweenDates(argin,SamplingType.getSamplingType ( SamplingType.ALL ));
    ...
    public DevVarLongStringArray get_att_data_inf_or_sup_than(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                ...
                ((TDBDataBaseManager)this.dbProxy.getManager()).getTdbExport().ExportData2Tdb(argin[ 0 ],  getTimeNow(),
            			this.dbProxy.getDataBase().getMode(), this.dbProxy.getDataBase().getAttribute(), this.dbProxy.getDataBase().getDbUtil() );
...
//=========================================================
    public int get_att_data_inf_or_sup_than_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                ((TDBDataBaseManager)this.dbProxy.getDataBase()).getTdbExport().ExportData2Tdb(argin[ 0 ],  getTimeNow(),
            			this.dbProxy.getDataBase().getMode(), this.dbProxy.getDataBase().getAttribute(), this.dbProxy.getDataBase().getDbUtil() );
    ...
    public DevVarLongStringArray get_att_data_inf_or_sup_than_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                ...
                ((TDBDataBaseManager)this.dbProxy.getDataBase()).getTdbExport().ExportData2Tdb(argin[ 0 ],  argin[4],
            			this.dbProxy.getDataBase().getMode(), this.dbProxy.getDataBase().getAttribute(), this.dbProxy.getDataBase().getDbUtil() );
    ...
    public int get_att_data_inf_or_sup_than_between_dates_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                ...
                ((TDBDataBaseManager)this.dbProxy.getDataBase()).getTdbExport().ExportData2Tdb(argin[ 0 ],  argin[5],
            			this.dbProxy.getDataBase().getMode(), this.dbProxy.getDataBase().getAttribute(), this.dbProxy.getDataBase().getDbUtil() );
    ...
    public DevVarLongStringArray get_att_data_inf_than_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                ...
                ((TDBDataBaseManager)this.dbProxy.getDataBase()).getTdbExport().ExportData2Tdb(argin[ 0 ],  argin[3],
            			this.dbProxy.getDataBase().getMode(), this.dbProxy.getDataBase().getAttribute(), this.dbProxy.getDataBase().getDbUtil() );
...
//=========================================================
    public double get_att_data_max(String argin) throws DevFailed
    {
        ...
        try
        {
            ((TDBDataBaseManager)this.dbProxy.getDataBase()).getTdbExport().ExportData2Tdb(argin,  getTimeNow(),
        			this.dbProxy.getDataBase().getMode(), this.dbProxy.getDataBase().getAttribute(), this.dbProxy.getDataBase().getDbUtil() );
...
//=========================================================
    ...
    public String get_max_time(String argin) throws DevFailed 
    {
        try
        {
            ...
            Timestamp last = db.getDbUtil().getTimeOfLastInsert(argin,true, db.getDbConn(), db.getAttribute());
            if ( last == null )
            {
    ...
    public String get_min_time(String argin) throws DevFailed 
    {
        ...
        {
            DataBaseManager db = this.dbProxy.getDataBase();
            Timestamp last = db.getDbUtil().getTimeOfLastInsert(argin,false, db.getDbConn(), db.getAttribute());
            if ( last == null )
            {
                return "NO VALUES RECORDED";
            }
