...
import TdbArchivingWatcher.TdbArchivingWatcherClass;
...
//	=========================================================
	...
	{
		HdbArchivingWatcherClass ds_class = (HdbArchivingWatcherClass) super.get_device_class();
...
//	=========================================================
	...
	private void startLoggingFactory()
	{
		...
		ILogger _logger = LoggerFactory.getImpl ( LoggerFactory.DEFAULT_TYPE , this.device_name , ArchivingWatch.getDiaryPath() , ArchivingWatch.isHasDiary());
