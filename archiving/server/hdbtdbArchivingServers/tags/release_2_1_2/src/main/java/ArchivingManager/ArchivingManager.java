...
/* WithShutdownRunnable */implements TangoConst {
    ...
    public void init_device() throws DevFailed {
        ...
        try {
            ...
            if (hdbName == null) this.hdbManager.ArchivingConfigure(hdbUser,
                    hdbPassword);
            else this.hdbManager.ArchivingConfigure(hdbHost, hdbName, hdbUser,
        ...
        try {
            ...
            if (tdbName == null) this.tdbManager.ArchivingConfigure(tdbUser,
                    tdbPassword);
            else this.tdbManager.ArchivingConfigure(tdbHost, tdbName, tdbUser,
    ...
    public void get_device_property() throws DevFailed {
        ...
        if (dev_prop[++i].is_empty() == false) hdbHost = dev_prop[i]
                .extractString();
        else {
        ...
        if (dev_prop[++i].is_empty() == false) hdbName = dev_prop[i]
                .extractString();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
        ...
        if (dev_prop[++i].is_empty() == false) tdbHost = dev_prop[i]
                .extractString();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
        ...
        if (dev_prop[++i].is_empty() == false) tdbName = dev_prop[i]
                .extractString();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
        ...
        if (dev_prop[++i].is_empty() == false) hdbUser = dev_prop[i]
                .extractString();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
        ...
        if (dev_prop[++i].is_empty() == false) hdbPassword = dev_prop[i]
                .extractString();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
        ...
        if (dev_prop[++i].is_empty() == false) tdbUser = dev_prop[i]
                .extractString();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
        ...
        if (dev_prop[++i].is_empty() == false) tdbPassword = dev_prop[i]
                .extractString();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
        ...
        if (dev_prop[++i].is_empty() == false) hdbRacConnection = dev_prop[i]
                .extractBoolean();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
        ...
        if (dev_prop[++i].is_empty() == false) tdbRacConnection = dev_prop[i]
                .extractBoolean();
        else {
            // Try to get value from class property
            DbDatum cl_prop = ds_class.get_class_property(dev_prop[i].name);
