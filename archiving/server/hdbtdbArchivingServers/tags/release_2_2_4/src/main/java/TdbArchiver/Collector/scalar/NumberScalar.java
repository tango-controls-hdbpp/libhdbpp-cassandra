...
public abstract class NumberScalar extends TdbCollector implements
		INumberScalarListener {
	/**
	 *
	 */
	private static final long serialVersionUID = -796042415278389755L;
	/**
	...
	public NumberScalar(TdbModeHandler _modeHandler, String currentDsPath,
	...
	public void processEventScalar(ScalarEvent scalarEvent, int try_number) {
		...
		try {
			...
			if (this.isFirstValue) {
				 ...
				 * super.m_logger.trace(ILogger.LEVEL_WARNING,
				 * "NumberScalar/processEventScalar/scalarEvent.getReadValue() == null/for attribute/"
				 * +scalarEvent.getAttribute_complete_name()); } if (
				 * getLastValue(scalarEvent) == null ) {
				 * super.m_logger.trace(ILogger.LEVEL_WARNING,
				 * "NumberScalar/processEventScalar/getLastValue(scalarEvent) == null/for attribute/"
			 ...
			 * scalarEvent.getReadValue() , getLastValue(scalarEvent)); if (
			 * valueCondition ) { ( ( FileTools )
