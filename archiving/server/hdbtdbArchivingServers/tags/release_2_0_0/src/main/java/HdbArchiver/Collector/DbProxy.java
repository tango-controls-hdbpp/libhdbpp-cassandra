...
public class DbProxy implements IDbProxy
{
    ...
    public DbProxy()
	{
		try
		{
            ...
            this.manager.ArchivingConfigure(HdbArchiver.HdbArchiver.myDbHost , HdbArchiver.HdbArchiver.myDbName, HdbArchiver.HdbArchiver.myDbUser , HdbArchiver.HdbArchiver.myDbPassword );
