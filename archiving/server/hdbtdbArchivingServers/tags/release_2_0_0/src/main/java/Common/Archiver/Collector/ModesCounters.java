...
/**
 * This class manages all the useful counters for the ModeHandler decision for one attribute
 * @author PIERREJOSEPH
 */
public class ModesCounters 
{
	...
	{
		return ("P=" + m_countModePeriodic + " A=" + m_countModeAbsolute + " R=" + m_countModeRelative
				+ " T=" + m_countModeThreshold + " C=" + m_countModeCalcul + " D=" + m_countModeDifference 
				+ "E=" + m_countModeExtern);
	}
}
