//+======================================================================
// $Source: /cvsroot/tango-cs/tango/jserver/archiving/HdbArchivingWatcher/GetReportLatestErrorClass.java,v $
//
...
// $Revision: 1.1 $
//
// $Log: GetReportLatestErrorClass.java,v $
...
public class GetReportLatestErrorClass extends Command implements TangoConst
{
	 ...
	 */
	//===============================================================
	public GetReportLatestErrorClass(String name,int in,int out, String in_comments, String out_comments)
	{
	 ...
	 */
	//===============================================================
	public GetReportLatestErrorClass(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
	{
	...
	public Any execute(DeviceImpl device,Any in_any) throws DevFailed
	{
		...
		return insert(((HdbArchivingWatcher)(device)).get_report_latest_error());
	}
...
//-----------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/HdbArchivingWatcher/GetReportLatestErrorClass.java,v $ */
