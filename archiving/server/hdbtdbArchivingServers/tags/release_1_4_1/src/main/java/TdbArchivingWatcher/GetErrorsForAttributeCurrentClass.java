//+======================================================================
// $Source: /cvsroot/tango-cs/tango/jserver/archiving/TdbArchivingWatcher/GetErrorsForAttributeCurrentClass.java,v $
//
...
// $Revision: 1.1 $
//
// $Log: GetErrorsForAttributeCurrentClass.java,v $
...
public class GetErrorsForAttributeCurrentClass extends Command implements TangoConst
{
	 ...
	 */
	//===============================================================
	public GetErrorsForAttributeCurrentClass(String name,int in,int out, String in_comments, String out_comments)
	{
	 ...
	 */
	//===============================================================
	public GetErrorsForAttributeCurrentClass(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
	{
	...
	public Any execute(DeviceImpl device,Any in_any) throws DevFailed
	{
		...
		return insert(((TdbArchivingWatcher)(device)).get_errors_for_attribute_current(argin));
	}
...
//-----------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/TdbArchivingWatcher/GetErrorsForAttributeCurrentClass.java,v $ */
