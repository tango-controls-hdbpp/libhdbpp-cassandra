//+======================================================================
// $Source: /cvsroot/tango-cs/tango/jserver/archiving/TdbArchivingWatcher/GetErrorDomainsCurrentClass.java,v $
//
...
// $Revision: 1.1 $
//
// $Log: GetErrorDomainsCurrentClass.java,v $
...
public class GetErrorDomainsCurrentClass extends Command implements TangoConst
{
	 ...
	 */
	//===============================================================
	public GetErrorDomainsCurrentClass(String name,int in,int out, String in_comments, String out_comments)
	{
	 ...
	 */
	//===============================================================
	public GetErrorDomainsCurrentClass(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
	{
	...
	public Any execute(DeviceImpl device,Any in_any) throws DevFailed
	{
		...
		return insert(((TdbArchivingWatcher)(device)).get_error_domains_current());
	}
...
//-----------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/TdbArchivingWatcher/GetErrorDomainsCurrentClass.java,v $ */
