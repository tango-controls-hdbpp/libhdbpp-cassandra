...
public class DbProxy
{
    ...
    public DbProxy()
	{
		try
		{
            ...
            this.manager.ArchivingConfigureWithoutArchiverListInit(HdbExtractor.HdbExtractor.myDbHost , HdbExtractor.HdbExtractor.myDbName, HdbExtractor.HdbExtractor.myDbUser , HdbExtractor.HdbExtractor.myDbPassword , true);
		}
	...
	{
		return this.manager.is_db_connected(true);
	}

	public DataBaseApi getDataBase()
	{
		return this.manager.getDataBase(true);
	}
}
