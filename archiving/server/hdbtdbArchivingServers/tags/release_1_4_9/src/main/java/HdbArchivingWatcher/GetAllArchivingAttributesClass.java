...
public class GetAllArchivingAttributesClass extends Command implements TangoConst
{
     ...
     */
    //===============================================================
    public GetAllArchivingAttributesClass(String name,int in,int out, String in_comments, String out_comments)
    {
     ...
     */
    //===============================================================
    public GetAllArchivingAttributesClass(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
    {
    ...
    public Any execute(DeviceImpl device,Any in_any) throws DevFailed
    {
        ...
        return insert(((HdbArchivingWatcher)(device)).get_all_archiving_attributes());
    }
...
//-----------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/HdbArchivingWatcher/GetAllArchivingAttributesClass.java,v $ */
