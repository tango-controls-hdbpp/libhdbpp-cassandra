...
public class GetListOfJobErrorsClass extends Command implements TangoConst {
	 ...
	 */
	// ===============================================================
	public GetListOfJobErrorsClass(String name, int in, int out, String in_comments, String out_comments) {
	 ...
	 */
	// ===============================================================
	public GetListOfJobErrorsClass(String name, int in, int out, String in_comments, String out_comments, DispLevel level) {
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		...
		return insert(((HdbArchivingWatcher) (device)).get_job_errors());
	}
