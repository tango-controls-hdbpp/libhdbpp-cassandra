...
public class TdbArchivingWatcherClass extends DeviceClass implements TangoConst {
	...
	public void command_factory() {
		command_list.addElement(new GetAllArchivingAttributesClass("GetAllArchivingAttributes", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "", "The list of all TDB archiving attributes",
				DispLevel.OPERATOR));
