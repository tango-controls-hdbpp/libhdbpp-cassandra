...
/* WithShutdownRunnable */implements TangoConst, Warnable {
     ...
     */
    // =========================================================
    public void trigger_archive_conf(String[] argin)
            throws DevFailed {
        set_state(DevState.RUNNING);
        set_status(device_name + " : " + "DevState.RUNNING");
    ...
    public void stop_archive_conf(String[] argin) throws DevFailed {
        ...
        Vector<AttributeLightMode> myConf = ArchivingManagerApiRef.stoppingVector(argin);
    ...
    // A priori la commande est déjà locké au niveau TangoDs.deviceImpl.command_inout
     ...
     */
    // =========================================================
    public boolean is_attribute_correctly_archived_internal(
    ...
    public void stop_archive_att(String[] argin) throws DevFailed {
        ...
        try {
            ...
            hdbCollector = collectorFactory.get(attributeLightMode,
                    this.logger, false, this.dbProxy);
