...
public class StringSpectrum_RO extends HdbCollector implements
	...
	private void addSourceForEvents(AttributeLightMode attributeLightMode)
		...
		try {
			...
			if (attribute == null) {
				System.out
						.println("\033[1;31mStringStringSpectrum_RO.java: the attribute \""
								+ attributeLightMode
	...
	public void stringSpectrumChange(StringSpectrumEvent event) {
		...
		SpectrumEvent_RO spectrumEvent_ro = new SpectrumEvent_RO();
		spectrumEvent_ro.setAttribute_complete_name(((IStringSpectrum) event
				.getSource()).getName());
		spectrumEvent_ro.setDim_x(((IStringSpectrum) event.getSource())
				.getXDimension());
