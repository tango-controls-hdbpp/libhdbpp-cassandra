    ...
    private DevVarLongStringArray add_attribute(DbData dbData)
        ...
        switch (dbData.getData_format()) {
            ...
            case AttrDataFormat._SPECTRUM:
                ...
                if (_2value)
                    add_attribute(new SpectrumAttr(random_name_2, data_type,
                            dimX));
                break;
        ...
        if (_2value) get_logger().info("attr " + random_name_2 + " created");
        ...
        if (_2value) tg_2.get_dserver_device().add_obj_polling(poll_2, false);
