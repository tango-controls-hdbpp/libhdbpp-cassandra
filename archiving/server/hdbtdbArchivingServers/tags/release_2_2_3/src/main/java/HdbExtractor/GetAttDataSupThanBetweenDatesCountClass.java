...
public class GetAttDataSupThanBetweenDatesCountClass extends Command implements
		TangoConst {
	// ===============================================================
	/**
	 ...
	 */
	// ===============================================================
	public GetAttDataSupThanBetweenDatesCountClass(String name, int in,
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("GetAttDataSupThanBetweenDatesCountClass.execute(): arrived");
		String[] argin = extract_DevVarStringArray(in_any);
		return insert(((HdbExtractor) (device))
				.get_att_data_sup_than_between_dates_count(argin));
	}
