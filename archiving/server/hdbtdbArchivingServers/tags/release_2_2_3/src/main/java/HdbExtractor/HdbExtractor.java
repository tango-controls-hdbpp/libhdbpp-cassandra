...
public class HdbExtractor extends DeviceImpl
/* WithShutdownRunnable */implements TangoConst {
     ...
     */
    // =========================================================
    HdbExtractor(DeviceClass cl, String s, String d, String version)
            throws DevFailed {
        super(cl, s, d);
        m_version = version;
        init_device();
    ...
    public void init_device() throws DevFailed {
        ...
        /*
         * MultiAttribute multiAttrs = new MultiAttribute ( this.device_name ,
         * this.device_class ); dynamicAttributesHelper = new
         * DynamicAttributesHelper ( this , multiAttrs );
         */
     ...
     */
    // =========================================================
    public String get_att_full_name(short argin) throws DevFailed {
        String argout = "";
        ...
        // ---Add your Own code to control device here ---
        try {
            argout = this.dbProxy.getDataBase().getAttribute().getNames()
                    .getAttFullName(argin);
        }
        catch (ArchivingException e) {
            throw e.toTangoException();
        }
    ...
    public String[] get_archiving_mode(String argin) throws DevFailed {
        String[] argout = null; //= new String[5];
...
//                    .getCurrentArchivingMode(argin)).toArray();
        	Mode mode = this.dbProxy.getDataBase().getMode().getCurrentArchivingMode(argin);
        	if(mode != null) {
        		argout = mode.toArray();
        	}

        	if (argout == null || argout.length == 0) {
        		throw new ArchivingException("Invalid attribute: " + argin,
                  "Invalid attribute: " + argin, ErrSeverity.WARN,
                  "No database connection or \"" + argin
    ...
    public DevVarLongStringArray get_att_data_between_dates(String[] argin)
        ...
        if (argin.length != 3) {
            ...
            try {
                ...
                get_logger()
                        .info(
                                "OutOfMemoryError in get_att_scalar_data_beetween_dates");
    ...
    public DevVarLongStringArray get_att_data_inf_or_sup_than(String[] argin)
        ...
        if (argin.length != 3) {
            ...
            try {
                ...
                get_logger().info(
                        "OutOfMemoryError get_att_scalar_data_inf_or_sup_than");
                Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
                        "HdbExtractor.get_att_scalar_data_inf_or_sup_than");
            }
        }
    ...
    public DevVarLongStringArray get_att_data_inf_or_sup_than_between_dates(
        ...
        if (argin.length != 5) {
            ...
            try {
                ...
                get_logger()
                        .info(
                                "OutOfMemoryError get_att_data_inf_or_sup_than_between_dates");
                Except
                        .throw_exception("MEMORY_ERROR", HintOnMemoryError,
                                "HdbExtractor.get_att_data_inf_or_sup_than_between_dates");
            }
        }
        get_logger().info(
    ...
    public DevVarLongStringArray get_att_data_inf_than(String[] argin)
        ...
        if (argin.length != 2) {
            ...
            try {
                ...
                get_logger().info(
                        "OutOfMemoryError get_att_scalar_data_inf_than");
                Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
                        "HdbExtractor.get_att_scalar_data_inf_than");
            }
        }
    ...
    public DevVarLongStringArray get_att_data_inf_than_between_dates(
        ...
        if (argin.length != 4) {
            ...
            try {
                ...
                get_logger().info(
                        "OutOfMemoryError get_att_data_inf_than_between_dates");
                Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
                        "HdbExtractor.get_att_data_inf_than_between_dates");
            }
        }
    ...
    public DevVarLongStringArray get_att_data_last_n(String[] argin)
        ...
        if (argin.length != 2) {
            ...
            try {
                ...
                Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
                        "HdbExtractor.get_att_data_last_n");
            }
            catch (Throwable t) {
                t.printStackTrace();
                if (t instanceof DevFailed) {
    ...
    public DevVarLongStringArray get_att_data_sup_than(String[] argin)
        ...
        if (argin.length != 2) {
            ...
            try {
                ...
                Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
                        "HdbExtractor.get_att_data_sup_than");
            }
        }
    ...
    public DevVarLongStringArray get_att_data_sup_and_inf_than(String[] argin)
        ...
        if (argin.length != 3) {
            ...
            try {
                ...
                get_logger().info(
                        "OutOfMemoryError get_att_data_sup_and_inf_than");
                Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
                        "HdbExtractor.get_att_data_sup_and_inf_than");
            }
        }
    ...
    public DevVarLongStringArray get_att_data_sup_and_inf_than_between_dates(
        ...
        if (argin.length != 5) {
            ...
            try {
                ...
                get_logger()
                        .info(
                                "OutOfMemoryError get_att_data_sup_and_inf_than_between_dates");
                Except
                        .throw_exception("MEMORY_ERROR", HintOnMemoryError,
                                "HdbExtractor.get_att_data_sup_and_inf_than_between_dates");
            }
        }
        get_logger().info(
    ...
    public DevVarLongStringArray get_att_data_sup_than_between_dates(
        ...
        if (argin.length != 4) {
            ...
            try {
                ...
                get_logger().info(
                        "OutOfMemoryError get_att_data_sup_than_between_dates");
                Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
                        "HdbExtractor.get_att_data_sup_than_between_dates");
            }
        }
...
//                String desc = "add_attribute/The DbData argument is empty.";
            ...
            if (_2value) {
                ...
                random_name_2 = this
                        .getName(dbData.getName(), id, !firstIsRead);
            }
            id++;
            ...
            switch (dbData.getData_format()) {
                case AttrDataFormat._SCALAR:
                    ...
                    add_attribute(new Attr(random_name_1, data_type,
                            AttrWriteType.READ));
                ...
                case AttrDataFormat._SPECTRUM:
                    ...
                    add_attribute(new SpectrumAttr(random_name_1, data_type,
                            dimX));
                    if (_2value)
                        add_attribute(new SpectrumAttr(random_name_2,
                                data_type, dimX));
                    break;
                case AttrDataFormat._IMAGE:
                    add_attribute(new ImageAttr(random_name_1, data_type,
                            dbData.getMax_x(), dbData.getMax_y()));
                    break;
            }
            ...
            if (_2value) argout.svalue[1] = random_name_2;
