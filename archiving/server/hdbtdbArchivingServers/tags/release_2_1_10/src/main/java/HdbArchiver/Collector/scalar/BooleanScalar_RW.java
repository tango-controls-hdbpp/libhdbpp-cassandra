	...
	public void archive(TangoArchiveEvent event) {
		...
		try {
			...
			if (arch == null || proxy == null || attrib == null) {
				System.out
						.println("\033[1;31mBooleanScalar_RW: event.getValue() or event.getSource() or event.getSource().getEventSupplier()) returned null!\033[0m");
				return;
			}
			...
			System.out.println(proxy.name() + ": " + attrib.getName()
					+ "{boolean, RW} [\033[1;32mEVENT\033[0m]: " + "R: "
					+ bvalue[0] + ", W: " + bvalue[1]);
