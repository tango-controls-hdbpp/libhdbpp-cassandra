...
public class NumberScalar_RO extends NumberScalar implements
		INumberScalarListener {

	/**
	 *
	 */
	private static final long serialVersionUID = -303861947370946159L;

	public NumberScalar_RO(TdbModeHandler _modeHandler, String currentDsPath,
