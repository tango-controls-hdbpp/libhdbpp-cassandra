...
public class DbProxy
{
    ...
    public DbProxy()
	{
		try
		{
            ...
            this.manager.ArchivingConfigureWithoutArchiverListInit(TdbExtractor.TdbExtractor.myDbHost , TdbExtractor.TdbExtractor.myDbName ,TdbExtractor.TdbExtractor.myDbUser , TdbExtractor.TdbExtractor.myDbPassword);
		}
