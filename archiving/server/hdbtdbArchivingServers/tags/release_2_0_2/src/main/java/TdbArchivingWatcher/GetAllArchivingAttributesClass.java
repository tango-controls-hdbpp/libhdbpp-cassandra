...
public class GetAllArchivingAttributesClass extends Command implements TangoConst
{
    ...
    public Any execute(DeviceImpl device,Any in_any) throws DevFailed
    {
        ...
        return insert(((TdbArchivingWatcher)(device)).get_all_archiving_attributes());
    }
...
//-----------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/TdbArchivingWatcher/GetAllArchivingAttributesClass.java,v $ */
