...
public class TdbArchiverClass extends DeviceClass implements TangoConst {
	...
	final Attr scalar_charge = new Attr("scalar_charge", Tango_DEV_SHORT, AttrWriteType.READ);
	...
	final Attr image_charge = new Attr("image_charge", Tango_DEV_SHORT, AttrWriteType.READ);
