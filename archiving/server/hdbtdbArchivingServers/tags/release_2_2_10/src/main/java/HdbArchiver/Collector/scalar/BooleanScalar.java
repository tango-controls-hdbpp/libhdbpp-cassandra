...
public abstract class BooleanScalar extends HdbCollector implements IBooleanScalarListener,
	...
	System.err.println("BooleanScalar.errorChange "
		+ errorEvent.getError().getLocalizedMessage());
	errorEvent.getError().printStackTrace();
