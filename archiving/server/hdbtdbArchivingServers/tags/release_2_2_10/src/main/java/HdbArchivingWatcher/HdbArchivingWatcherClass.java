...
public class HdbArchivingWatcherClass extends DeviceClass implements TangoConst {
	...
	public void command_factory() {
		command_list.addElement(new GetAllArchivingAttributesClass("GetAllArchivingAttributes", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "", "The list of all HDB archiving attributes",
				DispLevel.OPERATOR));
		command_list.addElement(new RestartClass("Restart", Tango_DEV_VOID, Tango_DEV_VOID, "", "", DispLevel.OPERATOR));
		command_list.addElement(new ResetClass("Reset", Tango_DEV_VOID, Tango_DEV_VOID, "", "", DispLevel.OPERATOR));
		command_list.addElement(new StartClass("Start", Tango_DEV_VOID, Tango_DEV_VOID, "", "", DispLevel.OPERATOR));
		command_list.addElement(new StopClass("Stop", Tango_DEV_VOID, Tango_DEV_VOID, "", "", DispLevel.OPERATOR));
		command_list.addElement(new GetReportCurrentClass("GetReportCurrent", Tango_DEV_VOID, Tango_DEV_STRING, "", "The report for the current cycle", DispLevel.OPERATOR));
		command_list.addElement(new GetReportLatestErrorClass("GetReportLatestError", Tango_DEV_VOID, Tango_DEV_STRING, "", "The report for the latest KO cycle", DispLevel.OPERATOR));
		command_list.addElement(new IsAttributeCorrectlyArchivedCurrentClass("IsAttributeCorrectlyArchivedCurrent", Tango_DEV_STRING, Tango_DEV_BOOLEAN, "The attribute complete name",
				"True if this attribute is archiving correctly (current cycle)", DispLevel.OPERATOR));
		command_list.addElement(new IsAttributeCorrectlyArchivedLatestErrorClass("IsAttributeCorrectlyArchivedLatestError", Tango_DEV_STRING, Tango_DEV_BOOLEAN, "The attribute complete name",
				"True if archiving works correctly for this attribute (latest KO cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorArchiversCurrentClass("GetErrorArchiversCurrent", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "",
				"The list of archivers that have at least one KO attribute (current cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorArchiversLatestErrorClass("GetErrorArchiversLatestError", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "",
				"The list of archivers that have at least one KO attribute (latest KO cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorsForArchiverCurrentClass("GetErrorsForArchiverCurrent", Tango_DEV_STRING, Tango_DEVVAR_STRINGARRAY, "The name of the archiver",
				"The list of KO attributes for this archiver (current cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorsForArchiverLatestErrorClass("GetErrorsForArchiverLatestError", Tango_DEV_STRING, Tango_DEVVAR_STRINGARRAY, "The name of the archiver",
				"The list of KO attributes for this archiver (latest KO cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorDomainsCurrentClass("GetErrorDomainsCurrent", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "",
				"The list of domains that have at least one KO attribute (current cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorDomainsLatestErrorClass("GetErrorDomainsLatestError", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "",
				"The list of domains that have at least one KO attribute (latest KO cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorsForDomainCurrentClass("GetErrorsForDomainCurrent", Tango_DEV_STRING, Tango_DEVVAR_STRINGARRAY, "The domain name",
				"The list of KO attributes for this domain (current cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorsForDomainLatestErrorClass("GetErrorsForDomainLatestError", Tango_DEV_STRING, Tango_DEVVAR_STRINGARRAY, "The domain name",
				"The list of KO attributes for this domain (latest KO cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorsForAttributeCurrentClass("GetErrorsForAttributeCurrent", Tango_DEV_STRING, Tango_DEVVAR_STRINGARRAY, "The NOT complete name of the attribute",
				"The list of KO attributes for this attribute name (current cycle)", DispLevel.OPERATOR));
		command_list.addElement(new GetErrorsForAttributeLatestErrorClass("GetErrorsForAttributeLatestError", Tango_DEV_STRING, Tango_DEVVAR_STRINGARRAY, "The NOT complete name of the attribute",
				"The list of KO attributes for this attribute name (latest KO cycle)", DispLevel.OPERATOR));
		command_list.addElement(new StartRelativeClass("StartRelative", Tango_DEV_DOUBLE, Tango_DEV_VOID, "The multiplier", "", DispLevel.EXPERT));
		command_list.addElement(new StartAbsoluteClass("StartAbsolute", Tango_DEVVAR_LONGARRAY, Tango_DEV_VOID,
				"The absolute mode parameters: argin[0] = the duration amount, argin[1] = the duration nature (1=seconds, 2=minutes, 3=hours)", "", DispLevel.EXPERT));

		// Admin report commands
		command_list.addElement(new StartArchivingReportClass("StartArchivingReport", Tango_DEV_VOID, Tango_DEV_VOID, "", "Start Watcher archiving report", DispLevel.OPERATOR));
		//
		...
		// DispLevel.OPERATOR));
		command_list.addElement(new GetAttributesCountClass("GetCurrentArchivingAttrCount", Tango_DEV_VOID, Tango_DEV_LONG, "", "Current archived attributes count", DispLevel.OPERATOR));

		command_list.addElement(new GetKOAttributesCountClass("GetKOAttributesCount", Tango_DEV_VOID, Tango_DEV_LONG, "", "KO attributes count", DispLevel.OPERATOR));

		command_list.addElement(new GetOKAttributesCountClass("GetOKAttributesCount", Tango_DEV_VOID, Tango_DEV_LONG, "", "OK attributes count", DispLevel.OPERATOR));
		command_list.addElement(new GetListOfKOAttributesClass("GetListOfKOAttributes", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "", "List of ko attributes details", DispLevel.OPERATOR));
		command_list.addElement(new GetListOfPartitionsClass("GetListOfPartitions", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "", "List of databes partitions details", DispLevel.OPERATOR));
		command_list.addElement(new GetListOfJobStatusClass("GetListOfJobStatus", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "", "List of database job status details", DispLevel.OPERATOR));
		command_list.addElement(new GetListOfJobErrorsClass("GetListOfJobErrors", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "", "List of database job errors details", DispLevel.OPERATOR));
		command_list.addElement(new GetKoCountByDeviceClass("GetListOfKoNbrByDevice", Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY, "", "List of ko attributes number by device", DispLevel.OPERATOR));

		command_list.addElement(new GetFeedAliveProgressionClass("GetFeedAliveProgression", Tango_DEV_VOID, Tango_DEV_LONG, "", "Percentage of the feedalive execution ", DispLevel.OPERATOR));
	...
	public void device_factory(String[] devlist) throws DevFailed {
		...
		for (int i = 0; i < devlist.length; i++) {
			...
			// ----------------------------------------------
			device_list.addElement(new HdbArchivingWatcher(this, devlist[i], device_version));
