...
public class HdbArchivingWatcher extends DeviceImpl/*WithShutdownRunnable*/ implements TangoConst,Warnable
{
	//private	int	state;
...
//	=========================================================
	 ...
	 */
	HdbArchivingWatcher(DeviceClass cl, String s, String version) throws DevFailed
	{
		super(cl,s);
		m_version = version;
		init_device();
...
//	=========================================================
	 ...
	 * @param   version The device version
	 */
	HdbArchivingWatcher(DeviceClass cl, String s, String d, String version) throws DevFailed
	{
		super(cl,s,d);
		m_version = version;
		init_device();
...
//	===================================================================
	public void get_device_property() throws DevFailed
	{
		...
		HdbArchivingWatcherClass	ds_class = (HdbArchivingWatcherClass)get_device_class();
		int	i = -1;
		...
		else
		{
			//  Try to get value from class property
			DbDatum cl_prop = ds_class.get_class_property(dev_prop[ i ].name);
			if ( cl_prop.is_empty() == false ) hdbRacConnection = cl_prop.extractBoolean();
		}
		...
		else
		{
			//  Try to get value from class property
			DbDatum cl_prop = ds_class.get_class_property(dev_prop[ i ].name);
			if ( cl_prop.is_empty() == false ) tdbRacConnection = cl_prop.extractBoolean();
		}
...
//	=========================================================
	 ...
	 * Lists all HDB archiving attributes (does a new request regardless of the watcher cycle).
...
//	=========================================================
	...
	public synchronized void start_archiving_report() throws DevFailed{
		...
		try {
			if(this.dbReader.getDatabase().getType()== ConfigConst.HDB_MYSQL){
				Except.throw_exception("DATABASE_ERROR"  ,
						"MySql Exception" , "MySql is not supported for this command ");
				return;
			}
	 ...
	 */
	public synchronized int get_current_archiving_attributes_count()throws DevFailed{
		// TODO Auto-generated method stub
	...
	public synchronized String[] get_job_status() throws DevFailed{
		...
		try {
			...
			String[] tmp =  this.dbReader.getDatabase().getDbUtil().getListOfJobStatus();
			if(tmp==null)
				return res;
			else return tmp;
		}
	...
	public synchronized String[] get_job_errors() throws DevFailed{
		...
		try {
			...
			String[] tmp= this.dbReader.getDatabase().getDbUtil().getListOfJobErrors();
			if(tmp==null)
				return res;
			else return tmp;
		}
	 ...
	 * @return
	 */
	public synchronized String[] get_ko_attributes_count_by_device()throws DevFailed{
		// TODO Auto-generated method stub
...
//--------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/HdbArchivingWatcher/HdbArchivingWatcher.java,v $ */
