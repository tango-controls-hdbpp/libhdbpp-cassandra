...
public class IsAttributeCorrectlyArchivedLatestErrorClass extends Command
	 ...
	 */
	// ===============================================================
	public IsAttributeCorrectlyArchivedLatestErrorClass(String name, int in,
			int out) {
		super(name, in, out);
	}
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("IsAttributeCorrectlyArchivedLatestErrorClass.execute(): arrived");
