...
public class GetAttDataInfOrSupThanBetweenDatesCountClass extends Command
	 ...
	 */
	// ===============================================================
	public GetAttDataInfOrSupThanBetweenDatesCountClass(String name, int in,
			int out) {
		super(name, in, out);
	}
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("GetAttDataInfOrSupThanBetweenDatesCountClass.execute(): arrived");
