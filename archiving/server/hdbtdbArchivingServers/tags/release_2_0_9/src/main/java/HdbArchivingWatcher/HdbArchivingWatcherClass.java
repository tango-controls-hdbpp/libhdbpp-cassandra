...
//
//===================================================================			
	public static HdbArchivingWatcherClass init(String class_name) throws DevFailed
	{
		if (_instance == null)
		{
...
//===================================================================			
	public void command_factory()
	{
		...
		command_list.addElement(new StartArchivingReportClass("StartArchivingReport",
				Tango_DEV_VOID, Tango_DEV_VOID,
				"",
				"Start Watcher archiving report",
				DispLevel.OPERATOR));
//
...
//				DispLevel.OPERATOR));
		command_list.addElement(new GetAttributesCountClass("GetCurrentArchivingAttrCount",
				Tango_DEV_VOID, Tango_DEV_LONG,
				"",
				"Current archived attributes count",
				DispLevel.OPERATOR));
		
		command_list.addElement(new GetKOAttributesCountClass("GetKOAttribitesCount",
				Tango_DEV_VOID, Tango_DEV_LONG,
				"",
				"KO attributes count",
				DispLevel.OPERATOR));
	
		command_list.addElement(new GetOKAttributesCountClass("GetOKAttribitesCount",
				Tango_DEV_VOID, Tango_DEV_LONG,
				"",
				"OK attributes count",
				DispLevel.OPERATOR));
		command_list.addElement(new GetListOfKOAttributesClass("GetListOfKOAttributes",
				Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY,
				"",
				"List of ko attributes details",
				DispLevel.OPERATOR));
		command_list.addElement(new GetListOfPartitionsClass("GetListOfPartitions",
				Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY,
				"",
				"List of databes partitions details",
				DispLevel.OPERATOR));
		command_list.addElement(new GetListOfJobStatusClass("GetListOfJobStatus",
				Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY,
				"",
				"List of database job status details",
				DispLevel.OPERATOR));
		command_list.addElement(new GetListOfJobErrorsClass("GetListOfJobErrors",
				Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY,
				"",
				"List of database job errors details",
				DispLevel.OPERATOR));
		command_list.addElement(new GetKoCountByDeviceClass("GetListOfKoNbrByDevice",
				Tango_DEV_VOID, Tango_DEVVAR_STRINGARRAY,
				"",
				"List of ko attributes number by device",
				DispLevel.OPERATOR));

		command_list.addElement(new GetFeedAliveProgressionClass("GetFeedAliveProgression",
				Tango_DEV_VOID, Tango_DEV_LONG,
				"",
				"Percentage of the feedalive execution ",
				DispLevel.OPERATOR));
