...
//	=========================================================
	 ...
	 */
	public String[] get_archiving_report() {
		// TODO Auto-generated method stub
		try {
			return this.dbReader.getArchivingReport();
		} catch (DevFailed e) {
	 ...
	 */
	public int get_current_archinving_attributes_count() {
		// TODO Auto-generated method stub
	 ...
	 */
	public int get_ko_attributes_count() {
		// TODO Auto-generated method stub
		
		try {
			return this.dbReader.getDatabase().getDbUtil().getAttributesCountOkOrKo(this.dbReader.getDatabase().getDbConn(), false);
		} catch (ArchivingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	 ...
	 */
	public int get_ok_attributes_count() {
		// TODO Auto-generated method stub
		
		try {
			return this.dbReader.getDatabase().getDbUtil().getAttributesCountOkOrKo(this.dbReader.getDatabase().getDbConn(), true);
		} catch (ArchivingException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	 ...
	 */
	public String[] get_ko_attributes() {
		// TODO Auto-generated method stub
		try {
			
				return this.dbReader.getDatabase().getDbUtil().getKoAttributes(this.dbReader.getDatabase().getDbConn());
			}
		catch (ArchivingException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
	...
	public String[] get_partitions() {
		...
		try {
				...
				return this.dbReader.getDatabase().getDbUtil().getListOfPartitions(this.dbReader.getDatabase().getDbConn());
			}
		catch (ArchivingException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
	...
	public String[] get_job_status() {
		...
		try {
				...
				String[] tmp =  this.dbReader.getDatabase().getDbUtil().getListOfJobStatus(this.dbReader.getDatabase().getDbConn());
				if(tmp==null)
					return res;
				else return tmp;
			}
	 ...
	 * @return Watcher list of oracle databse partitions
	 */
	public String[] get_job_errors() {
		// TODO Auto-generated method stub
		String[] res = {"No Job Errors"};
		try {
			
				String[] tmp= this.dbReader.getDatabase().getDbUtil().getListOfJobErrors(this.dbReader.getDatabase().getDbConn());
				if(tmp==null)
					return res;
				else return tmp;
			}
