...
public class NumberSpectrum_RO extends TdbCollector implements ISpectrumListener
{
	public NumberSpectrum_RO(TdbModeHandler modeHandler)
	{
		super(modeHandler);
	}
	...
	public void errorChange(ErrorEvent errorEvent)
	{
		...
		spectrumEvent_ro.setAttribute_complete_name(( ( INumberSpectrum ) errorEvent.getSource() ).getName());
