...
{
	private static final long serialVersionUID = 5000899893L; /* Recommended in java 5 */
	
    public StringScalar_RW ( HdbModeHandler _modeHandler )
    {
        super( _modeHandler );
    }
...
//        	--------------------------------------------------------------------------//    
        ...
        catch ( Exception exE )
        {
            ...
            String message = "Problem in StringScalar_RW/stringScalarChange";
...
//	--------------------------------------------------------------------------//
	...
	public void archive(TangoArchiveEvent event)
	{
		...
		{
			print_exception("Error getting archive event value \033[1;31mStringScalar_RW.archive.getValue() failed, caught DevFailed\033[0m", 
					f);
		    return;
		}
		...
		try{
			...
			{
				System.out.println("\033[1;31mStringScalar_RW.java: event.getValue() or event.getSource() or event.getSource().getEventSupplier()) returned null!\033[0m");
				return;
			}
			System.out.println("\033[1;35marchive() [String Scalar RW]: [EVENT]: \033[1;32m" + proxy.name() + "/" + attrib.getName() + "\033[0m");
            ...
            {
                String value = StringFormater.formatStringToWrite(svalue[i]);
                svalue[i] = value;
			...
			System.out.println("\033[1;35m(R): " + 
		    		svalue[0] + "\033[0m, (Set):\033[1;36m " + svalue[1]+ "\033[0m" );
