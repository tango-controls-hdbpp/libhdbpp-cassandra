...
/**
 * Class Description:
 * A DServer used for temporary database's extractions.
 *
 * @author  $Author$
 * @version $Revision$
 */
...
public class TdbExtractor extends DeviceImpl/*WithShutdownRunnable*/ implements TangoConst
{
    protected int state;
...
//=========================================================
     ...
     */
//=========================================================
    TdbExtractor(DeviceClass cl , String s , String d, String version) throws DevFailed
    {
        super(cl , s , d);
        m_version = version;
        init_device();
...
//=========================================================
    public String get_info() throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().getInfo();
        }
...
//=========================================================
    public String get_host() throws DevFailed
    {
        ...
        // ---Add your Own code to control device here ---
        argout = this.dbProxy.getDataBase().getHost();
...
//=========================================================
    public String get_user() throws DevFailed
    {
        ...
        // ---Add your Own code to control device here ---
        argout = this.dbProxy.getDataBase().getUser();
...
//=========================================================
     ...
     * Cheks if the connection to the temporary database is alive.
     *
...
//=========================================================
    public String[] get_att_definition_data(String argin) throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().toStringArray(this.dbProxy.getDataBase().getAttDefinitionData(argin));
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public String[] get_att_properties_data(String argin) throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().toStringArray(this.dbProxy.getDataBase().getAttPropertiesData(argin));
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
     ...
     * Gets for a specified attribute its ID as defined in TDB
     *
     * @param   argin   The attribute's name
...
//=========================================================
    public short get_att_id(String argin) throws DevFailed
    {
        ...
        try
        {
            ...
            argout = ( short ) this.dbProxy.getDataBase().getBufferedAttID(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
     ...
     * Gets whole list of the attributes registered in TDB.
     *
...
//=========================================================
    public String[] get_att_name_all() throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().toStringArray(this.dbProxy.getDataBase().getAttributes());
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
     ...
     * Gets whole list of the attributes registered in TDB and that belong to the current facility.
     *
     * @return  The whole list of the attributes registered in TDB, and that belong to the current facility.
     */
//=========================================================
    public String[] get_att_name_facility() throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().toStringArray(this.dbProxy.getDataBase().getAttributes(System.getProperty("TANGO_HOST")));
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
     ...
     * @return  The filtered list of attributes registered in TDB.  The filtering is made according to the given format [0 -> scalar - 1 -> spectrum - 2 -> image]
     */
//=========================================================
    public String[] get_att_name_filter_format(short argin) throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().toStringArray(this.dbProxy.getDataBase().getAttributesNamesF(argin));
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
     ...
     * Gets the list of <I>TDB</I> registered attributes for the given type
     *
     * @param   argin   A type [2 -> Tango::DevShort | 3 -> Tango::DevLong | 5 -> Tango::DevDouble and 8 -> Tango::DevString]
     * @return  The filtered list of attributes registered in TDB.  The filtering is made according to the given type [2 -> Tango::DevShort | 3 -> Tango::DevLong | 5 -> Tango::DevDouble and 8 -> Tango::DevString]
     */
//=========================================================
    public String[] get_att_name_filter_type(short argin) throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().toStringArray(this.dbProxy.getDataBase().getAttributesNamesT(argin));
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
     ...
     * Gets the total number of attributes defined in TDB.
     *
...
//=========================================================
    public short get_att_count_all() throws DevFailed
    {
        ...
        try
        {
            argout = ( short ) this.dbProxy.getDataBase().getAttributesCount();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
     ...
     *
     * @param   argin   A format [0 -> scalar - 1 -> spectrum - 2 -> image]
     * @return  The total number of attributes defined in TDB with the given format [0 -> scalar - 1 -> spectrum - 2 -> image]
     */
//=========================================================
    public short get_att_count_filter_format(short argin) throws DevFailed
    {
        ...
        try
        {
            argout = ( short ) this.dbProxy.getDataBase().getAttributesCountF(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
     ...
     * Gets the total number of attributes defined in TDB with the given type.
     *
     * @param   argin   A type [2 -> Tango::DevShort | 3 -> Tango::DevLong | 5 -> Tango::DevDouble and 8 -> Tango::DevString]
     * @return  The total number of attributes defined in TDB with the given type [2 -> Tango::DevShort | 3 -> Tango::DevLong | 5 -> Tango::DevDouble and 8 -> Tango::DevString]
     */
//=========================================================
    public short get_att_count_filter_type(short argin) throws DevFailed
    {
        ...
        try
        {
            argout = ( short ) this.dbProxy.getDataBase().getAttributesCountT(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public String[] get_domains() throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().get_domains();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public short get_domains_count() throws DevFailed
    {
        ...
        try
        {
            argout = ( short ) this.dbProxy.getDataBase().get_domainsCount();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public String[] get_families() throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().get_families();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public short get_families_count() throws DevFailed
    {
        ...
        try
        {
            argout = ( short ) this.dbProxy.getDataBase().get_familiesCount();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public String[] get_families_by_domain(String argin) throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().get_families(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public short get_families_by_domain_count(String argin) throws DevFailed
    {
        ...
        try
        {
            argout = ( short ) this.dbProxy.getDataBase().get_familiesCount(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public String[] get_members() throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().get_members();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public short get_members_count() throws DevFailed
    {
        ...
        try
        {
            argout = ( short ) this.dbProxy.getDataBase().get_membersCount();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public String[] get_members_by_domain_family(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                argout = this.dbProxy.getDataBase().get_members(argin[ 0 ].trim() , argin[ 1 ].trim());
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
    public short get_members_by_domain_family_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                argout = ( short ) this.dbProxy.getDataBase().get_membersCount(argin[ 0 ] , argin[ 1 ]);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
    public short get_attributes_by_domain_family_members_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                argout = ( short ) this.dbProxy.getDataBase().getAttributesCount(argin[ 0 ] , argin[ 1 ] , argin[ 2 ]);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
     ...
     * Gets the list of attributes that are being archived in <I>TDB</I>
     *
...
//=========================================================
    public String[] get_current_archived_att() throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().getCurrentArchivedAtt();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public boolean is_archived(String argin) throws DevFailed
    {
        ...
        try
        {
            argout = this.dbProxy.getDataBase().isArchived(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public String[] get_archiving_mode(String argin) throws DevFailed
    {
        ...
        try
        {
            argout = ( this.dbProxy.getDataBase().getCurrentArchivingMode(argin , false) ).toArray();
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public DevVarLongStringArray get_att_data(String argin) throws DevFailed
    {
        ...
        try
        {
            ArchivingManagerApi.ExportData2Tdb(argin);
            // Get data from db.
            
            dbData = this.dbProxy.getDataBase().getAttData(argin);
        ...
        catch ( ArchivingException e )
        {
            ...
            get_logger().info("cla ZZZZZZZZZZ!!!!!!!!!!!!!!!!!!");
            throw e.toTangoException();
        }
        catch (java.lang.OutOfMemoryError oome)
        {
            get_logger().info("OutOfMemoryError in get_att_data");
            Except.throw_exception("MEMORY_ERROR",HintOnMemoryError,  "TdbExtractor.get_att_data");
        }
        catch ( Throwable t )
        {
            t.printStackTrace();
...
//=========================================================
    public int get_att_data_count(String argin) throws DevFailed
    {
        ...
        try
        {
            this.dbProxy.getManager().ExportData2Tdb(argin, getTimeNow());
            argout = ( int ) this.dbProxy.getDataBase().getAttDataCount(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public double get_att_data_avg(String argin) throws DevFailed
    {
        ...
        {
            this.dbProxy.getManager().ExportData2Tdb(argin, getTimeNow());
            argout = this.dbProxy.getDataBase().getAttDataAvg(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public double get_att_data_avg_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 2 ]);
                argout = this.dbProxy.getDataBase().getAttDataAvgBetweenDates(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
    public DevVarLongStringArray get_att_data_between_dates_sampling(String[] argin) throws DevFailed
    {
        ...
        {
            // Get data from db.
            DbData dbData = this.dbProxy.getDataBase().getAttDataBetweenDates(argin,samplingType);
            // Buid an attribute and gets its references
            argout = add_attribute(dbData);
        }
        catch ( ArchivingException e )
        ...
        catch (java.lang.OutOfMemoryError oome)
        {
            ...
            Except.throw_exception("MEMORY_ERROR",HintOnMemoryError,  "TdbExtractor.get_att_data_between_dates_sampling");
        }
        catch ( Throwable t )
        {
            t.printStackTrace();
    ...
    public DevVarLongStringArray get_att_data_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                ...
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataBetweenDates(argin,SamplingType.getSamplingType ( SamplingType.ALL ));
...
//=========================================================
    public int get_att_data_between_dates_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 2 ]);
                argout = ( int ) this.dbProxy.getDataBase().getAttDataBetweenDatesCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
    public DevVarLongStringArray get_att_data_inf_or_sup_than(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataInfOrSupThan(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
...
//=========================================================
    public int get_att_data_inf_or_sup_than_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                argout = ( int ) this.dbProxy.getDataBase().getAttDataInfOrSupThanCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
    public DevVarLongStringArray get_att_data_inf_or_sup_than_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 4 ]);
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataInfOrSupThanBetweenDates(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
            ...
            catch (java.lang.OutOfMemoryError oome)
            {
                ...
                Except.throw_exception("MEMORY_ERROR",HintOnMemoryError,  "TdbExtractor.get_att_data_inf_or_sup_than_between_dates");
            }
        }
...
//=========================================================
    public int get_att_data_inf_or_sup_than_between_dates_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 5 ]);
                argout = ( int ) this.dbProxy.getDataBase().getAttDataInfOrSupThanBetweenDatesCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
    ...
    public DevVarLongStringArray get_att_data_inf_than(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataInfThan(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
...
//=========================================================
    public int get_att_data_inf_than_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                argout = ( int ) this.dbProxy.getDataBase().getAttDataInfThanCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
    public DevVarLongStringArray get_att_data_inf_than_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 3 ]);
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataInfThanBetweenDates(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
...
//=========================================================
    public int get_att_data_inf_than_between_dates_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 3 ]);
                argout = ( int ) this.dbProxy.getDataBase().getAttDataInfThanBetweenDatesCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
    ...
    public DevVarLongStringArray get_att_data_last_n(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataLast_n(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
...
//=========================================================
    public double get_att_data_max(String argin) throws DevFailed
    {
        ...
        {
            this.dbProxy.getManager().ExportData2Tdb(argin, getTimeNow());
            argout = this.dbProxy.getDataBase().getAttDataMax(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public double get_att_data_max_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 2 ]);
                argout = this.dbProxy.getDataBase().getAttDataMaxBetweenDates(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
    public double get_att_data_min(String argin) throws DevFailed
    {
        ...
        {
            this.dbProxy.getManager().ExportData2Tdb(argin, getTimeNow());
            argout = this.dbProxy.getDataBase().getAttDataMin(argin);
        }
        catch ( ArchivingException e )
        {
            throw e.toTangoException();
...
//=========================================================
    public double get_att_data_min_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 2 ]);
                argout = this.dbProxy.getDataBase().getAttDataMinBetweenDates(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
    ...
    public DevVarLongStringArray get_att_data_sup_than(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataSupThan(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
...
//=========================================================
    public int get_att_data_sup_than_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                argout = ( int ) this.dbProxy.getDataBase().getAttDataSupThanCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
    ...
    public DevVarLongStringArray get_att_data_sup_and_inf_than(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataSupAndInfThan(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
...
//=========================================================
    public int get_att_data_sup_and_inf_than_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], getTimeNow());
                argout = ( int ) this.dbProxy.getDataBase().getAttDataSupAndInfThanCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
    ...
    public DevVarLongStringArray get_att_data_sup_and_inf_than_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            try
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 4 ]);
                // Get data from db.
                DbData dbData = this.dbProxy.getDataBase().getAttDataSupAndInfThanBetweenDates(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
            ...
            catch (java.lang.OutOfMemoryError oome)
            {
                ...
                Except.throw_exception("MEMORY_ERROR",HintOnMemoryError,  "TdbExtractor.get_att_data_sup_and_inf_than_between_dates");
            }
        }
...
//=========================================================
    public int get_att_data_sup_and_inf_than_between_dates_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 4 ]);
                argout = ( int ) this.dbProxy.getDataBase().getAttDataSupAndInfThanBetweenDatesCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
    public DevVarLongStringArray get_att_data_sup_than_between_dates(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 3 ]);
                DbData dbData = this.dbProxy.getDataBase().getAttDataSupThanBetweenDates(argin);
                // Buid an attribute and gets its references
                argout = add_attribute(dbData);
            }
            catch ( ArchivingException e )
            ...
            catch (java.lang.OutOfMemoryError oome)
            {
                ...
                Except.throw_exception("MEMORY_ERROR",HintOnMemoryError,  "TdbExtractor.get_att_data_sup_than_between_dates");
            }
        }
...
//=========================================================
    public int get_att_data_sup_than_between_dates_count(String[] argin) throws DevFailed
    {
        ...
        else
        {
            ...
            {
                this.dbProxy.getManager().ExportData2Tdb(argin[ 0 ], argin[ 3 ]);
                argout = ( int ) this.dbProxy.getDataBase().getAttDataSupThanBetweenDatesCount(argin);
            }
            catch ( ArchivingException e )
            {
                throw e.toTangoException();
...
//=========================================================
     ...
     *
     * @param   argin   The TdbExtractor dynamic attribute's name
     */
//=========================================================
...
//            throw new ArchivingException(message , reason , null , desc , this.getClass().getName());
        ...
        switch ( dbData.getData_format() )
        {
            case AttrDataFormat._SCALAR:
                // TODO Correction Tango ï¿½ reporter !! Tango [Java side] ne supporte pas les attributs READ-WRITE.
    ...
    /*private DevVarLongStringArray add_attribute(DbData dbData) throws DevFailed
    {
        DevVarLongStringArray argout = new DevVarLongStringArray();
        ...
        //  And fill buffer with database's data
        DbData[] dbDatas = dbData.splitDbData();
        tg_1.fill_attr_polling_buffer(this , random_name_1 , dbDatas[ 0 ].getData());
        if ( _2value )
            tg_2.fill_attr_polling_buffer(this , random_name_2 , dbDatas[ 1 ].getData());
        ...
        argout.lvalue[ 0 ] = dbData.getData().length;
        argout.svalue[ 0 ] = random_name_1;
        if ( _2value )
            argout.svalue[ 1 ] = random_name_2;
...
//=========================================================
    ...
    public String get_max_time(String argin) throws DevFailed 
    {
        try
        {
            DataBaseApi db = this.dbProxy.getDataBase();
            Timestamp last = db.getTimeOfLastInsert(argin,true);
            if ( last == null )
            {
    ...
    public String get_min_time(String argin) throws DevFailed 
    {
        ...
        {
            DataBaseApi db = this.dbProxy.getDataBase();
            Timestamp last = db.getTimeOfLastInsert(argin,false);
            if ( last == null )
            {
                return "NO VALUES RECORDED";
            }
