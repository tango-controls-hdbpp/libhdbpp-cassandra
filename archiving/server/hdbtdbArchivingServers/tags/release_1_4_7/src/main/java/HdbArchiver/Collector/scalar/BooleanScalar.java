	...
	private void addSourceForPolling(AttributeLightMode attributeLightMode) throws ArchivingException
	{
		try
		{
			synchronized ( attributeList )
			{
				...
				//while ( ( IBooleanScalar ) attributeList.get(att_name) == null )
				//{
...
//	--------------------------------------------------------------------------//	
	private void addSourceForEvents(AttributeLightMode attributeLightMode) throws ArchivingException
	{
		...
		try
		{
			...
			if(attribute == null)
			{
				System.out.println("\033[1;31mBooleanScalar.java: the attribute \"" +
		...
		{
			System.out.println("\033[1;31mBooleanScalar.java: Failed to get the attribute from the AttributeFactory\033[0m");
