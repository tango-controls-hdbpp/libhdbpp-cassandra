...
public class DbProxy
{
    ...
    public DbProxy()
	{
		try
		{
            ...
            this.manager.ArchivingConfigure(TdbArchiver.myDbHost, TdbArchiver.myDbName, TdbArchiver.myDbUser , TdbArchiver.myDbPassword , false);
		}
	...
	public void insertModeRecord(AttributeLightMode attributeLightMode) throws ArchivingException
	{
        ...
        this.manager.getDataBase(false).insertModeRecord(attributeLightMode);
	...
	public boolean isArchived(String att_name) throws ArchivingException
	{
		...
		try
		{
			return this.manager.getDataBase(false).isArchived(att_name);
		}
		catch ( ArchivingException e )
		{
    ...
    public boolean isArchived(String att_name, String device_name) throws ArchivingException
    {
        ...
        try
        {
            return this.manager.getDataBase(false).isArchived(att_name, device_name);
        }
        catch ( ArchivingException e )
        {
            Util.out2.println(e.toString());
	...
	{
        this.manager.getDataBase(false).updateModeRecord(attributeLightMode.getAttribute_complete_name());
	}
	...
	public void updateModeRecord(String att_name) throws ArchivingException
	{
		...
		try
		{
            ...
            this.manager.getDataBase(false).updateModeRecord(att_name);
	...
	public void exportToDB_Scalar(String remoteFilePath , String fileName , String tableName, int writable) throws ArchivingException
	{
        ...
        this.manager.getDataBase(false).exportToDB_Scalar(remoteFilePath , fileName , tableName, writable);
	}
	...
	public void exportToDB_Spectrum(String remoteFilePath , String fileName , String tableName, int writable) throws ArchivingException
	{
        ...
        this.manager.getDataBase(false).exportToDB_Spectrum(remoteFilePath , fileName , tableName, writable);
	}
	...
	public void exportToDB_Image(String remoteFilePath , String fileName , String tableName, int writable) throws ArchivingException
	{
        ...
        this.manager.getDataBase(false).exportToDB_Image(remoteFilePath , fileName , tableName, writable);
	}
	...
	public Vector getArchiverCurrentTasks(String archiverName) //throws ArchivingException , DevFailed
	{
		...
		boolean facility = this.manager.getTdbFacility();
		try
		{
			archiverCurrentTasks = this.manager.getDataBase(false).getArchiverCurrentTasks(( ( facility ) ? "//" + ( new Database() ).get_tango_host() + "/" : "" ) + archiverName , false);
	...
	{
        this.manager.getDataBase(false).deleteOldRecords(time , attributeList);
	}
}