...
public class GetAttDataInfThanBetweenDatesCountClass extends Command implements
		TangoConst {
	// ===============================================================
	/**
	 ...
	 */
	// ===============================================================
	public GetAttDataInfThanBetweenDatesCountClass(String name, int in,
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("GetAttDataInfThanBetweenDatesCountClass.execute(): arrived");
		String[] argin = extract_DevVarStringArray(in_any);
		return insert(((HdbExtractor) (device))
				.get_att_data_inf_than_between_dates_count(argin));
	}
