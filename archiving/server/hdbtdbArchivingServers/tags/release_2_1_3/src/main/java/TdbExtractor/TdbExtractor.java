...
// Bug: 9378: Extract data from file when the needed respecting the export period and the extract precision value.
//
// Revision 1.5  2008/07/11 07:49:12  soleilarc
// Solve Bug n°8827: remove Corba exception when getting data between  an invalid dates.
//
// Revision 1.4  2008/05/07 16:37:39  pierrejoseph
// The tango state type is transformed in string type before the dynamic attribut creation because the state type.
//
...
public class TdbExtractor extends DeviceImpl
	 ...
	 */
	// =========================================================
	TdbExtractor(DeviceClass cl, String s, String version) throws DevFailed {
		super(cl, s);
		m_version = version;
		init_device();
	}
	 ...
	 */
	// =========================================================
	TdbExtractor(DeviceClass cl, String s, String d, String version)
			throws DevFailed {
		super(cl, s, d);
		m_version = version;
		init_device();
	...
	public void get_device_property() throws DevFailed {
		...
		TdbExtractorClass ds_class = (TdbExtractorClass) get_device_class();
		int i = -1;
	...
	public boolean get_connection_state() throws DevFailed {
		...
		try {
			...
			if (connection != null) {
				argout = true;
				this.dbProxy.getDataBase().getDbConn().closeConnection(
						connection);
			}
		} catch (ArchivingException e) {
	...
	public String[] get_att_definition_data(String argin) throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = DbUtils.toStringArray(this.dbProxy.getDataBase()
					.getAttribute().getAttDefinitionData(argin));
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public String[] get_att_properties_data(String argin) throws DevFailed {
		...
		try {
			argout = DbUtils
					.toStringArray(this.dbProxy.getDataBase().getAttribute()
							.getProperties().getAttPropertiesData(argin));
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public short get_att_id(String argin) throws DevFailed {
		...
		try {
			...
			argout = (short) this.dbProxy.getDataBase().getAttribute().getIds()
					.getBufferedAttID(argin);
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public String[] get_att_name_all() throws DevFailed {
		...
		try {
			argout = DbUtils.toStringArray(this.dbProxy.getDataBase()
					.getAttribute().getNames().getAttributes());
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public String[] get_att_name_filter_format(short argin) throws DevFailed {
		...
		try {
			argout = DbUtils.toStringArray(this.dbProxy.getDataBase()
					.getAttribute().getNames().getAttributesNamesF(argin));
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public String[] get_att_name_filter_type(short argin) throws DevFailed {
		...
		try {
			argout = DbUtils.toStringArray(this.dbProxy.getDataBase()
					.getAttribute().getNames().getAttributesNamesT(argin));
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public short get_att_count_all() throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = (short) this.dbProxy.getDataBase().getAttribute()
					.getNames().getAttributesCount();
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public short get_att_count_filter_format(short argin) throws DevFailed {
		...
		try {
			argout = (short) this.dbProxy.getDataBase().getAttribute()
					.getNames().getAttributesCountF(argin);
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public short get_att_count_filter_type(short argin) throws DevFailed {
		...
		try {
			argout = (short) this.dbProxy.getDataBase().getAttribute()
					.getNames().getAttributesCountT(argin);
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public String[] get_domains() throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = this.dbProxy.getDataBase().getAttribute().getDomains()
					.get_domains();
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public String[] get_families() throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = this.dbProxy.getDataBase().getAttribute().getFamilies()
					.get_families();
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public short get_families_by_domain_count(String argin) throws DevFailed {
		...
		try {
			argout = (short) this.dbProxy.getDataBase().getAttribute()
					.getFamilies().get_familiesCount(argin);
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public String[] get_members() throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			argout = this.dbProxy.getDataBase().getAttribute().getMembers()
					.get_members();
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	 ...
	 */
	// =========================================================
	public String[] get_members_by_domain_family(String[] argin)
			throws DevFailed {
		String[] argout = new String[5];
	 ...
	 */
	// =========================================================
	public short get_members_by_domain_family_count(String[] argin)
			throws DevFailed {
		short argout = (short) 0;
		...
		if (argin.length != 2) {
			...
			try {
				argout = (short) this.dbProxy.getDataBase().getAttribute()
						.getMembers().get_membersCount(argin[0], argin[1]);
			} catch (ArchivingException e) {
				throw e.toTangoException();
			}
		}
	 ...
	 */
	// =========================================================
	public short get_attributes_by_domain_family_members_count(String[] argin)
			throws DevFailed {
		short argout = (short) 0;

		get_logger().info(
				"Entering get_attributes_by_domain_family_members_count()");
		...
		if (argin.length != 3) {
			...
			try {
				argout = (short) this.dbProxy.getDataBase().getAttribute()
						.getNames().getAttributesCount(argin[0], argin[1],
								argin[2]);
			} catch (ArchivingException e) {
				throw e.toTangoException();
			}
		...
		get_logger().info(
				"Exiting get_attributes_by_domain_family_members_count()");
		return argout;
	}
	...
	public DevVarLongStringArray get_att_data(String argin) throws DevFailed {
		Except.throw_exception("DEPRECATED",
		 ...
		 * 
		 * // ---Add your Own code to control device here --- DbData dbData =
		 * null; try { ArchivingManagerApi.ExportData2Tdb(argin); // Get data
		 * from db.
		 * 
		 * dbData = this.dbProxy.getDataBase().getAttData(argin); // Buid an
		 * attribute and gets its references
		 * 
		 * argout = add_attribute(dbData); } catch ( ArchivingException e ) {
		 ...
		 * +"/reason/"+error.reason ); } }
		 * 
		 * get_logger().error ( "Error: /CAUSE---------------" ); if ( (
		 * (DevFailed) t ).getCause() != null ) { ( (DevFailed) t
	...
	public int get_att_data_count(String argin) throws DevFailed {
		...
		// ---Add your Own code to control device here ---
		try {
			((TDBDataBaseManager) this.dbProxy.getDataBase()).getTdbExport()
					.ExportData2Tdb(argin, getTimeNow());
			argout = (int) this.dbProxy.getDataBase().getExtractor()
					.getDataGetters().getAttDataCount(argin);
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	...
	public double get_att_data_avg(String argin) throws DevFailed {
		...
		try {
			((TDBDataBaseManager) this.dbProxy.getDataBase()).getTdbExport()
					.ExportData2Tdb(argin, getTimeNow());
			argout = this.dbProxy.getDataBase().getExtractor()
					.getMinMaxAvgGetters().getAttDataAvg(argin);
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	 ...
	 */
	// =========================================================
	public double get_att_data_avg_between_dates(String[] argin)
			throws DevFailed {
		double argout = (double) 0;
		...
		if (argin.length != 3) {
			...
			try {
				((TDBDataBaseManager) this.dbProxy.getDataBase())
						.getTdbExport().ExportData2Tdb(argin[0], argin[2]);
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_between_dates_sampling(
		...
		try {
			// Get data from db.
			DbData dbData = this.dbProxy.getDataBase().getExtractor()
			...
			get_logger().info(
					"OutOfMemoryError in get_att_data_between_dates_sampling");
			Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
					"TdbExtractor.get_att_data_between_dates_sampling");
		} catch (Throwable t) {
			t.printStackTrace();
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_between_dates(String[] argin)
			throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();
		...
		if (argin.length != 3) {
			...
			try {
				...
				// Get data from db.
				DbData dbData = this.dbProxy.getDataBase().getExtractor()
						.getDataGettersBetweenDates().getAttDataBetweenDates(
								argin,
				...
				get_logger().info(
						"OutOfMemoryError in get_att_data_between_dates");
				Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
	 ...
	 */
	// =========================================================
	public int get_att_data_between_dates_count(String[] argin)
			throws DevFailed {
		int argout = (int) 0;
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_inf_or_sup_than(String[] argin)
			throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();
		...
		if (argin.length != 3) {
			...
			try {
				...
				((TDBDataBaseManager) this.dbProxy.getManager()).getTdbExport()
						.ExportData2Tdb(argin[0], getTimeNow());

				// Get data from db.
				DbData dbData = this.dbProxy.getDataBase().getExtractor()
						.getInfSupGetters().getAttDataInfOrSupThan(argin);
				// Buid an attribute and gets its references
				argout = add_attribute(dbData);
			} catch (ArchivingException e) {
				throw e.toTangoException();
				...
				get_logger().info(
						"OutOfMemoryError in get_att_data_inf_or_sup_than");
				Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
	 ...
	 */
	// =========================================================
	public int get_att_data_inf_or_sup_than_count(String[] argin)
			throws DevFailed {
		int argout = (int) 0;
		...
		if (argin.length != 3) {
			...
			try {
				((TDBDataBaseManager) this.dbProxy.getDataBase())
						.getTdbExport().ExportData2Tdb(argin[0], getTimeNow());

				argout = (int) this.dbProxy.getDataBase().getExtractor()
						.getInfSupGetters().getAttDataInfOrSupThanCount(argin);
			} catch (ArchivingException e) {
				throw e.toTangoException();
			}
		}
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_inf_or_sup_than_between_dates(
			String[] argin) throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();

		get_logger().info(
				"Entering get_att_data_inf_or_sup_than_between_dates()");
		...
		if (argin.length != 5) {
			...
			try {
				...
				((TDBDataBaseManager) this.dbProxy.getDataBase())
						.getTdbExport().ExportData2Tdb(argin[0], argin[4]);

				// Get data from db.
				DbData dbData = this.dbProxy.getDataBase().getExtractor()
						.getInfSupGettersBetweenDates()
				...
				get_logger()
						.info(
								"OutOfMemoryError in get_att_data_inf_or_sup_than_between_dates");
				Except
						.throw_exception("MEMORY_ERROR", HintOnMemoryError,
								"TdbExtractor.get_att_data_inf_or_sup_than_between_dates");
			}
		}
		get_logger().info(
				"Exiting get_att_data_inf_or_sup_than_between_dates()");
		return argout;
	}
	 ...
	 */
	// =========================================================
	public int get_att_data_inf_or_sup_than_between_dates_count(String[] argin)
			throws DevFailed {
		int argout = (int) 0;

		get_logger().info(
				"Entering get_att_data_inf_or_sup_than_between_dates_count()");
		...
		if (argin.length != 5) {
			...
			try {
				...
				((TDBDataBaseManager) this.dbProxy.getDataBase())
						.getTdbExport().ExportData2Tdb(argin[0], argin[5]);
		...
		get_logger().info(
				"Exiting get_att_data_inf_or_sup_than_between_dates_count()");
		return argout;
	}
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_inf_than(String[] argin)
			throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();
		...
		if (argin.length != 2) {
			...
			try {
				...
				// Get data from db.
				DbData dbData = this.dbProxy.getDataBase().getExtractor()
						.getInfSupGetters().getAttDataInfThan(argin);
				// Buid an attribute and gets its references
				argout = add_attribute(dbData);
			} catch (ArchivingException e) {
				throw e.toTangoException();
	...
	public int get_att_data_inf_than_count(String[] argin) throws DevFailed {
		...
		if (argin.length != 2) {
			...
			try {
				...
				argout = (int) this.dbProxy.getDataBase().getExtractor()
						.getInfSupGetters().getAttDataInfThanCount(argin);
			} catch (ArchivingException e) {
				throw e.toTangoException();
			}
		}
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_inf_than_between_dates(
			String[] argin) throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();
		...
		if (argin.length != 4) {
			...
			try {
				...
				((TDBDataBaseManager) this.dbProxy.getDataBase())
						.getTdbExport().ExportData2Tdb(argin[0], argin[3]);
	 ...
	 */
	// =========================================================
	public int get_att_data_inf_than_between_dates_count(String[] argin)
			throws DevFailed {
		int argout = (int) 0;

		get_logger().info(
				"Entering get_att_data_inf_than_between_dates_count()");
		...
		get_logger()
				.info("Exiting get_att_data_inf_than_between_dates_count()");
		return argout;
	}
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_last_n(String[] argin)
			throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();
		...
		if (argin.length != 2) {
			...
			try {
				...
				// Get data from db.
				DbData dbData = this.dbProxy.getDataBase().getExtractor()
						.getDataGetters().getAttDataLast_n(argin);
				// Buid an attribute and gets its references
				argout = add_attribute(dbData);
			} catch (ArchivingException e) {
				e.printStackTrace();
	...
	public double get_att_data_max(String argin) throws DevFailed {
		...
		try {
			...
			argout = this.dbProxy.getDataBase().getExtractor()
					.getMinMaxAvgGetters().getAttDataMax(argin);
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	 ...
	 */
	// =========================================================
	public double get_att_data_max_between_dates(String[] argin)
			throws DevFailed {
		double argout = (double) 0;
	...
	public double get_att_data_min(String argin) throws DevFailed {
		...
		try {
			...
			argout = this.dbProxy.getDataBase().getExtractor()
					.getMinMaxAvgGetters().getAttDataMin(argin);
		} catch (ArchivingException e) {
			throw e.toTangoException();
		}
	 ...
	 */
	// =========================================================
	public double get_att_data_min_between_dates(String[] argin)
			throws DevFailed {
		double argout = (double) 0;
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_sup_than(String[] argin)
			throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();
		...
		if (argin.length != 2) {
			...
			try {
				...
				// Get data from db.
				DbData dbData = this.dbProxy.getDataBase().getExtractor()
						.getInfSupGetters().getAttDataSupThan(argin);
				// Buid an attribute and gets its references
				argout = add_attribute(dbData);
			} catch (ArchivingException e) {
				throw e.toTangoException();
	...
	public int get_att_data_sup_than_count(String[] argin) throws DevFailed {
		...
		if (argin.length != 2) {
			...
			try {
				...
				argout = (int) this.dbProxy.getDataBase().getExtractor()
						.getInfSupGetters().getAttDataSupThanCount(argin);
			} catch (ArchivingException e) {
				throw e.toTangoException();
			}
		}
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_sup_and_inf_than(String[] argin)
			throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();
		...
		if (argin.length != 3) {
			...
			try {
				...
				// Get data from db.
				DbData dbData = this.dbProxy.getDataBase().getExtractor()
						.getInfSupGetters().getAttDataSupAndInfThan(argin);
				// Buid an attribute and gets its references
				argout = add_attribute(dbData);
			} catch (ArchivingException e) {
				throw e.toTangoException();
				...
				get_logger().info(
						"OutOfMemoryError in get_att_data_sup_and_inf_than");
				Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
	 ...
	 */
	// =========================================================
	public int get_att_data_sup_and_inf_than_count(String[] argin)
			throws DevFailed {
		int argout = (int) 0;
		...
		if (argin.length != 3) {
			...
			try {
				...
				argout = (int) this.dbProxy.getDataBase().getExtractor()
						.getInfSupGetters().getAttDataSupAndInfThanCount(argin);
			} catch (ArchivingException e) {
				throw e.toTangoException();
			}
		}
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_sup_and_inf_than_between_dates(
			String[] argin) throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();

		get_logger().info(
				"Entering get_att_data_sup_and_inf_than_between_dates()");
		...
		if (argin.length != 5) {
			...
			try {
				...
				get_logger()
						.info(
								"OutOfMemoryError in get_att_data_sup_and_inf_than_between_dates");
				Except
						.throw_exception("MEMORY_ERROR", HintOnMemoryError,
		...
		get_logger().info(
				"Exiting get_att_data_sup_and_inf_than_between_dates()");
		return argout;
	}
	 ...
	 */
	// =========================================================
	public int get_att_data_sup_and_inf_than_between_dates_count(String[] argin)
			throws DevFailed {
		int argout = (int) 0;

		get_logger().info(
				"Entering get_att_data_sup_and_inf_than_between_dates_count()");
		...
		get_logger().info(
				"Exiting get_att_data_sup_and_inf_than_between_dates_count()");
		return argout;
	}
	 ...
	 */
	// =========================================================
	public DevVarLongStringArray get_att_data_sup_than_between_dates(
			String[] argin) throws DevFailed {
		DevVarLongStringArray argout = new DevVarLongStringArray();
		...
		if (argin.length != 4) {
			...
			try {
				...
				get_logger()
						.info(
								"OutOfMemoryError in get_att_data_sup_than_between_dates");
				Except.throw_exception("MEMORY_ERROR", HintOnMemoryError,
	 ...
	 */
	// =========================================================
	public int get_att_data_sup_than_between_dates_count(String[] argin)
			throws DevFailed {
		int argout = (int) 0;

		get_logger().info(
				"Entering get_att_data_sup_than_between_dates_count()");
		...
		get_logger()
				.info("Exiting get_att_data_sup_than_between_dates_count()");
		return argout;
	}
	...
	private DevVarLongStringArray add_attribute(DbData dbData)
			throws DevFailed, ArchivingException {
		if (dbData.getData_timed() == null
				|| dbData.getData_timed().length == 0) {
		...
		case AttrDataFormat._SCALAR:
			// TODO Correction Tango ï¿½ reporter !! Tango [Java side] ne
			...
			if (_2value)
				add_attribute(new Attr(random_name_2, data_type,
						AttrWriteType.READ));
			break;
		...
		case AttrDataFormat._IMAGE:
			add_attribute(new ImageAttr(random_name_1, data_type, dbData
					.getMax_x(), dbData.getMax_y()));
			break;
		}
		...
		if (_2value) {
			...
			tg_2.fill_attr_polling_buffer(this, random_name_2, dbDatas[1]
					.getDataAsTimedAttrData());
		} else {
	 ...
	 * random_name_1; names[ 1 ] = random_name_2; }
	 * 
	 * // Create the attribute depends on DataFormat switch (
	 * dbData.getData_format() ) { case AttrDataFormat._SCALAR: // TODO
	 * Correction Tango ï¿½ reporter !! Tango [Java side] ne supporte pas les
	 * attributs READ-WRITE. //add_attribute(new Attr(random_name_1,
	 * dbData.getData_type(), AttrWriteType.from_int(dbData.getWritable())));
	 * add_attribute(new Attr(random_name_1 , dbData.getData_type() ,
	 * AttrWriteType.READ)); if ( _2value ) add_attribute(new Attr(random_name_2
	 * , dbData.getData_type() , AttrWriteType.READ)); break; case
	 * AttrDataFormat._SPECTRUM: add_attribute(new SpectrumAttr(random_name_1 ,
	 * dbData.getData_type() , dbData.getMax_x())); break; case
	 * AttrDataFormat._IMAGE: add_attribute(new ImageAttr(random_name_1 ,
	 * dbData.getData_type() , dbData.getMax_x() , dbData.getMax_y())); break; }
	 * 
	 * get_logger().info("attr " + random_name_1 + " created"); if ( _2value )
	 * get_logger().info("attr " + random_name_2 + " created");
	 * set_polled_attr(names); set_poll_ring_depth(dbData.size());
	 * 
	 * // Start polling for this device in external sync. mode (udt = 0)
	 ...
	 * "attribute"; poll_1.svalue[ 2 ] = random_name_1;
	 * 
	 * if ( _2value ) { poll_2.lvalue = new int[ 1 ]; poll_2.lvalue[ 0 ] = 0;
	 * poll_2.svalue = new String[ 3 ]; poll_2.svalue[ 0 ] = device_name;
	 * poll_2.svalue[ 1 ] = "attribute"; poll_2.svalue[ 2 ] = random_name_2; }
	 * Util tg_1 = Util.instance();
	 * tg_1.get_dserver_device().add_obj_polling(poll_1 , false);
	 * 
	 * Util tg_2 = Util.instance(); if ( _2value )
	 * tg_2.get_dserver_device().add_obj_polling(poll_2 , false);
	 * 
	 * // And fill buffer with database's data DbData[] dbDatas =
	 * dbData.splitDbData(); tg_1.fill_attr_polling_buffer(this , random_name_1
	 * , dbDatas[ 0 ].getData()); if ( _2value )
	 * tg_2.fill_attr_polling_buffer(this , random_name_2 , dbDatas[ 1
	 * ].getData());
	 * 
	 * argout = new DevVarLongStringArray(); argout.lvalue = new int[ 1 ]; if (
	 * !_2value ) { argout.svalue = new String[ 1 ]; } else { argout.svalue =
	 * new String[ 2 ]; }
	 * 
	 * argout.lvalue[ 0 ] = dbData.getData().length; argout.svalue[ 0 ] =
	 * random_name_1; if ( _2value ) argout.svalue[ 1 ] = random_name_2;
	 * 
	 * return argout; }
	 */
	// ===================================================================
	...
	public static void main(String[] argv) {
		try {
			Util tg = Util.init(argv, "TdbExtractor");
			tg.server_init();
