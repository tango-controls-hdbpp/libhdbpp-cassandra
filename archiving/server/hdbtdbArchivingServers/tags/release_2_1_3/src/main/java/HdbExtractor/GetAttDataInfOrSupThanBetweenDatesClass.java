...
public class GetAttDataInfOrSupThanBetweenDatesClass extends Command implements
		TangoConst {
	// ===============================================================
	/**
	 ...
	 */
	// ===============================================================
	public GetAttDataInfOrSupThanBetweenDatesClass(String name, int in,
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("GetAttDataInfOrSupThanBetweenDatesClass.execute(): arrived");
		String[] argin = extract_DevVarStringArray(in_any);
		return insert(((HdbExtractor) (device))
				.get_att_data_inf_or_sup_than_between_dates(argin));
	}
