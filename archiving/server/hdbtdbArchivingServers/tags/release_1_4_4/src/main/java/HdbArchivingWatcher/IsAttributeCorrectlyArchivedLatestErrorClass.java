//+======================================================================
// $Source: /cvsroot/tango-cs/tango/jserver/archiving/HdbArchivingWatcher/IsAttributeCorrectlyArchivedLatestErrorClass.java,v $
//
...
// $Revision: 1.1 $
//
// $Log: IsAttributeCorrectlyArchivedLatestErrorClass.java,v $
...
public class IsAttributeCorrectlyArchivedLatestErrorClass extends Command implements TangoConst
{
	//===============================================================
	/**
	 *	Constructor for Command class IsAttributeCorrectlyArchivedLatestErrorClass
	 *
	 ...
	 */
	//===============================================================
	public IsAttributeCorrectlyArchivedLatestErrorClass(String name,int in,int out, String in_comments, String out_comments)
	{
	 ...
	 */
	//===============================================================
	public IsAttributeCorrectlyArchivedLatestErrorClass(String name,int in,int out, String in_comments, String out_comments, DispLevel level)
	{
	...
	public Any execute(DeviceImpl device,Any in_any) throws DevFailed
	{
		...
		return insert(((HdbArchivingWatcher)(device)).is_attribute_correctly_archived_latest_error(argin));
	}
...
//-----------------------------------------------------------------------------
/* end of $Source: /cvsroot/tango-cs/tango/jserver/archiving/HdbArchivingWatcher/IsAttributeCorrectlyArchivedLatestErrorClass.java,v $ */
