...
public class GetAttributesByDomainFamilyMembersCountClass extends Command
	 ...
	 */
	// ===============================================================
	public GetAttributesByDomainFamilyMembersCountClass(String name, int in,
			int out) {
		super(name, in, out);
	}
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("GetAttributesByDomainFamilyMembersCountClass.execute(): arrived");
		String[] argin = extract_DevVarStringArray(in_any);
		return insert(((HdbExtractor) (device))
				.get_attributes_by_domain_family_members_count(argin));
	}
