...
public class IsAttributeCorrectlyArchivedCurrentClass extends Command implements
		TangoConst {
	// ===============================================================
	/**
	 ...
	 */
	// ===============================================================
	public IsAttributeCorrectlyArchivedCurrentClass(String name, int in,
	...
	public Any execute(DeviceImpl device, Any in_any) throws DevFailed {
		Util.out2
				.println("IsAttributeCorrectlyArchivedCurrentClass.execute(): arrived");
