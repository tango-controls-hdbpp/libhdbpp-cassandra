...
public abstract class StateScalar extends HdbCollector implements IDevStateScalarListener,
	...
	try {
		 ...
		 * != null ) {
		 */
		final IDevStateScalar attribute = (IDevStateScalar) attributeList
			.get(attributeName);
		if (attribute != null) {
