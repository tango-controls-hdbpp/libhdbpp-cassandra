...
import HdbExtractor.GetAttFullNameClass;
...
public class HdbExtractorClass extends DeviceClass implements TangoConst {
	...
	public void command_factory() {
		...
		command_list.addElement(new RemoveDynamicAttributesClass(
				...
				"", DispLevel.OPERATOR));
        command_list.addElement(new GetAttFullNameClass("GetAttFullName",
                Tango_DEV_SHORT, Tango_DEV_STRING,
                "The id of an attribute",
                "The full name of this attribute",
                DispLevel.OPERATOR));
	...
	public void device_factory(String[] devlist) throws DevFailed {
		...
		for (int i = 0; i < devlist.length; i++) {
			...
			// ----------------------------------------------
			device_list.addElement(new HdbExtractor(this, devlist[i],
					device_version));
