...
//	=========================================================
	...
	public void set_equipments_with_command(String command_name, int snapId) throws DevFailed
	{
		...
		try {
			...
			snapAttributeExtractArray = m_manager.getSnap(snapId);
			...
			if(validSnapshot(snapAttributeExtractArray)){
				...
				for (int i = 0; i < snapAttributeExtractArray.length; i++) {
					System.out.println(snapAttributeExtractArray[i].getdeviceName());
					DeviceProxy deviceProxy = new DeviceProxy(snapAttributeExtractArray[i].getdeviceName());
					DeviceData device_data = new DeviceData();
					snapAttributeExtractArray[i].insertsnapAttributeValue(device_data);

					deviceProxy.command_inout( command_name , device_data);
				}
			}
			else
			{
