...
public abstract class DeviceImplWithShutdownRunnable extends
		DeviceImplWithShutdownHook {
	public DeviceImplWithShutdownRunnable(DeviceClass cl, String d_name)
			throws DevFailed {
		super(cl, d_name);
	...
	public DeviceImplWithShutdownRunnable(DeviceClass cl, String d_name,
			String desc) throws DevFailed {
		super(cl, d_name, desc);
		this.addShutdownRunnable();
	}

	public DeviceImplWithShutdownRunnable(DeviceClass cl, String d_name,
			String de, DevState st, String sta) throws DevFailed {
