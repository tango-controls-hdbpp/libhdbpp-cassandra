...
public abstract class AbstractLogger implements ILogger {
	...
	protected Hashtable<Integer, String> levels;
	protected Hashtable<String, Integer> reverseLevels;
	...
	public void initDiaryWriter(String path, String archiver)
		...
		levels = new Hashtable<Integer, String>(5);
		...
		reverseLevels = new Hashtable<String, Integer>(5);
...
//		}
		...
		/*
		 * DateHeure dh = new DateHeure (); String time =
		 * dh.getHeure()+"_"+dh.getMinute(); absp += "_" + time;
		 */
