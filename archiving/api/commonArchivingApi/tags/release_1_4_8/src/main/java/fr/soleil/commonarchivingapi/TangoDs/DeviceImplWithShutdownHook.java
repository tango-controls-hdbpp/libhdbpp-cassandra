...
public abstract class DeviceImplWithShutdownHook extends DeviceImpl {
	public DeviceImplWithShutdownHook(DeviceClass cl, String d_name)
			throws DevFailed {
		super(cl, d_name);
	}

	public DeviceImplWithShutdownHook(DeviceClass cl, String d_name, String desc)
			throws DevFailed {
		super(cl, d_name, desc);
	}

	public DeviceImplWithShutdownHook(DeviceClass cl, String d_name, String de,
			DevState st, String sta) throws DevFailed {
		super(cl, d_name, de, st, sta);
	}

	private class ShutdownThread extends Thread {
		public ShutdownThread(Runnable runnable) {
			super(runnable, DeviceImplWithShutdownHook.super.device_name
					+ ".ShutdownThread");
		}
	}
