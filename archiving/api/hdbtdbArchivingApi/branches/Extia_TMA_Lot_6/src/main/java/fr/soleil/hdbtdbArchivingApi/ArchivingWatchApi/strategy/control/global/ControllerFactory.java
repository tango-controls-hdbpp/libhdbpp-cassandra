//+======================================================================
//$Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingWatchApi/strategy/control/global/ControllerFactory.java,v $
//
	...
	public static IController getImpl(int typeOfImpl) {
		...
		default:
			throw new IllegalArgumentException(
					"Expected either DUMMY_TYPE (1) or BASIC_TYPE (2) or SECOND_CHANCE_TYPE(3), got "
							+ typeOfImpl + " instead.");
		}
