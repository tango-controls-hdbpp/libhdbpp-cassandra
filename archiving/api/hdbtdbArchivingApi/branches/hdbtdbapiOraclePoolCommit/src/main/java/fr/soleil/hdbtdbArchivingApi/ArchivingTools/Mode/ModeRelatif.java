...
public class ModeRelatif extends ModeRoot {
	...
	public boolean equals(Object o) {
		...
		if (percent_inf != modeRelatif.percent_inf)
			return false;
		if (percent_sup != modeRelatif.percent_sup)
			return false;
		if (slow_drift != modeRelatif.slow_drift)
			return false;
	...
	public String toStringWatcher() {
		return "MODE_R + " + super.getPeriod() + " + " + this.getPercentInf()
				+ " + " + this.getPercentSup() + " + "
				+ Boolean.toString(this.isSlow_drift());
	}
