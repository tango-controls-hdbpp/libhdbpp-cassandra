...
public class MySqlTdbDataExport extends TdbDataExport {
	 ...
	 * @param f
	 */
	public MySqlTdbDataExport(int type) {
		super(type);
	 ...
	 * .DataExport#exportToDB_Data(java.lang.String, java.lang.String,
	...
	private void exportToDB(String tableName, String fullFileName)
		...
		Statement stmt = null;
		fullFileName = fullFileName.replaceAll(new StringBuffer().append(
				File.separator).append(File.separator).toString(),
				new StringBuffer().append(File.separator)
						.append(File.separator).append(File.separator).append(
								File.separator).toString());
		StringBuffer export_query = new StringBuffer().append(
				"LOAD DATA LOCAL INFILE  '").append(fullFileName).append(
				"' INTO TABLE ").append(tableName).append(
