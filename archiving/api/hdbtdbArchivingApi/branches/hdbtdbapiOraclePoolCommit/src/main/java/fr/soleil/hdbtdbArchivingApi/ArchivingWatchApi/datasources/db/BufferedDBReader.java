...
public abstract class BufferedDBReader extends DBReaderAdapter {
	// Store the writable criteria for each attribut : AttrWriteType._READ_WRITE
	// or AttrWriteType._READ or AttrWriteType._WRITE
	private Hashtable<String, Integer> m_nameToWritableCriterionHash;
	// Store the format of each attribut : AttrDataFormat._SCALAR or
	// AttrDataFormat._SPECTRUM ot AttrDataFormat._IMAGE
	...
	public int getAttWritableCriterion(String completeName) throws DevFailed {
		Integer writable = (Integer) this.m_nameToWritableCriterionHash
				.get(completeName);
		if (writable == null) {
	...
	public int getAttFormatCriterion(String completeName) throws DevFailed {
		Integer writable = (Integer) this.m_nameToFormatCriterionHash
				.get(completeName);
		if (writable == null) {
