...
public class AttributeProperties extends AttributesData {
    ...
    /**
     * <b>Description : </b> Returns an array containing the differents properties informations for
     * the given attribute
     * 
     ...
     */
    public Vector<String> getAttPropertiesData(String att_name) throws ArchivingException {
    ...
    public String getDisplayFormat(String att_name) throws ArchivingException {
        ...
        // My statement
        String selectString = "SELECT " + ConfigConst.TAB_PROP[7] + " FROM " + dbConn.getSchema()
                + "." + ConfigConst.TABS[0] + ", " + dbConn.getSchema() + "." + ConfigConst.TABS[1]
                + " WHERE " + ConfigConst.TAB_DEF[2] + " = ?" + " AND " + ConfigConst.TABS[1] + "."
                + ConfigConst.TAB_PROP[0] + "=" + ConfigConst.TABS[0] + "."
