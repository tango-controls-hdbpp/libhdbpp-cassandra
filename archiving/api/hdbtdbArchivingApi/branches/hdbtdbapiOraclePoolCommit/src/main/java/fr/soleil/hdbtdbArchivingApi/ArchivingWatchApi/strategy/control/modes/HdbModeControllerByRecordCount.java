...
public class HdbModeControllerByRecordCount extends HdbModeControllerAdapter {
	...
	protected int controlPeriodicMode(ModePeriode modeP, ArchivingAttribute attr)
		...
		if (modeP == null) {
			Tools
					.trace(
							"HdbModeControllerByRecordCount/controlPeriodicMode/modeP == null!/for attribute|"
		...
		if (recordCount > 0) {
			 ...
			 * "HdbModeControllerByRecordCount/controlPeriodicMode/failed calling isLastValueNull for attribute|"
