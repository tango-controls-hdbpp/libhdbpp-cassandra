...
public class GetConf
{
	...
	public static String readStringInDB(String className, String propertyName) throws ArchivingException
	{
		try
		{
		...
		catch ( DevFailed devFailed )
		{
			...
			String reason = GlobalConst.TANGO_COMM_EXCEPTION + " or " + propertyName + " property missing...";
	...
	public static long  readLongInDB(String className, String propertyName) throws ArchivingException
	{
		try
		{
			Database dbase = ApiUtil.get_db_obj();
			...
			}else return m_DEFAULT_EXPORT_PERIOD_PRECISION_VALUE;
		}
		catch ( DevFailed devFailed )
		{
			String message = GlobalConst.ARCHIVING_ERROR_PREFIX;
			...
			return m_DEFAULT_EXPORT_PERIOD_PRECISION_VALUE;
		}
