...
public class ModeSeuil extends ModeRoot {
	...
	public boolean equals(Object o) {
		...
		if (threshold_inf != ModeSeuil.threshold_inf)
			return false;
		if (threshold_sup != ModeSeuil.threshold_sup)
			return false;
	...
	public String toStringWatcher() {
		return "MODE_T + " + super.getPeriod() + " + " + this.getThresholdInf()
				+ " + " + this.getThresholdSup();
	}
}