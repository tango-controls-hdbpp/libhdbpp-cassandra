...
public class ControlResultLineComparator implements Comparator<ControlResultLine> {

	public ControlResultLineComparator() {
		super();
	}

	public int compare(ControlResultLine obj1, ControlResultLine obj2) {
...
//		return ret;
	...
	private int compareNotNull(Object obj1, Object obj2) {/*ControlResultLine obj1, ControlResultLine obj2) {*/
		if (obj1 instanceof ControlResultLine) {
			...
			return compareObject(attr1, attr2);
