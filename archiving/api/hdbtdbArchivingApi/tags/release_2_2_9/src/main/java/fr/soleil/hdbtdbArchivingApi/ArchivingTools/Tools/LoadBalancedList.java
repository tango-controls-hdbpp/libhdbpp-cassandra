...
//+======================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingTools/Tools/LoadBalancedList.java,v $
//
...
public class LoadBalancedList {
	Hashtable<String, LoadBalancedArchiver> _lblist;
	boolean historic;
	...
	public LoadBalancedList(boolean _historic) {
		_lblist = new Hashtable<String, LoadBalancedArchiver>();
		historic = _historic;
	}
	 ...
	 */
	public void addArchiver(String archiverName, int scLoad, int spLoad,
			int imLoad) {
		/*
		 * if ( !_lblist.containsKey(archiverName) ) CLA 16/11/06 {
		 */
		LoadBalancedArchiver loadBalancedArchiver = new LoadBalancedArchiver(
				scLoad, spLoad, imLoad);
	...
	private String findLightScalarArchiver() {
		String lightArch = "";
		int min_load = -1;
		Enumeration<String> archivers = _lblist.keys();
		while (archivers.hasMoreElements()) {
			String arch = (String) archivers.nextElement();
			/*
			 * Archiver nextVal = new Archiver ( arch ); nextVal.load ();
			 */
			Archiver nextVal;
			try {
	 ...
	 */
	public void addAtt2LBL(String att, int data_format)
			throws ArchivingException {
		String archiverName = findLightArchiver(data_format);
		// System.out.println ( "LoadBalancedList/addAtt2LBL/archiverName|" +
		// archiverName + "|" );
	...
	public void forceAddAtt2Archiver(String att, String arch, int data_format) {
		// System.out.println (
		// "CLA/forceAddAtt2Archiver/att|"+att+"|arch|"+arch+"|");
	...
	public String[] getArchiverAssignedAtt(String archiver) {
		return ((LoadBalancedArchiver) _lblist.get(archiver))
	 ...
	 */
	public Enumeration<String> getArchivers() {
		return _lblist.keys();
	}
