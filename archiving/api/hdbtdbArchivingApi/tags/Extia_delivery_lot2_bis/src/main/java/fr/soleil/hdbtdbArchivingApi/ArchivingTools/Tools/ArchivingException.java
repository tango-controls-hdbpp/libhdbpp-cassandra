...
//+======================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingTools/Tools/ArchivingException.java,v $
//
...
public class ArchivingException extends Exception {
	 ...
	 */
	public ArchivingException(String message, String reason,
			ErrSeverity archSeverity, String desc, String origin) {
		super(message);
		archExcepMessage = message;
		String _reason = (reason.equals(null) || reason.equals("")) ? "Unknown reason"
				: reason;
		ErrSeverity _archSeverity = (archSeverity == null) ? ErrSeverity.WARN
				: archSeverity;
		String _desc = (desc.equals(null) || desc.equals("")) ? "Unknown exception"
				: desc;
		String _origin = (origin.equals(null) || origin.equals("")) ? "Unknown origin"
				: origin;
	...
	public ArchivingException(String message, String reason,
		...
		if (e instanceof DevFailed) {
			...
			ErrSeverity _archSeverity = (archSeverity == null) ? ErrSeverity.WARN
					: archSeverity;
			String _desc = (desc.equals(null) || desc.equals("")) ? "DevFailed EXCEPTION"
					: desc;
			String _origin = (origin.equals(null) || origin.equals("")) ? e
			...
			// The stack of the catched error copied
			System
					.arraycopy(((ArchivingException) e).devErrorTab, 0,
							devErrorTab, 0,
	...
	public void addStack(String message, String reason,
		...
		if (e.devErrorTab != null) {
			if (devErrorTabClone != null) {
				// The current stack is re-initialized
				int devErrorTabLength = e.devErrorTab == null ? 0
						: e.devErrorTab.length;
				devErrorTab = new DevError[devErrorTabClone.length
						+ devErrorTabLength + 1];
				// devErrorTab = new DevError[ devErrorTabClone.length +
		...
		if (devErrorTab != null) {
			for (int i = 0; i < devErrorTab.length; i++) {
				...
				stringBuffer.append("\t [").append(i + 1).append("] : ")
						.append("\r\n");
				stringBuffer.append("\t").append("\t").append("Reason : ")
						.append(devError.reason).append("\r\n");
				stringBuffer.append("\t").append("\t").append("Severity : ")
						.append(errorSeverityToString(devError.severity))
						.append("\r\n");
				stringBuffer.append("\t").append("\t").append("Description : ")
						.append(devError.desc).append("\r\n");
				stringBuffer.append("\t").append("\t").append("Origin : ")
						.append(devError.origin).append("\r\n");
			}
		}
