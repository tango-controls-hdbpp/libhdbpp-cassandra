...
/**
 * Cette classe contient des methodes utiles pour manipuler les chaines de
 * caractere. <BR>
 * Elle contient :
 * <UL>
 * <LI>Une methode {@link #substring(String, int, int) substring(...)} evoluee.
 * <LI>Deux methodes {@link #lTrim(String)} et {@link #rTrim(String)} pour
 * retirer les espaces a gauche ou a droite.
 * <LI>Une methode {@link #remplace(String, String, String) remplace(...)} qui
 * permet de remplacer une chaine dans une autre.
 * <LI>Une methode {@link #separe(String, String)} qui permet de decouper une
 * chaine en fonction d'un delimiteur.
 * <LI>Deux methodes {@link #groupe(String[], String)} et
 * {@link #groupe(String[])} qui permettent de regrouper des chaines separees.
 * <LI>Une methode {@link #compte(String, String)} pour compter le nombre
 * d'occurence d'une chaine dans une autre.
 * <LI>Une methode {@link #repeter(String, int)} qui permet de creer une chaine
 * composee de plusieurs occurences d'une autre chaine.
 * <LI>Une methode {@link #retireAccents(String)} qui permet de retirer les
 * caracteres accentues, et deux autre methodes qui permettent en plus de
 * changer la casse des lettres ({@link #toUpperCaseSansAccents(String)} et
 * {@link #toLowerCaseSansAccents(String)}).
...
public class Chaine {
	// ---------- Constantes ----------
	/*
	 * Cette constante contient les caracteres accentues geres. <BR> Les
	 * equivalents sans accent de ces caracteres sont contenus dans la constante
	...
	/*
	 * Cette constante contient les caracteres sans accent correspondant a la
	 * chaine {@link #CHAR_ACCENTS}.
	 */
	...
	/**
	 * Extrait une chaine de caracteres en fonction de sa position et de sa
	 * longueur. <BR>
	 * Cette methode est relativement sophistiquee, car elle permet d'utiliser
	 * une position et un indice negatifs.
	 * 
	 * @param chaine
	 *            Chaine de caracteres a partir de laquelle on extrait la
	 *            nouvelle chaine.
	 * @param position
	 *            Position de depart de la chaine a extraire (peut etre negatif
	 *            ou superieur a la longueur de <CODE>chaine</CODE>)
	 * @param longueur
	 *            Longueur de la chaine a extraire (peut etre negatif ou plus
	 *            long que <CODE>chaine</CODE>)
	...
	/**
	 * Remplace toutes les occurences de <CODE>aRemplacer</CODE> dans
	 * <CODE>chaine</CODE> par <CODE>remplacement</CODE>.
	 * 
	 * @param chaine
	 *            Chaine dans laquelle on effectue les remplacements.
	 * @param aRemplacer
	 *            Chaine a remplacer.
	 * @param remplacement
	 ...
	 */
	public static String remplace(String chaine, String aRemplacer,
			String remplacement) {
	...
	/**
	 * Separe les champs de <CODE>chaine</CODE> delimites par
	 * <CODE>separateur</CODE> et les renvoie dans un tableau.
	 * 
	 * @param chaine
	...
	/**
	 * Regroupe tous les elements d'un tableau de <CODE>String</CODE> dans une
	 * chaine unique (sans ajout de separateur).
	 * 
	 * @param tableau
	 *            Tableau contenant toutes les chaines a regrouper.
	...
	/**
	 * Regroupe tous les elements d'un tableau de <CODE>String</CODE> dans une
	 * chaine unique en les separant par <CODE>separateur</CODE>.
	 * 
	 * @param tableau
	 *            Tableau contenant toutes les chaines a regrouper.
	 * @param separateur
	 *            Utilise pour separer les differents elements du tableau.
	 * @return Chaine de regroupement.
	 */
	 ...
	 * 
	 * @param chaine
	 *            Chaine dont on souhaite retirer les espaces a gauche.
	 ...
	 * 
	 * @param chaine
	 *            Chaine dont on souhaite retirer les espaces a droite.
	...
	/**
	 * Creation d'une chaine contenant <CODE>nombre</CODE> fois le motif
	 * <CODE>chaine</CODE>.
	 * 
	 * @param chaine
	 *            Motif a repeter.
	 * @param nombre
	 *            Nombre de repetition du motif.
	 * @return Chaine contenant <CODE>nombre</CODE> fois le motif
	 *         <CODE>chaine</CODE>.
	 */
	...
	/**
	 * Compte le nombre d'occurences du motif <CODE>partie</CODE> dans
	 * <CODE>chaine</CODE>.
	 * 
	 * @param chaine
	 *            Chaine dans laquelle on souhaite compter le motif
	 *            <CODE>partie</CODE>.
	 * @param partie
	 *            Motif a compter dans <CODE>chaine</CODE>.
	 * @return Nombre de motifs.
	 */
	public static int compte(String chaine, String partie) {
		if ((chaine == null) || (partie == null) || (chaine.equals(""))
				|| (partie.equals(""))) {
			return 0;
		}
	...
	/**
	 * Convertion d'un <CODE>byte</CODE> en hexadecimal (resultat sur 8 bits). <BR>
	 * <B>Attention :</B> Seuls les 8 bits de poids faible sont convertis. Les
	 * autres bits sont ignores.
	 * 
	 * @param nombre
	 *            Nombre 8 bits a convertir en hexadecimal.
	...
	/**
	 * Convertion d'un <CODE>short</CODE> en hexadecimal (resultat sur 16 bits). <BR>
	 * <B>Attention :</B> Seuls les 16 bits de poids faible sont convertis. Les
	 * autres bits sont ignores.
	 * 
	 * @param nombre
	 *            Nombre 16 bits a convertir en hexadecimal.
	 * @return Chaine representant le nombre en hexadecimal.
	 */
	 ...
	 * 
	 * @param caractere
	 *            Caractere a convertir en hexadecimal.
	 * @return Chaine representant le nombre en hexadecimal.
	 */
	 ...
	 * 
	 * @param nombre
	 *            Nombre 32 bits a convertir en hexadecimal.
	 * @return Chaine representant le nombre en hexadecimal.
	 */
	...
	// ---------- Constructeur ----------
	/*
	 * Constructeur declare <CODE>private</CODE> pour empecher l'instanciation
	 * de la classe.
	 */
	private Chaine() {
	}
