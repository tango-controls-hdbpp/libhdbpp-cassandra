...
public class AttributeLight {
	...
	/*
	 * public static int getAttributeLight_length() { return
	 * attributeLight_length; }
	 */
	...
	/**
	 * Sets the AttributeLight's <I>type property</I>
	 * (DevShort/DevLong/DevDouble)
	 * 
	 * @param data_type
	 *            the AttributeLight's <I>type property</I>
	 *            (DevShort/DevLong/DevDouble)
	 */
	...
	/**
	 * Sets the AttributeLight's <I>data format property</I>
	 * (SCALAR/SPECTRUM/IMAGE)
	 * 
	 * @param data_format
	 *            the AttributeLight's <I>data format property</I>
	 *            (SCALAR/SPECTRUM/IMAGE)
	 */
	 ...
	 * 
	 * @param writable
	 *            the AttributeLight's <I>writable property</I>
	 *            (READ/READ_WRITE/READ_WITH_WRITE).
	 */
	...
	public boolean equals(Object o) {
		...
		if (data_format != attributeLight.data_format)
			return false;
		if (data_type != attributeLight.data_type)
			return false;
		if (writable != attributeLight.writable)
			return false;
		if (!attribute_complete_name
				.equals(attributeLight.attribute_complete_name))
			return false;
