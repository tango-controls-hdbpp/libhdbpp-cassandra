...
public class SpectrumEvent_RW extends ArchivingEvent {
	...
	public SpectrumEvent_RW(String[] hdbSpectrumEvent_ro) {
		...
		for (int i = 0; i < value.length; i++) {
			if (hdbSpectrumEvent_ro[i + 4] == null
					|| "".equals(hdbSpectrumEvent_ro[i + 4])
					|| "null".equals(hdbSpectrumEvent_ro[i + 4])) {
				value[i] = null;
			} else {
	...
	public String toString() {
		...
		event_String.append("Source : \t").append(getAttribute_complete_name())
				.append("\r\n");
		event_String.append("TimeSt : \t").append(getTimeStamp())
				.append("\r\n");
