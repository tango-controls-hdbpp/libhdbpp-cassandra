...
public class RelativeSaferPeriodCalculator implements ISaferPeriodCalculator 
{
    ...
    /* (non-Javadoc)
     * @see fr.soleil.hdbtdbArchivingApi.ArchivingWatchApi.strategy.control.safetyperiod.ISaferPeriodCalculator#getSaferPeriod(int)
     */
    ...
    /* (non-Javadoc)
     * @see fr.soleil.hdbtdbArchivingApi.ArchivingWatchApi.strategy.control.safetyperiod.ISaferPeriodCalculator#getCalculationDescription()
     */
