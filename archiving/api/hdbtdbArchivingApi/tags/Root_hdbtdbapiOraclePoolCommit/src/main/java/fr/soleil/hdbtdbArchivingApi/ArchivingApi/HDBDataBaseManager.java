...
public class HDBDataBaseManager extends DataBaseManager {
	 ...
	 * 
	 */
	public IHdbAttributeInsert getHdbAttributeInsert()
			throws ArchivingException {
		if (attributeInsert == null)
			attributeInsert = HdbAttributeInsertFactroy.getInstance(
					archivingType, getAttribute());
	 ...
	 * 
	 * @see
	 * fr.soleil.hdbtdbArchivingApi.ArchivingApi.DataBaseManager#getArchivingType
	 * (int)
	 */
