...
public abstract class AbstractMySqlConnection extends DBConnection {
	...
	public AbstractMySqlConnection(int type, String host, String name, String schema,
...
//		// TODO Auto-generated method stub
//		url = ConfigConst.DRIVER_MYSQL + "://" + getHost() + "/" + getName(); // D�finition
//																				// du
//																				// pilote
//																				// MySQL
//		System.out
...
//	}
	...
	public void connect(boolean rac) throws ArchivingException {
		...
		try {
			...
			// cache parms
			dataSource.setMetadataCacheSize(50); // Taille du pool device property a ajouter
