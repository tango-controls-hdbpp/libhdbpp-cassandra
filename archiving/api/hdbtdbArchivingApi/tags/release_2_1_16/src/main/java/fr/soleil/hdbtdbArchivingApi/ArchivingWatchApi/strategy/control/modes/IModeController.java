...
public interface IModeController {
	...
	/**
	 * The control that was supposed to find out whether the attribute is
	 * archiving correctly or not failed
	 */
	...
	/**
	 * The attribute is archiving, but the control that was supposed to find out
	 * whether the attribute's most recent archived value is null or not failed
	 */
	...
	/**
	 * Controls the archiving of a given attribute with respect to a theoretical
	 * global mode.
	 * 
	 * @param mode
	 *            The global archiving mode to control
	 * @param attr
	 *            The attribute to control
