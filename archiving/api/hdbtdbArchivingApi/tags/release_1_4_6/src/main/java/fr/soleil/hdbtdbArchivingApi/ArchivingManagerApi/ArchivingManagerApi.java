...
//$Log: ArchivingManagerApi.java,v $
//Revision 1.63  2007/10/19 14:01:50  soleilarc
//Author: XP
//Mantis bug ID: 7027
//Comment: In the getArchiverListSize method, add 2 lines with “return 0” if the data m_xxxExportedArchiverList is null (xxx = hdb or tdb).

//Revision 1.62  2007/06/18 12:50:28  pierrejoseph
//minor changes
...
//Some constants were moved from fr.soleil.TangoArchiving.ArchivingApi.ConfigConst to fr.soleil.hdbtdbArchivingApi.ArchivingTools.Tools.GlobalConst.
...
//	//Export period precision value (15 min)
//	private static final long m_EXPORT_PERIOD_PRECISION_VALUE = 900000;  
	...
	private static String[] split_att_name_3_fields(String att_name)
	{
		...
		String[] decoupe; // dï¿½coupage en 5 partie : host, domain, family, member, attribut
	 ...
	 * @throws ArchivingException
	 */
	private void connectArchivingDatabase(boolean historic , String mdbhost , String mdbname, String muser , String mpassword) throws ArchivingException
	{
	 ...
	 * @throws ArchivingException
	 */
	public void ArchivingConfigure(String host , String name ,String user , String password , boolean historic) throws ArchivingException
	{
		System.out.println( "ArchivingConfigure/historic/"+historic);

		ArchivingConfigureWithoutArchiverListInit( host, name, user ,  password ,  historic);

		// The created lists are useful during the start archiving action 
		initDbArchiverList ( historic );
	}

	public void ArchivingConfigureWithoutArchiverListInit(String host , String name, String user , String password , boolean historic) throws ArchivingException
	{
		...
		// Database connection
		connectArchivingDatabase(historic , host, name, user , password);
	}
	...
	public static Hashtable getClassAndDevices(String domain) throws ArchivingException
	{
		...
		catch ( DevFailed devFailed )
		{
			...
			String message = GlobalConst.ARCHIVING_ERROR_PREFIX;
			String reason = GlobalConst.TANGO_COMM_EXCEPTION;
			String desc = "Failed while executing ArchivingManagerApi.getClassAndDevices() method for domain = " + domain;
			throw new ArchivingException(message , reason , ErrSeverity.WARN , desc , "" , devFailed);
		}
	}
