...
public class ControlResult 
{
    ...
    public String getReportHeader() throws DevFailed 
    {
        ...
        buff.append ( "Number of attributes with null values: " + this.getNumberOfAttributesControlledWithSuccessWithNullValue () );
    ...
    private void buildLines ( Hashtable _lines ) throws DevFailed 
    {
        ...
        this.setNumberOfAttributesControlledWithSuccessWithNullValue(_numberOfAttributesOKWithNullValues);
    }
    ...
    /**
     * @return Returns the m_numberOfAttributesControlledWithSuccessWithNullValue.
     */
    ...
    /**
     * @param numberOfAttributesControlledWithSuccessWithNullValue The numberOfAttributesControlledWithSuccessWithNullValue to set.
     */
    private void setNumberOfAttributesControlledWithSuccessWithNullValue(int numberOfAttributesControlledWithSuccessWithNullValue) 
    {
