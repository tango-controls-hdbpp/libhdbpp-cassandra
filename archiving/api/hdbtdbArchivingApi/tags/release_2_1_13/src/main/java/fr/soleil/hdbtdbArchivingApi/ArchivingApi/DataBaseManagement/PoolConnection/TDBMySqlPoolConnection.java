...
public class TDBMySqlPoolConnection implements IPoolConnection {
	...
	public DataSource getPoolInstance(String url, String user, String pwd)
		...
		if (dataSource == null) {
			...
			try {
				...
				// cache parms
				((MysqlDataSource) dataSource).setMetadataCacheSize(50); // device
																			// property
				if (conn != null)
					conn.close();
				...
				throw new ArchivingException(mysqlMessage, mysqlReason,
						ErrSeverity.PANIC, mysqlDesc, "");
