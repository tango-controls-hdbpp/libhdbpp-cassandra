...
public interface IChoosingStrategy {
	/**
	 * @param allAttributes
	 *            The whole set of archiving HDB attributes: a Hashtable which
	 *            keys are the attributes complete names, and which values are
	 *            the associated ModeData.
	...
	/**
	 * 
	 * @return The number of attributes that have to be controlled according to
	 *         this filter
	 */
