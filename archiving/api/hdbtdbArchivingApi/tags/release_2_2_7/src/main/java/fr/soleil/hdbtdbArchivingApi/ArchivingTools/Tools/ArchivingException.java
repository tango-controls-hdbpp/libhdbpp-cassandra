...
// +======================================================================
// $Source:
// /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingTools/Tools/ArchivingException.java,v
// $
//
...
// $Revision: 1.8 $
//
// $Log: ArchivingException.java,v $
// Revision 1.8 2007/10/18 15:28:37 pierrejoseph
// Else if was missing in one constructor
//
...
public class ArchivingException extends Exception {
    ...
    /**
     * This class can be instanciated when exceptions in the archiving service. Exceptions can be :
     * ConnectionException, ATKException
     */
    public ArchivingException(String message, String reason, ErrSeverity archSeverity, String desc,
            String origin) {
        super(message);
        archExcepMessage = message;
    ...
    public ArchivingException(String message, String reason, ErrSeverity archSeverity, String desc,
        ...
        if (e instanceof DevFailed) {
            ...
            System.arraycopy(((DevFailed) e).errors, 0, devErrorTab, 0,
                    ((DevFailed) e).errors.length);
            ...
            String _origin = (origin.equals(null) || origin.equals("")) ? e.getClass().getName()
                    : origin;
            DevError devError = new DevError(_reason, _archSeverity, _desc, _origin);
            ...
            // The stack of the catched error copied
            System.arraycopy(((ArchivingException) e).devErrorTab, 0, devErrorTab, 0,
                    ((ArchivingException) e).devErrorTab.length);
            // A new DevError object is built with the given parameters
            String _reason = (reason.equals(null) || reason.equals("")) ? "Unknown reason" : reason;
            ErrSeverity _archSeverity = (archSeverity == null) ? ErrSeverity.WARN : archSeverity;
            String _desc = (desc.equals(null) || desc.equals("")) ? "Unknown exception" : desc;
            ...
            DevError devError_original = new DevError(reason_original, archSeverity_original,
    ...
    public void addStack(String message, ArchivingException e) {
        ...
        if (e.devErrorTab != null) {
            if (devErrorTabClone != null) {
                ...
                // The stack of the catched error copied
                System.arraycopy(e.devErrorTab, 0, devErrorTab, devErrorTabClone.length,
    ...
    public void addStack(String message, String reason, ErrSeverity archSeverity, String desc,
            String origin, ArchivingException e) {
        if (e.isDueToATimeOut()) {
            this.setDueToATimeOut(true);
        }
    ...
    public String getLastExceptionReason() {
        return devErrorTab[0].reason;
    }

    public String getLastExceptionOrigin() {
        return devErrorTab[0].origin;
    }
    ...
    public String toString() {
        ...
        if (devErrorTab != null) {
            for (int i = 0; i < devErrorTab.length; i++) {
                ...
                stringBuffer.append("\t").append("\t").append("Reason : ").append(devError.reason)
                        .append("\r\n");
                stringBuffer.append("\t").append("\t").append("Severity : ").append(
                        errorSeverityToString(devError.severity)).append("\r\n");
                stringBuffer.append("\t").append("\t").append("Description : ").append(
                        devError.desc).append("\r\n");
                stringBuffer.append("\t").append("\t").append("Origin : ").append(devError.origin)
                        .append("\r\n");
            }
        }
