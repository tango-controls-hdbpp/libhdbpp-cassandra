 ...
 */
package fr.soleil.hdbtdbArchivingApi.ArchivingWatchApi.tools;
...
public class Tools {
	 ...
	 * <UL>
	 * <LI>If the archiving watcher runs in standalone mode, usual System.out
	 * logs
	 * <LI>If the archiving watcher runs in device mode, the device's tango
	 * logging
	 * </UL>
	 * 
	 * @param msg
