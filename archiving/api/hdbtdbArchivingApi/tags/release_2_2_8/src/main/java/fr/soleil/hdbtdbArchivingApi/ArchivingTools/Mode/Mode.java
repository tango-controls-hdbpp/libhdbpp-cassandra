...
public class Mode {
	...
	buf.append("periodic", mode_p);
	buf.append("absolute", mode_a);
	buf.append("relative", mode_r);
	buf.append("threshold", mode_s);
	buf.append("calculation", mode_c);
	buf.append("difference", mode_d);
	buf.append("extenal", mode_e);
