...
public class ShortPeriodAttributesManager {
	...
	final String[] shortPeriodAttributesArray = GetConf.readStringArrayInDB(
		ConfigConst.HDB_CLASS_DEVICE, m_shortAttributesListProperty);
	if (shortPeriodAttributesArray != null) {
		...
		if (attribute != null && !attribute.trim().isEmpty()) {
			...
			if (attributeName.isEmpty()) {
			    ...
			    throw new ArchivingException(message, DEFAULT_INIT_LIST_REASON,
	...
	return new ArchivingException(GlobalConst.ARCHIVING_ERROR_PREFIX + "WRONG_FORMAT",
		DEFAULT_INIT_LIST_REASON, ErrSeverity.ERR,
     ...
     * map
     */
    public static boolean isShortPeriodAttribute(final String attributeName)
     ...
     */
    public static Integer getPeriodFromShortAttributeName(final String attributeName)
	    throws ArchivingException {
	if (attributeName == null) {
	    return null;
	}
