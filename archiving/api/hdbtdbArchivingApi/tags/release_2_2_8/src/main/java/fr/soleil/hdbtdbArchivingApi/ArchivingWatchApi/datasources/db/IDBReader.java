...
/**
 * Contains methods to access the necessary HDB data for the Archiving Watcher
 * API
 *
 * @author CLAISSE
 */
public interface IDBReader {
	 ...
	 *
	 * @param forceOpening
	 *            True if the method must reconnect even if already connected
	 * @throws DevFailed
	 */
	...
	/**
	 * Loads from the HDB table AMT into a Hashtable the attributes that are
	 * supposed to be archiving. The keys are the attributes complete names, the
	 * values are ModeData objects that describe a given attribute's archiving.
	 *
	 * @return A Hashtable which keys are the attributes complete names, and
	 *         which values are ModeData objects that describe a given
	 *         attribute's archiving.
	 * @throws DevFailed
	 */
	public Hashtable<String, ModeData> getArchivedAttributes() throws DevFailed;

	/**
	 * Loads from the HDB table ADT the attribute corresponding to the
	 * attribute's name.
	 *
	...
	/**
	 * Returns a String array which contains as first element the time value and
	 * the second element indicates if the corresponding value is null or not
	...
	/**
	 * Returns the number of records for a given attribute, that are more recent
	 * than a given age.
	 *
	 * @param completeName
	 *            The attribute's complete name
	...
	/**
	 * Returns whether a given attribute's most recent recorded value is null or
	 * otherwise empty
	 *
	 * @param completeName
	 *            The attribute's complete name
	 ...
	 *
	 * @param archiverName
	 *            The archiver's complete name
	 * @param loadType
	 *            The type of load, can be any of
	 *            (LOAD_ALL,LOAD_SCALAR,LOAD_SPECTRUM,LOAD_IMAGE)
	 ...
	 *
	 * @param completeName
	 * @return AttrWriteType._READ_WRITE or AttrWriteType._READ or
	 *         AttrWriteType._WRITE
	 * @throws DevFailed
	 */
	 ...
	 *
	 * @param completeName
	 * @return AttrDataFormat._SCALAR or AttrDataFormat._SPECTRUM ot
	 *         AttrDataFormat._IMAGE
	 * @throws DevFailed
	 */
