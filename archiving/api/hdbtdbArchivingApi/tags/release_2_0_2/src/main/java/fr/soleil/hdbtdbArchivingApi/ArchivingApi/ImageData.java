...
{
	/*
	 * TODO : TANGO WEB WARNING : 
	 * We need to implement the java.io.serializable interface
	 * AND
	 * We need to correct the load() method 
	 * */
    ...
    private AttributeExtractor databaseExtractor;
     ...
     * 
     */
    public ImageData(AttributeExtractor _ext) 
    {
        super();
        this.databaseExtractor = _ext;
    }
    ...
    public void load() throws ArchivingException 
    {
    	/*
    	 * TODO 
    	 * Correct this method to use the same system of Mambo's life cycle with an interface and two implementation (classic and web)
    	 * Data and treatment will be in different class 
    	 */
        double [][] _value = databaseExtractor.getAttImageDataForDate ( this.name , this.date.toString () );
        this.value = _value;
    }
