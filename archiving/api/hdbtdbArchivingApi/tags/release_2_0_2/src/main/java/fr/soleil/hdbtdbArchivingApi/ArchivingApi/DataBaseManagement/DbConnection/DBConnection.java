...
//	private Connection conn;
	 ...
	 */
	public DBConnection(IPoolConnection pc)
	{
	 ...
	 */
	public DBConnection(String host_name , String db_name , String db_schema, IPoolConnection pc)
	{
		idsBuffer = new Hashtable ();
	 ...
	 */
	public DBConnection(String host_name , String db_name , String db_schema , String user_name , String password, IPoolConnection pc)
	{
		this(host_name , db_name , db_schema, pc);        
		setUser(user_name);
		setPasswd(password);
	}
