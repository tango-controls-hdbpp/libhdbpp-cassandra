...
public class OracleConnection extends DBConnection {
	...
	public OracleConnection( int type, String host , String name , String schema , String user , String pass){
	...
	public void connect(boolean rac) throws ArchivingException
	{
		...
		try
		{
			...
			String url = rac?"jdbc:oracle:oci8:@"+getName():ConfigConst.DRIVER_ORACLE + ":@" + getHost() + ":" + ConfigConst.ORACLE_PORT + ":" + getName(); //pilote Oracle;
			String driver = rac?"oracle.jdbc.driver.OracleDriver":ConfigConst.DRIVER_ORACLE;
			setDriver( driver );
...
//			conn = getConnection();
		...
		{
			String message  =  DbUtilsFactory.getInstance(getDbType()).getCommunicationFailureMessage(e); 
