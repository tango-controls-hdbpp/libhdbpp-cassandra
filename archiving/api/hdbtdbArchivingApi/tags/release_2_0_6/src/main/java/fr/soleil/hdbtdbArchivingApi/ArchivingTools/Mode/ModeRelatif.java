...
public class ModeRelatif extends ModeRoot
{
	 ...
	 * @param p_inf the lower proportion limit
	 * @param p_sup the upper proportion limit
	 * @param sd the slow drift option
	 */
	public ModeRelatif(int pe , double p_inf , double p_sup, boolean sd)
	{
		super.period = pe;
		percent_inf = Math.abs(p_inf);
		percent_sup = Math.abs(p_sup);
	...
	public String toString()
	{
		...
		buf.append("[" + Tag.MODE_R_TAG + "\t\r\n" +
		           ...
		           "\t" + Tag.MODE_R3_TAG + " = \"" + Boolean.toString(this.isSlow_drift()) + "\" )]\r\n");
		return buf.toString();
	}
	...
	public boolean equals(Object o)
	{
		...
		if ( slow_drift != modeRelatif.slow_drift ) return false;
    ...
    {
        return "MODE_R + " + super.getPeriod() + " + " + this.getPercentInf() + " + " + this.getPercentSup() + " + " + Boolean.toString(this.isSlow_drift());
    }
	...
	public void setPrev_stored_val(double prev_stored_val) {
	...
	public void setSlow_drift(boolean slow_drift) {
