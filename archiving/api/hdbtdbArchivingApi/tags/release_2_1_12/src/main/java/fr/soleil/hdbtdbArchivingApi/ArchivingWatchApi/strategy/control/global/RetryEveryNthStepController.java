...
public class RetryEveryNthStepController extends RetryAtEachStepController {
	...
	/**
	 * @param numberOfStepsBetweenTwoRetries
	 *            The numberOfStepsBetweenTwoRetries to set.
	 */
	protected void setNumberOfStepsBetweenTwoRetries(
			int numberOfStepsBetweenTwoRetries) {
