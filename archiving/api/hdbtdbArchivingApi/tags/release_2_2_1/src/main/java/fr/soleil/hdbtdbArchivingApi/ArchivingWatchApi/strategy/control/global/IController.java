...
public interface IController {
	 ...
	 * 
	 * @param attributesToControl
	 *            A hashtable which keys are the attributes complete names, and
	 *            which values are ModeData objects describing their theoretical
	 *            archiving.
	 */
	 ...
	 *            True if investigation of KO archivers (archivers that have at
	 *            least 1 KO attribute) is required
	 ...
	 * 
	 * @param control
	 *            The control's result to use
	 * @return A return code, has to be either NO_ACTION_NEEDED,
	 *         ACTION_SUCCESSED, or ACTION_FAILED
	 */
