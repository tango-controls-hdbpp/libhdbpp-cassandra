...
public class ConfigConst {
	 ...
	 */
	public static final String[] TABS = { "adt", "apt", "amt",
			"isalived",
			"statpart", // 0 ->4
	 ...
	 * lenght will be 25
	 */
	public static final String[] TAB_MOD = { "ID", "archiver",
			"start_date",
			"stop_date", // 0 -> 3
			"per_mod",
			"per_per_mod", // 4 -> 5
			"abs_mod", "per_abs_mod", "dec_del_abs_mod",
			"gro_del_abs_mod", // 6 -> 9
			"rel_mod", "per_rel_mod", "n_percent_rel_mod",
			"p_percent_rel_mod", // 10 -> 13
			"thr_mod", "per_thr_mod", "min_val_thr_mod",
			"max_val_thr_mod", // 14 -> 17
			"cal_mod", "per_cal_mod", "val_cal_mod", "type_cal_mod",
			"algo_cal_mod", // 18 -> 22
			"dif_mod", "per_dif_mod", "ext_mod", // 23 -> 25
			"export_per", "keeping_per" }; // 26 -> 27

	public static final String[] TAB_ISALIVED = { "status", "full_name", "id",
			"archiver", "maxtime" }; // 0->4
	public static final String[] TAB_PARTITION = { "nb", "partition_name" }; // 0->1
	public static final String[] TAB_LOG_JOB = { "log_id", "log_date",
			"owner",
			"job_name", // 0->3
			"job_subname", "job_class", "operation", "status", "user_name",
			"client_id", // 4 ->9
			"global_uid", "additional_info" }; // 10->11

	public static final String[] TAB_RUN_DETAILS = { "log_id",
			"log_date",
			"owner",
			"job_name", // 0->3
			"job_subname", "status", "error#", "req_start_date",
			"actual_start_date",
			"run_duration", // 4 ->9
			"instance_id", "session_id", "slave_pid", "cpu_used",
			"additional_info" }; // 10->14
	 ...
	 * Attribute's Table
	 */
	public static final String[] TAB_SCALAR_RW = { "time", "read_value",
			"write_value" };
	/**
	 ...
	 * Attribute's Table
	 */
	public static final String[] TAB_SPECTRUM_RW = { "time", "dim_x",
			"read_value", "write_value" };
	/**
	 * Array that contains the name's fields for the Image_Read Attribute's
	 * Table
	 */
	public static final String[] TAB_IMAGE_RO = { "time", "dim_x", "dim_y",
			"value" };
	/**
	 * Array that contains the name's fields for the Image_ReadWrite Attribute's
	 * Table
	 */
	public static final String[] TAB_IMAGE_RW = { "time", "dim_x", "dim_y",
			"read_value", "write_value" };
	...
	// todo mettre en place une solution plus générique pour le
	// "common_dir_path"
	static String common_dir_path = "D:" + File.separator + "Temporaire"
			+ File.separator + "partage";
