...
public class OracleConnection extends DBConnection {
	public OracleConnection(int type) {
		super();
		setDriver(ConfigConst.DRIVER_ORACLE);
		setDbType(type);
	}

	public OracleConnection(int type, String host, String name, String schema,
	...
	protected void setDataBaseUrl(String url) {
		// TODO Auto-generated method stub
		url = ConfigConst.DRIVER_ORACLE + ":@" + getHost() + ":"
				+ ConfigConst.ORACLE_PORT + ":" + getName(); // pilote Oracle
		System.out.println("DBConnection/buildUrlAndConnect/BD_ORACLE/url|"
				+ url);
