...
public class ConnectionFactory {
	...
	private static IDBConnection getDbConnection(int type) {
		...
		IPoolConnection pc = PoolConnectionFactory.getInstance(type);
		int dbType = DbUtils.getDbType(type);
		IDbUtils dbUtils = DbUtilsFactory.getInstance(dbType);

		switch(dbType){
		case ConfigConst.BD_MYSQL:
			return  new MySqlConnection(type, dbUtils, pc);
		case ConfigConst.BD_ORACLE:
			return  new OracleConnection(type, dbUtils, pc);
		}
		return null;
	 ...
	 * 
	 */
	public  static IDBConnection connect_auto(String host, String name, String schema, String user, String pass, int type) throws ArchivingException
	{
	...
	private static IDBConnection getDbConnection(int type, String host,
		...
		switch(dbType){
		case ConfigConst.BD_MYSQL:
			return  new MySqlConnection(type, dbUtils, host, name, schema, user, pass, pc);
		case ConfigConst.BD_ORACLE:
			return  new OracleConnection(type, dbUtils, host, name, schema, user, pass, pc);
		}
		return null;
