...
//          System.out.println ( "-------------/now/"+now );
            ...
            int saferPeriod = saferPeriodCalculator.getSaferPeriod ( modeP.getPeriod () );
        ...
        {
            Tools.trace ( "HdbModeControllerByRecordCount/controlPeriodicMode/failed calling getRecordCount for attribute|"+_completeName+"|" , e , Warnable.LOG_LEVEL_WARN );
            return IModeController.CONTROL_FAILED;
        }
        catch(Exception e)
        {
        	Tools.trace ( "HdbModeControllerByRecordCount/controlPeriodicMode/failed calling for attribute|"+_completeName+"|" , e , Warnable.LOG_LEVEL_WARN );
        	return IModeController.CONTROL_FAILED;
        }
    } 
