...
public   class TdbMode extends GenericMode {
	 ...
	 * @param c
	 */
	public TdbMode(IDbMode m, IDBConnection c) {
		super(m, c);
		// TODO Auto-generated constructor stub
	}
	/* (non-Javadoc)
	 * @see fr.soleil.hdbtdbArchivingApi.ArchivingApi.ModesManagement.IMode#getSelectField(java.lang.String)
	 */
	public String getSelectField(String select_field) {
		// TODO Auto-generated method stub
		return select_field + ", " + ConfigConst.TABS[ 2 ] + "." + ConfigConst.TAB_MOD[ 26 ] + ", " +
        	ConfigConst.TABS[ 2 ] + "." + ConfigConst.TAB_MOD[ 27 ];
	}

	/* (non-Javadoc)
	 * @see fr.soleil.hdbtdbArchivingApi.ArchivingApi.ModesManagement.IMode#setSpec(fr.soleil.hdbtdbArchivingApi.ArchivingTools.Mode.Mode, java.sql.ResultSet)
	 */
	public void setSpec(Mode mode, ResultSet rset) {
		// TODO Auto-generated method stub
		TdbSpec tdbSpec;
		try {
			tdbSpec = new TdbSpec(rset.getInt(ConfigConst.TAB_MOD[ 26 ]) , rset.getInt(ConfigConst.TAB_MOD[ 27 ]));
	...
	public void updateSelectField(StringBuffer select_field) {
		// TODO Auto-generated method stub
		select_field.append(", ").append(ConfigConst.TABS[ 2 ]).append(".").append(ConfigConst.TAB_MOD[ 26 ])
		.append(", ").append(ConfigConst.TABS[ 2 ]).append(".").append(ConfigConst.TAB_MOD[ 27 ]);
     ...
     */
	@Override
	protected void setSpecificStatementForInsertMode(PreparedStatement preparedStatement,
