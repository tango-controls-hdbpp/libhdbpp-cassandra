...
//+======================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingTools/Tools/DateUtil.java,v $
//
	...
	static public long stringToMilli(String date) throws ArchivingException
	{
		...
		catch ( ParseException e1 )
		{
            ...
            catch ( Exception e )
            {
                ...
                archivingException = new ArchivingException(message , reason , ErrSeverity.WARN , desc , "fr.soleil.hdbtdbArchivingApi.ArchivingTools.Tools.DateUtil" , e1);
