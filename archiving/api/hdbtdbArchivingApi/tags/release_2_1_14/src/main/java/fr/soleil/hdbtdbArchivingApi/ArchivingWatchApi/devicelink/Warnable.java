 ...
 */
package fr.soleil.hdbtdbArchivingApi.ArchivingWatchApi.devicelink;

import fr.esrf.Tango.DevFailed;

/**
 * Models a device that can be warned by the API classes. Typically, one wants
 * to use the ArchivingWatcher device's Tango methods of logging, state setting
 * and warning, but from the API classes.
 * 
 * @author CLAISSE
 */
