...
public class GetConf {
    ...
    public static String[] readStringArrayInDB(String className,
            String propertyName) throws ArchivingException {
        try {
            Database dbase = ApiUtil.get_db_obj();
            ...
            String reason = GlobalConst.TANGO_COMM_EXCEPTION + " or "
                    + propertyName + " property missing...";
            String desc = "Failed while executing GetConf.readStringArrayInDB() method ";
            throw new ArchivingException(message, reason, ErrSeverity.WARN,
                    desc, "", devFailed);
        }
    }

    public static boolean readBooleanInDB(String className, String propertyName)
            throws ArchivingException {
        try {
            Database dbase = ApiUtil.get_db_obj();
            ...
            String reason = GlobalConst.TANGO_COMM_EXCEPTION + " or "
                    + propertyName + " property missing...";
            String desc = "Failed while executing GetConf.readBooleanInDB() method ";
            throw new ArchivingException(message, reason, ErrSeverity.WARN,
                    desc, "", devFailed);
        }
    }

    public static short readShortInDB(String className, String propertyName,
            final short defaultValue) throws ArchivingException {
        ...
        try {
            ...
            String reason = GlobalConst.TANGO_COMM_EXCEPTION + " or "
                    + propertyName + " property missing...";
            String desc = "Failed while executing GetConf.readShortInDB() method ";
            throw new ArchivingException(message, reason, ErrSeverity.WARN,
                    desc, "", devFailed);
        } catch (Exception e) {
            String message = GlobalConst.ARCHIVING_ERROR_PREFIX;
