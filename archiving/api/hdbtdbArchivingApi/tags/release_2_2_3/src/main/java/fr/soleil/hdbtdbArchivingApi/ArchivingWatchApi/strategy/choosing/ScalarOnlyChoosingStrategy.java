...
public class ScalarOnlyChoosingStrategy implements IChoosingStrategy {
	 ...
	 * (java.util.Hashtable)
	 */
	public Hashtable filterAttributesToControl(Hashtable allAttributes)// throws
																		// DevFailed
	{
		...
		if (allAttributes == null) {
			Tools
					.trace(
							"ScalarOnlyChoosingStrategy/chooseAttributesToControl/allAttributes == null !!!!",
		...
		while (keys.hasMoreElements()) {
			...
			try {
				...
				Tools
						.trace(
								"ScalarOnlyChoosingStrategy/chooseAttributesToControl/failed during call to isScalar ( "
										+ key + " )", e,
								Warnable.LOG_LEVEL_WARN);
