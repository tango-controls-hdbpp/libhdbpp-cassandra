...
public class AttributeLightMode extends AttributeLight {
	...
	public AttributeLightMode(String fullName,
			fr.soleil.hdbtdbArchivingApi.ArchivingTools.Mode.Mode mode) {
		super(fullName);
		device_in_charge = "";
		this.mode = mode;
	...
	public AttributeLightMode(AttributeLight attributeLight,
	 ...
	 */
	public AttributeLightMode(String full_name, String deviceInCharge,
			fr.soleil.hdbtdbArchivingApi.ArchivingTools.Mode.Mode mode) {
		super(full_name);
	 ...
	 * @return
	 */
	static public AttributeLightMode creationWithFullInformation(
			String[] att_tab) {
	 ...
	 * @return
	 */
	static public AttributeLightMode creationWithoutFullInformation(
			String[] att_tab) {
	...
	public boolean equals(Object o) {
		...
		if (device_in_charge != null ? !device_in_charge
			...
			return false;
		if (mode != null ? !mode.equals(attributeLightMode.mode)
				: attributeLightMode.mode != null)
			return false;
		if (trigger_time != null ? !trigger_time
				.equals(attributeLightMode.trigger_time)
	...
	public int hashCode() {
		...
		result = 29 * result
				+ (device_in_charge != null ? device_in_charge.hashCode() : 0);
		result = 29 * result
				+ (trigger_time != null ? trigger_time.hashCode() : 0);
