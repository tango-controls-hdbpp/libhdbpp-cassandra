//+======================================================================
//$Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingWatchApi/strategy/control/modes/ModeControllerFactory.java,v $
//
...
//$Revision: 1.4 $
//
//$Log: ModeControllerFactory.java,v $
	...
	public static IModeController getImpl(int typeOfImpl) {
		...
		default:
			throw new IllegalArgumentException(
					"Expected either DUMMY (1) or DEBUG (2) or HDB_BY_RECORD_COUNT (3) or TDB_BY_RECORD_COUNT (4) , got "
							+ typeOfImpl + " instead.");
		}
