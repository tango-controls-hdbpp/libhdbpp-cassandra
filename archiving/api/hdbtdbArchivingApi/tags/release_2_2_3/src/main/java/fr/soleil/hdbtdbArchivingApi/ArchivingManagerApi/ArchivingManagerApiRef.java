...
public abstract class ArchivingManagerApiRef implements IArchivingManagerApiRef {
	...
	public void ArchivingStart(ArchivingMessConfig archivingMessConfig)
		...
		Enumeration<String> attributeNameList = archivingMessConfig
	...
	public void ArchivingStop(String[] attributeNameList)
		...
		for (int i = 0; i < attributeNameList.length; i++) {
			...
			try {
				...
				archiverName = genericMode.getDeviceInCharge(
						attributeName);
				if (archiverName == ""
	...
	private void connectArchivingDatabase(String mdbhost, String mdbname,
			...
			boolean harvestableCnx, boolean autoCommit)
			throws ArchivingException {
		if (m_DataBase == null) {
			// Host
			String host = mdbhost;
			...
			m_DataBase.setDbConn(ConnectionFactory.connect_auto(host, name,
					schema, user, pass, m_type, rac, harvestableCnx, autoCommit));
			is_connected = true;
		}
	}
	...
	public void ArchivingConfigure(String user, String password, boolean rac)
		...
		ArchivingConfigureWithoutArchiverListInit("", "", user, password, rac,
				false, false);
	...
	public void ArchivingConfigure(String host, String name, String user,
			String password, boolean rac, boolean harvestableCnx,
			boolean autoCommit) throws ArchivingException {

		ArchivingConfigureWithoutArchiverListInit(host, name, user, password,
				rac, harvestableCnx, autoCommit);
	...
	public void ArchivingConfigureWithoutArchiverListInit(String user,
			String password) throws ArchivingException {
	 ...
	 */
	public static Vector<AttributeLightMode> stoppingVector(
			String[] my_light_attributs) {
