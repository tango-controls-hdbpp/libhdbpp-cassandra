...
public class ModeAbsolu extends ModeRoot
{
	 ...
	 * @param i Any received event upper value below this parameter  is archived
	 * @param s Any received event with value upper this parameter  is archived
	 * @param sd Activated  slow dift mode for archiving process
	 * @see #ModeAbsolu()
	 * @see #ModeAbsolu(int, double, double, boolean)
	 */

	public ModeAbsolu(int p , double i , double s, boolean sd)
	{
		super.period = p;
		val_inf = i;
		val_sup = s;
	...
	public String toString()
	{
		...
		buf.append("[" + Tag.MODE_A_TAG + "\r\n" +
		           ...
		           "\t" + Tag.MODE_A3_TAG + " = \"" + this.isSlow_drift() + "\"" + ")]");
		return buf.toString();
	}
	...
	public boolean equals(Object o)
	{
		...
		if ( slow_drift != modeAbsolu.slow_drift ) return false;
    ...
    {
        return "MODE_A + " + super.getPeriod() + " + " + this.getValInf() + " + " + this.getValSup() + " + "+ this.isSlow_drift();
    } 
