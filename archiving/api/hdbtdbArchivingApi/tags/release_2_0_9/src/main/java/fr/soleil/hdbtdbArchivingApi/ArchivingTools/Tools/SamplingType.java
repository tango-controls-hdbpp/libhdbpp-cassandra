...
public class SamplingType implements java.io.Serializable
{
    ...
    private SamplingType( short _type , String _oracleFormat , String _mySqlFormat , String _label )
    {
        this.type = _type;
    ...
    {
        SamplingType newSamplingType = SamplingType.getSamplingType ( this.getType () );
