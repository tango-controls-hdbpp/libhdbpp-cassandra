...
public class ControlResultLine 
{
    ...
    public String getReport() 
    {
        ...
        int id = attr.getId();
        return formatReportLine ( completeName, id , archiver , isArchivingOK , isDetermined , period , lastInsert , lastInsertRequest , deviceStatus );
    }
    ...
    private String formatReportLine ( String completeName , int id, String archiver , boolean isArchivingOK , boolean isDetermined , int period , Timestamp lastInsert , Timestamp lastInsertRequest , String deviceStatus ) 
    {
