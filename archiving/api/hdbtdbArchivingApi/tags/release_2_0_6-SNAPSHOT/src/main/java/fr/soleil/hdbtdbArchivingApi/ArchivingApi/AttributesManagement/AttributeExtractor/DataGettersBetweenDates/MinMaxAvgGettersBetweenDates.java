...
public class MinMaxAvgGettersBetweenDates extends DataExtractor {
	 ...
	 * @param at
	 */
	public MinMaxAvgGettersBetweenDates(IDBConnection con,IAdtAptAttributes at) {
		super(con, at);
	...
	{
		return methods.getAttScalarDataMinMaxAvgBetweenDates(att_name, time_0, time_1, writable, "MAX", dbConn);
	}
	/*
	 * 
	 */
	...
	{
		return methods.getAttScalarDataMinMaxAvgBetweenDates(att_name, time_0, time_1, writable, "MIN", dbConn);
	}
	/*
	 * 
	 */
	...
	{
		return methods.getAttScalarDataMinMaxAvgBetweenDates(att_name, time_0, time_1, writable, "AVG", dbConn);
	}
