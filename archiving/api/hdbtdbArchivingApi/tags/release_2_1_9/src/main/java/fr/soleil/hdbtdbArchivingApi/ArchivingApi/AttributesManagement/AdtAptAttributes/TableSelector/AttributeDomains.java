...
public class AttributeDomains extends AttributesData {
	...
	public String[] get_domains() throws ArchivingException {
		...
		String sqlStr;
		sqlStr = "SELECT DISTINCT " + ConfigConst.TAB_DEF[4] + " FROM "
	 ...
	 * @throws ArchivingException
	 */
	public String[] get_domains_by_criterion(String dom_regexp)
			throws ArchivingException {
		IDBConnection dbConn = ConnectionFactory.getInstance(arch_type);
		if (dbConn == null)
			return null;
	...
	public int get_domainsCount() throws ArchivingException {
		...
		// Create and execute the SQL query string
		String sqlStr;
		sqlStr = "SELECT COUNT(DISTINCT " + ConfigConst.TAB_DEF[4] + ") FROM "
				+ dbConn.getSchema() + "." + ConfigConst.TABS[0];
		// System.out.println("sqlStr = " + sqlStr);
