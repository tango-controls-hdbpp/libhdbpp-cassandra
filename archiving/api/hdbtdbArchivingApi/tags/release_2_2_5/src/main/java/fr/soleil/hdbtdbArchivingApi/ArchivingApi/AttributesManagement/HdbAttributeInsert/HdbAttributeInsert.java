...
public abstract class HdbAttributeInsert implements IHdbAttributeInsert {
	...
	public void insert_ScalarData(ScalarEvent scalarEvent)
		...
		try {
			...
			insertScalarDataInDB(_query, _attributeName, _writable, _timeSt,
					_value, _dataType);
	...
	protected void insertScalarDataInDB(StringBuffer _query,
		...
		try {
			...
			this.logger.trace(ILogger.LEVEL_ERROR,
					"SqlException has been raised insertScalarData()");
			String message = "";
			if (e.getMessage()
			...
			String desc = "Failed while executing HdbAttributeInsert.insertScalarDataInDB() method...";
