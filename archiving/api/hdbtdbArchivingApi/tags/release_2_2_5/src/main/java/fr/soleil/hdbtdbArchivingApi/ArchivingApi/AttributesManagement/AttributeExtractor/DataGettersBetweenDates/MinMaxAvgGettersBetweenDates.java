...
public class MinMaxAvgGettersBetweenDates extends DataExtractor {
	 ...
	 * attribute and beetwen two dates (date_1 & date_2).
	 * 
	 * @param argin
	 ...
	 */
	public double getAttDataMinBetweenDates(String[] argin)
			throws ArchivingException {
		...
		case AttrDataFormat._SCALAR:
			min = getAttScalarDataMinBetweenDates(att_name, time_0, time_1,
					writable);
			break;
	 ...
	 * attribute during a given period. and beetwen two dates (date_1 & date_2).
	 * 
	 * @param argin
	 *            The attribute's name, the beginning date (DD-MM-YYYY
	 *            HH24:MI:SS.FF) and the ending date (DD-MM-YYYY HH24:MI:SS.FF).
	 ...
	 * @throws ArchivingException
	 */
	public double getAttDataMaxBetweenDates(String[] argin)
			throws ArchivingException {
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
			return 0;
		...
		switch (data_format) { // [0 - > SCALAR] (1 - > SPECTRUM] [2 - > IMAGE]
		case AttrDataFormat._SCALAR:
			max = getAttScalarDataMaxBetweenDates(att_name, time_0, time_1,
					writable);
			break;
		case AttrDataFormat._SPECTRUM:
			methods.makeDataException(data_format, "Scalar", "Spectrum");
	 ...
	 * during a given period. and beetwen two dates (date_1 & date_2).
	 * 
	 * @param argin
	 *            The attribute's name, the beginning date (DD-MM-YYYY
	 *            HH24:MI:SS.FF) and the ending date (DD-MM-YYYY HH24:MI:SS.FF).
	 ...
	 * @throws ArchivingException
	 */
	public double getAttDataAvgBetweenDates(String[] argin)
			throws ArchivingException {
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
			return 0;
		...
		switch (data_format) { // [0 - > SCALAR] (1 - > SPECTRUM] [2 - > IMAGE]
		case AttrDataFormat._SCALAR:
			avg = getAttScalarDataAvgBetweenDates(att_name, time_0, time_1,
					writable);
			break;
		case AttrDataFormat._SPECTRUM:
			methods.makeDataException(data_format, "Scalar", "Spectrum");
	 ...
	 * 
	 */
	private double getAttScalarDataMaxBetweenDates(String att_name,
			String time_0, String time_1, int writable)
			throws ArchivingException {
		return methods.getAttScalarDataMinMaxAvgBetweenDates(att_name, time_0,
				time_1, writable, "MAX");
	}
	 ...
	 * 
	 */
	private double getAttScalarDataMinBetweenDates(String att_name,
			String time_0, String time_1, int writable)
			throws ArchivingException {
		return methods.getAttScalarDataMinMaxAvgBetweenDates(att_name, time_0,
				time_1, writable, "MIN");
	 ...
	 * 
	 */
	private double getAttScalarDataAvgBetweenDates(String att_name,
			String time_0, String time_1, int writable)
			throws ArchivingException {
		return methods.getAttScalarDataMinMaxAvgBetweenDates(att_name, time_0,
				time_1, writable, "AVG");
