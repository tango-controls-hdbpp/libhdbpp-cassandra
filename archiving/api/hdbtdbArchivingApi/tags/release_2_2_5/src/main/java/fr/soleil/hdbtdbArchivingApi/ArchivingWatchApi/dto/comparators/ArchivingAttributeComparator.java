...
public class ArchivingAttributeComparator implements Comparator<ArchivingAttribute> {
	...
	public int compare(ArchivingAttribute o1, ArchivingAttribute o2) {
		boolean doCompare = false;
		if (o1 != null && o2 != null) {
			if (o1 instanceof ArchivingAttribute
					&& o2 instanceof ArchivingAttribute) {
				doCompare = true;
			}
		}
