//+======================================================================
//$Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingWatchApi/strategy/delay/DelayManagerFactory.java,v $
//
...
//$Revision: 1.7 $
//
//$Log: DelayManagerFactory.java,v $
...
public class DelayManagerFactory {
	...
	public static IDelayManager getImpl(int typeOfImpl) throws DevFailed {
		...
		default:
			Tools.throwDevFailed(new IllegalArgumentException(
					"Expected either DEFAULT_TYPE (1) or FAST_REFRESHING_TYPE(2), got "
							+ typeOfImpl + " instead."));
		}
	...
	/**
	 * Stores a reference to the specified Warnable device implementation for
	 * future use: future instances created by this factory will be given this
	 * Warnable reference.
	 * 
	 * @param _watcherToWarn
	 *            The specified Warnable device implementation
	 */
