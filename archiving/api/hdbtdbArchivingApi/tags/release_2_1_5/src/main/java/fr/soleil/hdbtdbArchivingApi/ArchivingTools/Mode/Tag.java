...
public class Tag
{
	...
	/**
	 * String which describes the <I>slow drift</I> parameter of the absolute mode.
	 */
	...
	/**
	 * String which describes the <I>precision parameter</I> parameter of the difference mode.
	 */
