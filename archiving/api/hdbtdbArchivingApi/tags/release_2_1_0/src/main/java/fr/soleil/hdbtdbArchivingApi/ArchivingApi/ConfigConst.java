...
public class ConfigConst
{
	...
	*                                     PART 2 :      Special constants used to describe the database structure
	 ...
	 */
	public static final String[] TABS = {"adt", "apt", "amt", "isalived", "statpart", //0 ->4
		"dba_scheduler_job_log", "dba_scheduler_job_run_details", "isalived2"};  // 5 -> 7
	...
	public static final String[] TAB_ISALIVED = {"status", "full_name", "id", "archiver","maxtime"}; //0->4
	...
	public static final String[] TAB_LOG_JOB = {"log_id", "log_date", "owner", "job_name", //0->3
		"job_subname", "job_class", "operation", "status", "user_name", "client_id", //4 ->9
		"global_uid", "additional_info"}; //10->11
	
	public static final String[] TAB_RUN_DETAILS = {"log_id", "log_date", "owner", "job_name", //0->3
		"job_subname", "status", "error#", "req_start_date", "actual_start_date", "run_duration", //4 ->9
