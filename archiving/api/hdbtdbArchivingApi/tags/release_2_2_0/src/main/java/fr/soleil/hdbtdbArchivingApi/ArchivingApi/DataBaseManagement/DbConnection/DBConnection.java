...
//    }
    ...
    protected void setM_dataSource(DataSource source) {
        m_dataSource = source;
    }
    ...
    public void setIdsBuffer(Hashtable<String, Integer> idsBuf) {
        this.idsBuffer = idsBuf;
    }

	public void setIsHarvestable(boolean harvestable){
	...
	public void setIsRacConnection(boolean racConnection){
		this.isRacConnection = racConnection;
	}

	public boolean getIsRacConnection(){
		return this.isRacConnection;
	}
