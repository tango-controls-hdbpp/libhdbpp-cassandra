//+======================================================================
//$Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingWatchApi/strategy/choosing/ChoosingStrategyFactory.java,v $
//
...
//$Revision: 1.5 $
//
//$Log: ChoosingStrategyFactory.java,v $
	...
	public static IChoosingStrategy getImpl(int typeOfImpl) {
		...
		default:
			throw new IllegalArgumentException(
					"Expected either TOTAL_TYPE (1) or RANDOM_TYPE (2) or EXHAUSTIVE_TYPE (3) or SCALAR_ONLY_TYPE(4) or SCALAR_AND_SPECTRUMS_ONLY_TYPE(5), got "
							+ typeOfImpl + " instead.");
		}
