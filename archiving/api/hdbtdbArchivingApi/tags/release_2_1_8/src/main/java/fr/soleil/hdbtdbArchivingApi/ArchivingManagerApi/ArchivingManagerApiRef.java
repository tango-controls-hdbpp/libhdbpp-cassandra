...
public abstract class ArchivingManagerApiRef implements IArchivingManagerApiRef {
    ...
    public String getDbHost() throws ArchivingException {
        if (m_DataBase != null) return m_DataBase.getDbConn().getHost();
        return "";
    }
    ...
    public String getDbName() throws ArchivingException {
        if (m_DataBase != null) return m_DataBase.getDbConn().getName();
        return "";
    }
    ...
    public String getDbUser() throws ArchivingException {
        if (m_DataBase != null) return m_DataBase.getDbConn().getUser();
        return "";
    }
    ...
    public String getDbPassword() throws ArchivingException {
        if (m_DataBase != null) return m_DataBase.getDbConn().getPasswd();
        return "";
    }
    ...
    public int getDbType() throws ArchivingException {
        if (m_DataBase != null) return m_DataBase.getDbConn().getDbType();
        return -1;
    }
    ...
    public void ArchivingStart(ArchivingMessConfig archivingMessConfig)
        ...
        initDbArchiverList();
        if (m_DataBase == null) setArchivingException();
        ...
        while (attributeNameList.hasMoreElements()) {
            ...
            // System.out.println (
            // "ArchivingManagerApi/ArchivingStart/attribute|"+attribute );
            try {
                ...
                String desc = "The archiving of the attribute named '"
                        + attribute + "'" + "was not launched ! : \r\n";
                archivingStartException.addStack(message, reason,
                        ErrSeverity.WARN, desc, "", new ArchivingException(e
                                .getMessage()));
                badAttributeList.add(attribute);
        ...
        if (goodAttributeList.size() == 0) {
            ...
            ArchivingException archivingException = new ArchivingException(
                    reason, reason, ErrSeverity.ERR, reason,
                    "ArchivingManagerApi");
        ...
        while (my_archivers.hasMoreElements()) {
            ...
            // System.out.println (
            // "ArchivingManagerApi/ArchivingStart/my_archiver|"+my_archiver );
            ...
            if (assignedAttributes.length > 0) {
                ...
                for (int i = 0; i < assignedAttributes.length; i++) {
                    ...
                    // System.out.println (
                    // "ArchivingManagerApi/ArchivingStart/assignedAttributes[ i ]|"+assignedAttributes[
                    // i ] );
                }
                ...
                try {
                    ...
                    // System.out.println (
                    // "ArchivingManagerApi/ArchivingStart/BEFORE command_inout/my_archiver|"+my_archiver
                    // );
                    ...
                    // System.out.println (
                    // "ArchivingManagerApi/ArchivingStart/AFTER command_inout"
                    // );
                }
                catch (DevFailed devFailed) {
    ...
    public void ArchivingStopConf(String[] attributeNameList)
        ...
        try {
            for (int i = 0; i < attributeNameList.length; i++) {
                ...
                if (!m_DataBase.getMode().getDeviceInCharge(attributeName)
                        .equals("")) {
    ...
    public boolean isArchived(String attributeName) throws ArchivingException {
        ...
        else return m_DataBase.getMode().isArchived(attributeName);
    }
    ...
    private boolean IsArchivedStop(String[] attributeNameList)
            throws ArchivingException {
        for (int i = 0; i < attributeNameList.length; i++) {
            if (isArchived(attributeNameList[i])) return true;
        }
        return false;
    }
    ...
    private static String[] split_att_name_3_fields(String att_name) {
        ...
        if (att_name.startsWith("//")) att_name = att_name.substring(2,
                att_name.length());
        else att_name = TangoAccess.getTangoHost() + "/" + att_name;
    ...
    private void connectArchivingDatabase(String mdbhost, String mdbname,
        ...
        if (m_DataBase == null) {
            ...
            try {
                ...
                if (schema.equals("")) schema = getSchema();// ( historic ) ?
