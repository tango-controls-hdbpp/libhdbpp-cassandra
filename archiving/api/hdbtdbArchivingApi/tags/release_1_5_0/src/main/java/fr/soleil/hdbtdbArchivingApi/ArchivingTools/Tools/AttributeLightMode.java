...
public class AttributeLightMode extends AttributeLight
{
	...
	public AttributeLightMode(String fullName , fr.soleil.hdbtdbArchivingApi.ArchivingTools.Mode.Mode mode)
	{
		super(fullName);
		device_in_charge = "";
		this.mode = mode;
	...
	public AttributeLightMode(AttributeLight attributeLight , String deviceIncharge , fr.soleil.hdbtdbArchivingApi.ArchivingTools.Mode.Mode mode)
	{
	 ...
	 */
	public AttributeLightMode(String full_name , String deviceInCharge , fr.soleil.hdbtdbArchivingApi.ArchivingTools.Mode.Mode mode)
	{
		super(full_name);
