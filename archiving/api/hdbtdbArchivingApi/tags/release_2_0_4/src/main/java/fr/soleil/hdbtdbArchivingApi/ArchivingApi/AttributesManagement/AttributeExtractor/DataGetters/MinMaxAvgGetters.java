...
public class MinMaxAvgGetters extends DataExtractor {
	 ...
	 * @param at
	 */
	public MinMaxAvgGetters(IDBConnection con,  IAdtAptAttributes at) {
		super(con, at);
	...
	{
		return methods.getAttScalarDataMinMaxAvg(att_name, writable, "MIN", dbConn);
	}
	/*
	 * 
	 */
	...
	{
		return methods.getAttScalarDataMinMaxAvg(att_name, writable, "MAX", dbConn);
	}
	/*
	 * 
	 */
	...
	{
		return methods.getAttScalarDataMinMaxAvg(att_name, writable, "AVG", dbConn);
	}
