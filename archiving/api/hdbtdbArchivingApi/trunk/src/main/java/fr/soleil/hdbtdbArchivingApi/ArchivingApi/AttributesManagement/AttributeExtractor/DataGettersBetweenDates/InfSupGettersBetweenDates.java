...
public class InfSupGettersBetweenDates extends DataExtractor {
	 ...
	 */
	public DbData getAttDataInfThanBetweenDates(String[] argin)
			throws ArchivingException {
		...
		case AttrDataFormat._SCALAR:
			dvdsa = getAttScalarDataInfThanBetweenDates(att_name, upper_value,
					time_0, time_1, dbData.getWritable());
	...
	/**
	 * <b>Description : </b> Returns the number data lower than the given value
	 * x, and beetwen two dates (date_1 & date_2).
	 * 
	 * @param argin
	 *            The attribute's name, the lower limit, the beginning date
	 *            (DD-MM-YYYY HH24:MI:SS.FF) and the ending date (DD-MM-YYYY
	 *            HH24:MI:SS.FF).
	 * @return The number data lower than the given value x, and beetwen two
	 *         dates (date_1 & date_2).<br>
	 * @throws ArchivingException
	 */
	public int getAttDataInfThanBetweenDatesCount(String[] argin)
			throws ArchivingException {
		int valuesCount = 0;
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
		...
		case AttrDataFormat._SCALAR:
			valuesCount = getAttScalarDataInfThanBetweenDatesCount(att_name,
					upper_value, time_0, time_1, writable);
			break;
		case AttrDataFormat._SPECTRUM:
	 ...
	 * @throws ArchivingException
	 */
	public DbData getAttDataSupThanBetweenDates(String[] argin)
			throws ArchivingException {
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
			return null;
		...
		switch (dbData.getData_format()) { // [0 - > SCALAR] (1 - > SPECTRUM] [2
											// - > IMAGE]
		case AttrDataFormat._SCALAR:
			dvdsa = getAttScalarDataSupThanBetweenDates(att_name, lower_value,
					time_0, time_1, dbData.getWritable());
			dbData.setData(dvdsa);
			break;
		case AttrDataFormat._SPECTRUM:
	 ...
	 * value y, and beetwen two dates (date_1 & date_2).
	 * 
	 * @param argin
	 *            The attribute's name, the lower limit, the beginning date
	 *            (DD-MM-YYYY HH24:MI:SS.FF) and the ending date (DD-MM-YYYY
	 ...
	 * @throws ArchivingException
	 */
	public int getAttDataSupThanBetweenDatesCount(String[] argin)
			throws ArchivingException {
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
			return 0;
		...
		switch (data_format) { // [0 - > SCALAR] (1 - > SPECTRUM] [2 - > IMAGE]
		case AttrDataFormat._SCALAR:
			valuesCount = getAttScalarDataSupThanBetweenDatesCount(att_name,
					lower_value, time_0, time_1, writable);
			break;
		case AttrDataFormat._SPECTRUM:
			methods.makeDataException(data_format, "Scalar", "Spectrum");
		case AttrDataFormat._IMAGE:
	 ...
	 * @throws ArchivingException
	 */
	public DbData getAttDataInfOrSupThanBetweenDates(String[] argin)
			throws ArchivingException {
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
			return null;
		...
		switch (dbData.getData_format()) { // [0 - > SCALAR] (1 - > SPECTRUM] [2
											// - > IMAGE]
		case AttrDataFormat._SCALAR:
			dvdsa = getAttScalarDataInfOrSupThanBetweenDates(att_name,
					lower_value, upper_value, time_0, time_1, dbData
							.getWritable());
			dbData.setData(dvdsa);
			break;
		case AttrDataFormat._SPECTRUM:
	 ...
	 * 
	 */
	public int getAttDataInfOrSupThanBetweenDatesCount(String[] argin)
			throws ArchivingException {
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
			return 0;
		...
		switch (data_format) { // [0 - > SCALAR] (1 - > SPECTRUM] [2 - > IMAGE]
		case AttrDataFormat._SCALAR:
			valuesCount = getAttScalarDataInfOrSupThanBetweenDatesCount(
					att_name, lower_value, upper_value, time_0, time_1,
					writable);
			break;
		case AttrDataFormat._SPECTRUM:
			methods.makeDataException(data_format, "Scalar", "Spectrum");
	...
	/**
	 * <b>Description : </b> Retrieves data beetwen two dates (date_1 & date_2)
	 * - Data are higher than the given value x AND lower than the given value
	 * y.
	 * 
	 * @param argin
	 *            The attribute's name, the lower limit, the upper limit, the
	 ...
	 * @throws ArchivingException
	 */
	public DbData getAttDataSupAndInfThanBetweenDates(String[] argin)
			throws ArchivingException {
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
			return null;
		...
		switch (dbData.getData_format()) { // [0 - > SCALAR] (1 - > SPECTRUM] [2
											// - > IMAGE]
		case AttrDataFormat._SCALAR:
			dvdsa = getAttScalarDataSupAndInfThanBetweenDates(att_name,
					lower_value, upper_value, time_0, time_1, dbData
							.getWritable());
			dbData.setData(dvdsa);
			break;
	...
	/**
	 * <b>Description : </b> Returns the number of data higher than the given
	 * value x, (AND) lower than the given value y, and beetwen two dates
	 * (date_1 & date_2).
	 * 
	 * @param argin
	 *            The attribute's name, the lower limit, the upper limit, the
	 ...
	 *         than the given value y, and beetwen two dates (date_1 & date_2).<br>
	 * @throws ArchivingException
	 */
	public int getAttDataSupAndInfThanBetweenDatesCount(String[] argin)
			throws ArchivingException {
		int valuesCount = 0;
		IAdtAptAttributes att = AdtAptAttributesFactory.getInstance(arch_type);
		if (att == null)
		...
		switch (data_format) { // [0 - > SCALAR] (1 - > SPECTRUM] [2 - > IMAGE]
		case AttrDataFormat._SCALAR:
			valuesCount = getAttScalarDataSupAndInfThanBetweenDatesCount(
					att_name, lower_value, upper_value, time_0, time_1,
					writable);
			break;
		case AttrDataFormat._SPECTRUM:
	 ...
	 * 
	 */
	private DevVarDoubleStringArray getAttScalarDataInfThanBetweenDates(
			String att_name, int upper_value, String time_0, String time_1,
		...
		String fields = ro_fields ? (dbUtils
				.toDbTimeFieldString(ConfigConst.TAB_SCALAR_RO[0])
				+ ", " + ConfigConst.TAB_SCALAR_RO[1])
				: (dbUtils.toDbTimeFieldString(ConfigConst.TAB_SCALAR_RW[0])
						+ ", " + ConfigConst.TAB_SCALAR_RW[1] + ", " + ConfigConst.TAB_SCALAR_RW[2]); // if
																										// (writable
																										// ==
		...
		String selectField = ro_fields ? ConfigConst.TAB_SCALAR_RO[1]
				: ConfigConst.TAB_SCALAR_RW[1];
		String dateClause = ConfigConst.TAB_SCALAR_RO[0] + " BETWEEN "
		...
		// + ")" + ")";
		String query = "SELECT " + fields + " FROM " + tableName + " WHERE "
				+ "(" + "(" + selectField + " < " + upper_value + ")" + " AND "
				+ "(" + dateClause + ")" + ")" + " ORDER BY time";

		return methods.getAttScalarConditionBetweenDates(query, ro_fields,
				dbConn);
	}
	 ...
	 * 
	 */
	private DevVarDoubleStringArray getAttScalarDataSupThanBetweenDates(
			String att_name, int lower_value, String time_0, String time_1,
			int writable) throws ArchivingException {
		boolean ro_fields = (writable == AttrWriteType._READ || writable == AttrWriteType._WRITE);
		IDBConnection dbConn = ConnectionFactory.getInstance(arch_type);
		IDbUtils dbUtils = DbUtilsFactory.getInstance(arch_type);
	 ...
	 * 
	 */
	private DevVarDoubleStringArray getAttScalarDataInfOrSupThanBetweenDates(
			String att_name, int lower_value, int upper_value, String time_0,
			String time_1, int writable) throws ArchivingException {
		IDBConnection dbConn = ConnectionFactory.getInstance(arch_type);
		IDbUtils dbUtils = DbUtilsFactory.getInstance(arch_type);
		if (dbConn == null || dbUtils == null)
			return null;
	 ...
	 * 
	 */
	private DevVarDoubleStringArray getAttScalarDataSupAndInfThanBetweenDates(
			String att_name, int lower_value, int upper_value, String time_0,
			String time_1, int writable) throws ArchivingException {
		IDBConnection dbConn = ConnectionFactory.getInstance(arch_type);
		IDbUtils dbUtils = DbUtilsFactory.getInstance(arch_type);
	 ...
	 * 
	 */
	private int getAttScalarDataSupThanBetweenDatesCount(String att_name,
			int lower_value, String time_0, String time_1, int writable)
			throws ArchivingException {
		IDBConnection dbConn = ConnectionFactory.getInstance(arch_type);
		IDbUtils dbUtils = DbUtilsFactory.getInstance(arch_type);
		if (dbConn == null || dbUtils == null)
		...
		getAttributeDataQuery = "SELECT " + selectFields + " FROM " + tableName
				+ " WHERE " + "(" + "(" + selectField_1 + " > " + lower_value
				+ ")" + " AND " + "(" + dateClause + ")" + ")";
	 ...
	 * 
	 */
	private int getAttScalarDataInfThanBetweenDatesCount(String att_name,
			int upper_value, String time_0, String time_1, int writable)
			throws ArchivingException {
		IDBConnection dbConn = ConnectionFactory.getInstance(arch_type);
		IDbUtils dbUtils = DbUtilsFactory.getInstance(arch_type);
		if (dbConn == null || dbUtils == null)
		...
		getAttributeDataQuery = "SELECT " + selectFields + " FROM " + tableName
				+ " WHERE " + "(" + "(" + selectField_1 + " < " + upper_value
				+ ")" + " AND " + "(" + dateClause + ")" + ")";
	 ...
	 * 
	 */
	private int getAttScalarDataInfOrSupThanBetweenDatesCount(String att_name,
			int lower_value, int upper_value, String time_0, String time_1,
			int writable) throws ArchivingException {
		IDBConnection dbConn = ConnectionFactory.getInstance(arch_type);
		IDbUtils dbUtils = DbUtilsFactory.getInstance(arch_type);
		if (dbConn == null || dbUtils == null)
		...
		getAttributeDataQuery = "SELECT " + selectFields + " FROM " + tableName
				+ " WHERE " + "(" + "(" + selectField_1 + " < " + lower_value
				+ " OR " + selectField_1 + " > " + upper_value + ")" + " AND "
				+ "(" + dateClause + ")" + ")";
		return methods.getDataCountFromQuery(getAttributeDataQuery, dbConn);
	}
	 ...
	 * @throws ArchivingException
	 */
	private int getAttScalarDataSupAndInfThanBetweenDatesCount(String att_name,
			int lower_value, int upper_value, String time_0, String time_1,
			int writable) throws ArchivingException {
		// Create and execute the SQL query string
		// Build the query string
		...
		getAttributeDataQuery = "SELECT " + selectFields + " FROM " + tableName
				+ " WHERE " + "(" + "(" + selectField_1 + " > " + lower_value
				+ " AND " + selectField_1 + " < " + upper_value + ")" + " AND "
				+ "(" + dateClause + ")" + ")";
		return methods.getDataCountFromQuery(getAttributeDataQuery, dbConn);
	}
