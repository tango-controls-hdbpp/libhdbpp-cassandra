//+============================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoArchiving/ArchivingTools/Mode/ModePeriode.java,v $
//
 ...
 * 'periodic mode' (the archiving occurs folowing a specified period).<BR>
 * </p>
 * 
...
public class ModePeriode extends ModeRoot {
     ...
     */
    public ModePeriode(final int p) {
	super(p);
    }
