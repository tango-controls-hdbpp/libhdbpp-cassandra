...
public class SnapManagerApi
{
	 ...
	 * @throws SnapshotingException 
	 */
	public static void setEquipmentWithCommand(String cmd_name, String option,
			SnapShot snapShot) throws SnapshotingException {
		...
		if ( !device.equals("") )
		{
			...
			//System.out.println("----------------------------On transfère au SnapManager");
			deviceProxy.command_inout("SetEquipmentsWithCommand" , device_data);
		}
		else
		{
			String message = GlobalConst.SNAPSHOTING_ERROR_PREFIX + " : " + GlobalConst.ERROR_SNAP_SET_EQUIPMENT;
