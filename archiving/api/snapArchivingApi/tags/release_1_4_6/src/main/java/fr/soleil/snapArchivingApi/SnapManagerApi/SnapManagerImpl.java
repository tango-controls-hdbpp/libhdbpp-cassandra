...
public class SnapManagerImpl implements ISnapManager
{
    ...
    public SnapManagerImpl ( String _user , String _pwd, boolean _isConnected)
    {
        ...
        System.out.println("SnapManagerImpl/new/user/"+user+"/pwd/"+pwd+"/isConnected/"+isConnected);
    }
	 ...
	 * @see fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#findSnapshotAttributes(fr.soleil.snapArchivingApi.SnapshotingTools.Tools.SnapShotLight)
	 */
	 ...
	 * @throws SnapshotingException
	 * @see fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#saveContext(fr.soleil.snapArchivingApi.SnapshotingTools.Tools.SnapContext, java.util.Hashtable)
	 */
	 ...
	 * @throws SnapshotingException
	 * @see fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#launchSnapshot(fr.soleil.snapArchivingApi.SnapshotingTools.Tools.SnapContext)
	 */
    public SnapShot launchSnapshot(SnapContext context) throws SnapshotingException
    {
        ...
        catch (DevFailed dFEx)// Failure of 'launchSnap2Archiver'. 
        {
            ...
            String desc = "";
            SnapshotingException snapEx = new SnapshotingException(message, reason, ErrSeverity.ERR , desc , "");
            try {
	 ...
	 * @throws SnapshotingException
	 * @see fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#updateCommentOfSnapshot(fr.soleil.snapArchivingApi.SnapshotingTools.Tools.SnapShotLight, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#setEquipmentsWithSnapshot(fr.soleil.snapArchivingApi.SnapshotingTools.Tools.SnapShot)
	 */
	 ...
	 * @throws SnapshotingException
	 * @see fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#findContexts(manager.Criterions)
	 */
	 ...
	 * @throws SnapshotingException
	 * @see fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#findSnapshots(manager.Criterions)
	 */
	 ...
	 * @throws SnapshotingException
	 * @see fr.soleil.snapArchivingApi.SnapManagerApi.ISnapManager#findContextAttributes(fr.soleil.snapArchivingApi.SnapshotingTools.Tools.SnapContext, manager.Criterions)
	 */
	...
	public SnapAttributeExtract[] getSnap ( int id ) throws SnapshotingException
	{
        ...
        try
        {
            ...
            SnapAttributeExtract[] sae = this.findSnapshotAttributes( snapshotLight );
	...
	public void setEquipmentsWithCommand(String cmd_name, String option,
			SnapShot snapShot) {
		// TODO Auto-generated method stub
		try {
			SnapManagerApi.setEquipmentWithCommand(cmd_name, option, snapShot);
		} catch (SnapshotingException e) {
