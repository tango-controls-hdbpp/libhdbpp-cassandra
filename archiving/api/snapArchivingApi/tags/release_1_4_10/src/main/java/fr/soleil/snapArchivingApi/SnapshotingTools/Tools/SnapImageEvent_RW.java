...
public class SnapImageEvent_RW extends SnapAttribute {
	...
	public SnapImageEvent_RW(String[] snapImageEvent_RW) {
		...
		Double[][] value = new Double[dim_y + dim_y_write][max(dim_x,
				dim_x_write)];
		int k = 8;
	...
	public String[] toArray() {
		...
		String[] snapImageEvent_RO = new String[8 + (dim_x + dim_x_write)
				* max(dim_y, dim_y_write)];
	...
	public String toString() {
		...
		snapImageEvent_RO = "Source : \t" + getAttribute_complete_name()
