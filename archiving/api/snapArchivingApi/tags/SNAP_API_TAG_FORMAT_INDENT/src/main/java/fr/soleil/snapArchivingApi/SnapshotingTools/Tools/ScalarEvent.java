...
public class ScalarEvent extends SnapAttribute {
	...
	public Object getValue(String[] scalarEvent) {
		...
		case AttrWriteType._READ_WITH_WRITE:
			...
			switch (getData_type()) {
			case TangoConst.Tango_DEV_STRING:
				String[] valueString = { new String(scalarEvent[7]),
						new String(scalarEvent[8]) };
				value = valueString;
				break;
			case TangoConst.Tango_DEV_STATE:
				Integer[] valueInteger = { new Integer(scalarEvent[7]),
						new Integer(scalarEvent[8]) };
				value = valueInteger;
				break;
			case TangoConst.Tango_DEV_UCHAR:
				Byte[] valueByte = { new Byte(scalarEvent[7]),
						new Byte(scalarEvent[8]) };
				value = valueByte;
				break;
			case TangoConst.Tango_DEV_LONG:
				Integer[] valueLong = { new Integer(scalarEvent[7]),
						new Integer(scalarEvent[8]) };
				value = valueLong;
				break;
			case TangoConst.Tango_DEV_ULONG:
				Integer[] valueULong = { new Integer(scalarEvent[7]),
						new Integer(scalarEvent[8]) };
				value = valueULong;
				break;
			case TangoConst.Tango_DEV_BOOLEAN:
				Boolean[] valueBoolean = { new Boolean(scalarEvent[7]),
						new Boolean(scalarEvent[8]) };
				value = valueBoolean;
				break;
			case TangoConst.Tango_DEV_SHORT:
				Short[] valueShort = { new Short(scalarEvent[7]),
						new Short(scalarEvent[8]) };
				value = valueShort;
				break;
			case TangoConst.Tango_DEV_USHORT:
				Short[] valueUShort = { new Short(scalarEvent[7]),
						new Short(scalarEvent[8]) };
				value = valueUShort;
				break;
			case TangoConst.Tango_DEV_FLOAT:
				Float[] valueFloat = { new Float(scalarEvent[7]),
						new Float(scalarEvent[8]) };
				value = valueFloat;
				break;
			case TangoConst.Tango_DEV_DOUBLE:
				Double[] valueDouble = { new Double(scalarEvent[7]),
						new Double(scalarEvent[8]) };
				value = valueDouble;
				break;
			default:
				value = null;
