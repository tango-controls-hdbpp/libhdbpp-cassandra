...
public class SnapAttributeMedium extends SnapAttributeLight {
	...
	public SnapAttributeMedium(SnapAttributeLight snapAttributeLight,
			int id_context, int id_snap, java.sql.Timestamp snap_date) {
		setAttribute_complete_name(snapAttributeLight
	...
	public boolean equals(Object o) {
		...
		if (getData_format() != snapAttributeMedium.getData_format())
			return false;
		if (getData_type() != snapAttributeMedium.getData_type())
			return false;
		if (getAttribute_id() != snapAttributeMedium.getAttribute_id())
			return false;
		if (id_snap != snapAttributeMedium.id_snap)
			return false;
		if (getWritable() != snapAttributeMedium.getWritable())
			return false;
		if (!getAttribute_complete_name().equals(
				snapAttributeMedium.getAttribute_complete_name()))
			return false;
