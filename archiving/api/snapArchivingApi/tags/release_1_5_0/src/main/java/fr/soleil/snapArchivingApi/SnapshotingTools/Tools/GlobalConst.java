...
//+======================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoSnapshoting/SnapshotingTools/Tools/GlobalConst.java,v $
//
...
// $Revision: 1.11 $
//
// $Log: GlobalConst.java,v $
// Revision 1.11  2007/11/16 10:16:04  soleilarc
// Author: XPigeon
// Mantis bug ID: 5341
// Comment : Add some new constants : STORED_READ_VALUE, STORED_WRITE_VALUE, NEW_VALUE.
//
...
public class GlobalConst {
	...
	public static final String DBT_EXCEPTION = "Tango database exception";
	...
	public static final String[] TAB_DEF = { "ID", "time", "full_name",
			"device", // 0 -> 3
	...
	public static final String[] TAB_SNAP = { "id_snap", "id_context", "time",
			"snap_comment" }; // 0 -> 2
	/**
	 * Array that contains the name's fields for the HDB Mode Table
	 */
	public static final String[] TAB_CONTEXT = { "ID_context", "time", "name",
			"author", "reason", "description" }; // 0 -> 5
	/**
	 * Array that contains the name's fields for the HDB Mode Table
	 */
	 ...
	 * Attribute's Table
	 */
	public static final String[] TAB_SC_RW_NUM = { "id_snap", "id_att",
			"read_value", "write_value" };
	/**
	 * Array that contains the name's fields for the Scalar_Read Attribute's
	 * Table
	 */
	public static final String[] TAB_SC_RW_STR = { "id_snap", "id_att",
			"read_value", "write_value" };
	/**
	 * Array that contains the name's fields for the Scalar_ReadWrite
	 * Attribute's Table
	 ...
	 * Table
	 */
	public static final String[] TAB_SP_RO_STR = { "id_snap", "id_att",
			"dim_x", "value" };
	/**
	 * Array that contains the name's fields for the Scalar_ReadWrite
	 * Attribute's Table
	 */
	public static final String[] TAB_SP_RW_NUM = { "id_snap", "id_att",
			"dim_x", "read_value", "write_value" };
	/**
	 * Array that contains the name's fields for the Scalar_Read Attribute's
	 * Table
	 */
	public static final String[] TAB_SP_RW_STR = { "id_snap", "id_att",
			"dim_x", "read_value", "write_value" };
	/**
	 * Array that contains the name's fields for the Scalar_ReadWrite
	 * Attribute's Table
	 */
	public static final String[] TAB_IM_RO_NUM = { "id_snap", "id_att",
			"dim_x", "dim_y", "value" };
	/**
	 * Array that contains the name's fields for the Scalar_Read Attribute's
	 * Table
	 */
	public static final String[] TAB_IM_RO_STR = { "id_snap", "id_att",
			"dim_x", "dim_y", "value" };
	/**
	 * Array that contains the name's fields for the Scalar_ReadWrite
	 * Attribute's Table
	 */
	public static final String[] TAB_IM_RW_NUM = { "id_snap", "id_att",
			"dim_x", "dim_y", "read_value", "write_value" };
	/**
	 * Array that contains the name's fields for the Scalar_Read Attribute's
	 * Table
	 */
	public static final String[] TAB_IM_RW_STR = { "id_snap", "id_att",
			"read_value", "write_value" };
