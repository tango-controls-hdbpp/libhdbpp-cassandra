//+======================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoSnapshoting/SnapshotingTools/Tools/SnapAttributeExtract.java,v $
//
...
// $Revision: 1.15 $
//
// $Log: SnapAttributeExtract.java,v $
// Revision 1.15  2007/11/16 10:19:06  soleilarc
// Author: XPigeon
// Mantis bug ID: 5341
// Comment :
// Add the new methods named getNewValue and setWriteValue.
// In the getWriteValue and getReadValue methods, modify the case for the image attribute data format.
//
// Revision 1.14  2007/06/29 09:20:31  ounsy
...
public class SnapAttributeExtract extends SnapAttribute {
	...
	public SnapAttributeExtract(String[] argin) {
		...
		case AttrDataFormat._SCALAR:
			...
			case AttrWriteType._READ_WITH_WRITE:
				...
				switch (this.data_type) {
				case TangoConst.Tango_DEV_STRING:
					String[] valueString = { new String(argin[5]),
							new String(argin[6]) };
					value = valueString;
					break;
				case TangoConst.Tango_DEV_STATE:
					Integer[] valueInteger = { new Integer(argin[5]),
							new Integer(argin[6]) };
					value = valueInteger;
					break;
				case TangoConst.Tango_DEV_UCHAR:
					...
					break;
				case TangoConst.Tango_DEV_LONG:
					Integer[] valueLong = { new Integer(argin[5]),
							new Integer(argin[6]) };
					value = valueLong;
					break;
				case TangoConst.Tango_DEV_ULONG:
					Integer[] valueULong = { new Integer(argin[5]),
							new Integer(argin[6]) };
					value = valueULong;
					break;
				case TangoConst.Tango_DEV_BOOLEAN:
					Boolean[] valueBoolean = { new Boolean(argin[5]),
							new Boolean(argin[6]) };
					value = valueBoolean;
					break;
				case TangoConst.Tango_DEV_SHORT:
					Short[] valueShort = { new Short(argin[5]),
							new Short(argin[6]) };
					value = valueShort;
					break;
				case TangoConst.Tango_DEV_FLOAT:
					Float[] valueFloat = { new Float(argin[5]),
							new Float(argin[6]) };
					value = valueFloat;
					break;
				case TangoConst.Tango_DEV_DOUBLE:
					Double[] valueDouble = { new Double(argin[5]),
							new Double(argin[6]) };
					value = valueDouble;
					break;
				default:
					Double[] valueDouble2 = { new Double(argin[5]),
							new Double(argin[6]) };
					value = valueDouble2;
					break;
				}
		...
		case AttrDataFormat._SPECTRUM:
			...
			case AttrWriteType._WRITE:
				...
				stringArrayWrite = toSplitWrite.substring(1,
						toSplitWrite.length() - 1).split(
				...
				case TangoConst.Tango_DEV_BOOLEAN:
					...
					for (int i = 0; i < stringArrayWrite.length; i++) {
						try {
							((Boolean[]) value)[i] = new Boolean(
									Double.valueOf(stringArrayWrite[i])
											.byteValue() != 0);
						} catch (NumberFormatException n) {
							((Boolean[]) value)[i] = new Boolean("true"
				...
				case TangoConst.Tango_DEV_UCHAR:
					...
					for (int i = 0; i < stringArrayWrite.length; i++) {
						try {
							((Byte[]) value)[i] = Byte
									.valueOf(stringArrayWrite[i]);
						} catch (NumberFormatException n) {
							((Byte[]) value)[i] = new Byte(Double.valueOf(
									stringArrayWrite[i]).byteValue());
						}
					}
					break;
				case TangoConst.Tango_DEV_LONG:
				case TangoConst.Tango_DEV_ULONG:
					...
					for (int i = 0; i < stringArrayWrite.length; i++) {
						try {
							...
							((Integer[]) value)[i] = new Integer(Double
									.valueOf(stringArrayWrite[i]).intValue());
						}
					}
					break;
				...
				case TangoConst.Tango_DEV_SHORT:
					...
					for (int i = 0; i < stringArrayWrite.length; i++) {
						try {
							...
							((Short[]) value)[i] = new Short(Double.valueOf(
									stringArrayWrite[i]).shortValue());
						}
					}
					break;
				case TangoConst.Tango_DEV_FLOAT:
			...
			case AttrWriteType._READ:
				...
				stringArrayRead = toSplitRead.substring(1,
						toSplitRead.length() - 1).split(
						GlobalConst.CLOB_SEPARATOR);
				switch (this.data_type) {
				case TangoConst.Tango_DEV_BOOLEAN:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						try {
							((Boolean[]) value)[i] = new Boolean(
									Double.valueOf(stringArrayRead[i])
											.byteValue() != 0);
						} catch (NumberFormatException n) {
							((Boolean[]) value)[i] = new Boolean("true"
				...
				case TangoConst.Tango_DEV_UCHAR:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						try {
							((Byte[]) value)[i] = Byte
									.valueOf(stringArrayRead[i]);
						} catch (NumberFormatException n) {
							((Byte[]) value)[i] = new Byte(Double.valueOf(
									stringArrayRead[i]).byteValue());
						}
					}
					break;
				case TangoConst.Tango_DEV_STATE:
				...
				case TangoConst.Tango_DEV_ULONG:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						try {
							...
							((Integer[]) value)[i] = new Integer(Double
									.valueOf(stringArrayRead[i]).intValue());
						}
					}
					break;
				case TangoConst.Tango_DEV_USHORT:
			...
			case AttrWriteType._READ_WITH_WRITE:
				...
				case TangoConst.Tango_DEV_BOOLEAN:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						try {
							((Boolean[]) ((((Object[]) value))[0]))[i] = new Boolean(
									Double.valueOf(stringArrayRead[i])
											.byteValue() != 0);
						} catch (NumberFormatException n) {
							((Boolean[]) ((((Object[]) value))[0]))[i] = new Boolean(
									"true".equalsIgnoreCase(stringArrayRead[i]));
						}
					}
					for (int i = 0; i < stringArrayWrite.length; i++) {
						try {
							((Boolean[]) ((((Object[]) value))[1]))[i] = new Boolean(
									Double.valueOf(stringArrayWrite[i])
											.byteValue() != 0);
						} catch (NumberFormatException n) {
							((Boolean[]) ((((Object[]) value))[1]))[i] = new Boolean(
				...
				case TangoConst.Tango_DEV_STRING:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						((String[]) ((((Object[]) value))[0]))[i] = new String(
								stringArrayRead[i]);
					}
					for (int i = 0; i < stringArrayWrite.length; i++) {
						((String[]) ((((Object[]) value))[1]))[i] = new String(
								stringArrayWrite[i]);
					}
					break;
				case TangoConst.Tango_DEV_CHAR:
				case TangoConst.Tango_DEV_UCHAR:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						try {
							((Byte[]) ((((Object[]) value))[0]))[i] = Byte
									.valueOf(stringArrayRead[i]);
						} catch (NumberFormatException n) {
							((Byte[]) ((((Object[]) value))[0]))[i] = new Byte(
									Double.valueOf(stringArrayRead[i])
											.byteValue());
						}
					}
					for (int i = 0; i < stringArrayWrite.length; i++) {
						try {
							((Byte[]) ((((Object[]) value))[1]))[i] = Byte
									.valueOf(stringArrayWrite[i]);
						} catch (NumberFormatException n) {
							((Byte[]) ((((Object[]) value))[1]))[i] = new Byte(
									Double.valueOf(stringArrayWrite[i])
											.byteValue());
						}
					}
				...
				case TangoConst.Tango_DEV_ULONG:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						try {
							((Integer[]) ((((Object[]) value))[0]))[i] = Integer
									.valueOf(stringArrayRead[i]);
						} catch (NumberFormatException n) {
							((Integer[]) ((((Object[]) value))[0]))[i] = new Integer(
									Double.valueOf(stringArrayRead[i])
											.intValue());
						}
					}
					for (int i = 0; i < stringArrayWrite.length; i++) {
						try {
							((Integer[]) ((((Object[]) value))[1]))[i] = Integer
									.valueOf(stringArrayWrite[i]);
						} catch (NumberFormatException n) {
							((Integer[]) ((((Object[]) value))[1]))[i] = new Integer(
									Double.valueOf(stringArrayWrite[i])
											.intValue());
						}
					}
				...
				case TangoConst.Tango_DEV_SHORT:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						try {
							((Short[]) ((((Object[]) value))[0]))[i] = Short
									.valueOf(stringArrayRead[i]);
						} catch (NumberFormatException n) {
							((Short[]) ((((Object[]) value))[0]))[i] = new Short(
									Double.valueOf(stringArrayRead[i])
											.shortValue());
						}
					}
					for (int i = 0; i < stringArrayWrite.length; i++) {
						try {
							((Short[]) ((((Object[]) value))[1]))[i] = Short
									.valueOf(stringArrayWrite[i]);
						} catch (NumberFormatException n) {
							((Short[]) ((((Object[]) value))[1]))[i] = new Short(
									Double.valueOf(stringArrayWrite[i])
											.shortValue());
						}
					}
				...
				case TangoConst.Tango_DEV_FLOAT:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						((Float[]) ((((Object[]) value))[0]))[i] = Float
								.valueOf(stringArrayRead[i]);
					}
					for (int i = 0; i < stringArrayWrite.length; i++) {
						((Float[]) ((((Object[]) value))[1]))[i] = Float
								.valueOf(stringArrayWrite[i]);
					}
					break;
				case TangoConst.Tango_DEV_DOUBLE:
					...
					for (int i = 0; i < stringArrayRead.length; i++) {
						((Double[]) ((((Object[]) value))[0]))[i] = Double
								.valueOf(stringArrayRead[i]);
					}
					for (int i = 0; i < stringArrayWrite.length; i++) {
						((Double[]) ((((Object[]) value))[1]))[i] = Double
								.valueOf(stringArrayWrite[i]);
					}
					break;
				default:
	...
	public SnapAttributeExtract(SnapAttributeLight snapAttributeLight) {
		super.setAttribute_complete_name(snapAttributeLight
	...
	public Object getNewValue(String stringValue) {
		...
		case AttrDataFormat._SPECTRUM: {
			String[] stringTable = stringValue
					.split(GlobalConst.CLOB_SEPARATOR_IMAGE_COLS);
		...
		case AttrDataFormat._IMAGE: {
			...
			String[] stringTable = stringValue
					.split(GlobalConst.CLOB_SEPARATOR_IMAGE_ROWS);
			for (int i = 0; i < stringTable.length; i++) {
				stringMatrix[i] = stringTable[i]
						.split(GlobalConst.CLOB_SEPARATOR_IMAGE_COLS);
			}
			...
			case TangoConst.Tango_DEV_BOOLEAN:
				...
				for (int i = 0; i < dimX; i++) {
					for (int j = 0; j < dimX; j++) {
						newMatrix[i][j] = Boolean
								.parseBoolean(stringMatrix[i][j]);
					}
				}
				break;
			...
			case TangoConst.Tango_DEV_DOUBLE:
				...
				for (int i = 0; i < dimX; i++) {
					for (int j = 0; j < dimX; j++) {
						newMatrix[i][j] = Double
								.parseDouble(stringMatrix[i][j]);
					}
				}
				break;
	...
	public String toString() {
		String snapStr = "";
		String value = ((writable == AttrWriteType._READ
				|| writable == AttrWriteType._READ_WITH_WRITE || writable == AttrWriteType._READ_WRITE) ? "read value :  "
				+ valueToString(0)
				: "")
				+ ((writable == AttrWriteType._WRITE
						|| writable == AttrWriteType._READ_WITH_WRITE || writable == AttrWriteType._READ_WRITE) ? "\t "
