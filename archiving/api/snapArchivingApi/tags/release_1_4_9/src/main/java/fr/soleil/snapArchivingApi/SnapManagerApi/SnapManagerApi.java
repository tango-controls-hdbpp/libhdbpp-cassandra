...
public class SnapManagerApi {
	...
	public static int launchSnap2Archiver(int contextID) throws DevFailed {
		String snapArchiverName = chooseDevice(/* m_snapArchiverClassDevice */m_snapManagerClassDevice);
				...
				try {
					...
					case AttrDataFormat._SCALAR:
						...
						case TangoConst.Tango_DEV_SHORT:
							deviceAttribute
									.insert(((Short) value).shortValue());
							break;
						case TangoConst.Tango_DEV_FLOAT:
							deviceAttribute
									.insert(((Float) value).floatValue());
							break;
					...
					case AttrDataFormat._SPECTRUM:
						...
						case TangoConst.Tango_DEV_UCHAR:
							...
							deviceAttribute.insert_uc(byteVal2, byteVal.length,
									0);
							break;
						case TangoConst.Tango_DEV_LONG:
