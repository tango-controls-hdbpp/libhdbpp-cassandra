//+======================================================================
//$Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoSnapshoting/SnapExtractorApi/naming/DynamicAttributeNamerFactory.java,v $
//
...
//$Revision: 1.3 $
//
//$Log: DynamicAttributeNamerFactory.java,v $
	...
	public static IDynamicAttributeNamer getImpl(int typeOfImpl) {
		...
		default:
			throw new IllegalArgumentException(
					"Expected DEFAULT_NAMING (0) or DUMMY_NAMING(1), got "
							+ typeOfImpl + " instead.");
		}
