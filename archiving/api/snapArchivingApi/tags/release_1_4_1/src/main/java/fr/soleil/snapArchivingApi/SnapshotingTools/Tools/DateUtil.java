...
public class DateUtil
{
	...
	static public long stringToMilli(String date) throws SnapshotingException
	{
		...
		{
			String message = fr.soleil.snapArchivingApi.SnapshotingTools.Tools.GlobalConst.SNAPSHOTING_ERROR_PREFIX + " : " + GlobalConst.DATE_PARSING_EXCEPTION;
			String reason = GlobalConst.DATE_PARSING_EXCEPTION;
			String desc = "Failed while executing DateUtil.stringToMilli() method...";
			archivingException = new SnapshotingException(message , reason , ErrSeverity.WARN , desc , "fr.soleil.snapArchivingApi.SnapshotingTools.Tools.DateUtil" , e1);
