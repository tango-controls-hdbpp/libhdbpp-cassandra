//+======================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoSnapshoting/SnapshotingTools/Tools/DateUtil.java,v $
//
...
public class DateUtil {
	 ...
	 * @param date
	 * @return
	 * @throws fr.soleil.snapArchivingApi.SnapshotingTools.Tools.SnapshotingException
	 * 
	 */
	static public long stringToMilli(String date) throws SnapshotingException {
		...
		try {
			...
			String message = fr.soleil.snapArchivingApi.SnapshotingTools.Tools.GlobalConst.SNAPSHOTING_ERROR_PREFIX
			...
			archivingException = new SnapshotingException(
					message,
					reason,
					ErrSeverity.WARN,
					desc,
					"fr.soleil.snapArchivingApi.SnapshotingTools.Tools.DateUtil",
					e1);
	 ...
	 * 
	 */
	static public String stringToDisplayString(String date)
