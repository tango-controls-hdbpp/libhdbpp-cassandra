//+======================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoSnapshoting/SnapshotingTools/Tools/SnapAttributeHeavy.java,v $
//
 ...
 * <p/>
 * <B>Description :</B><BR>
 * The <I>SnapAttributeHeavy</I> object describes a TANGO attribute about to be
 * registered into the SnapShot filing service. It thus contains all available
 * informations characterizing it. An <I>SnapAttributeHeavy</I> contains :
 * <ul>
 ...
 * @version 1.0
 * @see fr.soleil.snapArchivingApi.SnapshotingTools.Tools.SnapContext
 */
public class SnapAttributeHeavy extends SnapAttributeLight {
	 ...
	 * 
	 * @param argin
	 *            an array that contains the SnapAttributeHeavy's registration
	 *            time, full name, device name, associated domain name,
	 *            associated family name, associated member name, attribute
	 *            name, data type parameter, data format parameter, writable
	 *            parameter, max_dim_x value, max_dim_y value, level value,
	 *            belonging control system name, archivable value, substitue
	 *            name.
	 */
	public SnapAttributeHeavy(String[] argin) {
		setRegistration_time(java.sql.Timestamp.valueOf(argin[0])); // ****************
		// Attribute
		// registration
		// timestamp
		setAttribute_complete_name(argin[1]); // **************** The whole
		// attribute name (device_name +
		// attribute_name)
		setAttribute_device_name(argin[2]); // **************** name of the
		// belonging device.
		setDomain(argin[3]); // **************** domain to which the attribute
		// is associated
		setFamily(argin[4]);
		setMember(argin[5]);
		setAttribute_name(argin[6]); // **************** attribute name
		setData_type(Integer.parseInt(argin[7])); // **************** Attribute
		// data type
		setData_format(Integer.parseInt(argin[8])); // ****************
		// Attribute data format
		setWritable(Integer.parseInt(argin[9])); // **************** Attribute
		// read/write type
		setMax_dim_x(Integer.parseInt(argin[10])); // **************** Attribute
		// Maximum X dimension
		setMax_dim_y(Integer.parseInt(argin[11])); // **************** Attribute
		// Maximum Y dimension
		setLevel(Integer.parseInt(argin[12])); // **************** Attribute
		// display level
		setCtrl_sys(argin[13]); // **************** Control system to which the
		// attribute belongs
		setArchivable(Integer.parseInt(argin[14])); // ****************
		// archivable (Property that
		// precises whether the
		// attribute is
		// "on-run-only" archivable,
		// or if it is "always"
		// archivable
		setSubstitute(Integer.parseInt(argin[15])); // ****************
		// substitute
	}
	 ...
	 */
	/*
	 * public String getAttribute_complete_name() { return
	 * getAttribute_complete_name(); //return attribute_complete_name; }
	 */
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>device name</I> (The device to which
	 * it belongs to).
	 * 
	 * @return the SnapAttributeHeavy's <I>device name</I> (The device to which
	 *         it belongs to).
	 */
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>device name</I> (The device to which it
	 * belongs to).
	 * 
	 * @param attribute_device_name
	 *            the SnapAttributeHeavy's <I>device name</I> (The device to
	 *            which it belongs to).
	 */
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>domain</I> (The domain to which it is
	 * associated) .
	 * 
	 * @return the SnapAttributeHeavy's <I>domain</I> (The domain to which it is
	 *         associated).
	 */
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>domain</I> (The domain to which it is
	 * associated) .
	 * 
	 * @param domain
	 *            the SnapAttributeHeavy's <I>domain</I> (The domain to which it
	 *            is associated) .
	 */
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>family</I> (The family to which it is
	 * associated)
	 * 
	 * @return the SnapAttributeHeavy's <I>family</I> (The family to which it is
	 *         associated)
	 */
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>member</I> (The member to which it is
	 * associated).
	 * 
	 * @return the SnapAttributeHeavy's <I>member</I> (The member to which it is
	 *         associated) .
	 */
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>member</I> (The member to which it is
	 * associated)
	 * 
	 * @param member
	 *            the SnapAttributeHeavy's <I>member</I> (The member to which it
	 *            is associated)
	 */
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>name</I> (its personal name, without
	 * the device part).
	 * 
	 * @return the SnapAttributeHeavy's <I>name</I> (its personal name, without
	 *         the device part)
	 */
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>name</I> (its personal name, without the
	 * device part)
	 * 
	 * @param attribute_name
	 *            the SnapAttributeHeavy's <I>name</I> (its personal name,
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>type property</I>
	 * (DevShort/DevLong/DevDouble)
	 * 
	 * @return the SnapAttributeHeavy's <I>type property</I>
	 *         (DevShort/DevLong/DevDouble)
	 */
	/*
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>type property</I>
	 * (DevShort/DevLong/DevDouble)
	 * 
	 * @param data_type
	 *            the SnapAttributeHeavy's <I>type property</I>
	 *            (DevShort/DevLong/DevDouble)
	 */
	/*
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>data format property</I>
	 * (SCALAR/SPECTRUM/IMAGE)
	 * 
	 * @return the SnapAttributeHeavy's <I>data format property</I>
	 *         (SCALAR/SPECTRUM/IMAGE)
	 */
	/*
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>data format property</I>
	 * (SCALAR/SPECTRUM/IMAGE)
	 * 
	 * @param data_format
	 *            the SnapAttributeHeavy's <I>data format property</I>
	 *            (SCALAR/SPECTRUM/IMAGE)
	 */
	/*
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>writable property</I>
	 * (READ/READ_WRITE/READ_WITH_WRITE).
	 * 
	 * @return the SnapAttributeHeavy's <I>writable property</I>
	 *         (READ/READ_WRITE/READ_WITH_WRITE).
	 */
	/*
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>writable property</I>
	 * (READ/READ_WRITE/READ_WITH_WRITE).
	 * 
	 * @param writable
	 *            the SnapAttributeHeavy's <I>writable property</I>
	 *            (READ/READ_WRITE/READ_WITH_WRITE).
	 */
	/*
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>max_dim_x parameter</I> (maximum size
	 * for attributes of the SPECTRUM and IMAGE data format).
	 * 
	 * @return the SnapAttributeHeavy's <I>max_dim_x parameter</I> (maximum size
	 *         for attributes of the SPECTRUM and IMAGE data format).
	 */
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>max_dim_x parameter</I> (maximum size
	 * for attributes of the SPECTRUM and IMAGE data format).
	 * 
	 * @param max_dim_x
	 *            the SnapAttributeHeavy's <I>max_dim_x parameter</I> (maximum
	 *            size for attributes of the SPECTRUM and IMAGE data format).
	 */
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>max_dim_y parameter</I> (maximum size
	 * for attributes of the SPECTRUM and IMAGE data format).
	 * 
	 * @return the SnapAttributeHeavy's <I>max_dim_y parameter</I> (maximum size
	 *         for attributes of the SPECTRUM and IMAGE data format).
	 */
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>max_dim_y parameter</I> (maximum size
	 * for attributes of the SPECTRUM and IMAGE data format).
	 * 
	 * @param max_dim_y
	 *            the SnapAttributeHeavy's <I>max_dim_y parameter</I> (maximum
	 *            size for attributes of the SPECTRUM and IMAGE data format).
	 */
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>level parameter</I> (This parameter
	 * is only an help for graphical application - this parameter defines an
	 * operator mode or an expert mode).
	 * 
	 * @return the SnapAttributeHeavy's <I>level parameter</I> (This parameter
	 *         is only an help for graphical application - this parameter
	 *         defines an operator mode or an expert mode).
	 */
	public int getLevel() {
		return level;
	}
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>Control system info</I> (Control
	 * system to which belongs the attribute).
	 * 
	 * @return the SnapAttributeHeavy's <I>Control system info</I> (Control
	 *         system to which belongs the attribute).
	 */
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>Control system info</I> (Control system
	 * to which belongs the attribute).
	 * 
	 * @param ctrl_sys
	 *            the SnapAttributeHeavy's <I>Control system info</I> (Control
	 *            system to which belongs the attribute).
	 */
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>archivable property</I> that precises
	 * whether the attribute is "on-run-only" archivable or if it is "always"
	 * archivable.
	 * 
	 * @return the SnapAttributeHeavy's <I>archivable property</I> that precises
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>archivable property</I> that precises
	 * whether the attribute is "on-run-only" archivable or if it is "always"
	 * archivable.
	 * 
	 * @param archivable
	 *            the SnapAttributeHeavy's <I>archivable property</I> that
	 *            precises whether the attribute is "on-run-only" archivable or
	...
	/**
	 * Returns the SnapAttributeHeavy's <I>substitute parameter</I> (Name of the
	 * attribute eventualy replaced by this one).
	 * 
	 * @return the SnapAttributeHeavy's <I>substitute parameter</I> (Name of the
	 *         attribute eventualy replaced by this one).
	 */
	...
	/**
	 * Sets the SnapAttributeHeavy's <I>substitute parameter</I> (Name of the
	 * attribute eventualy replaced by this one).
	 * 
	 * @param substitute
	 *            the SnapAttributeHeavy's <I>substitute parameter</I> (Name of
	 *            the attribute eventualy replaced by this one).
	 */
	 ...
	 * <li>the <I>attribute writable property</I>
	 * (READ/READ_WRITE/READ_WITH_WRITE),
	 * <li>the <I>max_dim_x parameter</I> (maximum size for attributes of the
	 * SPECTRUM and IMAGE data format)
	 * <li>the <I>max_dim_y parameter</I> (maximum size for attributes of the
	 * IMAGE data format)
	 * <li>the <I>level parameter</I> (This parameter is only an help for
	 * graphical application - this parameter defines an operator mode or an
	 * expert mode).
	 * <li>the <I>control system reference</I> (Control system to which belongs
	 * the attribute)
	 * <li>the <I>archivable property</I> that precises whether the attribute is
	 * "on-run-only" archivable, or if it is "always" archivable.
	 * <li>the <I>substitute parameter</I> (Name of the attribute eventualy
