//+======================================================================
//$Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoSnapshoting/SnapExtractorApi/convert/ConverterFactory.java,v $
//
	...
	public static IConverter getImpl(int typeOfImpl) {
		...
		default:
			throw new IllegalArgumentException(
					"Expected DEFAULT_CONVERTER (0), got " + typeOfImpl
							+ " instead.");
		}
