//+======================================================================
// $Source: /cvsroot/tango-cs/tango/api/java/fr/soleil/TangoSnapshoting/SnapshotingTools/Tools/SnapAttributeLight.java,v $
//
 ...
 * <p/>
 * <B>Description :</B><BR>
 * The <I>SnapAttributeLight</I> object describes a TANGO attribute about to be
 * snapshooted. It thus contains all available informations characterizing it.
...
public class SnapAttributeLight {
	...
	/**
	 * Default constructor Creates a new instance of SnapAttributeLight
	 * 
	 ...
	 * 
	 * @param argin
	 *            an array that contains the SnapAttributeLight's full name,
	 *            data type parameter, data format parameter, writable
	 *            parameter.
	 */
	public SnapAttributeLight(String[] argin) {
		setAttribute_complete_name(argin[0]); // **************** The whole
		// attribute name (device_name +
		// attribute_name)
		setAttribute_id(Integer.parseInt(argin[1])); // ****************
		// Attribute identifier
		// used for the database
		// SNAP
		setData_type(Integer.parseInt(argin[2])); // **************** Attribute
		// data type
		setData_format(Integer.parseInt(argin[3])); // ****************
	 ...
	 * 
	 * @param attribute_id
	 *            identifier used for the database SNAP.
	 */
	...
	/**
	 * Returns the SnapAttributeLight's <I>type property</I>
	 * (DevShort/DevLong/DevDouble)
	 * 
	 * @return the SnapAttributeLight's <I>type property</I>
	 *         (DevShort/DevLong/DevDouble)
	 */
	...
	/**
	 * Sets the SnapAttributeLight's <I>type property</I>
	 * (DevShort/DevLong/DevDouble)
	 * 
	 * @param data_type
	 *            the SnapAttributeLight's <I>type property</I>
	 *            (DevShort/DevLong/DevDouble)
	 */
	...
	/**
	 * Returns the SnapAttributeLight's <I>data format property</I>
	 * (SCALAR/SPECTRUM/IMAGE)
	 * 
	 * @return the SnapAttributeLight's <I>data format property</I>
	 *         (SCALAR/SPECTRUM/IMAGE)
	 */
	...
	/**
	 * Sets the SnapAttributeLight's <I>data format property</I>
	 * (SCALAR/SPECTRUM/IMAGE)
	 * 
	 * @param data_format
	 *            the SnapAttributeLight's <I>data format property</I>
	 *            (SCALAR/SPECTRUM/IMAGE)
	 */
	...
	/**
	 * Returns the SnapAttributeLight's <I>writable property</I>
	 * (READ/READ_WRITE/READ_WITH_WRITE).
	 * 
	 * @return the SnapAttributeLight's <I>writable property</I>
	 *         (READ/READ_WRITE/READ_WITH_WRITE).
	 */
	...
	/**
	 * Sets the SnapAttributeLight's <I>writable property</I>
	 * (READ/READ_WRITE/READ_WITH_WRITE).
	 * 
	 * @param writable
	 *            the SnapAttributeLight's <I>writable property</I>
	 *            (READ/READ_WRITE/READ_WITH_WRITE).
	 */
