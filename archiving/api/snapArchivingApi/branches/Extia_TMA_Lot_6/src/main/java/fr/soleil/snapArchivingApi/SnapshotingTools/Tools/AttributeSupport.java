...
public class AttributeSupport {
	public static boolean checkAttributeSupport(String name, int data_type,
			int data_format, int writable) throws SnapshotingException {
		switch (data_format) {
		case AttrDataFormat._SCALAR:
			...
			case AttrWriteType._READ:
				...
				case TangoConst.Tango_DEV_CHAR:
					throw generateException(GlobalConst.DATA_TYPE_EXCEPTION,
							data_type, name);
	...
	private static SnapshotingException generateException(String cause,
		...
		// name + "]";
		return new SnapshotingException(message, reason, ErrSeverity.WARN,
				desc, "");
	}
}
